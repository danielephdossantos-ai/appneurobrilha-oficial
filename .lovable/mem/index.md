...
**Matemática 3º ano+ formato por conteúdo**: numeração → casas de valor; tabuada → tabuada interativa + referência; geometria → figura com vértices A,B,C,D e ângulos rotulados; estatística → gráfico real; medidas → régua/relógio/balança; frações → figura repartida. Nunca forçar casas de valor fora de numeração. Ver [Matemática formato por conteúdo](mem://preferences/matematica-formato-por-conteudo).
