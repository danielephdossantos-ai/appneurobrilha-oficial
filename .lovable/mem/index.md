...
- [Contrato Português 4º ano — Nivelamento](mem://features/contrato-portugues-4ano) — Auditoria de "A Redação dos Exploradores" (24 aulas, 0 dica/reensino, avaliações com 3 alternativas, sem escrita/fluência/sondagem, BNCC 44%) + 7 fases de edição.
