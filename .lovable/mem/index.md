...
- [Contrato Auditoria Escola Brilha — 5 fases](mem://features/contrato-auditoria-escola-brilha-5-fases) — Ordem: (1) Português 6º–9º, (2) BNCC em Arte/Inglês, (3) ligar neuro-engine ao PlayerV4 + acessibilidade, (4) gerador anual 3º–9º, (5) volume mínimo de aulas por disciplina. Uma fase por turno, aprovação antes de aplicar.
...
- [Contrato Português 4º ano — Nivelamento](mem://features/contrato-portugues-4ano) — Auditoria de "A Redação dos Exploradores" (24 aulas) + 7 fases; Fases 1 e 2 ✅ (dica/reensino + avaliações de 4 alternativas). Faltam escrita, fluência, ortografia, ensino visual, sondagem e BNCC 100%.
- [Histórias: personagem = texto](mem://constraints/historias-personagem-genero) — Nome de menina exige figura de menina; só figuras do banco de mídia
