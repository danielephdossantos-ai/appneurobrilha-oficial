...
const aula: Aula = {
  ...
  atividadeGuiada: {
    ...
    visual: {
      ...
      opcoes: [
        ...
        { nome: "outra-opcao-4", imagemUrl: bauImg },],
      respostaCerta: "pipa",
    },
  },
      ...
      perguntas: [
        {
          ...
          opcoes: ["Tradicional", "Atual", "Nem sei", "Preciso observar melhor"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["Atual", "Tradicional", "Nem sei", "Preciso observar melhor"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["Sim, ainda hoje", "Só antigamente", "Nunca", "Preciso observar melhor"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["Tradicional", "Atual", "Nenhuma", "Preciso observar melhor"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["Fazer amigos e cooperar", "Ficar sozinho", "Não fazer nada", "Preciso observar melhor"],
          correta: 0,
  ...
  quiz: [
    ...
    },
    {
      ...
      opcoes: ["Pular corda", "Dirigir um carro", "Trabalhar", "Preciso observar melhor"],
      correta: 0,
    ...
    },
    {
      ...
      opcoes: ["Aprender e fazer amigos", "Apenas descansar", "Apenas correr", "Preciso observar melhor"],
      correta: 0,
  ...
  niveis: {
    ...
    facil: [
      ...
      },
      {
        ...
        opcoes: ["Ainda hoje", "Só antigamente", "Nunca", "Preciso observar melhor"],
        correta: 0,
    ...
    medio: [
      {
        ...
        opcoes: ["Ioiô", "Videogame", "Tablet", "Preciso observar melhor"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Cooperar e respeitar", "Só ganhar", "Ficar quieto", "Preciso observar melhor"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Ajudam a aprender e imaginar", "São iguais", "São só antigas", "Preciso observar melhor"],
        correta: 0,
    ...
    dificil: [
      {
        ...
        opcoes: ["História e cultura", "Somente tecnologia", "Nada importante", "Preciso observar melhor"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Aceitar o gosto dele", "Só brincar do meu jeito", "Nunca participar", "Preciso observar melhor"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["A tecnologia", "Os avós", "Os bisavós", "Preciso observar melhor"],
        correta: 0,
