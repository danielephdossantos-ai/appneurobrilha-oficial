...
const aula: Aula = {
  ...
  interativas: [
    ...
    { tipo: "contarQuiz", titulo: "Fase 2 · Coletar as estrelas conquistadas", instrucao: "Toque em cada estrela da Árvore da Amizade.", grupos: [{ imagemUrl: estrelaImg, quantidade: 10, rotulo: "Estrelas conquistadas", cor: "#FBBF24" }], pergunta: "Quantas estrelas a árvore recebeu?", opcoes: ["8", "9", "10"], correta: 2, acerto: "10 estrelas! Missão CONCLUÍDA.", erro: "Conte devagar: 10 estrelas no total." },
