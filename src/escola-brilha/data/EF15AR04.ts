...
const aula: Aula = {
  ...
  atividadeGuiada: {
    ...
    visual: {
      ...
      opcoes: [
        ...
        { nome: "pintura", imagemUrl: quadroImg },
      ],
      ...
      perguntas: [
        {
          ...
          opcoes: ["✏️ DESENHO", "🎨 PINTURA", "🧱 MODELAGEM", "Outra opção"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["🎨 PINTURA", "✏️ DESENHO", "📄 COLAGEM", "Outra opção"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["📄 COLAGEM", "🕊️ DOBRADURA", "🧱 MODELAGEM", "Outra opção"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["🕊️ DOBRADURA", "📄 COLAGEM", "🎨 PINTURA", "Outra opção"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["🧱 MODELAGEM", "🗿 ESCULTURA", "✏️ DESENHO", "Outra opção"],
          correta: 0,
  ...
  quiz: [
    {
      pergunta: "Traços de lápis no papel é:",
      opcoes: ["Desenho", "Escultura", "Colagem", "Outra opção"],
      correta: 0,
    ...
    {
      pergunta: "Tinta com pincel é:",
      opcoes: ["Pintura", "Dobradura", "Modelagem", "Outra opção"],
      correta: 0,
    ...
    },
    {
      ...
      opcoes: ["Dobradura", "Colagem", "Desenho", "Outra opção"],
      correta: 0,
    ...
    },
    {
      ...
      opcoes: ["Modelagem", "Pintura", "Quadrinhos", "Outra opção"],
      correta: 0,
    ...
    },
    {
      ...
      opcoes: ["Quadrinhos", "Colagem", "Escultura", "Outra opção"],
      correta: 0,
    ...
    // FASE 4 — Lupa: ateliê
    {
      ...
      itens: [
        ...
        },
        {
          ...
          rotulo: "🧱 MODELAGEM",
          descoberta: "MODELAGEM — moldar argila ou massinha com as mãos. Depois pode ser pintada!",
        },
        {
          nome: "Quadrinhos",
  ...
  niveis: {
    ...
    facil: [
      {
        pergunta: "Traços de lápis no papel é:",
        opcoes: ["Desenho", "Pintura", "Escultura", "Outra opção"],
        correta: 0,
        explicacao: "Lápis = desenho.",
        visual: { tipo: "itens", imagemUrl: desenhoImg, quantidade: 1, rotulo: "✏️" },
      },
      {
        pergunta: "Papéis coloridos colados é:",
        opcoes: ["Colagem", "Pintura", "Modelagem", "Outra opção"],
        correta: 0,
        explicacao: "Recortar + colar = colagem.",
        visual: { tipo: "itens", imagemUrl: colagemImg, quantidade: 1, rotulo: "📄" },
      },
      {
        pergunta: "Massinha moldada é:",
        opcoes: ["Modelagem", "Desenho", "Dobradura", "Outra opção"],
        correta: 0,
        explicacao: "Massinha = modelagem.",
        visual: { tipo: "itens", imagemUrl: modelagemImg, quantidade: 1, rotulo: "🧱" },
      },
    ...
    medio: [
      {
        ...
        opcoes: ["Pintura", "Escultura", "Quadrinhos", "Outra opção"],
        correta: 0,
        explicacao: "Tinta + pincel = pintura.",
      ...
      },
      {
        ...
        opcoes: ["Dobradura", "Colagem", "Modelagem", "Outra opção"],
        correta: 0,
        explicacao: "Dobrar = dobradura.",
        visual: { tipo: "itens", imagemUrl: dobraduraImg, quantidade: 1, rotulo: "🕊️" },
      },
      {
        pergunta: "Desenhos em sequência com balões é:",
        opcoes: ["Quadrinhos", "Escultura", "Pintura", "Outra opção"],
        correta: 0,
    ...
    dificil: [
      ...
      },
      {
        ...
        opcoes: ["Modelagem", "Colagem", "Dobradura", "Outra opção"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Sim, é criatividade", "Não, é proibido", "Só um tipo por vez", "Outra opção"],
        correta: 0,
  ...
  minijogo: {
    ...
    objetivo: "As obras passam na esteira. Toque na bandeja da técnica certa antes que caiam!",
    tempoSegundos: 90,
    minAcertos: 10,
    categorias: [
