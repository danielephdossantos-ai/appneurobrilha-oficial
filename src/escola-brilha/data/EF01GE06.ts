...
const aula: Aula = {
    ...
    narrativa: {
        ...
        contexto: "Brilha visita a FEIRA DAS CASINHAS 🏠 e descobre que existem MUITOS tipos de moradia: oca, casa de tijolo, prédio…",
        problema: "A Coruja Sábia mostra também os OBJETOS de casa — antigos e novos — e pergunta: 'De QUE eles são feitos? MADEIRA? TIJOLO? PLÁSTICO?'",
    ...
    missao: "Identificar tipos de moradia e objetos do cotidiano, comparando materiais e técnicas usadas na produção.",
    objetivos: [
    ...
    atividadeGuiada: {
        ...
        resposta: "🏕️ OCA!",
        explicacao: "A oca é uma moradia indígena feita de madeira e palha — muito fresquinha.",
        visual: {
            tipo: "escolherImagem",
            ...
            opcoes: [
                ...
                { nome: "casa antiga", imagemUrl: casaAntigaImg }
            ],
            respostaCerta: "oca",
        },
    },
            ...
            perguntas: [
                {
                    ...
                    opcoes: ["Palha e madeira", "Concreto", "Vidro", "Preciso observar melhor"],
                    correta: 0,
                ...
                },
                {
                    ...
                    opcoes: ["Concreto e tijolo", "Papel", "Algodão", "Preciso observar melhor"],
                    correta: 0,
                ...
                },
                {
                    ...
                    opcoes: ["Tecido macio", "Metal", "Vidro", "Preciso observar melhor"],
                    correta: 0,
                ...
                },
                {
                    ...
                    opcoes: ["Árvore", "Pedra", "Nuvem", "Preciso observar melhor"],
                    correta: 0,
                ...
                },
                {
                    ...
                    opcoes: ["Grande, com fio", "Igual celular", "De pano", "Preciso observar melhor"],
                    correta: 0,
    ...
    quiz: [
        {
            ...
            opcoes: ["Oca", "Prédio", "Casa moderna", "Preciso observar melhor"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Muitos andares", "Só um cômodo", "Roda", "Preciso observar melhor"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Barro cozido", "Tecido", "Vidro", "Preciso observar melhor"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Tecido", "Metal", "Madeira dura", "Preciso observar melhor"],
            correta: 0,
    ...
    conclusao: "🏅 Medalha conquistada: Arquiteto do Brilha! 🏠 Item desbloqueado: Coleção das Casinhas do Mundo.",
    curiosidade: {
        titulo: "Você sabia?",
        texto: "Em cada CANTO do Brasil as casas mudam: no Norte tem palafita 🏚️ (em cima da água), no Nordeste tem casa de taipa e no Sul tem casa de madeira 🪵.",
    },
    interativas: [
        ...
        // FASE 1 — escolherFigura: identificar oca
        {
            ...
            opcoes: [
                ...
                { nome: "casa antiga", imagemUrl: casaAntigaImg, rotulo: "CASA ANTIGA" }
            ],
            correta: 0,
            ...
            escolhas: [
                ...
                },
                {
                    ...
                    opcoes: [
                        ...
                        { nome: "Boneca", imagemUrl: bonecaImg, rotulo: "BONECA" }
                    ],
                },
                {
        ...
        facil: [
            {
                ...
                opcoes: ["Palha", "Vidro", "Metal", "Preciso observar melhor"],
                correta: 0,
            ...
            },
            {
                ...
                opcoes: ["Madeira", "Tecido só", "Vidro", "Preciso observar melhor"],
                correta: 0,
            ...
            {
                pergunta: "Prédio tem…",
                opcoes: ["Muitos andares", "Uma folha só", "Rodas", "Preciso observar melhor"],
                correta: 0,
        ...
        medio: [
            {
                ...
                opcoes: ["Grande e de madeira", "Fininho", "De pano", "Preciso observar melhor"],
                correta: 0,
            ...
            },
            {
                ...
                opcoes: ["Tecido", "Concreto", "Vidro", "Preciso observar melhor"],
                correta: 0,
            ...
            },
            {
                ...
                opcoes: ["Barro cozido", "Palha só", "Papel", "Preciso observar melhor"],
                correta: 0,
        ...
        dificil: [
            {
                ...
                opcoes: ["Telefone com fio", "Videogame", "TV moderna", "Preciso observar melhor"],
                correta: 0,
            ...
            },
            {
                ...
                opcoes: ["Ursinho e boneca", "Prédio", "Estrada", "Preciso observar melhor"],
                correta: 0,
    ...
    minijogo: {
        ...
        objetivo: "Arraste cada peça pro material certo antes do tempo acabar ⏱️! Cada acerto solta um brilho na fábrica.",
        tempoSegundos: 90,
        categorias: [
    ...
    missaoFamilia: {
        ...
        instrucao: "Com um familiar, andem pela CASA e escolham 3 objetos. Observem juntos DE QUE material cada um é feito.",
        registros: [
