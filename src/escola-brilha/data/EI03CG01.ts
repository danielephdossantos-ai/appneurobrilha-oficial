...
const aula: Aula = {
  ...
  desafio: {
    ...
    visual: {
      cena: [
        { personagem: "Brilha (levanta braços)", itemImagemUrl: brilhaImg, quantidade: 1, cor: "#FBBF24" },
        { personagem: "Lupi (pula)", itemImagemUrl: lupiImg, quantidade: 1, cor: "#F472B6" },
        { personagem: "Fifi (bate palma)", itemImagemUrl: fifiImg, quantidade: 1, cor: "#FB923C" }
      ],
      perguntas: [
  ...
  quiz: [
    { pergunta: "O que a gente usa pra PULAR?", opcoes: ["Braços", "Pernas", "Nariz"], correta: 1, explicacao: "As pernas empurram o corpo pra cima!", visual: { tipo: "itens", imagemUrl: brilhaImg, quantidade: 1, rotulo: "Movimento" } },
    { pergunta: "O que a gente usa pra ABRAÇAR?", opcoes: ["Pernas", "Braços", "Orelhas"], correta: 1, explicacao: "Os braços envolvem o amigo no abraço.", visual: { tipo: "itens", imagemUrl: brilhaImg, quantidade: 1, rotulo: "Movimento" } },
    { pergunta: "O que a gente usa pra BATER PALMA?", opcoes: ["Mãos", "Pés", "Olhos"], correta: 0, explicacao: "Palma é mão com mão!", visual: { tipo: "itens", imagemUrl: brilhaImg, quantidade: 1, rotulo: "Movimento" } }
  ],
  ...
  interativas: [
    ...
    { tipo: "ligar", titulo: "Fase 3 · Cada amigo, uma parte do corpo", instrucao: "Ligue cada amigo ao par certo.", pares: [
      { a: "Brilha", b: "levanta os braços", aImagem: brilhaImg, aQuantidade: 1, bImagem: estrelaImg, bQuantidade: 1 },
      { a: "Lupi", b: "pula com as pernas", aImagem: lupiImg, aQuantidade: 1, bImagem: florImg, bQuantidade: 1 },
      { a: "Fifi", b: "bate palma com as mãos", aImagem: fifiImg, aQuantidade: 1, bImagem: coracaoImg, bQuantidade: 1 }
    ] },
  ],
  ...
  niveis: {
    ...
    medio: [
      ...
      { pergunta: "E este amigo, o corpo está caído. Como está?", opcoes: ["Feliz", "Triste", "Animado"], correta: 1, explicacao: "Corpo pra baixo mostra tristeza.", visual: { tipo: "itens", imagemUrl: felizImg, quantidade: 1, rotulo: "Emoção" } }
    ],
    dificil: [
