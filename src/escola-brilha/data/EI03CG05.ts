...
const aula: Aula = {
  ...
  desafio: {
    ...
    visual: {
      cena: [
        { personagem: "Brilha (toca)", itemImagemUrl: brilhaImg, quantidade: 1, cor: "#FBBF24" },
        { personagem: "Lupi (arrasta)", itemImagemUrl: lupiImg, quantidade: 1, cor: "#F472B6" },
        { personagem: "Fifi (encaixa)", itemImagemUrl: fifiImg, quantidade: 1, cor: "#FB923C" }
      ],
      perguntas: [
  ...
  quiz: [
    { pergunta: "Pra pegar coisa PEQUENA, que dedos ajudam?", opcoes: ["Polegar + indicador", "Cotovelo", "Pé"], correta: 0, explicacao: "Pinça é o segredo!", visual: { tipo: "itens", imagemUrl: brilhaImg, quantidade: 1, rotulo: "Movimento" } },
    { pergunta: "Pra ENCAIXAR uma peça, precisa…", opcoes: ["Chutar", "Colocar no lugar certo", "Jogar longe"], correta: 1, explicacao: "Encaixar = lugar certo.", visual: { tipo: "itens", imagemUrl: brilhaImg, quantidade: 1, rotulo: "Movimento" } },
    { pergunta: "Arrastar é…", opcoes: ["Segurar e levar", "Soltar no ar"], correta: 0, explicacao: "Segurar sem soltar.", visual: { tipo: "itens", imagemUrl: brilhaImg, quantidade: 1, rotulo: "Movimento" } }
  ],
  ...
  interativas: [
    ...
    { tipo: "ligar", titulo: "Fase 3 · Cada amigo, seu movimento", instrucao: "Ligue cada amigo ao par certo.", pares: [
      { a: "Brilha", b: "TOCA no ponto", aImagem: brilhaImg, aQuantidade: 1, bImagem: estrelaImg, bQuantidade: 1 },
      { a: "Lupi", b: "ARRASTA o bloco", aImagem: lupiImg, aQuantidade: 1, bImagem: blocoImg, bQuantidade: 1 },
      { a: "Fifi", b: "ENCAIXA na caixa", aImagem: fifiImg, aQuantidade: 1, bImagem: bauImg, bQuantidade: 1 }
    ] },
  ],
  ...
  niveis: {
    dominioMinimo: 70,
    facil: [
      { pergunta: "Qual amigo ENCAIXA?", opcoes: ["Brilha", "Lupi", "Fifi"], correta: 2, explicacao: "Fifi coloca no lugar certo.", visual: { tipo: "itens", imagemUrl: brilhaImg, quantidade: 1, rotulo: "Movimento" } },
      { pergunta: "Quantos amigos treinam mãos?", opcoes: ["2", "3", "4"], correta: 1, explicacao: "3 amigos!", visual: { tipo: "itens", imagemUrl: brilhaImg, quantidade: 1, rotulo: "Movimento" } }
    ],
    medio: [
