  ...
  interativas: [
    ...
    // FASE 1 — Escolher figura: onde acontece essa festa
    {
      ...
      opcoes: [
        ...
        { nome: "País", imagemUrl: bandeiraBrasilImg, rotulo: "🇧🇷 PAÍS", correto: false },
      ],
    ...
    // FASE 2 — Ligar festa ao lugar
    {
      ...
      pares: [
        { esquerda: "Aniversário", direita: "Casa", esquerdaImagem: boloImg, direitaImagem: casaImg },
        { esquerda: "Festa Junina", direita: "Escola", esquerdaImagem: bandeirolaImg, direitaImagem: escolaImg },
        { esquerda: "Formatura", direita: "Pátio da escola", esquerdaImagem: professoraImg, direitaImagem: patioImg },
        { esquerda: "Independência", direita: "País", esquerdaImagem: bandeiraBrasilImg, direitaImagem: bandeiraBrasilImg },
      ],
    },
