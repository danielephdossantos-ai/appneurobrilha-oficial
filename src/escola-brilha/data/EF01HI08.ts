  ...
  atividadeGuiada: {
    ...
    visual: {
      ...
      opcoes: [
        ...
        { nome: "outra-opcao-4", imagemUrl: festaImg },],
      ...
      perguntas: [
        {
          ...
          opcoes: ["Família", "Escola", "País", "Preciso observar melhor"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["Escola", "Família só", "País só", "Preciso observar melhor"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["Comunidade e do país", "Só da escola", "Só da família", "Preciso observar melhor"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["Na família", "Na escola só", "No país só", "Preciso observar melhor"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["Lembrar algo importante", "Nada", "Só ganhar presente", "Preciso observar melhor"],
          correta: 0,
  ...
  quiz: [
    {
      ...
      opcoes: ["Algo importante", "Nada", "Só bolo", "Preciso observar melhor"],
      correta: 0,
    ...
    },
    {
      ...
      opcoes: ["Familiar", "Escolar", "Do país", "Preciso observar melhor"],
      correta: 0,
    ...
    },
    {
      ...
      opcoes: ["Da escola", "Só familiar", "De ninguém", "Preciso observar melhor"],
      correta: 0,
    ...
    },
    {
      ...
      opcoes: ["Da comunidade e do país", "Só da escola", "Só de uma família", "Preciso observar melhor"],
      correta: 0,
      ...
      escolhas: [
        ...
        },
        {
          ...
          opcoes: [
            ...
            { nome: "outra-opcao-4", imagemUrl: boloImg },],
        },
      ],
  ...
  niveis: {
    ...
    facil: [
      ...
      },
      {
        ...
        opcoes: ["Escolar", "Familiar", "Do país", "Preciso observar melhor"],
        correta: 0,
      ...
      {
        pergunta: "7 de Setembro é festa:",
        opcoes: ["Do país", "Só da escola", "Só de família", "Preciso observar melhor"],
        correta: 0,
    ...
    medio: [
      {
        ...
        opcoes: ["Escola", "Praia", "Rua", "Preciso observar melhor"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Em família", "Só em escola", "Nunca", "Preciso observar melhor"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Um significado", "Nada", "Só bolo", "Preciso observar melhor"],
        correta: 0,
    ...
    dificil: [
      {
        ...
        opcoes: ["Escola e famílias", "Só o motorista", "Ninguém", "Preciso observar melhor"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Da comunidade", "Só da escola", "Só de família", "Preciso observar melhor"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Fortalecer memórias", "Perder tempo", "Ficar sozinho", "Preciso observar melhor"],
        correta: 0,
