...
const aula: Aula = {
    ...
    narrativa: {
        ...
        contexto: "Brilha ganha um DIÁRIO MÁGICO 📓 onde tudo que ele desenha vira mapa 🗺️!",
        problema: "A Coruja Sábia propõe: 'Desenhe o seu CAMINHO da CASA até a ESCOLA — cada lugar que passa vira um pontinho especial!'",
    ...
    missao: "Criar mapas mentais simples com base em caminhos do dia a dia e histórias inventadas.",
    objetivos: [
            ...
            perguntas: [
                {
                    ...
                    opcoes: ["Casa", "Escola", "Padaria", "Preciso observar melhor"],
                    correta: 0,
                ...
                },
                {
                    ...
                    opcoes: ["Padaria", "Praia", "Museu", "Preciso observar melhor"],
                    correta: 0,
                ...
                },
                {
                    ...
                    opcoes: ["Escola", "Casa", "Ponto de ônibus", "Preciso observar melhor"],
                    correta: 0,
                ...
                },
                {
                    ...
                    opcoes: ["Direção", "Pintar", "Comer", "Preciso observar melhor"],
                    correta: 0,
                ...
                },
                {
                    ...
                    opcoes: ["O caminho do personagem", "Só nomes", "Nada", "Preciso observar melhor"],
                    correta: 0,
    ...
    quiz: [
        {
            ...
            opcoes: ["Um desenho do que conhecemos", "Uma comida", "Uma música", "Preciso observar melhor"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Lugares importantes", "Cores", "Nada", "Preciso observar melhor"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Direção do caminho", "Peso", "Tempo", "Preciso observar melhor"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Caminhos E histórias", "Só ruas", "Só comidas", "Preciso observar melhor"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["O ponto de partida", "O último", "Nenhum", "Preciso observar melhor"],
            correta: 0,
            explicacao: "Começamos onde estamos.",
            visual: { tipo: "itens", imagemUrl: casaImg, quantidade: 1, rotulo: "🏠" },
        },
    ],
    conclusao: "🏅 Medalha conquistada: Cartógrafo do Brilha! 📓 Item desbloqueado: Diário Mágico dos Mapas.",
    curiosidade: {
        titulo: "Você sabia?",
        texto: "Os primeiros mapas do mundo foram desenhados na TERRA e em pedaços de COURO 📜, muito antes de existir papel. Os navegadores antigos usavam ESTRELAS pra achar o caminho ⭐.",
    },
    interativas: [
        ...
        // FASE 3 — arrastar: montar o mapa (setas ao longo do trajeto)
        {
            ...
            instrucao: "Arraste cada LUGAR pra ordem certa do caminho: 1º, 2º, 3º e 4º passo.",
            pares: [
        ...
        facil: [
            {
                ...
                opcoes: ["Desenho do caminho", "Uma sopa", "Uma canção", "Preciso observar melhor"],
                correta: 0,
                explicacao: "Vem da cabeça.",
                visual: { tipo: "itens", imagemUrl: mapaImg, quantidade: 1, rotulo: "🗺️" },
            },
            {
                pergunta: "Setas mostram…",
                opcoes: ["Pra onde ir", "Que horas são", "Se tem chuva", "Preciso observar melhor"],
                correta: 0,
                explicacao: "Direção.",
            ...
            },
            {
                ...
                opcoes: ["Um lugar", "Um dia", "Uma cor", "Preciso observar melhor"],
                correta: 0,
        ...
        medio: [
            {
                ...
                opcoes: ["Casa", "Escola", "Praça", "Preciso observar melhor"],
                correta: 0,
                explicacao: "Começa em casa.",
                visual: { tipo: "itens", imagemUrl: casaImg, quantidade: 1, rotulo: "🏠" },
            },
            {
                ...
                opcoes: ["Orientar direção", "Escrever", "Cozinhar", "Preciso observar melhor"],
                correta: 0,
            ...
            },
            {
                ...
                opcoes: ["História inventada", "Nada", "Cor", "Preciso observar melhor"],
                correta: 0,
        ...
        dificil: [
            {
                ...
                opcoes: ["Começo, meio e fim", "Só o meio", "Só o fim", "Preciso observar melhor"],
                correta: 0,
            ...
            },
            {
                ...
                opcoes: ["O caminho muda", "Nada acontece", "Fica igual", "Preciso observar melhor"],
                correta: 0,
            ...
            },
            {
                ...
                opcoes: ["Entender a jornada do personagem", "Cozinhar", "Comprar", "Preciso observar melhor"],
                correta: 0,
    ...
    minijogo: {
        ...
        objetivo: "Toque nas cartas na ORDEM certa do trajeto ⏱️. Cada sequência completa ilumina uma página do Diário Mágico!",
        tempoSegundos: 90,
        sequencias: [
            {
    ...
    missaoFamilia: {
        ...
        instrucao: "Com um familiar, desenhem juntos o MAPA do caminho da casa até um lugar favorito. Marquem 3 pontos de referência.",
        registros: [
