...
import { url as funcionarioLimpezaImg } from "@/assets/neuro-treino/objetos/funcionario-limpeza.png.asset.json";
...
import { url as panelaImg } from "@/assets/neuro-treino/objetos/sopa.png.asset.json";
...
const aula: Aula = {
    ...
    narrativa: {
        ...
        contexto: "Brilha acorda cedinho na Vila do Brilha 🌅 e escuta a Coruja Sábia dizer: 'Quantas pessoas trabalham pra nossa vila funcionar!'",
        problema: "A padeira faz o pão, o médico cuida da saúde, a professora ensina… mas onde CADA um trabalha? Brilha precisa achar o LOCAL de cada trabalhador usando os pontos de referência 🏘️.",
    ...
    missao: "Reconhecer atividades de trabalho da comunidade e localizar seus lugares por meio de pontos de referência.",
    objetivos: [
            ...
            perguntas: [
                {
                    ...
                    opcoes: ["Escola", "Padaria", "Praça", "Preciso observar melhor"],
                    correta: 0,
                ...
                },
                {
                    ...
                    opcoes: ["Padaria", "Escola", "Museu", "Preciso observar melhor"],
                    correta: 0,
                ...
                },
                {
                    ...
                    opcoes: ["Praça e ruas", "Nada", "Só de casa dele", "Preciso observar melhor"],
                    correta: 0,
                ...
                },
                {
                    ...
                    opcoes: ["Museu", "Padaria", "Ponto de ônibus", "Preciso observar melhor"],
                    correta: 0,
                ...
                },
                {
                    ...
                    opcoes: ["Ponto de ônibus", "Mercado", "Escola", "Preciso observar melhor"],
                    correta: 0,
    ...
    quiz: [
        {
            ...
            opcoes: ["Escola", "Museu", "Praça", "Preciso observar melhor"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Padeira", "Médico", "Professora", "Preciso observar melhor"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Médico no posto", "Bibliotecário", "Pedreiro", "Preciso observar melhor"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Ajudar a se localizar", "Nada", "Comer", "Preciso observar melhor"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Funcionar bem", "Parar", "Ficar quieta", "Preciso observar melhor"],
            correta: 0,
            explicacao: "Todos ajudam.",
            visual: { tipo: "itens", imagemUrl: pracaImg, quantidade: 1, rotulo: "🌳" },
        },
    ],
    conclusao: "🏅 Medalha conquistada: Amigo dos Trabalhadores! 🧰 Item desbloqueado: Álbum de Profissões do Bairro.",
    curiosidade: {
        titulo: "Você sabia?",
        texto: "Muitos profissionais começam a trabalhar de MADRUGADA 🌙 pra nossa vila acordar pronta — como padeiros, feirantes e motoristas de ônibus 🚌.",
    },
    interativas: [
        ...
        // FASE 1 — escolherFigura: onde trabalha a professora
        {
            ...
            opcoes: [
                ...
                { nome: "museu", imagemUrl: museuImg, rotulo: "MUSEU" }
            ],
            correta: 0,
        ...
        facil: [
            {
                ...
                opcoes: ["Escola", "Praça", "Padaria", "Preciso observar melhor"],
                correta: 0,
            ...
            },
            {
                ...
                opcoes: ["Biblioteca", "Praça", "Ponto de ônibus", "Preciso observar melhor"],
                correta: 0,
        ...
        medio: [
            {
                ...
                opcoes: ["Mercado", "Escola", "Museu", "Preciso observar melhor"],
                correta: 0,
            ...
            },
            {
                ...
                opcoes: ["Esperar o ônibus", "Dormir", "Comer", "Preciso observar melhor"],
                correta: 0,
            ...
            },
            {
                ...
                opcoes: ["Ver obras e história", "Comprar comida", "Dormir", "Preciso observar melhor"],
                correta: 0,
        ...
        dificil: [
            {
                ...
                opcoes: ["Localizar caminho", "Cozinhar", "Correr", "Preciso observar melhor"],
                correta: 0,
            ...
            },
            {
                ...
                opcoes: ["Da rua limpa", "Só de casa", "De nada", "Preciso observar melhor"],
                correta: 0,
            ...
            },
            {
                ...
                opcoes: ["Não funciona bem", "Fica igual", "Melhora", "Preciso observar melhor"],
                correta: 0,
    ...
    minijogo: {
        ...
        objetivo: "Encontre os 5 TRABALHADORES da vila em 90 segundos ⏱️. Cuidado com os distratores!",
        tempoSegundos: 90,
        elementos: [
            { nome: "Professora", imagemUrl: professoraImg, rotulo: "👩‍🏫" },
            { nome: "Padeira", imagemUrl: cozinheiraImg, rotulo: "👩‍🍳" },
    ...
    missaoFamilia: {
        ...
        instrucao: "Andem pelo BAIRRO e observem 3 trabalhadores diferentes. Conversem sobre o que cada um faz e onde trabalha.",
        registros: [
