...
import { url as tecidoColoridoImg } from "@/assets/neuro-treino/objetos/tecido-colorido.png.asset.json";
...
const aula: Aula = {
  ...
  atividadeGuiada: {
    ...
    visual: {
      ...
      opcoes: [
        ...
        { nome: "mascara-africana", imagemUrl: mascaraAfricanaImg },
      ],
      ...
      perguntas: [
        {
          ...
          opcoes: ["🪶 INDÍGENA", "🌍 AFRICANA", "🎪 POPULAR", "Outra opção"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["🌍 AFRICANA", "🪶 INDÍGENA", "🎪 POPULAR", "Outra opção"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["🎪 POPULAR", "🪶 INDÍGENA", "🌍 AFRICANA", "Outra opção"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["🎪 POPULAR", "🌍 AFRICANA", "🪶 INDÍGENA", "Outra opção"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["🌍 AFRICANA", "🎪 POPULAR", "🪶 INDÍGENA", "Outra opção"],
          correta: 0,
  ...
  quiz: [
    {
      ...
      opcoes: ["Indígena", "Popular", "Africana", "Outra opção"],
      correta: 0,
    ...
    },
    {
      ...
      opcoes: ["Três (indígena, africana e popular)", "Só uma", "Nenhuma", "Outra opção"],
      correta: 0,
  ...
  niveis: {
    ...
    medio: [
      ...
      },
      {
        ...
        opcoes: ["Indígena, africana e popular", "Só popular", "Só europeia", "Outra opção"],
        correta: 0,
    ...
    dificil: [
      ...
      },
      {
        ...
        opcoes: ["A arte do Brasil de hoje", "Só uma cor", "Nada", "Outra opção"],
        correta: 0,
  ...
  minijogo: {
    ...
    objetivo: "As obras passam na esteira. Toque na bandeja da matriz certa antes que caiam!",
    tempoSegundos: 90,
    minAcertos: 10,
    categorias: [
