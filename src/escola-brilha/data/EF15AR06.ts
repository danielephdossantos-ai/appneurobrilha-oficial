...
const aula: Aula = {
  ...
  motivacao: "Quando você OUVE o que o outro vê na arte, aprende um jeito NOVO de olhar o mundo!",
  ...
  exemploResolvido: {
    enunciado: "Você vê um sol vermelho no quadro. Sua amiga vê um vulcão. Quem está certo?",
    passos: [
  ...
  atividadeGuiada: {
    ...
    visual: {
      ...
      opcoes: [
        ...
        { nome: "sem-emocao", imagemUrl: quadroImg },
      ],
      ...
      perguntas: [
        {
          ...
          opcoes: ["😄 ALEGRIA", "😢 TRISTEZA", "😴 SONO", "Outra opção"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["🌈 NATURAL e bonito", "❌ ERRADO", "🚫 PROIBIDO", "Outra opção"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["😢 TRISTEZA", "😄 ALEGRIA", "🤩 ANIMAÇÃO", "Outra opção"],
          correta: 0,
  ...
  quiz: [
    {
      ...
      opcoes: ["O que eu vejo?", "Quanto custa?", "Quem ganha?", "Outra opção"],
      correta: 0,
    ...
    },
    {
      ...
      opcoes: ["O que eu sinto?", "Que dia é hoje?", "Onde é o parque?", "Outra opção"],
      correta: 0,
    ...
    },
    {
      ...
      opcoes: ["É natural — sentidos plurais", "É erro", "É proibido", "Outra opção"],
      correta: 0,
    ...
    },
    {
      ...
      opcoes: ["Ouvir o que ele quis dizer", "Rir da obra", "Rasgar", "Outra opção"],
      correta: 0,
    ...
    },
    {
      ...
      opcoes: ["Alegria", "Tristeza", "Medo", "Outra opção"],
      correta: 0,
  ...
  interativas: [
    // FASE 1 — Ler emoção de obra alegre
    {
      ...
      opcoes: [
        ...
        { nome: "OUTRA-OPCAO", imagemUrl: coracaoImg, rotulo: "🔎 OUTRA OPÇÃO" },
      ],
      correta: 0,
    ...
    // FASE 4 — Lupa: perguntas do diálogo
    {
      ...
      itens: [
        ...
        },
        {
          ...
          descoberta: "SENTIDOS PLURAIS = a mesma obra tem MUITOS significados. Nenhum é errado!",
        },
        {
          nome: "Museu",
          imagemUrl: museuImg,
          rotulo: "🏛️ NO MUSEU",
          descoberta: "No MUSEU, cada visitante vê a obra do seu jeito. Por isso arte é pra todos!",
        },
      ],
    ...
    // FASE 5 — Selecionar tudo que é BOM diálogo
    {
      ...
      opcoes: [
        {
          nome: "Ouvir com atenção",
          imagemUrl: criancasGrupoImg,
          rotulo: "👂 OUVIR",
          correto: true,
        },
        {
          nome: "Perguntar o que quis dizer",
          imagemUrl: quadroImg,
          rotulo: "❓ PERGUNTAR",
          correto: true,
        },
        ...
        {
          nome: "Dizer que está errado",
          imagemUrl: surpresoImg,
          rotulo: "❌ CRITICAR",
          correto: false,
        },
      ],
  ...
  niveis: {
    ...
    facil: [
      {
        ...
        opcoes: ["O que vejo?", "Que horas são?", "Onde é o banheiro?", "Outra opção"],
        correta: 0,
        explicacao: "Começa observando.",
        visual: { tipo: "itens", imagemUrl: quadroImg, quantidade: 1, rotulo: "👀" },
      },
      ...
      },
      {
        ...
        opcoes: ["Ouvir com atenção", "Rir", "Rasgar", "Outra opção"],
        correta: 0,
    ...
    medio: [
      {
        pergunta: "Duas pessoas veem coisas diferentes na mesma obra:",
        opcoes: ["É natural", "É erro", "É proibido", "Outra opção"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["O que sinto?", "Quanto pesa?", "Onde mora?", "Outra opção"],
        correta: 0,
        explicacao: "Sentir é parte da arte.",
        visual: { tipo: "itens", imagemUrl: coracaoImg, quantidade: 1, rotulo: "💗" },
      },
      {
        ...
        opcoes: ["Tristeza ou calma", "Alegria", "Surpresa", "Outra opção"],
        correta: 0,
    ...
    dificil: [
      {
        ...
        opcoes: ["Muitos significados numa obra", "Só um sentido", "Nenhum", "Outra opção"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Respeitar cada olhar", "Ter razão", "Ganhar", "Outra opção"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Explica seu olhar sem brigar", "Grita", "Sai da sala", "Outra opção"],
        correta: 0,
  ...
  minijogo: {
    ...
    objetivo: "As atitudes passam na esteira. Toque em BOA ou RUIM antes que caiam!",
    tempoSegundos: 90,
    minAcertos: 10,
    categorias: [
