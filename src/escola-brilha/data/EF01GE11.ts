...
const aula: Aula = {
    ...
    narrativa: {
        ...
        contexto: "Brilha abre o GUARDA-ROUPA 🧥 e a Coruja Sábia comenta: 'Percebeu que nem sempre a gente usa a mesma roupa? Nem come a mesma comida?'",
        problema: "Quando faz CALOR ☀️, todo mundo quer sorvete e camiseta. Quando esfria ❄️, sopinha e casaco. Bora descobrir POR QUÊ isso muda?",
    ...
    missao: "Associar mudanças no vestuário e nos hábitos alimentares às variações de temperatura da comunidade.",
    objetivos: [
            ...
            perguntas: [
                {
                    ...
                    opcoes: ["Camiseta", "Casaco", "Cachecol", "Preciso observar melhor"],
                    correta: 0,
                ...
                },
                {
                    ...
                    opcoes: ["Casaco", "Camiseta regata", "Chinelo", "Preciso observar melhor"],
                    correta: 0,
                ...
                },
                {
                    ...
                    opcoes: ["Sombrinha", "Boné", "Óculos escuros", "Preciso observar melhor"],
                    correta: 0,
                ...
                },
                {
                    ...
                    opcoes: ["Fresca (sorvete)", "Quentíssima", "Nada", "Preciso observar melhor"],
                    correta: 0,
                    explicacao: "Refresca.",
                ...
                },
                {
                    ...
                    opcoes: ["Sopa quente", "Sorvete gelado", "Suco com gelo", "Preciso observar melhor"],
                    correta: 0,
    ...
    quiz: [
        {
            ...
            opcoes: ["Camiseta leve", "Casaco pesado", "Cachecol", "Preciso observar melhor"],
            correta: 0,
            explicacao: "Roupa leve.",
            visual: { tipo: "itens", imagemUrl: camisetaImg, quantidade: 1, rotulo: "👕" },
        },
        {
            ...
            opcoes: ["Casaco", "Regata", "Chinelo", "Preciso observar melhor"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Sorvete e suco", "Só sopa", "Só chá quente", "Preciso observar melhor"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Sopa quentinha", "Só sorvete", "Só picolé", "Preciso observar melhor"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Cuidar do corpo", "Perder tempo", "Não importa", "Preciso observar melhor"],
            correta: 0,
            explicacao: "Autocuidado.",
            visual: { tipo: "itens", imagemUrl: corujaImg, quantidade: 1, rotulo: "🦉" },
        },
    ],
    conclusao: "🏅 Medalha conquistada: Guardião das Estações! 🧥 Item desbloqueado: Álbum das Estações do Brilha.",
    curiosidade: {
        titulo: "Você sabia?",
        texto: "Em algumas partes do Brasil quase não faz FRIO ❄️ e em outras neva! Por isso as pessoas comem e se vestem de jeitos DIFERENTES em cada região 🇧🇷.",
    },
    interativas: [
        ...
        facil: [
            {
                ...
                opcoes: ["Leve", "Pesada", "Grossa", "Preciso observar melhor"],
                correta: 0,
                explicacao: "Refresca.",
                visual: { tipo: "itens", imagemUrl: camisetaImg, quantidade: 1, rotulo: "👕" },
            },
            {
                ...
                opcoes: ["Casaco", "Regata", "Biquíni", "Preciso observar melhor"],
                correta: 0,
                explicacao: "Aquece.",
                visual: { tipo: "itens", imagemUrl: casacoImg, quantidade: 1, rotulo: "🧥" },
            },
            {
                ...
                opcoes: ["Faz calor", "Faz frio", "Nunca", "Preciso observar melhor"],
                correta: 0,
                explicacao: "Refresca.",
                visual: { tipo: "itens", imagemUrl: sorveteImg, quantidade: 1, rotulo: "🍦" },
            },
        ...
        medio: [
            {
                ...
                opcoes: ["Faz frio", "Faz muito calor", "Nunca", "Preciso observar melhor"],
                correta: 0,
                explicacao: "Aquece.",
                visual: { tipo: "itens", imagemUrl: sopaImg, quantidade: 1, rotulo: "🍲" },
            },
            {
                pergunta: "Chuva pede…",
                opcoes: ["Sombrinha", "Regata", "Chinelo aberto", "Preciso observar melhor"],
                correta: 0,
            ...
            },
            {
                ...
                opcoes: ["Cuidar do corpo", "Perder tempo", "Errado", "Preciso observar melhor"],
                correta: 0,
                explicacao: "Autocuidado.",
        ...
        dificil: [
            {
                ...
                opcoes: ["Comem mais comida quente", "Comem só picolé", "Não comem", "Preciso observar melhor"],
                correta: 0,
            ...
            },
            {
                ...
                opcoes: ["Roupa leve", "Casaco grosso", "Sapato de neve", "Preciso observar melhor"],
                correta: 0,
                explicacao: "Refresca.",
                visual: { tipo: "itens", imagemUrl: camisetaImg, quantidade: 1, rotulo: "👕" },
            },
            {
                ...
                opcoes: ["A temperatura muda no ano", "Nada muda", "Só por moda", "Preciso observar melhor"],
                correta: 0,
    ...
    minijogo: {
        ...
        objetivo: "Arraste cada item pro TEMPO certo antes do relógio parar ⏱️! Coloque roupas e comidas em CALOR ou FRIO.",
        tempoSegundos: 90,
        categorias: [
    ...
    missaoFamilia: {
        ...
        instrucao: "Com a família, criem juntos um CARDÁPIO da semana pensando no clima. Escolham roupas e comidas pra cada dia.",
        registros: [
