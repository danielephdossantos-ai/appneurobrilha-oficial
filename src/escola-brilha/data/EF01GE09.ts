...
const aula: Aula = {
    ...
    narrativa: {
        ...
        contexto: "Brilha descobre um SEGREDO da Coruja Sábia 🦉: 'O seu próprio corpo é a MELHOR bússola pra se localizar 🧭!'",
        problema: "Frente, atrás, direita, esquerda, em cima, embaixo, dentro, fora — Brilha precisa aprender a mexer o corpo pra achar todos os TESOUROS escondidos!",
    ...
    missao: "Usar referenciais espaciais (frente/atrás, direita/esquerda, cima/baixo, dentro/fora) para localizar elementos.",
    objetivos: [
    ...
    atividadeGuiada: {
        ...
        visual: {
            ...
            opcoes: ["Em cima da caixa", "Embaixo da caixa", "Dentro da caixa", "Preciso observar melhor"],
            correta: 0,
        },
    },
    exercicios: [
            ...
            perguntas: [
                {
                    ...
                    opcoes: ["Dentro", "Fora", "Em cima", "Preciso observar melhor"],
                    correta: 0,
                ...
                },
                {
                    ...
                    opcoes: ["Embaixo", "Em cima", "Dentro", "Preciso observar melhor"],
                    correta: 0,
                ...
                },
                {
                    ...
                    opcoes: ["Em cima", "Embaixo", "Fora", "Preciso observar melhor"],
                    correta: 0,
                ...
                },
                {
                    ...
                    opcoes: ["À direita", "À esquerda", "Atrás", "Preciso observar melhor"],
                    correta: 0,
                ...
                },
                {
                    ...
                    opcoes: ["À esquerda", "À direita", "Em cima", "Preciso observar melhor"],
                    correta: 0,
    ...
    quiz: [
        {
            ...
            opcoes: ["O que está por dentro dele", "Do lado", "Longe", "Preciso observar melhor"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Embaixo", "Em cima", "Ao lado", "Preciso observar melhor"],
            correta: 0,
            explicacao: "Abaixo da árvore.",
            visual: {
                tipo: "cena",
        ...
        },
        {
            ...
            opcoes: ["À direita", "Atrás", "Em cima", "Preciso observar melhor"],
            correta: 0,
            explicacao: "Do lado direito.",
            visual: {
                tipo: "cena",
        ...
        },
        {
            ...
            opcoes: ["Se orientar no espaço", "Nada", "Só comer", "Preciso observar melhor"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Achar caminho", "Pintar", "Comer", "Preciso observar melhor"],
            correta: 0,
            explicacao: "Ajuda a se orientar.",
            visual: { tipo: "itens", imagemUrl: mapaImg, quantidade: 1, rotulo: "🗺️" },
        },
    ],
    conclusao: "🏅 Medalha conquistada: Bússola Viva! 🧭 Item desbloqueado: Explorador do Espaço.",
    curiosidade: {
        titulo: "Você sabia?",
        texto: "A gente decora rapidinho o caminho de casa 🏠 porque o cérebro cria um MAPA MENTAL sem a gente perceber — usando pontos de referência do dia a dia.",
    },
    interativas: [
            ...
            cenas: [
                {
                    ...
                    posicao: "cima",
                    pergunta: "O ursinho está…",
                    opcoes: ["Em cima", "Embaixo", "Dentro", "Preciso observar melhor"],
                    correta: 0,
                },
                {
                    modo: "dupla",
                    ...
                    opcoes: ["Dentro", "Fora", "Atrás", "Preciso observar melhor"],
                    correta: 0,
                },
                {
                    modo: "dupla",
                    ...
                    opcoes: ["Direita", "Esquerda", "Frente", "Preciso observar melhor"],
                    correta: 0,
                },
            ],
        },
        ...
        // FASE 3 — arrastar: colocar objeto em posição correta
        {
            ...
            instrucao: "Arraste cada OBJETO pra posição certa em relação à SALA DE AULA.",
            pares: [
    ...
    niveis: {
        ...
        facil: [
            {
                ...
                opcoes: ["Pra onde você olha", "Nas costas", "Embaixo", "Preciso observar melhor"],
                correta: 0,
            ...
            },
            {
                ...
                opcoes: ["Por dentro do lugar", "Fora", "Longe", "Preciso observar melhor"],
                correta: 0,
                explicacao: "Interior.",
            ...
            },
            {
                ...
                opcoes: ["Cima", "Baixo", "Esquerda", "Preciso observar melhor"],
                correta: 0,
                explicacao: "Pra cima.",
        ...
        medio: [
            ...
            },
            {
                ...
                opcoes: ["Esquerda", "Direita", "Cima", "Preciso observar melhor"],
                correta: 0,
        ...
        dificil: [
            {
                ...
                opcoes: ["Pra minhas costas", "Pra frente", "Pra cima", "Preciso observar melhor"],
                correta: 0,
            ...
            },
            {
                ...
                opcoes: ["Ele sai da referência", "Fica dentro", "Some", "Preciso observar melhor"],
                correta: 0,
            ...
            },
            {
                ...
                opcoes: ["Fica perdido", "Anda melhor", "Corre mais", "Preciso observar melhor"],
                correta: 0,
    ...
    minijogo: {
        ...
        objetivo: "Encontre os 4 TESOUROS escondidos em 90 segundos — cada um numa posição diferente do cenário! 🏴‍☠️",
        tempoSegundos: 90,
        elementos: [
    ...
    missaoFamilia: {
        ...
        instrucao: "Um familiar esconde um objeto e dá pistas usando FRENTE, ATRÁS, DIREITA, ESQUERDA, CIMA, BAIXO, DENTRO, FORA. Depois inverta os papéis!",
        registros: [
