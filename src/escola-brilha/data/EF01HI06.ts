  ...
  interativas: [
    ...
    // FASE 1 — Papel em casa (escolher figura)
    {
      ...
      opcoes: [
        ...
        { nome: "Professora", imagemUrl: professoraImg, rotulo: "👩‍🏫 PROFESSORA", correto: false },
        { nome: "Bibliotecário", imagemUrl: bibliotecarioImg, rotulo: "📚 BIBLIOTECÁRIO", correto: false },
      ],
    ...
    // FASE 2 — Ligar pessoa ao espaço/papel
    {
      ...
      pares: [
        { esquerda: "Professora", direita: "Sala de aula", esquerdaImagem: professoraImg, direitaImagem: salaImg },
        { esquerda: "Bibliotecário", direita: "Biblioteca", esquerdaImagem: bibliotecarioImg, direitaImagem: bibliotecaImg },
        { esquerda: "Cozinheira", direita: "Refeitório", esquerdaImagem: cozinheiraImg, direitaImagem: refeitorioImg },
        { esquerda: "Família", direita: "Casa", esquerdaImagem: familiaImg, direitaImagem: casaImg },
      ],
    },
