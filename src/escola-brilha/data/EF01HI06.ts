...
const aula: Aula = {
  ...
  atividadeGuiada: {
    ...
    visual: {
      ...
      opcoes: [
        ...
        { nome: "outra-opcao-4", imagemUrl: escolaImg },],
      ...
      perguntas: [
        {
          ...
          opcoes: ["Professora", "Cozinheira", "Motorista", "Preciso observar melhor"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["A família", "Ninguém", "A televisão", "Preciso observar melhor"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["Os avós", "O relógio", "A parede", "Preciso observar melhor"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["A cozinheira", "A professora", "O aluno", "Preciso observar melhor"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["Sim!", "Só o do professor", "Não", "Preciso observar melhor"],
          correta: 0,
  ...
  quiz: [
    ...
    },
    {
      ...
      opcoes: ["A professora", "A merendeira", "O porteiro", "Preciso observar melhor"],
      correta: 0,
    ...
    },
    {
      ...
      opcoes: ["Contar histórias e cuidar", "Ir pra escola", "Ficar longe", "Preciso observar melhor"],
      correta: 0,
    ...
    },
    {
      ...
      opcoes: ["Muito importante", "Bobagem", "Só às vezes", "Preciso observar melhor"],
      correta: 0,
  ...
  niveis: {
    ...
    facil: [
      {
        ...
        opcoes: ["Professora", "Motorista", "Aluno", "Preciso observar melhor"],
        correta: 0,
        explicacao: "A professora tem o papel de ensinar.",
        visual: { tipo: "itens", imagemUrl: professoraImg, quantidade: 1, rotulo: "👩‍🏫" },
      },
      {
        ...
        opcoes: ["A família", "A televisão", "A rua", "Preciso observar melhor"],
        correta: 0,
    ...
    medio: [
      {
        pergunta: "Quem CONTA histórias antigas?",
        opcoes: ["Os avós", "A parede", "O relógio", "Preciso observar melhor"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Na biblioteca", "Na cozinha", "No pátio", "Preciso observar melhor"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Uma história e um papel", "Nada importante", "Só um brinquedo", "Preciso observar melhor"],
        correta: 0,
    ...
    dificil: [
      {
        ...
        opcoes: ["Muito importante", "Bobagem", "Chato", "Preciso observar melhor"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Conhecer a história da família", "Perder tempo", "Brigar", "Preciso observar melhor"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Vizinhos, amigos e profissionais", "Só uma pessoa", "Ninguém", "Preciso observar melhor"],
        correta: 0,
