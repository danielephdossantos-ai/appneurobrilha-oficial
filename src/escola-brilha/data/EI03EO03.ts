 ...
 * Tema: "Meus Amigos" — spec EI-01 do usuário.
 * Estrela: ⭐ Amizade.
...
const aula: Aula = {
  ...
  narrativa: {
    titulo: "Meus Amigos",
    contexto: "O Brilha vai ao parque da floresta e encontra o Lupi, a Fifi e o Téo. Eles querem brincar juntos, mas cada um quer uma coisa. A Coruja Sábia explica: 'Amizade é ouvir, dividir, esperar a vez'.",
    problema: "Como a gente faz pra brincar com o amigo sem brigar? Vamos aprender juntos!",
    convite: "Bora ver o que faz um amigo ser AMIGO de verdade?",
  },
  ...
  missao: "Reconhecer atitudes boas de amizade: dividir, esperar a vez, escutar.",

  objetivos: [
    "Reconhecer o tema 'Meus Amigos' no dia a dia.",
    "Praticar a atitude em cenas com os amigos da floresta.",
  ],

  motivacao: "Amigo não é só quem brinca com você — é quem TE ESCUTA e quer TE VER FELIZ.",

  explicacao: "AMIGO é aquele que:\n\n• DIVIDE o brinquedo.\n• ESPERA a vez sem empurrar.\n• AJUDA quando o outro cai.\n• DIZ coisas legais, não coisas feias.\n\nAmigo de verdade faz o dia ficar mais bonito.",
  ...
  explicacaoAtiva: [
    ...
    { texto: "O Lupi e a Fifi vão brincar junto com você.", imagem: lupiImg, imagemAlt: "Lupi" },
    {
      ...
      imagemAlt: "Fifi",
      checagem: {
        pergunta: "Você tá pronto pra aprender sobre Meus Amigos?",
  ...
  explicacoesNiveis: {
    nivel1: "Meus Amigos é uma atitude boa que a gente pratica todo dia.",
    nivel2: "Os amigos da floresta mostram cenas de meus amigos — a gente aprende junto.",
    nivel3: "Praticar meus amigos deixa a floresta (e a gente) mais feliz.",
    nivel4: "Em casa, você pode praticar meus amigos com a família também.",
  },

  exemploResolvido: {
    enunciado: "A Coruja Sábia mostra 1 estrela apagada. Quantas estrelas faltam acender pra completar meus amigos?",
    passos: [
  ...
  atividadeGuiada: {
    enunciado: "3 amigos aparecem pra praticar meus amigos. Quantos amigos você vê?",
    resposta: "3 amigos — todos participando juntos.",
    explicacao: "Cada amigo mostra um jeito diferente de viver meus amigos.",
    visual: {
      tipo: "podio",
  ...
  exercicios: [
    { enunciado: "⭐ Por que a gente pratica meus amigos?", resposta: "Amigo não é só quem brinca com você — é quem TE ESCUTA e quer TE VER FELIZ.", dica: "Pensa em como o coração fica." },
  ...
  desafio: {
    enunciado: "Desafio Brilha: 3 cenas mostram meus amigos. Responda cada uma!",
    ...
    visual: {
      ...
      perguntas: [
        { pergunta: "O Brilha faz uma atitude boa. Isso é praticar meus amigos?", opcoes: ["Sim!", "Não"], correta: 0, explicacao: "Isso! Toda atitude boa conta." },
  ...
  revisao: {
    pontos: [
      "Meus Amigos é uma atitude BOA da floresta.",
      "A gente pratica no dia a dia com amigos e família.",
      "Cada boa atitude acende uma estrela.",
      "Quando todos praticam, a floresta brilha!",
    ],
    dica: "Hoje, pratique meus amigos com alguém da sua casa.",
  },

  quiz: [
    {
      pergunta: "Praticar meus amigos deixa a gente:",
    ...
    },
    {
      ...
      correta: 1,
      explicacao: "1 estrela — a estrela Amizade!",
      visual: { tipo: "itens", imagemUrl: estrelaImg, quantidade: 1, rotulo: "Estrela Amizade" },
    },
  ],

  conclusao: "🏅 Medalha: Guardião da Amizade! ⭐ Estrela Amizade ACESA na Árvore da Amizade. Missão em Casa: pratique meus amigos com alguém da família hoje. +100 XP · +50 moedas.",
  ...
  niveis: {
    ...
    facil: [
      {
        pergunta: "Praticar meus amigos é uma atitude:",
        opcoes: ["BOA", "Ruim"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["0", "1", "5"],
        correta: 1,
        explicacao: "1 estrela — a de Amizade!",
        visual: { tipo: "itens", imagemUrl: estrelaImg, quantidade: 1, rotulo: "Estrela" },
      },
    ],
    medio: [
      {
        pergunta: "Quando você pratica meus amigos, o coração fica:",
        opcoes: ["Feliz", "Triste"],
        correta: 0,
  ...
  proximaHabilidade: { codigo: "EI03EO04", titulo: "Minhas Emoções — o que eu sinto" },
};
