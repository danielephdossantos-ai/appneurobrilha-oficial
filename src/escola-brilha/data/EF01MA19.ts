...
const aula: Aula = {
  ...
  interativas: [
    ...
    // ==== MINI JOGO · Supermercado da Floresta ====
    {
      ...
      alvosVisuais: [
        { nome: "🍌 Banana R$ 2", cor: "#FBBF24", capacidade: 1, imagemUrl: bananaImg },
        { nome: "🧸 Ursinho R$ 5", cor: "#EA580C", capacidade: 1, imagemUrl: ursoImg },
        { nome: "📖 Livro R$ 10", cor: "#DC2626", capacidade: 1, imagemUrl: livroImg },
        { nome: "🧃 Suco R$ 20", cor: "#F59E0B", capacidade: 1, imagemUrl: sucoImg },
      ],
      pares: [
