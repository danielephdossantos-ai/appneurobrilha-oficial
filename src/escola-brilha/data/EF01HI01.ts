...
import { url as bebeEngatinhandoImg } from "@/assets/neuro-treino/objetos/bebe-engatinhando.png.asset.json";
import { url as criancaAndandoImg } from "@/assets/neuro-treino/objetos/crianca-andando.png.asset.json";
...
import { url as mamadeiraImg } from "@/assets/neuro-treino/objetos/mamadeira.png.asset.json";
  ...
  atividadeGuiada: {
    ...
    visual: {
      ...
      opcoes: [
        ...
        { nome: "outra-opcao-4", imagemUrl: bebeEngatinhandoImg },],
      ...
      perguntas: [
        {
          ...
          opcoes: ["👶 BEBÊ", "🧒 CRIANÇA", "🧓 IDOSO", "Preciso observar melhor"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["🍼 MAMADEIRA", "🎒 MOCHILA", "📱 CELULAR", "Preciso observar melhor"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["Mais um ano de vida", "O fim do ano", "As férias", "Preciso observar melhor"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["🎒 MOCHILA", "🍼 MAMADEIRA", "🛏️ CAMA", "Preciso observar melhor"],
          correta: 0,
        ...
        },
        {
          ...
          opcoes: ["Crescerem e mudarem", "Ficarem sempre iguais", "Pararem de aprender", "Preciso observar melhor"],
          correta: 0,
  ...
  quiz: [
    {
      ...
      opcoes: ["Sim", "Não", "Só os adultos", "Preciso observar melhor"],
      correta: 0,
    ...
    },
    {
      ...
      opcoes: ["O bebê", "A criança", "O adulto", "Preciso observar melhor"],
      correta: 0,
      explicacao: "Todo mundo começa bebê.",
      visual: { tipo: "itens", imagemUrl: bebeImg, quantidade: 1, rotulo: "👶" },
    },
    {
      ...
      opcoes: ["A família", "Um desconhecido", "Ninguém", "Preciso observar melhor"],
      correta: 0,
    ...
    },
    {
      ...
      opcoes: ["Um momento importante", "Apenas um brinquedo", "Apenas uma foto", "Preciso observar melhor"],
      correta: 0,
    ...
    },
    {
      ...
      opcoes: ["No álbum e na memória", "Só no armário", "Em lugar nenhum", "Preciso observar melhor"],
      correta: 0,
  ...
  interativas: [
    ...
    // FASE 2 — Antes e agora
    {
      ...
      opcoes: [
        ...
        { nome: "outra-opcao-4", imagemUrl: meninoImg },],
      correta: 1,
      ...
      escolhas: [
        ...
        },
        {
          ...
          opcoes: [
            ...
            { nome: "outra-opcao-4", imagemUrl: bebeImg },],
        },
        {
    ...
    facil: [
      {
        ...
        opcoes: ["Bolo", "Mochila", "Chocalho", "Preciso observar melhor"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Bebê", "Adulto", "Idoso", "Preciso observar melhor"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Mochila", "Chocalho", "Mamadeira", "Preciso observar melhor"],
        correta: 0,
    ...
    medio: [
      {
        ...
        opcoes: ["Bebê engatinhando", "Criança andando", "Idoso", "Preciso observar melhor"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Bola", "Chocalho", "Mamadeira", "Preciso observar melhor"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Mais um ano de vida", "As férias", "O fim do dia", "Preciso observar melhor"],
        correta: 0,
        explicacao: "Aniversário = mais um ano crescendo.",
        visual: { tipo: "itens", imagemUrl: boloImg, quantidade: 1, rotulo: "🎂" },
      },
    ...
    dificil: [
      {
        ...
        opcoes: ["O que já aconteceu", "O que vai acontecer", "O agora", "Preciso observar melhor"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["O agora", "O que já passou", "O amanhã", "Preciso observar melhor"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Diferentes", "Sempre iguais", "Nenhuma história", "Preciso observar melhor"],
        correta: 0,
