...
import cidadeImg from "@/assets/neuro-treino/objetos/cidade.png";
import praiaImg from "@/assets/neuro-treino/objetos/praia.png";
import campoImg from "@/assets/neuro-treino/objetos/campo.png";
import bairroImg from "@/assets/neuro-treino/objetos/bairro.png";
import predioImg from "@/assets/neuro-treino/objetos/predio.png";
import nuvemImg from "@/assets/neuro-treino/objetos/nuvem.png";
import ponteImg from "@/assets/neuro-treino/objetos/ponte.png";
import binoculoImg from "@/assets/neuro-treino/objetos/binoculo.png";
import navioImg from "@/assets/neuro-treino/objetos/navio.png";
import ruaImg from "@/assets/neuro-treino/objetos/rua.png";
...
const aula: Aula = {
  ...
  minijogo: {
    ...
    itens: [
      { nome: "Árvore", imagemUrl: arvoreImg, rotulo: "🌳", correto: true },
      { nome: "Flor", imagemUrl: florImg, rotulo: "🌼", correto: true },
      { nome: "Nuvem", imagemUrl: nuvemImg, rotulo: "☁️", correto: true },
      { nome: "Pássaro", imagemUrl: passaroImg, rotulo: "🐦", correto: true },
      { nome: "Borboleta", imagemUrl: borboletaImg, rotulo: "🦋", correto: true },
      { nome: "Sol", imagemUrl: solImg, rotulo: "☀️", correto: true },
      { nome: "Casa", imagemUrl: casaImg, rotulo: "🏠", correto: false },
      { nome: "Prédio", imagemUrl: predioImg, rotulo: "🏢", correto: false },
      { nome: "Ponte", imagemUrl: ponteImg, rotulo: "🌉", correto: false },
      { nome: "Carro", imagemUrl: carroImg, rotulo: "🚗", correto: false },
      { nome: "Navio", imagemUrl: navioImg, rotulo: "🚢", correto: false },
      { nome: "Rua", imagemUrl: ruaImg, rotulo: "🛣️", correto: false },
    ],
