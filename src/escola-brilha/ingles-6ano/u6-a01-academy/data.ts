...
const lesson: LessonData = {
  slug: "u6-a01-academy",
  bnccCodes: ["EF06LI01", "EF06LI02", "EF06LI05", "EF06LI06", "EF06LI17", "EF06LI19", "EF06LI23"],
  meta: {
  ...
  WRITING: [
    { prompt: "My name ______ Lucas. (verbo TO BE)", answer: "is", hint: "3ª pessoa singular do TO BE.", options: ["is", "am", "are", "be"] },
    { prompt: "I ______ from Brazil.", answer: "am", hint: "TO BE com 'I' = am.", options: ["am", "is", "are", "be"] },
    { prompt: "Where ______ you from?", answer: "are", hint: "TO BE com 'you' = are.", options: ["are", "is", "am", "be"] },
    { prompt: "How ______ are you?", answer: "old", hint: "Perguntar idade: 'How OLD are you?'", options: ["old", "many", "much", "age"] },
    { prompt: "______ mother is a teacher. (Ela)", answer: "Her", hint: "Possessivo de 'she' = HER.", options: ["Her", "His", "Your", "Our"] },
    { prompt: "Kenji is from Japan. He is ______.", answer: "Japanese", hint: "Nacionalidade do Japão.", options: ["Japanese", "Japan", "Japon", "Brazilian"] },
    { prompt: "______ is your name?", answer: "What", hint: "Perguntar 'qual' = WHAT.", options: ["What", "Where", "How", "Who"] },
  ],
  QUIZ: [
    { q: "Complete: My name ___ Maya.", options: [{ text: "am" }, { text: "is", correct: true }, { text: "are" }, { text: "be" }] },
    { q: "Complete: We ___ students at English Academy.", options: [{ text: "is" }, { text: "am" }, { text: "are", correct: true }, { text: "be" }] },
    { q: "Kenji é do Japão. Nacionalidade dele:", options: [{ text: "Japan" }, { text: "Japanese", correct: true }, { text: "Japonês" }, { text: "Brazilian" }] },
    { q: "Pergunta 'De onde você é?' em inglês:", options: [{ text: "What is your name?" }, { text: "Where are you from?", correct: true }, { text: "How old are you?" }, { text: "Who are you?" }] },
    { q: "'Her' é possessivo de:", options: [{ text: "he" }, { text: "she", correct: true }, { text: "it" }, { text: "we" }] },
    { q: "Complete: ___ father is an engineer. (Meu)", options: [{ text: "Your" }, { text: "My", correct: true }, { text: "His" }, { text: "Their" }] },
    { q: "'How old are you?' pergunta:", options: [{ text: "Seu nome" }, { text: "Sua idade", correct: true }, { text: "Seu país" }, { text: "Sua escola" }] },
    { q: "'Occupation' significa:", options: [{ text: "Profissão", correct: true }, { text: "País" }, { text: "Escola" }, { text: "Idioma" }] },
  ],
  REAL_LIFE: [
