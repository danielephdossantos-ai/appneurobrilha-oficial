...
const dia01: AulaEI = {
  ...
  momentos: [
    ...
    { tipo: "subitizingFlash", quantidade: 1, imagemUrl: bola,
...
const dia03: AulaEI = {
  ...
  momentos: [
    ...
    { tipo: "subitizingFlash", quantidade: 5, imagemUrl: flor,
...
const dia04: AulaEI = {
  ...
  momentos: [
    ...
    { tipo: "subitizingFlash", quantidade: 4, imagemUrl: joaninha,
    ...
    { tipo: "subitizingFlash", quantidade: 3, imagemUrl: joaninha,
    ...
    { tipo: "subitizingFlash", quantidade: 2, imagemUrl: joaninha,
      perguntaAudio: "Tem 2. Falta quanto pra 5?",
      opcoes: [opN(3, true), opN(2, false), opN(4, false)],
      feedbackAcerto: "3! 2 e 3 = 5.", feedbackErro: "Faltam 3." },
    { tipo: "subitizingFlash", quantidade: 1, imagemUrl: joaninha,
...
const dia05: AulaEI = {
  ...
  momentos: [
    ...
    { tipo: "subitizingFlash", quantidade: 3, imagemUrl: balao,
      perguntaAudio: "Quantos balões?",
      opcoes: [opN(3, true), opN(2, false), opN(4, false)],
      feedbackAcerto: "3!", feedbackErro: "3." },
    { tipo: "subitizingFlash", quantidade: 5, imagemUrl: balao,
...
const dia06: AulaEI = {
  ...
  momentos: [
    ...
    { tipo: "subitizingFlash", quantidade: 6, imagemUrl: maca,
...
const dia07: AulaEI = {
  ...
  momentos: [
    ...
    { tipo: "subitizingFlash", quantidade: 7, imagemUrl: bola,
      perguntaAudio: "Quantas bolas?",
...
const dia08: AulaEI = {
  ...
  momentos: [
    ...
    { tipo: "subitizingFlash", quantidade: 8, imagemUrl: estrela,
...
const dia09: AulaEI = {
  ...
  momentos: [
    ...
    { tipo: "subitizingFlash", quantidade: 9, imagemUrl: joaninha,
...
const dia16: AulaEI = {
  ...
  momentos: [
    ...
    { tipo: "subitizingFlash", quantidade: 6, imagemUrl: bola,
      perguntaAudio: "Quantas bolas?",
      opcoes: [opN(6, true), opN(5, false), opN(7, false)],
      feedbackAcerto: "6! 5+1.", feedbackErro: "6 = 5 + 1." },
    { tipo: "subitizingFlash", quantidade: 8, imagemUrl: bola,
      perguntaAudio: "Quantas?",
      opcoes: [opN(8, true), opN(7, false), opN(9, false)],
      feedbackAcerto: "8! 5+3.", feedbackErro: "8 = 5 + 3." },
    { tipo: "subitizingFlash", quantidade: 7, imagemUrl: estrela,
      perguntaAudio: "Quantas estrelas?",
      opcoes: [opN(7, true), opN(6, false), opN(8, false)],
      feedbackAcerto: "7! 5+2.", feedbackErro: "5 + 2 = 7." },
    { tipo: "subitizingFlash", quantidade: 9, imagemUrl: flor,
      perguntaAudio: "Quantas flores?",
      opcoes: [opN(9, true), opN(10, false), opN(8, false)],
      feedbackAcerto: "9! Quase 10.", feedbackErro: "9 = 5 + 4." },
    { tipo: "subitizingFlash", quantidade: 10, imagemUrl: joaninha,
