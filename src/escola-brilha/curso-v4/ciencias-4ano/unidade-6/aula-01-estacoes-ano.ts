...
export const aula01: AulaGeoV1 = {
  ...
  cena02_previsao: {
    ...
    opcoes: [
      ...
      { id: "rotacao", titulo: "A TERRA GIRA MAIS RÁPIDO", subtitulo: "o dia fica menor", emoji: "🔄", cor: "from-blue-500 to-indigo-700" },
    ],
  ...
  cena08_voceLe: {
    ...
    paragrafos: [
      ...
      },
      {
        id: "p3",
        texto:
          "Os movimentos da TERRA e da LUA formam ciclos regulares usados nos CALENDÁRIOS. A rotação organiza os dias, a translação organiza o ano e a sequência de fases da Lua — nova, crescente, cheia e minguante — repete-se em aproximadamente 29 dias e meio.",
        chaves: ["calendários", "fases da Lua"],
        definicoes: {
          calendários: "Sistemas que organizam dias, meses e anos com base em ciclos regulares.",
          "fases da Lua": "Mudanças na parte iluminada da Lua que observamos da Terra.",
        },
  ...
  cena11_avaliacao: {
    ...
    perguntas: [
      ...
      {
        id: "q3",
        pergunta: "Qual sequência representa um ciclo das fases da Lua?",
        fotoUrl: calendarioImg,
        opcoes: [
          { id: "a", texto: "Nova, crescente, cheia e minguante", correta: true },
          { id: "b", texto: "Manhã, tarde, noite e madrugada" },
          { id: "c", texto: "Preciso comparar outras evidências" },
          { id: "d", texto: "Preciso comparar outras evidências" },
        ],
        feedbackAcerto: "Isso. As fases se repetem regularmente e ajudam a organizar calendários.",
        feedbackErro: "Observe o ciclo lunar: nova, crescente, cheia e minguante.",
      },
    ],
    selo: {
