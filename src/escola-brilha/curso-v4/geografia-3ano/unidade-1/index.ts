...
export const unidade1: UnidadeGeoV1 = {
  ...
  descricao:
    "Brilha vira cartógrafo com Aurora e descobre que o município é feito de zona urbana e zona rural, com marcas de vários grupos e diferentes modos de vida.",
  corTema: "#22c55e",
