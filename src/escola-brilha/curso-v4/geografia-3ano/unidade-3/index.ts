...
import { aula05 } from "./aula-05-producao-consumo-lixo";
import { aula06 } from "./aula-06-usos-da-agua";
import { aula07 } from "./aula-07-cuidados-com-agua";
import { aula08 } from "./aula-08-impactos-ambientais";
...
export const unidade3: UnidadeGeoV1 = {
  ...
  corTema: "#10b981",
  aulas: [aula01, aula02, aula03, aula04, aula05, aula06, aula07, aula08],
};
