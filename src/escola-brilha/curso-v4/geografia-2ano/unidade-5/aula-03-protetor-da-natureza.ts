...
export const aula03: AulaPortuguesV4 = {
  ...
  momento02_previsao: {
    ...
    bloco: {
      ...
      hipoteses: [
        {
          texto: "Como CUIDAR e PROTEGER a natureza no meu município.",
          imagemUrl: jardim,
        },
        { texto: "Como plantar bala em uma planta.", imagemUrl: flor },
        { texto: "Como jogar bola no meio do rio.", imagemUrl: rio },
        { texto: "Sobre outra possibilidade relacionada ao tema.", imagemUrl: jardim },
      ],
      respostaCerta: 0,
      feedbackAcerto: "🎉 Isso! Vamos aprender a CUIDAR do lugar onde a gente vive.",
      feedbackErro:
  ...
  momento04_leituraGuiada: {
    ...
    leitura: {
      ...
      destacar: ["rio", "lixo", "poluído", "mutirão", "lixeiras", "reciclagem", "árvores"],
      paragrafos: [
    ...
    perguntas: [
      {
        ...
        feedbackErro: "O texto diz: 'Muita gente jogava GARRAFAS e SACOLAS na água'.",
      ...
      },
      {
        ...
        feedbackErro: "O texto diz: 'a comunidade fez um MUTIRÃO de limpeza'.",
        ondeEstaNoTexto: "…MUTIRÃO de limpeza…",
      },
      {
        pergunta: "O que a prefeitura colocou perto do rio?",
        opcoes: ["Lixeiras de reciclagem", "Prédios altos", "Semáforos", "Outra possibilidade"],
        correta: 0,
        feedbackAcerto: "🎉 LIXEIRAS DE RECICLAGEM.",
        feedbackErro: "O texto diz: 'A prefeitura colocou LIXEIRAS DE RECICLAGEM'.",
      ...
      },
      {
        ...
        feedbackErro: "O texto diz: 'o rio ficou LIMPO de novo'.",
    ...
    perguntas: [
      {
        ...
        opcoes: ["Cuidar", "Destruir (poluir)", "Não muda nada", "Outra possibilidade"],
        opcoesImagens: [lixeiraReciclagem, garrafa, arvore, lixeiraReciclagem],
        correta: 1,
        feedbackAcerto: "🎉 DESTRUIR.",
        feedbackErro: "Jogar lixo na rua é POLUIR — o certo é a LIXEIRA.",
      },
      {
        pergunta: "🌱 A família PLANTOU uma árvore na frente de casa. Isso é...",
        opcoes: ["Destruir", "Cuidar", "Fazer prédio", "Outra possibilidade"],
        opcoesImagens: [garrafa, planta, predio, garrafa],
        correta: 1,
        feedbackAcerto: "🎉 CUIDAR!",
        feedbackErro: "Plantar árvore é CUIDAR da natureza.",
      },
      {
        pergunta: "🚿 Deixar a torneira ABERTA MUITO tempo é...",
        opcoes: ["Cuidar da água", "Desperdiçar (destruir)", "Reciclar", "Outra possibilidade"],
        opcoesImagens: [rio, garrafa, lixeiraReciclagem, rio],
        correta: 1,
        feedbackAcerto: "🎉 DESPERDIÇAR a água.",
        feedbackErro: "Torneira aberta à toa DESPERDIÇA água — a gente precisa CUIDAR.",
      },
      {
        pergunta: "♻️ SEPARAR o plástico do papel na lixeira colorida é...",
        opcoes: ["Reciclar (cuidar)", "Poluir", "Nada", "Outra possibilidade"],
        opcoesImagens: [lixeiraReciclagem, garrafa, lixeira, lixeiraReciclagem],
        correta: 0,
        feedbackAcerto: "🎉 RECICLAR = CUIDAR.",
        feedbackErro: "SEPARAR o lixo pra reciclagem é CUIDAR da natureza.",
      },
    ],
  },

  momento07_sequencia: {
    instrucao: "Ordene os passos do MUTIRÃO que limpou o rio (do primeiro → último).",
    bloco: {
      ...
      itens: [
        ...
        {
          id: "s4",
          texto: "4) SEPARARAM em lixeiras de reciclagem.",
          imagemUrl: lixeiraReciclagem,
        },
        { id: "s5", texto: "5) O rio ficou LIMPO, peixes voltaram.", imagemUrl: peixe },
      ],
      ordemCerta: ["s1", "s2", "s3", "s4", "s5"],
      feedbackAcerto: "🎉 Perfeito! Comunidade junta → material → coletar → separar → rio limpo.",
      feedbackErro:
    ...
    perguntas: [
      {
        ...
        opcoesImagens: [predio, funcionarioLimpeza, garrafa, predio],
        correta: 1,
        feedbackAcerto: "🎉 CUIDAM da árvore.",
        feedbackErro: "O texto diz: 'Os moradores CUIDAM dela'.",
      ...
      },
      {
        ...
        opcoesImagens: [arvore, predio, cidade, arvore],
        correta: 0,
        feedbackAcerto: "🎉 SOMBRA e NINHOS.",
        feedbackErro: "O texto diz: 'a árvore dá SOMBRA fresquinha, os PÁSSAROS fazem ninhos'.",
        ondeEstaNoTexto: "…dá SOMBRA fresquinha, os PÁSSAROS fazem ninhos…",
      },
    ],
  },
  ...
  momento_minijogo: {
    ...
    instrucao: "Cada atitude PRESERVA ou POLUI a natureza? Arraste pra caixa certa.",
    jogo: {
      ...
      bloco: {
        ...
        itens: [
          ...
          {
            id: "i6",
            texto: "Separar lixo pra reciclagem",
            alvoId: "cuidar",
            imagemUrl: lixeiraReciclagem,
          },
          {
            id: "i7",
            texto: "Mutirão pra limpar a praça",
            alvoId: "cuidar",
            imagemUrl: funcionarioLimpeza,
          },
          { id: "i8", texto: "Fechar a torneira ao escovar", alvoId: "cuidar", imagemUrl: rio },
        ],
        feedbackAcerto: "🎉 Protetor da Natureza! Você separou o CUIDAR do DESTRUIR.",
        feedbackErro:
  ...
  momento09_revisao: {
    ...
    miniDesafio: {
      pergunta: "O rio está cheio de lixo. Como o Protetor RESOLVE?",
      opcoes: [
      ...
      correta: 1,
      feedbackAcerto: "🎉 MUTIRÃO + LIXEIRAS de reciclagem = rio limpo.",
      feedbackErro: "Pra CUIDAR do rio: MUTIRÃO pra limpar e LIXEIRAS de reciclagem por perto.",
    },
  },
    ...
    perguntas: [
      {
        ...
        opcoes: ["Cuidar do rio", "Sujar a natureza", "Plantar árvores", "Outra possibilidade"],
        correta: 1,
      ...
      },
      {
        ...
        opcoes: ["Jogar tudo junto", "Separar o lixo", "Queimar o lixo", "Outra possibilidade"],
        correta: 1,
        feedbackAcerto: "🎉 SEPARAR o lixo.",
        feedbackErro: "RECICLAR é SEPARAR o lixo pra virar coisa nova.",
      },
      {
        pergunta: "3/5 — Jogar papel na RUA é...",
        opcoes: ["Cuidar", "Destruir (poluir)", "Reciclar", "Outra possibilidade"],
        correta: 1,
      ...
      },
      {
        ...
        feedbackErro: "MUTIRÃO é TODA a comunidade JUNTA ajudando.",
      },
      {
        ...
        feedbackErro: "PRESERVAR = CUIDAR pra a natureza CONTINUAR existindo.",
      },
    ],
  },
  ...
  momento11_missaoFamilia: {
    ...
    registro: "📸 Uma foto do seu desenho de PROTETOR em ação.",
  },
