...
export const aula01: AulaGeoV1 = {
  ...
  cena08_voceLe: {
    ...
    paragrafos: [
      { id: "p1", texto: "PROBLEMA: entre 9 e 14 anos, o corpo passa por transformações rápidas: crescimento acelerado, mudança de voz, pelos, maturação sexual. Quem comanda tudo isso?", chaves: ["maturação sexual"], definicoes: { "maturação sexual": "Desenvolvimento dos órgãos reprodutores." }, fotoUrl: hormonalImg },
      { id: "p2", texto: "MECANISMO: a HIPÓFISE (no cérebro) libera FSH e LH. Esses hormônios chegam pelo sangue aos TESTÍCULOS (que produzem testosterona) ou aos OVÁRIOS (que produzem estrogênio). Testosterona e estrogênio geram as mudanças físicas.", chaves: ["hipófise", "testosterona", "estrogênio"], definicoes: { hipófise: "Glândula-mestre do sistema endócrino.", testosterona: "Hormônio sexual masculino.", estrogênio: "Hormônio sexual feminino." }, fotoUrl: hormonalImg },
  ...
  cena09_minijogo: {
    ...
    rodadas: [
      { id: "r1", municipioA: { nome: "Puxar a mão do fogo", emoji: "🔥", cor: "from-red-500 to-rose-700" }, municipioB: { nome: "Menos de 100 ms", emoji: "⚡", cor: "from-amber-500 to-yellow-700" }, contexto: "Reação super-rápida.", pecaCertaId: "nervoso", fotoUrl: cerebroImg, feedbackAcerto: "Nervoso. Arco reflexo elétrico.", feedbackErro: "Rápido demais para hormônio. Só o nervoso responde em ms." },
      { id: "r2", municipioA: { nome: "Puberdade", emoji: "🌱", cor: "from-fuchsia-500 to-pink-700" }, municipioB: { nome: "Testosterona/estrogênio", emoji: "💧", cor: "from-pink-500 to-rose-700" }, contexto: "Transformação lenta ao longo de anos.", pecaCertaId: "endocrino", fotoUrl: hormonalImg, feedbackAcerto: "Endócrino. Hormônios agem em anos.", feedbackErro: "Puberdade é hormonal — não elétrica." },
      { id: "r3", municipioA: { nome: "Susto", emoji: "😱", cor: "from-red-500 to-rose-700" }, municipioB: { nome: "Adrenalina + coração dispara", emoji: "❤️", cor: "from-rose-500 to-pink-700" }, contexto: "Cérebro percebe → suprarrenal libera hormônio.", pecaCertaId: "ambos", fotoUrl: hormonalImg, feedbackAcerto: "Ambos. Nervoso dispara; endócrino sustenta o alerta.", feedbackErro: "Cérebro percebe (nervoso) E manda liberar adrenalina (endócrino). AMBOS." },
      { id: "r4", municipioA: { nome: "Digestão do almoço", emoji: "🍽️", cor: "from-amber-500 to-orange-700" }, municipioB: { nome: "Insulina do pâncreas", emoji: "💉", cor: "from-emerald-500 to-teal-700" }, contexto: "Açúcar sobe → pâncreas libera insulina.", pecaCertaId: "endocrino", fotoUrl: hormonalImg, feedbackAcerto: "Endócrino — insulina é hormônio.", feedbackErro: "Insulina no sangue = endócrino." },
    ],
    falaFinal:
