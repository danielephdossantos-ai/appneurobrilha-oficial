...
export const aula01: AulaGeoV1 = {
  ...
  cena10_revisao: {
    ...
    fatias: [
      { id: "astro", rotulo: "Astronomia (movimentos)", emoji: "🌍", percentual: 35, cor: "#6366f1",
        descricao: "Rotação, translação e inclinação — o que a Terra faz no espaço.",
        exemplos: ["🔄 Dia/noite", "🛰️ Estações", "📐 Eixo 23,5°"] },
      { id: "fisica", rotulo: "Terra física (placa+relevo+clima)", emoji: "🌋", percentual: 35, cor: "#d97706",
        descricao: "Tectônica, relevo e clima moldam a superfície do planeta.",
        exemplos: ["🌋 Vulcões", "⛰️ Planaltos", "🌦️ Massas de ar"] },
      { id: "vida", rotulo: "Vida (biomas)", emoji: "🌳", percentual: 30, cor: "#059669",
        descricao: "Onde o físico encontra o biológico. 6 biomas brasileiros.",
