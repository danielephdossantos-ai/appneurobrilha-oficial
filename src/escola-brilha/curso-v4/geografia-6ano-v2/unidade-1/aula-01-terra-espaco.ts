...
export const aula01: AulaGeoV1 = {
    ...
    perguntas: [
      {
        ...
        cards: [
          { id: "rot", emoji: "🔄", titulo: "Rotação", cor: "from-sky-500 to-blue-700" },
          { id: "trans", emoji: "🛰️", titulo: "Translação", cor: "from-purple-500 to-fuchsia-700" },
          { id: "incl", emoji: "📐", titulo: "Inclinação", cor: "from-amber-500 to-orange-700" },
        ],
        correta: "rot",
      ...
      },
      {
        ...
        fotoUrl: orbitaEstacoes,
        cards: [
          { id: "dez", emoji: "🎄", titulo: "Dezembro–Março", cor: "from-red-500 to-rose-700" },
          { id: "jun", emoji: "❄️", titulo: "Junho–Setembro", cor: "from-sky-500 to-indigo-700" },
          { id: "sem", emoji: "🌀", titulo: "Ano todo igual", cor: "from-slate-500 to-gray-700" },
        ],
        correta: "dez",
      ...
      },
      {
        ...
        pergunta: "O que causa as ESTAÇÕES do ano?",
        cards: [
          { id: "dist", emoji: "📏", titulo: "Distância ao Sol", cor: "from-amber-500 to-orange-700" },
          { id: "eixo", emoji: "📐", titulo: "Inclinação do eixo", cor: "from-emerald-500 to-green-700" },
          { id: "lua", emoji: "🌙", titulo: "Fases da Lua", cor: "from-slate-500 to-gray-700" },
        ],
        correta: "eixo",
  ...
  cena09_minijogo: {
    ...
    rodadas: [
      {
        id: "r1",
        municipioA: { nome: "Amanhece em Tóquio", emoji: "🌅", cor: "from-amber-400 to-orange-600" },
        municipioB: { nome: "Anoitece em SP", emoji: "🌆", cor: "from-indigo-400 to-purple-600" },
      ...
      {
        id: "r2",
        municipioA: { nome: "Natal na praia", emoji: "🏖️", cor: "from-sky-400 to-blue-600" },
        municipioB: { nome: "Ano Novo no calor", emoji: "🎇", cor: "from-red-400 to-rose-600" },
      ...
      {
        id: "r3",
        municipioA: { nome: "Ano bissexto 2024", emoji: "📅", cor: "from-purple-400 to-fuchsia-600" },
        municipioB: { nome: "29 de fevereiro", emoji: "🗓️", cor: "from-emerald-400 to-teal-600" },
      ...
      {
        id: "r4",
        municipioA: { nome: "Junho na Europa", emoji: "☀️", cor: "from-amber-400 to-orange-600" },
        municipioB: { nome: "Junho no Brasil", emoji: "🧥", cor: "from-slate-400 to-blue-600" },
      ...
      {
        id: "r5",
        municipioA: { nome: "Sol nasce no leste", emoji: "🌄", cor: "from-yellow-400 to-orange-600" },
        municipioB: { nome: "Sol se põe no oeste", emoji: "🌇", cor: "from-red-400 to-rose-600" },
      ...
      {
        id: "r6",
        municipioA: { nome: "Um ano completo", emoji: "🔁", cor: "from-emerald-400 to-teal-600" },
        municipioB: { nome: "365 dias", emoji: "🎉", cor: "from-purple-400 to-indigo-600" },
