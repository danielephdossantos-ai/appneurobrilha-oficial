...
export const aula01: AulaGeoV1 = {
  ...
  cena10_revisao: {
    ...
    fatias: [
      { id: "quente", rotulo: "Climas quentes (~88%)", emoji: "☀️", percentual: 88, cor: "#d97706",
        descricao: "Equatorial + Tropical + Semiárido + Tropical Litorâneo. Predominam no Brasil.",
        exemplos: ["🌳 Amazônia", "🌾 Cerrado", "🌵 Sertão"] },
      { id: "ameno", rotulo: "Climas amenos (~12%)", emoji: "❄️", percentual: 12, cor: "#0369a1",
        descricao: "Subtropical (Sul) e Tropical de Altitude (serras). Únicos com inverno rigoroso.",
        exemplos: ["🌲 Porto Alegre", "⛰️ Campos do Jordão"] },
    ],
