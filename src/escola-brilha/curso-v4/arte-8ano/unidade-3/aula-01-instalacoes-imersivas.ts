...
export const aula01: AulaArteV1 = {
  ...
  iconeTrilha: "🎭",
  bncc: ["EF69AR05", "EF69AR26", "EF69AR32", "EF69AR35"],
  duracaoMin: 36,
  ...
  cena01_motivacao: {
    ...
    itens: [
      {
        emoji: "🌊",
        rotulo: "Chão reativo de luz",
        descricao:
          "Sensores no piso detectam cada passo e disparam ondas de luz que se espalham pela sala inteira, como se o chão fosse água digital.",
        cor: "#0891b2",
        fotoUrl: ondasLuzChao,
      },
      {
        emoji: "🖼️",
        rotulo: "Projeção 360° nas paredes",
        descricao:
          "Projetores cobrem TODAS as paredes com imagens em movimento, apagando os limites da sala e criando um mundo visual completo ao redor do público.",
        cor: "#7c3aed",
        fotoUrl: projecao360,
      },
      {
        emoji: "🧑‍🤝‍🧑",
        rotulo: "Público dentro da obra",
        descricao:
          "Diferente de um quadro na parede, aqui o visitante caminha, toca e se movimenta DENTRO da instalação — o corpo do público faz parte da obra.",
        cor: "#f97316",
        fotoUrl: publicoImerso,
      },
      {
        emoji: "🕶️",
        rotulo: "Realidade Virtual Artística",
        descricao:
          "Óculos de VR e sensores criam mundos digitais completos, onde a percepção do espaço real se mistura com camadas virtuais.",
        cor: "#16a34a",
        fotoUrl: museuVr,
      },
    ],
    falaFinal:
      "Sua missão: entender como projetores, sensores e VR transformam uma sala vazia numa obra viva que reage à sua presença.",
  },
  ...
  cena02_previsao: {
    ...
    perguntas: [
      {
        pergunta:
          "Uma sala inteira — chão, paredes e teto — é coberta por projeções de luz que reagem quando as pessoas caminham. O que é essa obra?",
        fotoUrl: teamlabImersivo,
        alternativas: [
          {
            texto:
              "Uma Instalação Artística Imersiva — o espaço inteiro é a obra e o público entra fisicamente nela",
            correta: true,
          },
          {
            texto: "Apenas uma decoração de festa, sem nenhuma intenção artística",
            correta: false,
          },
        ...
        feedbackAcerto:
          "Perfeito! Na instalação imersiva, o espaço TODO vira suporte da obra, não apenas uma parede.",
        feedbackErro:
          "Cuidado: não é decoração. É uma linguagem artística que transforma o espaço inteiro em experiência.",
      },
      {
        pergunta:
          "Em 1967, um artista brasileiro criou um ambiente com areia, brita, plantas tropicais, araras vivas e cabines de TV dentro de uma galeria. Que tipo de obra é essa?",
        fotoUrl: oiticicaTropicalia,
        alternativas: [
          {
            texto:
              "Uma Instalação Artística — ambiente tridimensional que o público atravessa com o corpo todo",
            correta: true,
          },
        ...
        feedbackAcerto:
          "Isso! É a Tropicália de Hélio Oiticica — marco da instalação artística brasileira.",
        feedbackErro:
          "Não é pintura emoldurada: é um AMBIENTE que se atravessa com o corpo — instalação.",
      },
      {
        pergunta:
          "Um museu tem uma sala onde, se duas pessoas se dão as mãos, um rio projetado no chão começa a encher de água virtual. Que característica da arte contemporânea aparece aqui?",
        fotoUrl: salaProjecaoRios,
        alternativas: [
          { texto: "Arte Interativa — a obra só se completa com a AÇÃO do público", correta: true },
          {
            texto: "Arte estática — a obra é sempre igual, não importa o que o público faça",
            correta: false,
          },
        ...
        feedbackAcerto:
          "Exato! Sem a ação das pessoas, o rio nunca enche — a interação é parte da obra.",
    ...
    cards: [
      {
        ...
        definicao:
          "Obra tridimensional que ocupa um espaço inteiro (sala, galeria, rua) e que o público atravessa fisicamente, em vez de apenas observar de longe.",
        emoji: "🏛️",
        cor: "#f97316",
        fotoUrl: publicoImerso,
      },
      {
        termo: "Arte Imersiva",
        definicao:
          "Instalação que envolve o espectador com projeções, sons e luzes em 360°, apagando os limites entre a obra e quem a observa.",
        emoji: "🌊",
        cor: "#0891b2",
        fotoUrl: teamlabImersivo,
      },
      {
        termo: "Arte Interativa",
        definicao:
          "Obra que só se completa com a AÇÃO do público — sensores captam movimento, toque ou som e a obra responde em tempo real.",
        emoji: "🖐️",
        cor: "#7c3aed",
        fotoUrl: sensorPiso,
      },
      {
        termo: "Realidade Virtual Artística",
        definicao:
          "Uso de óculos VR, projetores e sensores para criar mundos digitais que se sobrepõem à percepção do espaço físico real.",
        emoji: "🕶️",
        cor: "#16a34a",
        fotoUrl: museuVr,
      },
  ...
  cena04_leituraGuiada: {
    ...
    pigmentos: [
      {
        nome: "Instalação Artística",
        hex: "#f97316",
        fonte: "Espaço inteiro como obra",
        emoji: "🏛️",
        fotoUrl: oiticicaTropicalia,
      },
      {
        nome: "Arte Imersiva",
        hex: "#0891b2",
        fonte: "Projeções em 360°",
        emoji: "🌊",
        fotoUrl: teamlabImersivo,
      },
      {
        nome: "Arte Interativa",
        hex: "#7c3aed",
        fonte: "A ação do público completa a obra",
        emoji: "🖐️",
        fotoUrl: sensorPiso,
      },
      {
        nome: "Realidade Virtual Artística",
        hex: "#16a34a",
        fonte: "Óculos VR e sensores",
        emoji: "🕶️",
        fotoUrl: museuVr,
      },
    ],
    ...
    perguntas: [
      {
        ...
        alternativas: [
          {
            texto:
              "A instalação ocupa o espaço inteiro e o público entra fisicamente nela, em vez de só observar de longe",
            correta: true,
          },
          {
            texto: "A instalação é só um quadro maior, pendurado numa parede mais alta",
            correta: false,
          },
        ...
        feedbackAcerto:
          "Correto! O espaço tridimensional inteiro — e o corpo do público dentro dele — é o que define a instalação.",
        feedbackErro:
          "Não é tamanho de quadro: é a ocupação do espaço inteiro e a entrada física do público que define a instalação.",
      },
      {
        pergunta:
          "Por que a Tropicália de Hélio Oiticica é considerada um marco da instalação artística?",
        fotoUrl: oiticicaTropicalia,
        alternativas: [
          {
            texto:
              "Porque criava um AMBIENTE completo (areia, plantas, araras, cabines) que o visitante atravessava com o corpo",
            correta: true,
          },
          {
            texto: "Porque era uma escultura de bronze fixa, para ser vista só de um ângulo",
            correta: false,
          },
        ...
        feedbackAcerto:
          "Isso! A Tropicália é um ambiente sensorial completo, não uma escultura estática.",
        feedbackErro:
          "Escultura fixa de bronze é o oposto: a Tropicália era um ambiente vivido com o corpo todo.",
      },
      {
        pergunta:
          "Numa instalação do teamLab, um rio projetado só enche de água virtual quando duas pessoas se dão as mãos. Qual conceito isso ilustra?",
        fotoUrl: salaProjecaoRios,
        alternativas: [
          {
            texto: "Arte Interativa — a obra depende da AÇÃO do público para se completar",
            correta: true,
          },
          {
            texto: "Arte conceitual estática — a obra é a mesma independente do público",
            correta: false,
          },
        ...
        feedbackAcerto:
          "Perfeito! Sem a ação das pessoas dando as mãos, o rio nunca enche — é interação pura.",
  ...
  cena06_personagensLugar: {
    ...
    animais: [
      {
        nome: "Sala com areia, plantas e araras (1967)",
        emoji: "🦜",
        fotoUrl: oiticicaTropicalia,
      ...
      {
        nome: "Projeções 360° reagindo aos passos",
        emoji: "🌊",
        fotoUrl: teamlabImersivo,
      ...
      {
        nome: "Sensor que faz o rio encher ao dar as mãos",
        emoji: "🖐️",
        fotoUrl: sensorPiso,
  ...
  cena07_sequencia: {
    ...
    passos: [
      {
        id: "p1",
        texto: "Desenho a PLANTA BAIXA da sala escolhida, marcando entrada e paredes disponíveis",
        emoji: "📐",
        ordem: 1,
        fotoUrl: passo1,
      },
      {
        id: "p2",
        texto: "Escolho ONDE ficam o projetor e a cortina de fios de luz que vai receber a imagem",
        emoji: "🎥",
        ordem: 2,
        fotoUrl: passo2,
      },
      {
        id: "p3",
        texto:
          "Marco com linhas técnicas ONDE ficam os sensores sonoros que vão captar a presença do público",
        emoji: "🎙️",
        ordem: 3,
        fotoUrl: passo3,
      },
      {
        id: "p4",
        texto:
          "Colorizo indicando como a LUZ reage quando alguém entra, aplaude ou caminha pela sala",
        emoji: "🎨",
        ordem: 4,
        fotoUrl: passo4,
      },
      {
        id: "p5",
        texto:
          "Dou um TÍTULO pra instalação e escrevo a sensação que ela deve provocar em quem entra",
        emoji: "🏷️",
        ordem: 5,
        fotoUrl: passo5,
      },
    ...
    falaAcerto:
      "Você acabou de projetar a primeira Instalação Imersiva de bolso do Laboratório dos Eco-Simulacros!",
  },
  ...
  cena08_voceLe: {
    ...
    trechos: [
      {
        texto: "Sou exploradora imersiva. Meu suporte não é a parede — é a",
        palavraDestaque: "sala inteira",
        corDestaque: "#f97316",
      },
      {
        texto: "Quando o público entra fisicamente na obra, isso é",
        palavraDestaque: "instalação artística",
        corDestaque: "#f97316",
      },
      {
        texto: "Se projetores cobrem tudo em 360° e envolvem quem observa, viro",
        palavraDestaque: "arte imersiva",
        corDestaque: "#0891b2",
      },
      {
        texto: "Mas nada acontece sem a ação das pessoas — por isso é",
        palavraDestaque: "arte interativa",
        corDestaque: "#7c3aed",
      },
      {
        texto: "e, com óculos e sensores avançados, tudo se transforma em",
        palavraDestaque: "realidade virtual artística",
        corDestaque: "#16a34a",
      },
  ...
  cena09_minijogo: {
    ...
    variante: "minijogo",
    aurora:
      "🎯 O Direcionador de Lasers Cênicos! Alinha espelhos e lentes pra mapear a escultura antes do tempo acabar.",
    titulo: "🎯 O Direcionador de Lasers Cênicos",
    instrucao:
      "Ajusta cada espelho e lente pra que o laser acerte exatamente a escultura antes do tempo acabar!",
    tempoSeg: 40,
    itens: [
    ...
    itens: [
      {
        ...
        descricao:
          "Obra tridimensional que ocupa um espaço inteiro e que o público atravessa fisicamente.",
        cor: "#f97316",
        fotoUrl: publicoImerso,
      },
      {
        emoji: "🌊",
        rotulo: "Arte Imersiva",
        descricao:
          "Projeções em 360° envolvem o espectador, apagando os limites entre obra e observador.",
        cor: "#0891b2",
        fotoUrl: teamlabImersivo,
      },
      {
        emoji: "🖐️",
        rotulo: "Arte Interativa",
        descricao:
          "A obra só se completa com a ação do público captada por sensores de movimento, toque ou som.",
        cor: "#7c3aed",
        fotoUrl: sensorPiso,
      },
      {
        ...
        rotulo: "Realidade Virtual Artística",
        descricao:
          "Óculos VR, projetores e sensores criam mundos digitais sobrepostos à percepção do espaço real.",
        cor: "#16a34a",
        fotoUrl: museuVr,
      },
      {
        emoji: "🦜",
        rotulo: "Tropicália (Hélio Oiticica, 1967)",
        descricao:
          "Ambiente com areia, brita, plantas tropicais, araras vivas e cabines de TV — marco da instalação brasileira.",
        cor: "#dc2626",
        fotoUrl: oiticicaTropicalia,
      },
      {
        emoji: "🎥",
        rotulo: "Projetor + Sensor",
        descricao:
          "Dupla técnica que transforma qualquer sala em superfície reativa de luz e imagem.",
        cor: "#7c2d12",
        fotoUrl: projetorArtistico,
      },
    ],
  ...
  cena11_avaliacao: {
    ...
    quiz: {
      pergunta:
        "O que torna uma INSTALAÇÃO IMERSIVA diferente de uma pintura tradicional na parede?",
      alternativas: [
        {
          texto:
            "Na instalação, o público entra fisicamente no espaço e faz parte da obra, em vez de só observar de longe",
          correta: true,
        },
        {
          texto:
            "A instalação usa apenas tintas mais brilhantes, enquanto a pintura tradicional usa lâmpadas comuns",
          correta: false,
        },
