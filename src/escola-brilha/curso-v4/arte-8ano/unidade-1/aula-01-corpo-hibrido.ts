...
export const aula01: AulaArteV1 = {
  ...
  iconeTrilha: "🎭",
  bncc: ["EF69AR05", "EF69AR06", "EF69AR32", "EF69AR35"],
  duracaoMin: 36,
  ...
  cena01_motivacao: {
    ...
    itens: [
      {
        emoji: "🧬",
        rotulo: "Corpo Híbrido (biológico + digital)",
        descricao:
          "O corpo humano atravessado por circuitos, sensores e fibras: a arte contemporânea investiga a fronteira entre o que é biológico e o que é tecnológico.",
        cor: "#f97316",
        fotoUrl: corpoHibrido,
      },
      {
        emoji: "🖐️",
        rotulo: "Próteses poéticas (anos 1970)",
        descricao:
          "Uma artista contemporânea colocou extensões gigantes de madeira em cada dedo. Não conseguia mais tocar nada normalmente — a percepção de espaço e tato foi COMPLETAMENTE reprogramada.",
        cor: "#0891b2",
        fotoUrl: rebeccaHorn,
      },
      {
        emoji: "💡",
        rotulo: "Wearable Art (Arte Vestível)",
        descricao:
          "Roupas com sensores, LEDs e circuitos que respondem a luz, som e movimento. O vestuário deixa de ser proteção e vira obra de arte INTERATIVA.",
        cor: "#7c3aed",
        fotoUrl: jaquetaLed,
      },
      {
        emoji: "🔧",
        rotulo: "Cultura Maker / DIY",
        descricao:
          "Do It Yourself: qualquer pessoa pode construir, modificar e consertar seus próprios dispositivos usando Arduino, materiais reciclados e hardware livre.",
        cor: "#16a34a",
        fotoUrl: makerSpace,
      },
    ],
    falaFinal:
      "Sua missão: criar extensões pro corpo que misturem biologia e tecnologia, questionando o planeta na era digital.",
  },
  ...
  cena02_previsao: {
    ...
    perguntas: [
      {
        pergunta:
          "Uma artista coloca EXTENSÕES DE MADEIRA gigantes nos próprios dedos e não consegue mais pegar objetos normalmente. Qual é o objetivo POÉTICO dessa obra?",
        fotoUrl: rebeccaHorn,
        alternativas: [
          {
            texto:
              "Quebrar o AUTOMATISMO do dia a dia e fazer o público repensar tato, espaço e limites do corpo",
            correta: true,
          },
          {
            texto: "Apenas mostrar habilidade em marcenaria — sem intenção crítica",
            correta: false,
          },
        ...
        feedbackAcerto:
          "Perfeito! A prótese poética estranha o corpo e nos força a REFLETIR sobre o que damos como natural.",
        feedbackErro:
          "Cuidado: arte contemporânea NUNCA é só técnica. A prótese existe pra provocar reflexão sobre o corpo e a percepção.",
      },
      {
        pergunta:
          "Uma jaqueta tem sensores de proximidade: quando alguém chega perto, ela infla e acende luzes de alerta. Que tipo de arte é esse?",
        fotoUrl: jaquetaSensor,
        alternativas: [
          {
            texto:
              "Tecnologia Vestível (Wearable Art) — a roupa vira obra INTERATIVA que discute o espaço pessoal",
            correta: true,
          },
        ...
        feedbackAcerto:
          "Isso! Wearable Art integra eletrônica ao vestuário pra criar arte que responde ao ambiente e ao público.",
        feedbackErro:
          "Escultura em bronze é imóvel. Aqui a roupa REAGE — é wearable art contemporâneo.",
      },
      {
        pergunta:
          "Uma pessoa monta seu próprio circuito com Arduino, fios reciclados e um LED. Que subcultura tecnológica ela pratica?",
        fotoUrl: arduinoDiy,
        alternativas: [
          {
            texto:
              "Cultura Maker / DIY (Do It Yourself) — qualquer um pode construir e modificar seus dispositivos",
            correta: true,
          },
          {
            texto: "Consumo passivo — só empresas grandes podem fabricar eletrônicos",
            correta: false,
          },
        ...
        feedbackAcerto:
          "Excelente! A filosofia DIY dá autonomia técnica e artística pra quem sempre foi só consumidor.",
        feedbackErro:
          "A cultura maker é o OPOSTO do consumo passivo: ela devolve o poder de criar hardware pras pessoas comuns.",
      },
    ],
  },
  ...
  cena03_vocabulario: {
    ...
    cards: [
      {
        termo: "Wearable Art (Arte Vestível)",
        definicao:
          "Roupas ou adereços com sensores, LEDs e circuitos que respondem a estímulos (luz, som, batimento) e transformam o vestuário em obra INTERATIVA.",
        emoji: "💡",
        cor: "#7c3aed",
        fotoUrl: jaquetaLed,
      },
      {
        termo: "Cultura Maker / DIY",
        definicao:
          "Filosofia Do It Yourself: qualquer pessoa constrói, modifica e conserta dispositivos usando hardware livre (Arduino) e materiais reciclados.",
        emoji: "🔧",
        cor: "#16a34a",
        fotoUrl: makerSpace,
      },
      {
        termo: "Performance Artística",
        definicao:
          "Linguagem da arte contemporânea em que o CORPO do artista (e suas ações) é a obra principal, num tempo e espaço específicos, gerando estranhamento.",
        emoji: "🎭",
        cor: "#dc2626",
        fotoUrl: performanceGaleria,
      },
      {
        termo: "Prótese Poética",
        definicao:
          "Extensão do corpo (dedos, braços, cabeça) usada em performance pra QUEBRAR o automatismo e fazer o público repensar percepção e limites físicos.",
        emoji: "🖐️",
        cor: "#0891b2",
        fotoUrl: rebeccaHorn,
      },
  ...
  cena04_leituraGuiada: {
    ...
    pigmentos: [
      {
        nome: "Prótese Poética",
        hex: "#0891b2",
        fonte: "Extensão que estranha o corpo",
        emoji: "🖐️",
        fotoUrl: rebeccaHorn,
      },
      {
        nome: "Wearable Art",
        hex: "#7c3aed",
        fonte: "Roupa que reage ao ambiente",
        emoji: "💡",
        fotoUrl: jaquetaLed,
      },
      {
        nome: "Cultura Maker (DIY)",
        hex: "#16a34a",
        fonte: "Hardware livre + reciclagem",
        emoji: "🔧",
        fotoUrl: arduinoDiy,
      },
      {
    ...
    perguntas: [
      {
        ...
        alternativas: [
          {
            texto:
              "A wearable tem sensores, LEDs ou circuitos INTEGRADOS que reagem ao ambiente (luz, som, toque)",
            correta: true,
          },
          {
            texto:
              "A wearable é apenas mais cara, mas funciona exatamente igual a uma jaqueta normal",
            correta: false,
          },
        ...
        feedbackAcerto:
          "Correto! O elemento eletrônico interativo é o que transforma vestuário em ARTE.",
        feedbackErro:
          "Preço não define wearable — o que define é a integração de eletrônica INTERATIVA na roupa.",
      },
      {
        ...
        alternativas: [
          {
            texto:
              "Autonomia: qualquer pessoa pode construir, modificar e consertar seus próprios dispositivos",
            correta: true,
          },
          {
            texto:
              "Só engenheiros formados podem mexer em eletrônica — as pessoas comuns devem só comprar",
            correta: false,
          },
        ...
        feedbackAcerto:
          "Isso! DIY é resistência ao consumo passivo — o poder de fabricar volta pras pessoas.",
        feedbackErro:
          "Esse é o modelo que a cultura maker COMBATE. O DIY diz o oposto: todo mundo pode ser criador de tecnologia.",
      },
      {
        pergunta:
          "Um artista veste uma escultura tecnológica e INTERAGE com o público numa galeria em tempo real. Que linguagem ele usa?",
        fotoUrl: performanceGaleria,
        alternativas: [
          {
            texto: "Performance Artística com Tecnologia Vestível — o corpo em ação é a obra",
            correta: true,
          },
        ...
        feedbackAcerto:
          "Perfeito! Performance + wearable = uma das linguagens mais fortes da arte contemporânea.",
        feedbackErro:
          "Cavalete é tradição do século XIX. Aqui a obra é o próprio corpo agindo — é performance.",
      },
    ],
  },
  ...
  cena06_personagensLugar: {
    ...
    animais: [
      {
        nome: "Extensões de madeira nos dedos",
        emoji: "🖐️",
        fotoUrl: rebeccaHorn,
      ...
      {
        nome: "Jaqueta com LEDs e fibra óptica",
        emoji: "💡",
        fotoUrl: jaquetaLed,
      ...
      {
        nome: "Ativista com capacete de antenas na rua",
        emoji: "🎭",
        fotoUrl: ciberAtivista,
  ...
  cena07_sequencia: {
    ...
    passos: [
      {
        id: "p1",
        texto:
          "Desenho a base ANATÔMICA da parte do corpo escolhida (mão, braço, cabeça) em papel quadriculado",
        emoji: "✋",
        ordem: 1,
        fotoUrl: passo1,
      },
      {
        id: "p2",
        texto: "Esboço por cima a ESTRUTURA VESTÍVEL — luva, elmo ou ombreira acoplada à anatomia",
        emoji: "🧤",
        ordem: 2,
        fotoUrl: passo2,
      },
      {
        id: "p3",
        texto:
          "Puxo linhas técnicas em vermelho apontando ONDE ficam os sensores e componentes fictícios",
        emoji: "📝",
        ordem: 3,
        fotoUrl: passo3,
      },
      {
        id: "p4",
        texto:
          "Colorizo indicando LEDs, fios de cobre e como a peça REAGE ao ambiente (luz, toque, som)",
        emoji: "🎨",
        ordem: 4,
        fotoUrl: passo4,
      },
      {
        id: "p5",
        texto:
          "Dou um TÍTULO pra obra e escrevo a crítica social/ecológica que ela faz — está pronta!",
        emoji: "🏷️",
        ordem: 5,
        fotoUrl: passo5,
      },
    ...
    falaAcerto:
      "Você acabou de projetar a primeira Extensão Corporal Poética do Laboratório Biomecânico!",
  },
  ...
  cena08_voceLe: {
    ...
    trechos: [
      {
        texto: "Sou ciber-designer. Meu suporte não é a tela — é o",
        palavraDestaque: "corpo humano",
        corDestaque: "#f97316",
      },
      {
        texto: "Quando visto um objeto que estranha o gesto, faço uma",
        palavraDestaque: "prótese poética",
        corDestaque: "#0891b2",
      },
      {
        texto: "Se integro sensores e LEDs ao tecido, o resultado é",
        palavraDestaque: "wearable art",
        corDestaque: "#7c3aed",
      },
      {
        texto: "Nada disso seria possível sem a",
        palavraDestaque: "cultura maker",
        corDestaque: "#16a34a",
      },
      {
        texto:
          "que me dá autonomia via Arduino e reciclagem. Ao subir na galeria e agir, tudo vira",
        palavraDestaque: "performance",
        corDestaque: "#dc2626",
      },
  ...
  cena09_minijogo: {
    ...
    variante: "minijogo",
    aurora:
      "🎯 A Forja do Circuito Estético! Solda TODOS os componentes na placa flexível antes do tempo acabar.",
  ...
  cena10_revisao: {
    ...
    itens: [
      {
        emoji: "🧬",
        rotulo: "Corpo Híbrido",
        descricao:
          "Corpo biológico atravessado por circuitos e sensores — o novo suporte da arte contemporânea.",
        cor: "#f97316",
        fotoUrl: corpoHibrido,
      },
      {
        emoji: "🖐️",
        rotulo: "Prótese Poética",
        descricao:
          "Extensão corporal que quebra o automatismo do gesto e força o público a repensar percepção e limites.",
        cor: "#0891b2",
        fotoUrl: rebeccaHorn,
      },
      {
        ...
        rotulo: "Wearable Art",
        descricao:
          "Roupa/adereço com sensores, LEDs e circuitos que reagem a luz, som e proximidade. Vestuário como obra interativa.",
        cor: "#7c3aed",
        fotoUrl: jaquetaLed,
      },
      {
        ...
        rotulo: "Cultura Maker / DIY",
        descricao:
          "Filosofia Do It Yourself: hardware livre (Arduino) + materiais reciclados dão autonomia técnica e artística.",
        cor: "#16a34a",
        fotoUrl: arduinoDiy,
      },
      {
        emoji: "🎭",
        rotulo: "Performance Artística",
        descricao:
          "O corpo em ação num tempo/espaço específicos é a obra. Gera estranhamento e reflexão no público.",
        cor: "#dc2626",
        fotoUrl: performanceGaleria,
      },
      {
        ...
        descricao:
          "Circuitos velhos, capacitores, fios de cobre viram matéria-prima da nova arte — crítica ecológica embutida.",
        cor: "#7c2d12",
        fotoUrl: materiaisReciclados,
      },
    ],
  ...
  cena11_avaliacao: {
    ...
    quiz: {
      pergunta:
        "Na arte contemporânea, quando um artista usa o próprio corpo com adereços tecnológicos pra interagir com o público em uma galeria, qual LINGUAGEM artística ele está utilizando?",
      alternativas: [
        {
          texto:
            "Performance Artística com Tecnologia Vestível (Wearable) — o corpo em ação é a obra",
          correta: true,
        },
        { texto: "Pintura Acadêmica de Cavalete — arte tradicional em tela", correta: false },
