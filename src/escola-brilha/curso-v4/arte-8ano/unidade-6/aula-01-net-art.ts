...
export const aula01: AulaArteV1 = {
  ...
  cena01_motivacao: {
    ...
    itens: [
      {
        emoji: "☎️",
        rotulo: "Modem discado (anos 1990)",
        descricao:
          "Nos anos 1990, conectar à internet fazia um som de bipes e chiados. A rede era LENTA, mas artistas já a usavam como espaço de criação.",
        cor: "#0891b2",
        fotoUrl: modemOld,
      },
      {
        emoji: "🖥️",
        rotulo: "Net Art (Arte de Internet)",
        descricao:
          "Movimento artístico em que a OBRA só existe na rede: páginas web, e-mails, chats e hyperlinks viram material de criação.",
        cor: "#7c3aed",
        fotoUrl: crtMonitor,
      },
      {
        emoji: "🔗",
        rotulo: "Hipertexto e Links",
        descricao:
          "Textos e imagens conectados por LINKS clicáveis: o público navega e monta seu próprio caminho de leitura pela obra.",
        cor: "#16a34a",
        fotoUrl: hyperlink,
      },
      {
        emoji: "😂",
        rotulo: "Memes e Remix Digital",
        descricao:
          "Imagens, vídeos e frases que se espalham e se TRANSFORMAM em cada compartilhamento — uma nova forma de autoria coletiva.",
        cor: "#f97316",
        fotoUrl: meme,
      },
    ],
  ...
  cena02_previsao: {
    ...
    perguntas: [
      {
        pergunta:
          "Um artista cria uma obra que só existe DENTRO de uma página de internet, com links que o público clica pra navegar. Que tipo de arte é essa?",
        fotoUrl: crtMonitor,
        alternativas: [
        ...
        feedbackAcerto:
          "Perfeito! Net Art é a arte que usa a PRÓPRIA internet (páginas, links, e-mails) como suporte e obra.",
        feedbackErro:
          "Mármore é material físico tradicional. Aqui a obra só existe NA REDE — isso é Net Art.",
      },
      {
        pergunta:
          "Um meme viaja de perfil em perfil e cada pessoa modifica a imagem original com uma frase nova. O que esse processo representa?",
        fotoUrl: meme,
        alternativas: [
          {
            texto: "Remix e autoria coletiva — a obra se transforma a cada compartilhamento",
            correta: true,
          },
        ...
        feedbackAcerto:
          "Isso! Na cultura de rede, remixar e compartilhar É a forma de criação — autoria vira coletiva.",
        feedbackErro:
          "Na internet, remixar não é roubo: é a LINGUAGEM da cultura de rede, onde todos recriam juntos.",
      },
      {
        pergunta:
          "Uma pessoa clica em palavras sublinhadas de um texto e pula para outra página, montando seu próprio caminho de leitura. Como se chama essa estrutura?",
        fotoUrl: hyperlink,
        alternativas: [
          {
            texto: "Hipertexto — textos conectados por links que o leitor escolhe navegar",
            correta: true,
          },
          {
            texto: "Texto linear impresso — só pode ser lido do início ao fim, em ordem fixa",
            correta: false,
          },
        ...
        feedbackAcerto:
          "Excelente! O hipertexto quebra a leitura linear: cada pessoa cria seu próprio percurso pela obra.",
        feedbackErro:
          "Texto impresso é sempre linear. O hipertexto é o OPOSTO: caminhos múltiplos escolhidos por quem lê.",
      },
    ],
  },
  ...
  cena03_vocabulario: {
    ...
    cards: [
      {
        termo: "Net Art (Arte de Internet)",
        definicao:
          "Movimento artístico surgido nos anos 1990 em que a obra só existe e faz sentido DENTRO da internet: páginas, e-mails, chats e navegadores.",
        emoji: "🖥️",
        cor: "#7c3aed",
        fotoUrl: crtMonitor,
      },
      {
        termo: "Hipertexto",
        definicao:
          "Estrutura de texto com LINKS clicáveis que conectam páginas e conteúdos, permitindo que cada leitor monte seu próprio caminho de navegação.",
        emoji: "🔗",
        cor: "#16a34a",
        fotoUrl: hyperlink,
      },
      {
        termo: "Cultura de Rede",
        definicao:
          "Conjunto de práticas, valores e estéticas nascidas da conexão global: compartilhamento, colaboração e viralização de conteúdo.",
        emoji: "🌐",
        cor: "#0891b2",
        fotoUrl: serverRoom,
      },
      {
        termo: "Remix / Cultura Meme",
        definicao:
          "Prática de recriar, modificar e compartilhar imagens, vídeos ou frases, gerando autoria COLETIVA que se transforma a cada compartilhamento.",
        emoji: "😂",
        cor: "#f97316",
        fotoUrl: meme,
      },
    ...
    pigmentos: [
      {
        nome: "Net Art",
        hex: "#7c3aed",
        fonte: "Obra que só existe na internet",
        emoji: "🖥️",
        fotoUrl: crtMonitor,
      },
      {
        nome: "Hipertexto",
        hex: "#16a34a",
        fonte: "Links que criam caminhos de leitura",
        emoji: "🔗",
        fotoUrl: hyperlink,
      },
      {
        nome: "Cultura de Rede",
        hex: "#0891b2",
        fonte: "Compartilhar, comentar, remixar",
        emoji: "🌐",
        fotoUrl: serverRoom,
      },
      {
        nome: "Remix / Meme",
        hex: "#f97316",
        fonte: "Autoria coletiva em transformação",
        emoji: "😂",
        fotoUrl: meme,
      },
    ],
    ...
    perguntas: [
      {
        ...
        alternativas: [
          {
            texto:
              "Ela só existe DENTRO da internet e pode mudar ou interagir com o público a cada clique",
            correta: true,
          },
          {
            texto:
              "Ela é feita exclusivamente com tinta a óleo sobre tela, igual às pinturas clássicas",
            correta: false,
          },
        ...
        feedbackAcerto:
          "Correto! A Net Art vive na rede — página, link e clique fazem parte da própria obra.",
        feedbackErro:
          "Tinta a óleo é técnica tradicional. A Net Art é DIGITAL e existe apenas dentro da internet.",
      },
      {
        ...
        alternativas: [
          {
            texto:
              "Conectar páginas por links, permitindo que cada pessoa monte seu próprio caminho de navegação",
            correta: true,
          },
          {
            texto: "Obrigar todo mundo a ler o texto sempre na mesma ordem, do início ao fim",
            correta: false,
          },
        ...
        feedbackAcerto:
          "Isso! O hipertexto quebra a linearidade — cada clique gera uma experiência única.",
        feedbackErro:
          "Isso é leitura linear tradicional. O hipertexto faz o OPOSTO: libera caminhos múltiplos.",
      },
      {
        ...
        alternativas: [
          {
            texto:
              "Porque cada pessoa que compartilha pode remixar e transformar a obra, somando novas camadas de sentido",
            correta: true,
          },
          {
            texto: "Porque só o criador original tem permissão de alterar ou compartilhar a imagem",
            correta: false,
          },
        ...
        feedbackAcerto:
          "Perfeito! Na cultura de rede, remixar é criar junto — a autoria se espalha por toda a comunidade.",
        feedbackErro:
          "Pelo contrário: o meme vive justamente porque OUTRAS pessoas o remixam e recriam.",
      },
    ],
  },
  ...
  cena06_personagensLugar: {
    ...
    animais: [
      {
        nome: "Página web com links que mudam a cada clique",
        emoji: "🖥️",
        fotoUrl: crtMonitor,
      ...
      {
        nome: "Texto sublinhado que leva a outra página",
        emoji: "🔗",
        fotoUrl: hyperlink,
      ...
      {
        nome: "Imagem engraçada que muda de frase a cada compartilhamento",
        emoji: "😂",
        fotoUrl: meme,
        ...
        falaAcerto:
          "Perfeito! Imagem que se transforma a cada compartilhamento = remix da cultura meme.",
      },
    ],
  },
  ...
  cena07_sequencia: {
    ...
    passos: [
      {
        id: "p1",
        texto: "Escolho uma IMAGEM ou frase original pra ser o ponto de partida da obra",
        emoji: "🖼️",
        ordem: 1,
        fotoUrl: digitalCollage,
      },
      {
        id: "p2",
        texto: "Recorto e colo elementos de OUTRAS fontes digitais, criando uma colagem híbrida",
        emoji: "✂️",
        ordem: 2,
        fotoUrl: htmlSource,
      },
      {
        id: "p3",
        texto: "Adiciono um TEXTO ou frase de efeito que dialoga com a imagem, no estilo meme",
        emoji: "💬",
        ordem: 3,
        fotoUrl: chat90s,
      },
      {
        id: "p4",
        texto:
          "Penso em como essa obra pode ser MODIFICADA por outras pessoas ao ser compartilhada",
        emoji: "🔁",
        ordem: 4,
        fotoUrl: fiberOptics,
      },
      {
        id: "p5",
        texto:
          "Compartilho a obra e convido a turma a REMIXAR, criando uma corrente de autoria coletiva",
        emoji: "📤",
        ordem: 5,
        fotoUrl: keyboard,
      },
    ...
    falaAcerto:
      "Você acabou de criar sua primeira Obra Remixável do Laboratório de Cultura de Rede!",
  },
  ...
  cena08_voceLe: {
    ...
    trechos: [
      {
        texto: "Sou ciber-designer de rede. Meu ateliê agora é a",
        palavraDestaque: "internet",
        corDestaque: "#0891b2",
      },
      {
        texto: "Quando crio uma obra que só existe online e reage ao clique, faço",
        palavraDestaque: "net art",
        corDestaque: "#7c3aed",
      },
      {
        texto: "Se conecto textos e imagens por links clicáveis, uso",
        palavraDestaque: "hipertexto",
        corDestaque: "#16a34a",
      },
      {
        texto: "Tudo isso faz parte da",
        palavraDestaque: "cultura de rede",
        corDestaque: "#0891b2",
      },
      {
        texto:
          "que valoriza compartilhar e comentar. Quando remixo uma imagem que todo mundo transforma, crio um",
        palavraDestaque: "meme",
        corDestaque: "#f97316",
      },
  ...
  cena09_minijogo: {
    ...
    variante: "minijogo",
    aurora:
      "🔗 A Cadeia do Compartilhamento! Passa a obra adiante pela rede antes que o sinal caia.",
    ...
    falaFinal:
      "Cadeia completa! A obra se espalhou por toda a rede, transformada por cada mão que a tocou.",
  },
  ...
  cena10_revisao: {
    ...
    itens: [
      {
        emoji: "☎️",
        rotulo: "Internet dos anos 1990",
        descricao:
          "Modem discado, telas de tubo e as primeiras conexões que abriram espaço pra arte em rede.",
        cor: "#0891b2",
        fotoUrl: modemOld,
      },
      {
        ...
        rotulo: "Net Art",
        descricao:
          "Movimento artístico em que a obra só existe e faz sentido dentro da internet — páginas, links e e-mails.",
        cor: "#7c3aed",
        fotoUrl: crtMonitor,
      },
      {
        ...
        rotulo: "Hipertexto",
        descricao:
          "Estrutura de links clicáveis que conecta conteúdos e permite caminhos de leitura escolhidos pelo público.",
        cor: "#16a34a",
        fotoUrl: hyperlink,
      },
      {
        emoji: "🌐",
        rotulo: "Cultura de Rede",
        descricao:
          "Valores e práticas nascidas da conexão global: compartilhar, comentar e colaborar em tempo real.",
        cor: "#0891b2",
        fotoUrl: serverRoom,
      },
      {
        emoji: "😂",
        rotulo: "Remix / Cultura Meme",
        descricao:
          "Prática de recriar e transformar imagens e vídeos, gerando autoria coletiva que se espalha pela rede.",
        cor: "#f97316",
        fotoUrl: meme,
      },
      {
        ...
        rotulo: "Fibra Óptica",
        descricao:
          "Cabos de luz que carregam dados a velocidades altíssimas, sustentando a rede que conecta o planeta.",
        cor: "#16a34a",
        fotoUrl: fiberOptics,
      },
    ],
  ...
  cena11_avaliacao: {
    ...
    quiz: {
      pergunta:
        "Um artista cria uma página de internet cujo conteúdo muda de acordo com os cliques do público, e convida outras pessoas a remixarem a obra compartilhando-a. Que características da arte contemporânea de rede estão presentes aqui?",
      alternativas: [
        {
          texto:
            "Net Art (a obra só existe na internet) + Cultura de Rede (compartilhamento e remix como autoria coletiva)",
          correta: true,
        },
        {
          texto:
            "Escultura clássica em mármore, fixa e produzida por um único autor num ateliê fechado",
          correta: false,
        },
