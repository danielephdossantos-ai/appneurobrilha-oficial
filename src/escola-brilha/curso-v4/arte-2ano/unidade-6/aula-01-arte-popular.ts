...
import __asset_vocabArtesao from "@/assets/arte-2ano/u6-vocab-artesao.jpg.asset.json";
const vocabArtesao = __asset_vocabArtesao.url;
import __asset_vocabCordel from "@/assets/arte-2ano/u6-vocab-cordel.jpg.asset.json";
const vocabCordel = __asset_vocabCordel.url;
import __asset_vocabCeramica from "@/assets/arte-2ano/u6-vocab-ceramica.jpg.asset.json";
const vocabCeramica = __asset_vocabCeramica.url;
import __asset_vocabCultura from "@/assets/arte-2ano/u6-vocab-cultura.jpg.asset.json";
const vocabCultura = __asset_vocabCultura.url;
import __asset_pigCarranca from "@/assets/arte-2ano/u6-pig-carranca.jpg.asset.json";
const pigCarranca = __asset_pigCarranca.url;
import __asset_pigBonecas from "@/assets/arte-2ano/u6-pig-bonecas.jpg.asset.json";
const pigBonecas = __asset_pigBonecas.url;
import __asset_pigCordel from "@/assets/arte-2ano/u6-pig-cordel.jpg.asset.json";
const pigCordel = __asset_pigCordel.url;
import __asset_pigBoi from "@/assets/arte-2ano/u6-pig-boi.jpg.asset.json";
const pigBoi = __asset_pigBoi.url;
import __asset_animalBoi from "@/assets/arte-2ano/u6-animal-boi.jpg.asset.json";
const animalBoi = __asset_animalBoi.url;
import __asset_animalCarranca from "@/assets/arte-2ano/u6-animal-carranca.jpg.asset.json";
const animalCarranca = __asset_animalCarranca.url;
import __asset_animalBonecas from "@/assets/arte-2ano/u6-animal-bonecas.jpg.asset.json";
const animalBonecas = __asset_animalBonecas.url;
import __asset_u6passo1 from "@/assets/arte-2ano/u6-passo1-barro.jpg.asset.json";
const u6passo1 = __asset_u6passo1.url;
import __asset_u6passo2 from "@/assets/arte-2ano/u6-passo2-amassar.jpg.asset.json";
const u6passo2 = __asset_u6passo2.url;
import __asset_u6passo3 from "@/assets/arte-2ano/u6-passo3-modelar.jpg.asset.json";
const u6passo3 = __asset_u6passo3.url;
import __asset_u6passo4 from "@/assets/arte-2ano/u6-passo4-secar.jpg.asset.json";
const u6passo4 = __asset_u6passo4.url;
