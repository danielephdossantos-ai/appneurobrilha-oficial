...
export const aula01: AulaArteV1 = {
    ...
    itens: [
      {
        emoji: "🍂",
        rotulo: "Folhas secas",
        descricao: "Amarelas, laranjas, marrons. Formam MOSAICOS lindos no chão.",
        cor: "#f97316",
      },
      {
        emoji: "🌸",
        rotulo: "Pétalas de flores",
        descricao: "Coloridas e macias. Vira arco-íris circular no chão.",
        cor: "#f472b6",
      },
      {
        emoji: "🪨",
        rotulo: "Pedras do rio",
        descricao: "Podem ser empilhadas em TORRES ou fazer espirais.",
        cor: "#6b7280",
      },
      {
        emoji: "🌰",
        rotulo: "Sementes e frutos",
        descricao: "Contas naturais pra fazer mandalas e caminhos.",
        cor: "#78350f",
      },
    ],
  ...
  cena03_vocabulario: {
    ...
    cards: [
      {
        termo: "Land Art",
        definicao: "Arte feita AO AR LIVRE, só com materiais da natureza.",
        emoji: "🌿",
        cor: "#16a34a",
        fotoUrl: vocabLandArt,
      },
      {
        termo: "Efêmero",
        definicao: "Que dura pouco tempo, depois some. Como uma nuvem.",
        emoji: "☁️",
        cor: "#94a3b8",
        fotoUrl: vocabEfemero,
      },
      {
        termo: "Mandala",
        definicao: "Desenho em forma de CÍRCULO, cheio de simetria e cor.",
        emoji: "🌸",
        cor: "#f472b6",
        fotoUrl: vocabMandala,
      },
      {
        termo: "Natureza",
        definicao: "Todos os seres vivos e coisas que a Terra criou sem a mão do homem.",
        emoji: "🌍",
        cor: "#0ea5e9",
        fotoUrl: vocabNatureza,
      },
    ],
  },
  ...
  cena04_leituraGuiada: {
    tipo: "leituraTintas",
    aurora:
      "Vou te contar sobre um artista que fez arte SÓ na natureza a vida inteira: Andy Goldsworthy!",
    paragrafos: [
    ...
    pigmentos: [
      {
        nome: "Amarelo das folhas",
        hex: "#eab308",
        fonte: "Outono no chão",
        emoji: "🍂",
        fotoUrl: pigFolhas,
      },
      {
        nome: "Rosa das pétalas",
        hex: "#f472b6",
        fonte: "Mandala de flores",
        emoji: "🌸",
        fotoUrl: pigPetalas,
      },
      {
  ...
  cena06_personagensLugar: {
    ...
    animais: [
      ...
      {
        nome: "Mandala colorida",
        emoji: "🌸",
        fotoUrl: animalMandala,
      ...
      {
        nome: "Caminho na terra",
        emoji: "🛤️",
        fotoUrl: animalCaminho,
  ...
  cena07_sequencia: {
    ...
    passos: [
      ...
      {
        id: "p2",
        texto: "COLETO folhas, pétalas e pedrinhas",
        emoji: "🍂",
        ordem: 2,
        fotoUrl: u7passo2,
      },
      {
        id: "p3",
        texto: "Marco um CÍRCULO grande na terra",
        emoji: "⭕",
        ordem: 3,
        fotoUrl: u7passo3,
      },
      {
        id: "p4",
        texto: "Vou ORGANIZANDO por cor e tamanho",
        emoji: "🌈",
        ordem: 4,
        fotoUrl: u7passo4,
      },
      {
        id: "p5",
        texto: "Tiro uma FOTO e deixo a natureza levar",
        emoji: "📷",
        ordem: 5,
        fotoUrl: u7passo5,
      },
  ...
  cena08_voceLe: {
    ...
    trechos: [
      {
        texto: "Fui pro jardim procurar folhas e",
        palavraDestaque: "pedrinhas",
        corDestaque: "#6b7280",
      },
  ...
  cena09_minijogo: {
    ...
    variante: "minijogo",
    aurora:
      "Grande Coleta! Toque em CADA material da natureza antes do tempo acabar pra montar sua obra final!",
  ...
  cena10_revisao: {
    ...
    variante: "revisar",
    aurora:
      "Última roda de revisão — de TODAS as unidades do Pincel Mágico! Toca em cada uma pra lembrar.",
    titulo: "🔁 Roda Final do Pincel Mágico",
    itens: [
      {
        emoji: "🎨",
        rotulo: "Cores (U1)",
        descricao: "Primárias + mistura = secundárias.",
        cor: "#dc2626",
      },
      {
        emoji: "📐",
        rotulo: "Formas (U2)",
        descricao: "Círculo, quadrado, triângulo, retângulo.",
        cor: "#a855f7",
      },
      {
        emoji: "🖐️",
        rotulo: "Texturas (U3)",
        descricao: "Áspero, liso, macio + frotagem.",
        cor: "#f97316",
      },
      {
        emoji: "🥁",
        rotulo: "Sons do corpo (U4)",
        descricao: "Palmas, pés, estalos = percussão.",
        cor: "#dc2626",
      },
      {
        emoji: "🎭",
        rotulo: "Sombras (U5)",
        descricao: "Luz + objeto = teatro milenar.",
        cor: "#1f2937",
      },
      {
        emoji: "🇧🇷",
        rotulo: "Arte popular (U6)",
        descricao: "Carranca, cerâmica, cordel, boi.",
        cor: "#16a34a",
      },
      {
        emoji: "🍃",
        rotulo: "Land Art (U7)",
        descricao: "Arte só com natureza — efêmera.",
        cor: "#0ea5e9",
      },
    ],
  ...
  cena11_avaliacao: {
    ...
    quiz: {
      ...
      feedback:
        "Isso! Land Art é feita ao ar livre, com folhas, pedras e galhos — e some com o tempo, porque vira parte da natureza de novo.",
    },
    missaoFamilia:
