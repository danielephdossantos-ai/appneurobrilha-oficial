...
import __asset_vocabPrimaria from "@/assets/arte-2ano/u1-vocab-primaria.jpg.asset.json";
const vocabPrimaria = __asset_vocabPrimaria.url;
import __asset_vocabSecundaria from "@/assets/arte-2ano/u1-vocab-secundaria.jpg.asset.json";
const vocabSecundaria = __asset_vocabSecundaria.url;
import __asset_vocabMistura from "@/assets/arte-2ano/u1-vocab-mistura.jpg.asset.json";
const vocabMistura = __asset_vocabMistura.url;
import __asset_vocabPigmento from "@/assets/arte-2ano/u1-vocab-pigmento.jpg.asset.json";
const vocabPigmento = __asset_vocabPigmento.url;
import __asset_pigVermelho from "@/assets/arte-2ano/u1-pig-vermelho-terra.jpg.asset.json";
const pigVermelho = __asset_pigVermelho.url;
import __asset_pigUrucum from "@/assets/arte-2ano/u1-pig-urucum.jpg.asset.json";
const pigUrucum = __asset_pigUrucum.url;
import __asset_pigFolha from "@/assets/arte-2ano/u1-pig-folha-verde.jpg.asset.json";
const pigFolha = __asset_pigFolha.url;
import __asset_pigAnil from "@/assets/arte-2ano/u1-pig-anil.jpg.asset.json";
const pigAnil = __asset_pigAnil.url;
import __asset_animalSapo from "@/assets/arte-2ano/u1-animal-sapo.jpg.asset.json";
const animalSapo = __asset_animalSapo.url;
import __asset_animalRaposa from "@/assets/arte-2ano/u1-animal-raposa.jpg.asset.json";
const animalRaposa = __asset_animalRaposa.url;
import __asset_animalBorboleta from "@/assets/arte-2ano/u1-animal-borboleta.jpg.asset.json";
const animalBorboleta = __asset_animalBorboleta.url;
import __asset_passo1Img from "@/assets/arte-2ano/u1-passo1-escolho.jpg.asset.json";
const passo1Img = __asset_passo1Img.url;
import __asset_passo2Img from "@/assets/arte-2ano/u1-passo2-cauldron.jpg.asset.json";
const passo2Img = __asset_passo2Img.url;
import __asset_passo3Img from "@/assets/arte-2ano/u1-passo3-segunda.jpg.asset.json";
const passo3Img = __asset_passo3Img.url;
import __asset_passo4Img from "@/assets/arte-2ano/u1-passo4-misturo.jpg.asset.json";
const passo4Img = __asset_passo4Img.url;
import __asset_passo5Img from "@/assets/arte-2ano/u1-passo5-nasce.jpg.asset.json";
