...
import __asset_vocabAgudo from "@/assets/arte-2ano/u4-vocab-agudo.jpg.asset.json";
const vocabAgudo = __asset_vocabAgudo.url;
import __asset_vocabPercussao from "@/assets/arte-2ano/u4-vocab-percussao.jpg.asset.json";
const vocabPercussao = __asset_vocabPercussao.url;
import __asset_pigPeito from "@/assets/arte-2ano/u4-pig-peito.jpg.asset.json";
const pigPeito = __asset_pigPeito.url;
import __asset_pigBoca from "@/assets/arte-2ano/u4-pig-boca.jpg.asset.json";
const pigBoca = __asset_pigBoca.url;
...
import __asset_passo1Img from "@/assets/arte-2ano/u4-passo1-palma.jpg.asset.json";
...
import __asset_passo3Img from "@/assets/arte-2ano/u4-passo3-estalo.jpg.asset.json";
