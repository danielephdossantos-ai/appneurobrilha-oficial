...
import __asset_vocabMacio from "@/assets/arte-2ano/u3-vocab-macio.jpg.asset.json";
const vocabMacio = __asset_vocabMacio.url;
import __asset_vocabFrotagem from "@/assets/arte-2ano/u3-vocab-frotagem.jpg.asset.json";
const vocabFrotagem = __asset_vocabFrotagem.url;
...
import __asset_animalOvelha from "@/assets/arte-2ano/u3-animal-ovelha.jpg.asset.json";
const animalOvelha = __asset_animalOvelha.url;
import __asset_animalPeixe from "@/assets/arte-2ano/u3-animal-peixe.jpg.asset.json";
const animalPeixe = __asset_animalPeixe.url;
import __asset_animalTatu from "@/assets/arte-2ano/u3-animal-tatu.jpg.asset.json";
const animalTatu = __asset_animalTatu.url;
import __asset_passo1Img from "@/assets/arte-2ano/u3-passo1-folha.jpg.asset.json";
const passo1Img = __asset_passo1Img.url;
import __asset_passo2Img from "@/assets/arte-2ano/u3-passo2-papel.jpg.asset.json";
const passo2Img = __asset_passo2Img.url;
import __asset_passo3Img from "@/assets/arte-2ano/u3-passo3-lapis.jpg.asset.json";
const passo3Img = __asset_passo3Img.url;
import __asset_passo4Img from "@/assets/arte-2ano/u3-passo4-esfregar.jpg.asset.json";
...
export const aula01: AulaArteV1 = {
  ...
  cena01_motivacao: {
    ...
    itens: [
      {
        emoji: "🌳",
        rotulo: "Casca de árvore",
        descricao: "ÁSPERA e cheia de sulcos, como uma mão enrugada.",
        cor: "#78350f",
      },
      {
        emoji: "🧽",
        rotulo: "Esponja",
        descricao: "MACIA e cheia de furinhos que somem quando aperta.",
        cor: "#fbbf24",
      },
      {
        emoji: "🪨",
        rotulo: "Pedra do rio",
        descricao: "LISA e fria, polida pela água por muitos anos.",
        cor: "#6b7280",
      },
      {
        emoji: "🐑",
        rotulo: "Lã da ovelha",
        descricao: "FOFA, quentinha, parece uma nuvem.",
        cor: "#f3f4f6",
      },
    ],
    falaFinal:
      "Textura é tudo aquilo que a MÃO sente. E o artista usa isso pra dar vida ao desenho!",
  },
  ...
  cena03_vocabulario: {
    ...
    cards: [
      {
        termo: "Áspero",
        definicao: "Cheio de saliências, arranha um pouquinho. Ex: casca de árvore.",
        emoji: "🌳",
        cor: "#78350f",
        fotoUrl: vocabAspero,
      },
      {
        termo: "Liso",
        definicao: "Sem relevos, a mão desliza. Ex: vidro, mármore.",
        emoji: "🪞",
        cor: "#0ea5e9",
        fotoUrl: vocabLiso,
      },
      {
        termo: "Macio",
        definicao: "Fofinho, cede quando aperta. Ex: algodão, pluma.",
        emoji: "☁️",
        cor: "#f3f4f6",
        fotoUrl: vocabMacio,
      },
      {
        termo: "Frotagem",
        definicao: "Coloca papel sobre uma textura e passa lápis: aparece o desenho dela!",
        emoji: "✏️",
        cor: "#a855f7",
        fotoUrl: vocabFrotagem,
      },
    ],
  },
  ...
  cena04_leituraGuiada: {
    tipo: "leituraTintas",
    aurora:
      "Vou te contar o segredo da FROTAGEM, uma técnica que artistas usam há mais de 100 anos.",
    paragrafos: [
  ...
  cena07_sequencia: {
    ...
    passos: [
      {
        id: "p1",
        texto: "Escolho uma folha bem cheia de nervuras",
        emoji: "🍃",
        ordem: 1,
        fotoUrl: passo1Img,
      },
      {
        id: "p2",
        texto: "Coloco a folha embaixo do papel branco",
        emoji: "📄",
        ordem: 2,
        fotoUrl: passo2Img,
      },
      {
        id: "p3",
        texto: "Pego um lápis de cor DEITADO",
        emoji: "✏️",
        ordem: 3,
        fotoUrl: passo3Img,
      },
      {
        id: "p4",
        texto: "Esfrego o lápis por cima do papel bem devagar",
        emoji: "🖐️",
        ordem: 4,
        fotoUrl: passo4Img,
      },
      {
        id: "p5",
        texto: "A textura da folha aparece como MÁGICA!",
        emoji: "✨",
        ordem: 5,
        fotoUrl: passo5Img,
      },
  ...
  cena08_voceLe: {
    ...
    trechos: [
      ...
      {
        texto: "Fiz frotagem numa folha e apareceu um desenho",
        palavraDestaque: "mágico",
        corDestaque: "#a855f7",
      },
    ...
    itens: [
      {
        emoji: "🌳",
        rotulo: "Áspero",
        descricao: "Casca, lixa, tijolo. Arranham um pouquinho.",
        cor: "#78350f",
      },
      {
        emoji: "🪞",
        rotulo: "Liso",
        descricao: "Vidro, espelho, mármore. A mão desliza.",
        cor: "#0ea5e9",
      },
      {
        emoji: "☁️",
        rotulo: "Macio",
        descricao: "Algodão, pluma, pelúcia. Fofinho.",
        cor: "#f3f4f6",
      },
      {
        emoji: "🧽",
        rotulo: "Esponjoso",
        descricao: "Cheio de furinhos que voltam ao lugar.",
        cor: "#fbbf24",
      },
      {
        emoji: "✏️",
        rotulo: "Frotagem",
        descricao: "Técnica pra copiar textura com lápis.",
        cor: "#a855f7",
      },
      {
        emoji: "🖐️",
        rotulo: "Tato",
        descricao: "O sentido que descobre as texturas.",
        cor: "#f472b6",
      },
    ],
  ...
  cena11_avaliacao: {
    ...
    quiz: {
      pergunta:
        "Qual técnica coloca papel sobre uma superfície e passa lápis por cima pra copiar sua textura?",
      alternativas: [
