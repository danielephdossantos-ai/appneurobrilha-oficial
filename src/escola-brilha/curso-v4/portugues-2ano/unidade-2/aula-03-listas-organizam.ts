...
export const aula03: AulaPortuguesV4 = {
  ...
  // ------------------------------------------------------------
  momento_fluencia: {
    titulo: "Ler três vezes: Lista de coisas pra escola",
    instrucao:
    ...
    perguntas: [
      {
        ...
        correta: 1,
        feedbackOpcoes: [
          "«Contar história» não é a resposta. A certa é «Organizar coisas em ordem, item por item».",
          null,
          "«Convidar pra festa» não é a resposta. A certa é «Organizar coisas em ordem, item por item».",
          "«Cada coisa da lista» não é a resposta. A certa é «Organizar coisas em ordem, item por item».",
        ],
        feedbackAcerto: "🎉 Isso!",
      ...
      },
      {
        ...
        correta: 1,
        feedbackOpcoes: [
          "«Tudo em UMA linha» não é a resposta. A certa é «Um item em cada LINHA».",
          null,
          "«Só com números, sem palavra» não é a resposta. A certa é «Um item em cada LINHA».",
          "«📄 Papel toalha» não é a resposta. A certa é «Um item em cada LINHA».",
        ],
      ...
      },
      {
        ...
        correta: 1,
        feedbackOpcoes: [
          "«Um personagem» não é a resposta. A certa é «Cada coisa da lista».",
          null,
          "«Um tipo de festa» não é a resposta. A certa é «Cada coisa da lista».",
          "«Papel branco» não é a resposta. A certa é «Cada coisa da lista».",
        ],
        feedbackAcerto: "🎉 Isso!",
      ...
      },
      {
        ...
        correta: 2,
        feedbackOpcoes: [
          "«Bolo» não é a resposta. A certa é «A escola inteira».",
          "«Frutas» não é a resposta. A certa é «A escola inteira».",
          null,
          "«🍌 Banana» não é a resposta. A certa é «A escola inteira».",
        ],
      ...
      },
      {
        ...
        correta: 1,
        feedbackOpcoes: [
          "«1» não é a resposta. A certa é «4».",
          null,
          "«10» não é a resposta. A certa é «4».",
          "«banana» não é a resposta. A certa é «4».",
        ],
