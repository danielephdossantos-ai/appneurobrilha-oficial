...
export const aula02: AulaPortuguesV4 = {
  ...
  // ------------------------------------------------------------
  momento_fluencia: {
    titulo: "Ler três vezes: Convite — Aniversário do Léo",
    instrucao:
    ...
    perguntas: [
      {
        ...
        correta: 1,
        feedbackOpcoes: [
          "«Contar história de dormir» não é a resposta. A certa é «Chamar alguém pra um evento».",
          null,
          "«Comprar coisas no mercado» não é a resposta. A certa é «Chamar alguém pra um evento».",
          "«Sábado, 20 de setembro» não é a resposta. A certa é «Chamar alguém pra um evento».",
        ],
        feedbackAcerto: "🎉 Isso!",
      ...
      },
      {
        ...
        feedbackOpcoes: [
          null,
          "«Hora» não é a resposta. A certa é «Data».",
          "«Local» não é a resposta. A certa é «Data».",
          "«O motivo» não é a resposta. A certa é «Data».",
        ],
      ...
      },
      {
        ...
        correta: 1,
        feedbackOpcoes: [
          "«Local» não é a resposta. A certa é «Horário».",
          null,
          "«Motivo» não é a resposta. A certa é «Horário».",
          "«Às 19h» não é a resposta. A certa é «Horário».",
        ],
      ...
      },
      {
        ...
        feedbackOpcoes: [
          null,
          "«Motivo» não é a resposta. A certa é «Local».",
          "«Data» não é a resposta. A certa é «Local».",
          "«O motivo» não é a resposta. A certa é «Local».",
        ],
      ...
      },
      {
        ...
        correta: 2,
        feedbackOpcoes: [
          "«Local» não é a resposta. A certa é «Motivo».",
          "«Horário» não é a resposta. A certa é «Motivo».",
          null,
          "«Às 19h» não é a resposta. A certa é «Motivo».",
        ],
