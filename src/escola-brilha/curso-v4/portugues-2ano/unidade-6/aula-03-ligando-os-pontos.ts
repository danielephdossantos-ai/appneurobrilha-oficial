...
export const aula03: AulaPortuguesV4 = {
  ...
  // ------------------------------------------------------------
  momento_fluencia: {
    titulo: "Ler três vezes: O cachorro molhado",
    instrucao:
    ...
    perguntas: [
      {
        ...
        feedbackOpcoes: [
          ...
          "«A cor» não é a resposta. A certa é «A CAUSA».",
          "«só o começo» não é a resposta. A certa é «A CAUSA».",
        ],
      ...
      },
      {
        ...
        feedbackOpcoes: [
          null,
          "«O lugar» não é a resposta. A certa é «O RESULTADO».",
          "«O autor» não é a resposta. A certa é «O RESULTADO».",
          "«PORQUE» não é a resposta. A certa é «O RESULTADO».",
        ],
      ...
      },
      {
        ...
        feedbackOpcoes: [
          null,
          "«pintou a parede» não é a resposta. A certa é «bebeu água».",
          "«dormiu» não é a resposta. A certa é «bebeu água».",
          "«PORQUE» não é a resposta. A certa é «bebeu água».",
        ],
      ...
      },
      {
        ...
        feedbackOpcoes: [
          null,
          "«estava sol forte» não é a resposta. A certa é «choveu».",
          "«era feriado» não é a resposta. A certa é «choveu».",
          "«Porque tomou banho» não é a resposta. A certa é «choveu».",
        ],
      ...
      },
      {
        ...
        feedbackOpcoes: [
          null,
          "«só as figuras» não é a resposta. A certa é «causa e resultado».",
          "«só o começo» não é a resposta. A certa é «causa e resultado».",
          "«todo mundo cantou» não é a resposta. A certa é «causa e resultado».",
        ],
