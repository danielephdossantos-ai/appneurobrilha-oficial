 ...
 * BNCC EF08ER01 → EF08ER06. NÃO CONFESSIONAL.
...
const curso: CursoGeoV1 = {
  ...
  tipoAula: "geo-v1",
  unidades: [unidade1, unidade2, unidade3, unidade4, unidade5, unidade6, unidade7].map((unidade,indice)=>({...unidade,aulas:unidade.aulas.map(aula=>normalizarAula(indice===5?{...aula,bncc:[]}:aula))})),
};
