...
export const aula01: AulaGeoV1 = {
  ...
  cena05_compreensao: {
    ...
    perguntas: [
      { id: "q1", pergunta: "O céu costuma ficar mais escuro:", fotoUrl: noiteImg, cards: [{ id: "a", emoji: "🌌", titulo: "De noite", cor: "from-slate-700 to-indigo-900" }, { id: "b", emoji: "☀️", titulo: "De dia", cor: "from-yellow-400 to-orange-600" }, { id: "c", emoji: "🌈", titulo: "Sempre", cor: "from-pink-400 to-fuchsia-600" }, { id: "d", emoji: "❓", titulo: "Nunca", cor: "from-blue-400 to-indigo-700" }], correta: "a", feedbackAcerto: "De noite nosso lado da Terra não recebe luz direta do Sol.", feedbackErro: "De noite, o lugar onde estamos fica voltado para longe da luz direta do Sol." },
      { id: "q2", pergunta: "Quem ilumina o dia:", fotoUrl: solImg, cards: [{ id: "a", emoji: "☀️", titulo: "O Sol", cor: "from-yellow-400 to-orange-600" }, { id: "b", emoji: "🌙", titulo: "A Lua", cor: "from-indigo-400 to-purple-700" }, { id: "c", emoji: "⭐", titulo: "Estrela", cor: "from-cyan-400 to-sky-600" }, { id: "d", emoji: "❓", titulo: "Outra resposta", cor: "from-blue-400 to-indigo-700" }], correta: "a", feedbackAcerto: "O SOL brilha e ilumina tudo!", feedbackErro: "Lua brilha de noite. De dia é o SOL." },
      { id: "q3", pergunta: "A hora de dormir é:", fotoUrl: dormindoImg, cards: [{ id: "a", emoji: "🌙", titulo: "À noite", cor: "from-indigo-400 to-purple-700" }, { id: "b", emoji: "☀️", titulo: "De manhã", cor: "from-yellow-400 to-orange-600" }, { id: "c", emoji: "🌞", titulo: "Meio-dia", cor: "from-orange-400 to-red-600" }, { id: "d", emoji: "❓", titulo: "Outra resposta", cor: "from-blue-400 to-indigo-700" }], correta: "a", feedbackAcerto: "À NOITE o corpo descansa!", feedbackErro: "De dia a gente acorda. À NOITE dorme." },
    ],
  ...
  cena07_sequencia: {
    ...
    paradas: [
      ...
      { id: "noite", emoji: "🌙", rotulo: "3. Noite", descricao: "Escurece e podemos observar melhor estrelas; a Lua pode aparecer de dia ou de noite.", fotoUrl: noiteImg },
  ...
  cena08_voceLe: {
    ...
    paragrafos: [
      ...
      { id: "p3", texto: "O CORPO precisa DORMIR para descansar, aprender e se desenvolver. Crianças precisam de uma rotina de sono adequada.", chaves: ["dormir", "desenvolver"], definicoes: { dormir: "Período de repouso importante para o organismo.", desenvolver: "Passar por mudanças e adquirir novas capacidades." }, fotoUrl: dormindoImg },
    ],
  ...
  cena11_avaliacao: {
    ...
    fotoUrl: brilhaImg,
    perguntas: [
      { id: "q1", pergunta: "De dia aparece:", fotoUrl: solImg, opcoes: [{ id: "a", texto: "O Sol", correta: true }, { id: "b", texto: "A Lua" }, { id: "c", texto: "Outra resposta" }, { id: "d", texto: "Nenhuma das anteriores" }], feedbackAcerto: "Isso!", feedbackErro: "É o SOL." },
      { id: "q2", pergunta: "À noite aparece:", fotoUrl: luaImg, opcoes: [{ id: "a", texto: "A Lua", correta: true }, { id: "b", texto: "O Sol" }, { id: "c", texto: "Outra resposta" }, { id: "d", texto: "Nenhuma das anteriores" }], feedbackAcerto: "Certo!", feedbackErro: "É a LUA." },
      { id: "q3", pergunta: "A gente dorme:", fotoUrl: dormindoImg, opcoes: [{ id: "a", texto: "À noite", correta: true }, { id: "b", texto: "De manhã" }, { id: "c", texto: "Outra resposta" }, { id: "d", texto: "Nenhuma das anteriores" }], feedbackAcerto: "PERFEITO!", feedbackErro: "Dorme à NOITE." },
    ],
