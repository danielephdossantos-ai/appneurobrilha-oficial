...
export const aula01: AulaGeoV1 = {
  ...
  cena04_leituraGuiada: {
    ...
    pontos: [
      ...
      { id: "mes", x: 40, y: 70, emoji: "🗓️", cor: "from-purple-400 to-fuchsia-700", titulo: "Mês", texto: "Pode ter 28, 29, 30 ou 31 dias. Há 12 meses no ano.", fotoUrl: mesImg },
  ...
  cena07_sequencia: {
    ...
    paradas: [
      ...
      { id: "mes", emoji: "🗓️", rotulo: "4. Mês", descricao: "28, 29, 30 ou 31 dias.", fotoUrl: mesImg },
  ...
  cena08_voceLe: {
    ...
    paragrafos: [
      { id: "p1", texto: "O RELÓGIO mede HORAS e MINUTOS. Cada dia completo tem 24 HORAS. A duração da parte clara e da noite varia conforme o lugar e a época do ano.", chaves: ["relógio", "horas"], definicoes: { relógio: "Instrumento que mede o tempo em horas e minutos.", horas: "Unidades de tempo. Um dia completo tem 24 horas." }, fotoUrl: relogioImg },
  ...
  cena11_avaliacao: {
    ...
    fotoUrl: brilhaImg,
    perguntas: [
      { id: "q1", pergunta: "Quantas horas num dia?", fotoUrl: relogioImg, opcoes: [{ id: "a", texto: "24", correta: true }, { id: "b", texto: "12" }, { id: "c", texto: "Outra resposta" }, { id: "d", texto: "Nenhuma das anteriores" }], feedbackAcerto: "Isso!", feedbackErro: "24 horas." },
      { id: "q2", pergunta: "Dias na semana:", fotoUrl: semanaImg, opcoes: [{ id: "a", texto: "7", correta: true }, { id: "b", texto: "5" }, { id: "c", texto: "Outra resposta" }, { id: "d", texto: "Nenhuma das anteriores" }], feedbackAcerto: "Certo!", feedbackErro: "7 dias." },
      { id: "q3", pergunta: "Meses num ano:", fotoUrl: aniversarioImg, opcoes: [{ id: "a", texto: "12", correta: true }, { id: "b", texto: "7" }, { id: "c", texto: "Outra resposta" }, { id: "d", texto: "Nenhuma das anteriores" }], feedbackAcerto: "PERFEITO!", feedbackErro: "12 meses." },
    ],
