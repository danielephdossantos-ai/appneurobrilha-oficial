...
export const aula01: AulaGeoV1 = {
  ...
  cena02_previsao: {
    ...
    opcoes: [
      ...
      { id: "papel", titulo: "Papel", subtitulo: "fino e dobrável", emoji: "📄", cor: "from-blue-300 to-cyan-600" },
    ],
    respostaCerta: "metal",
  ...
  cena05_compreensao: {
    ...
    perguntas: [
      { id: "q1", pergunta: "Um copo transparente pode ser feito de:", fotoUrl: vidroImg, cards: [{ id: "a", emoji: "🥃", titulo: "Vidro", cor: "from-cyan-300 to-sky-500" }, { id: "b", emoji: "🪵", titulo: "Madeira", cor: "from-amber-700 to-yellow-900" }, { id: "c", emoji: "🧵", titulo: "Tecido", cor: "from-pink-400 to-rose-600" }, { id: "d", emoji: "📄", titulo: "Papel", cor: "from-blue-300 to-cyan-600" }], correta: "a", feedbackAcerto: "VIDRO — transparente e rígido!", feedbackErro: "Observe: o copo da imagem é transparente e feito de VIDRO." },
      { id: "q2", pergunta: "Uma roupa pode ser feita de:", fotoUrl: tecidoImg, cards: [{ id: "a", emoji: "🧵", titulo: "Tecido", cor: "from-pink-400 to-rose-600" }, { id: "b", emoji: "🔩", titulo: "Metal", cor: "from-slate-400 to-slate-700" }, { id: "c", emoji: "🥃", titulo: "Vidro", cor: "from-cyan-300 to-sky-500" }, { id: "d", emoji: "🪵", titulo: "Madeira", cor: "from-amber-700 to-yellow-900" }], correta: "a", feedbackAcerto: "Isso! Roupa é feita de TECIDO.", feedbackErro: "A roupa da imagem é flexível e feita de TECIDO." },
      { id: "q3", pergunta: "A garrafa mostrada é feita de:", fotoUrl: plasticoImg, cards: [{ id: "a", emoji: "🧴", titulo: "Plástico", cor: "from-emerald-400 to-green-600" }, { id: "b", emoji: "🪵", titulo: "Madeira", cor: "from-amber-700 to-yellow-900" }, { id: "c", emoji: "🧵", titulo: "Tecido", cor: "from-pink-400 to-rose-600" }, { id: "d", emoji: "📄", titulo: "Papel", cor: "from-blue-300 to-cyan-600" }], correta: "a", feedbackAcerto: "PLÁSTICO — leve e resistente a quedas!", feedbackErro: "Observe a garrafa da imagem: ela é de PLÁSTICO." },
    ],
  ...
  cena11_avaliacao: {
    ...
    fotoUrl: brilhaImg,
    perguntas: [
      { id: "q1", pergunta: "O copo transparente mostrado é feito de:", fotoUrl: vidroImg, opcoes: [{ id: "a", texto: "Vidro", correta: true }, { id: "b", texto: "Tecido" }, { id: "c", texto: "Madeira" }, { id: "d", texto: "Papel" }], feedbackAcerto: "Isso!", feedbackErro: "Observe a transparência: é VIDRO." },
      { id: "q2", pergunta: "A panela mostrada é feita de:", fotoUrl: metalImg, opcoes: [{ id: "a", texto: "Metal", correta: true }, { id: "b", texto: "Madeira" }, { id: "c", texto: "Tecido" }, { id: "d", texto: "Papel" }], feedbackAcerto: "Certo!", feedbackErro: "A panela da imagem é de METAL e resiste ao calor do uso culinário." },
      { id: "q3", pergunta: "A roupa mostrada é feita de:", fotoUrl: tecidoImg, opcoes: [{ id: "a", texto: "Tecido", correta: true }, { id: "b", texto: "Vidro" }, { id: "c", texto: "Metal" }, { id: "d", texto: "Madeira" }], feedbackAcerto: "PERFEITO!", feedbackErro: "É TECIDO." },
    ],
