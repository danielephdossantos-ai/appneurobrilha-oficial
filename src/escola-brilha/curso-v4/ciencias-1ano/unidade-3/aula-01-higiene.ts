...
export const aula01: AulaGeoV1 = {
  ...
  cena03_vocabulario: {
    ...
    cadernos: [
      ...
      { id: "dentes", capa: "ESCOVAR OS DENTES", emoji: "🦷", cor: "from-purple-400 to-fuchsia-600", conteudo: "Escovar com creme dental com flúor remove restos de comida e ajuda a evitar cárie.", exemplo: "Ex.: após as refeições, principalmente antes de dormir.", fotoUrl: dentesImg },
  ...
  cena04_leituraGuiada: {
    ...
    pontos: [
      ...
      { id: "dentes", x: 40, y: 30, emoji: "🦷", cor: "from-purple-400 to-fuchsia-600", titulo: "Escovar os dentes", texto: "Escovar com creme dental com flúor depois das refeições, principalmente antes de dormir, ajuda a evitar cárie.", fotoUrl: dentesImg },
      { id: "banho", x: 60, y: 30, emoji: "🚿", cor: "from-sky-400 to-blue-600", titulo: "Banho", texto: "Ajuda a retirar suor e sujeira. A rotina pode variar conforme o clima, as atividades e a orientação da família.", fotoUrl: banhoImg },
  ...
  cena05_compreensao: {
    ...
    perguntas: [
      { id: "q1", pergunta: "Qual cuidado é importante antes de dormir?", fotoUrl: dentesImg, cards: [{ id: "a", emoji: "🦷", titulo: "Escovar os dentes", cor: "from-purple-400 to-fuchsia-600" }, { id: "b", emoji: "🍬", titulo: "Comer doce", cor: "from-pink-400 to-rose-700" }, { id: "c", emoji: "🥤", titulo: "Tomar refrigerante", cor: "from-red-400 to-rose-700" }, { id: "d", emoji: "❓", titulo: "Não cuidar", cor: "from-slate-400 to-slate-700" }], correta: "a", feedbackAcerto: "Escovar antes de dormir ajuda a proteger os dentes!", feedbackErro: "Antes de dormir, escove os dentes com creme dental com flúor." },
      { id: "q2", pergunta: "Antes de comer, sempre:", fotoUrl: maosImg, cards: [{ id: "a", emoji: "🧼", titulo: "Lavar as mãos", cor: "from-cyan-400 to-sky-600" }, { id: "b", emoji: "🍔", titulo: "Comer direto", cor: "from-red-400 to-rose-700" }, { id: "c", emoji: "💤", titulo: "Dormir", cor: "from-indigo-400 to-purple-700" }, { id: "d", emoji: "❓", titulo: "Outra resposta", cor: "from-blue-400 to-indigo-700" }], correta: "a", feedbackAcerto: "Isso! LAVAR AS MÃOS.", feedbackErro: "Comer com mão suja leva germes pra dentro." },
      { id: "q3", pergunta: "Quando o corpo está suado e sujo, qual cuidado ajuda?", fotoUrl: banhoImg, cards: [{ id: "a", emoji: "🚿", titulo: "Tomar banho", cor: "from-sky-400 to-blue-600" }, { id: "b", emoji: "👕", titulo: "Só trocar a camisa", cor: "from-amber-400 to-orange-700" }, { id: "c", emoji: "💤", titulo: "Dormir", cor: "from-purple-400 to-fuchsia-600" }, { id: "d", emoji: "❓", titulo: "Não fazer nada", cor: "from-slate-400 to-slate-700" }], correta: "a", feedbackAcerto: "O banho ajuda a retirar suor e sujeira!", feedbackErro: "Água e sabonete ajudam a limpar o corpo." },
    ],
  ...
  cena08_voceLe: {
    ...
    paragrafos: [
      ...
      { id: "p2", texto: "ESCOVAR OS DENTES com creme dental com flúor, principalmente antes de dormir, ajuda a evitar CÁRIE. O BANHO ajuda a retirar suor e sujeira; a rotina depende do clima e das atividades.", chaves: ["cárie", "suor"], definicoes: { cárie: "Lesão no dente relacionada à ação de microrganismos e açúcares.", suor: "Líquido que ajuda o corpo a controlar a temperatura." }, fotoUrl: dentesImg },
    ],
  ...
  cena11_avaliacao: {
    ...
    fotoUrl: brilhaImg,
    perguntas: [
      { id: "q1", pergunta: "Antes de comer:", fotoUrl: maosImg, opcoes: [{ id: "a", texto: "Lavar as mãos", correta: true }, { id: "b", texto: "Nada" }, { id: "c", texto: "Outra resposta" }, { id: "d", texto: "Nenhuma das anteriores" }], feedbackAcerto: "Isso!", feedbackErro: "SEMPRE lavar as mãos." },
      { id: "q2", pergunta: "O banho ajuda a:", fotoUrl: banhoImg, opcoes: [{ id: "a", texto: "Retirar suor e sujeira", correta: true }, { id: "b", texto: "Sujar as mãos" }, { id: "c", texto: "Criar cárie" }, { id: "d", texto: "Manchar os dentes" }], feedbackAcerto: "Certo!", feedbackErro: "O banho ajuda na limpeza do corpo." },
      { id: "q3", pergunta: "Antes de dormir é importante:", fotoUrl: dentesImg, opcoes: [{ id: "a", texto: "Escovar os dentes", correta: true }, { id: "b", texto: "Comer doce" }, { id: "c", texto: "Não cuidar" }, { id: "d", texto: "Só beber refrigerante" }], feedbackAcerto: "PERFEITO!", feedbackErro: "Escovar antes de dormir ajuda a proteger os dentes." },
    ],
