...
export const aula01: AulaGeoV1 = {
  ...
  cena04_leituraGuiada: {
    ...
    mapaUrl: imgIpi,
    pontos: [
      { id: "rio", x: 65, y: 55, emoji: "🏛️", cor: "from-teal-700 to-slate-900", fotoUrl: imgIpi, titulo: "RIO DE JANEIRO (capital)", texto: "Sede do Império desde 1808 (vinda da Corte). Palácio imperial em São Cristóvão. Centro político e financeiro." },
      { id: "vp", x: 55, y: 45, emoji: "☕", cor: "from-amber-700 to-slate-900", fotoUrl: imgCafe, titulo: "VALE DO PARAÍBA (café)", texto: "Fazendas de café em SP e RJ. Sustentavam a economia do Império com mão de obra escravizada. 'Barões do café' viraram elite política." },
      ...
      { id: "rs", x: 40, y: 90, emoji: "🏇", cor: "from-slate-700 to-slate-900", fotoUrl: imgIpi, titulo: "FARROUPILHA (RS, 1835-45)", texto: "Fazendeiros gaúchos declararam a República Rio-Grandense. Guerra de 10 anos. Terminou com anistia geral." },
    ],
  ...
  cena07_sequencia: {
    ...
    paradas: [
      { id: "ind", emoji: "🇧🇷", rotulo: "1. Independência (1822)", fotoUrl: imgIpi, descricao: "D. Pedro I às margens do Ipiranga." },
      { id: "cst", emoji: "📜", rotulo: "2. Constituição outorgada (1824)", fotoUrl: imgIpi, descricao: "Poder Moderador e voto censitário." },
      { id: "reg", emoji: "⚔️", rotulo: "3. Regência e revoltas (1831-1840)", fotoUrl: imgIpi, descricao: "Pedro I abdica; explosão de revoltas regionais." },
      { id: "aur", emoji: "🕊️", rotulo: "4. Lei Áurea (1888)", fotoUrl: imgCafe, descricao: "Abolição da escravidão — última das Américas." },
    ],
  ...
  cena11_avaliacao: {
    ...
    selo: { nome: "A Coroa Tropical", subtitulo: "Engrenagem 6 das Liberdades", emoji: "🇧🇷", cor: "from-teal-500 to-slate-900", fotoUrl: imgIpi },
