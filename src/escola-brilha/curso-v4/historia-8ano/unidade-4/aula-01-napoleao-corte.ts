...
export const aula01: AulaGeoV1 = {
  ...
  cena04_leituraGuiada: {
    ...
    mapaUrl: imgCoroacao,
    pontos: [
      { id: "lis", x: 20, y: 30, emoji: "⛵", cor: "from-teal-700 to-slate-900", fotoUrl: imgCorte, titulo: "LISBOA (nov/1807)", texto: "Tropas napoleônicas se aproximam. A família real embarca em 15 navios com 15 mil pessoas, escoltada pela Marinha Real Britânica." },
      { id: "atl", x: 50, y: 55, emoji: "🌊", cor: "from-amber-700 to-slate-900", fotoUrl: imgPortos, titulo: "TRAVESSIA DO ATLÂNTICO", texto: "Cerca de 60 dias de viagem. Passagem breve por Salvador (janeiro 1808) — onde D. João decreta a Abertura dos Portos." },
      { id: "rio", x: 80, y: 65, emoji: "🏰", cor: "from-cyan-700 to-slate-900", fotoUrl: imgNap, titulo: "RIO DE JANEIRO (março/1808)", texto: "Nova capital do IMPÉRIO PORTUGUÊS. D. João funda Banco do Brasil, Imprensa Régia, Jardim Botânico, Escolas de Medicina e a Real Academia Militar." },
      { id: "nap", x: 30, y: 15, emoji: "🎩", cor: "from-slate-700 to-slate-900", fotoUrl: imgFam, titulo: "NAPOLEÃO NA EUROPA", texto: "Segue conquistando até 1812 (invasão desastrosa da Rússia). Cai em 1815 em WATERLOO, contra ingleses e prussianos. Exilado na ilha de Santa Helena." },
    ],
  ...
  cena07_sequencia: {
    ...
    paradas: [
      { id: "cor", emoji: "👑", rotulo: "1. Napoleão coroado imperador (1804)", fotoUrl: imgFam, descricao: "Se autocoroa em Notre-Dame." },
      { id: "blo", emoji: "🚫", rotulo: "2. Bloqueio Continental (1806)", fotoUrl: imgCoroacao, descricao: "Portugal se recusa a aderir." },
      { id: "fug", emoji: "⛵", rotulo: "3. Fuga da Corte (nov/1807)", fotoUrl: imgCorte, descricao: "Tropas francesas entram em Lisboa." },
      { id: "por", emoji: "⚓", rotulo: "4. Abertura dos Portos (jan/1808)", fotoUrl: imgPortos, descricao: "D. João decreta em Salvador." },
    ],
