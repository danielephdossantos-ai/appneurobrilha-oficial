...
export const aula01: AulaGeoV1 = {
  ...
  cena04_leituraGuiada: {
    ...
    mapaUrl: imgMapaAfr,
    pontos: [
      { id: "br", x: 25, y: 30, emoji: "🇬🇧", cor: "from-teal-700 to-slate-900", fotoUrl: imgFerrovia, titulo: "IMPÉRIO BRITÂNICO", texto: "Do Cairo à Cidade do Cabo: Egito, Sudão, Quênia, Rodésia, África do Sul. Sonho de eixo norte-sul. Colônias na Índia, Austrália, Canadá, Nigéria." },
      { id: "fr", x: 55, y: 30, emoji: "🇫🇷", cor: "from-amber-700 to-slate-900", fotoUrl: imgMissio, titulo: "IMPÉRIO FRANCÊS", texto: "Grande parte do Oeste e Norte da África: Argélia, Marrocos, Tunísia, Senegal, Costa do Marfim, Madagáscar. Também Indochina (Vietnã)." },
      { id: "bp", x: 80, y: 55, emoji: "🇧🇪", cor: "from-cyan-700 to-slate-900", fotoUrl: imgBerlim, titulo: "CONGO BELGA (Leopoldo II)", texto: "Propriedade PESSOAL do rei belga por 20 anos. Extração brutal de borracha com trabalho forçado. Estima-se que 10 milhões de congoleses morreram." },
  ...
  cena07_sequencia: {
    ...
    paradas: [
      ...
      { id: "ber", emoji: "🏛️", rotulo: "2. Conferência de Berlim (1884)", fotoUrl: imgMapaAfr, descricao: "Potências dividem a África com régua e mapa." },
      { id: "adw", emoji: "⚔️", rotulo: "3. Batalha de Adwa (1896)", fotoUrl: imgFerrovia, descricao: "Etiópia derrota a Itália. Resistência africana." },
      { id: "gm1", emoji: "💥", rotulo: "4. I Guerra Mundial (1914)", fotoUrl: imgMissio, descricao: "Rivalidades imperialistas explodem na Europa." },
    ],
  ...
  cena11_avaliacao: {
    ...
    selo: { nome: "O Cetro Global", subtitulo: "Engrenagem 7 das Liberdades", emoji: "🗺️", cor: "from-teal-500 to-slate-900", fotoUrl: imgAfrica },
