...
export const aula01: AulaGeoV1 = {
  ...
  cena04_leituraGuiada: {
    ...
    mapaUrl: imgBandeira,
    pontos: [
      { id: "cle", x: 20, y: 25, emoji: "⛪", cor: "from-teal-700 to-slate-900", fotoUrl: imgEstados, titulo: "1º ESTADO — CLERO (~0,5%)", texto: "Alto clero (bispos, cardeais) tinha luxo. Baixo clero (padres pobres) muitas vezes se aliou ao 3º Estado. Isento de impostos, recebia dízimo." },
      { id: "nob", x: 50, y: 25, emoji: "🗡️", cor: "from-amber-700 to-slate-900", fotoUrl: imgDeclara, titulo: "2º ESTADO — NOBREZA (~1,5%)", texto: "Donos das terras, altos cargos, viviam em Versalhes. Isentos da maioria dos impostos. Alguns nobres liberais apoiaram a revolução (Lafayette)." },
      { id: "ter", x: 80, y: 25, emoji: "🛠️", cor: "from-cyan-700 to-slate-900", fotoUrl: imgBast, titulo: "3º ESTADO — POVO (~97%)", texto: "Burguesia (comerciantes, profissionais liberais), camponeses (80% da população) e trabalhadores urbanos (sans-culottes). Pagavam TODOS os impostos e não tinham voto." },
      { id: "bast", x: 50, y: 75, emoji: "🏰", cor: "from-slate-700 to-slate-900", fotoUrl: imgGuil, titulo: "QUEDA DA BASTILHA (14/07/1789)", texto: "A prisão símbolo do absolutismo cai. Data se tornou feriado nacional francês. Marca oficial do início da Revolução." },
    ],
  ...
  cena07_sequencia: {
    ...
    paradas: [
      { id: "est", emoji: "📜", rotulo: "1. Estados Gerais (maio/1789)", fotoUrl: imgGuil, descricao: "3º Estado se declara Assembleia Nacional." },
      { id: "bast", emoji: "🏰", rotulo: "2. Queda da Bastilha (jul/1789)", fotoUrl: imgBandeira, descricao: "Povo toma a prisão símbolo da tirania." },
      { id: "cst", emoji: "📖", rotulo: "3. Constituinte (1789-1791)", fotoUrl: imgEstados, descricao: "Declaração dos Direitos; monarquia constitucional." },
      { id: "ter", emoji: "🗡️", rotulo: "4. República e Terror (1792-1794)", fotoUrl: imgDeclara, descricao: "Luís XVI executado; Robespierre lidera." },
    ],
  ...
  cena11_avaliacao: {
    ...
    selo: { nome: "O Estandarte Tricolor", subtitulo: "Engrenagem 3 das Liberdades", emoji: "🇫🇷", cor: "from-teal-500 to-slate-900", fotoUrl: imgGuil },
