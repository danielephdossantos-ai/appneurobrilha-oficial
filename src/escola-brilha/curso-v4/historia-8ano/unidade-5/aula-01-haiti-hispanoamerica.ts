...
export const aula01: AulaGeoV1 = {
  ...
  cena04_leituraGuiada: {
    ...
    mapaUrl: imgBoli,
    pontos: [
      { id: "hai", x: 30, y: 25, emoji: "🇭🇹", cor: "from-teal-700 to-slate-900", fotoUrl: imgHaiti, titulo: "HAITI (1804)", texto: "Primeira. Liderada por Toussaint L'Ouverture e Jean-Jacques Dessalines. Aboliu a escravidão. Primeira república negra do mundo." },
      { id: "arg", x: 25, y: 75, emoji: "🇦🇷", cor: "from-amber-700 to-slate-900", fotoUrl: imgBoli, titulo: "ARGENTINA (1816)", texto: "Congresso de Tucumán proclama a independência. San Martín será o principal general do sul do continente." },
      { id: "grc", x: 55, y: 40, emoji: "🇻🇪", cor: "from-cyan-700 to-slate-900", fotoUrl: imgBoli, titulo: "GRÃ-COLÔMBIA (1819)", texto: "Bolívar reúne Venezuela, Colômbia e Equador em UMA nação. Sonho panamericano — fragmentado em 1830 após sua morte." },
  ...
  cena07_sequencia: {
    ...
    paradas: [
      ...
      { id: "hai", emoji: "🇭🇹", rotulo: "2. Haiti (1804)", fotoUrl: imgHaiti, descricao: "Primeira república negra do mundo." },
      { id: "arg", emoji: "🇦🇷", rotulo: "3. Argentina (1816)", fotoUrl: imgBoli, descricao: "Congresso de Tucumán." },
      { id: "ay", emoji: "⚔️", rotulo: "4. Ayacucho (1824)", fotoUrl: imgBoli, descricao: "Batalha final da independência sul-americana." },
    ],
