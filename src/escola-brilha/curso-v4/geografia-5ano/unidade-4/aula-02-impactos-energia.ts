    ...
    fatias: [
      {
        ...
        percentual: 60,
        cor: "#0ea5e9",
        descricao: "A maior parte da luz do Brasil vem de barragens de água.",
        exemplos: ["🏞️ Itaipu", "🌊 Belo Monte"],
      },
      {
        id: "vento",
        rotulo: "Eólica (12%)",
        ...
        percentual: 12,
        cor: "#22d3ee",
        descricao: "Vento do Nordeste virou fonte importante.",
        exemplos: ["🌬️ RN", "💨 BA"],
      },
      {
        id: "sol",
        ...
        percentual: 10,
        cor: "#eab308",
        descricao: "Painéis crescem rápido em casas, escolas e fazendas.",
        exemplos: ["🏠 Telhados", "🌞 Fazendas solares"],
      },
      {
        id: "term",
        rotulo: "Termelétrica (18%)",
        emoji: "🏭",
        percentual: 18,
        cor: "#64748b",
        descricao: "Fóssil (gás e carvão) — usado só quando falta chuva.",
        exemplos: ["🔥 Gás", "⚫ Carvão"],
      },
    ],
