    ...
    fatias: [
      {
        ...
        percentual: 25,
        cor: "#ef4444",
        descricao: "Diz do que o mapa fala.",
        exemplos: ["📖 Nome do mapa"],
      },
      {
        id: "escala",
        rotulo: "Escala (25%)",
      ...
      },
      {
        ...
        percentual: 25,
        cor: "#f59e0b",
        descricao: "Traduz cores e símbolos.",
        exemplos: ["🎨 Cores explicadas"],
      },
      {
        id: "rosa",
        rotulo: "Rosa dos ventos (25%)",
        emoji: "🧭",
        percentual: 25,
        cor: "#0ea5e9",
        descricao: "Orienta o Norte.",
        exemplos: ["⬆️ N"],
      },
    ],
