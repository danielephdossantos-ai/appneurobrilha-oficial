    ...
    fatias: [
      {
        ...
        percentual: 55,
        cor: "#ef4444",
        descricao: "SP e RJ continuam sendo o maior destino — emprego, indústria e serviços.",
        exemplos: ["🏭 Indústria", "🏢 Escritórios", "🏥 Hospitais"],
      },
      {
        id: "outros",
        rotulo: "Outras regiões (45%)",
        emoji: "🗺️",
        percentual: 45,
        cor: "#10b981",
        descricao: "Centro-Oeste (agro), Norte (mineração) e o RETORNO ao Nordeste.",
        exemplos: ["🌾 Soja no MT", "⛏️ Minério no PA", "🔄 Volta pra Fortaleza"],
      },
    ],
