    ...
    cenas: [
      {
        ...
        linhas: [
          { rotulo: "U1", valores: ["U1", "Naturais, reta, sistema decimal"] },
          { rotulo: "U2", valores: ["U2", "+ − × ÷, expressões e potência"] },
          { rotulo: "U3", valores: ["U3", "Primos, MMC, MDC"] },
          { rotulo: "U4", valores: ["U4", "Frações"] },
          { rotulo: "U5", valores: ["U5", "Decimais, %"] },
          { rotulo: "U6", valores: ["U6", "Igualdade, valor desconhecido e partilhas"] },
