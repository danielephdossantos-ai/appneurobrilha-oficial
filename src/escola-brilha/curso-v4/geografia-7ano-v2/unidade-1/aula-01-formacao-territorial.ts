...
export const aula01: AulaGeoV1 = {
  ...
  cena10_revisao: {
    ...
    fatias: [
      ...
      {
        id: "expansao",
        rotulo: "Ganho pela expansão (1500–1750)",
        emoji: "⚔️",
        percentual: 55,
        cor: "#059669",
        descricao: "Bandeirantes, missões, ciclo do ouro. 5 milhões de km² incorporados via ocupação real (uti possidetis).",
        exemplos: ["⛰️ Minas Gerais", "🌾 Centro-Oeste", "🌳 Sul", "🌊 Parte da Amazônia"],
      },
      {
        id: "acordos",
        rotulo: "Ajustes finais (1750–1909)",
        emoji: "🖋️",
        percentual: 15,
        cor: "#0ea5e9",
        descricao: "Tratados de Madri, Santo Ildefonso e Petrópolis. Fecham fronteiras com Argentina, Uruguai, Bolívia e Peru.",
        exemplos: ["🌿 Acre (1903)", "🏞️ Palmas (1895)", "🌋 Fronteiras amazônicas"],
      },
    ],
