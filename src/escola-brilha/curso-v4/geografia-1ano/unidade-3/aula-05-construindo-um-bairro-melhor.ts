  ...
  momento10_minijogo: {
    ...
    jogo: {
      ...
      bloco: {
        ...
        alvos: [
          { id: "moradia", texto: "🏠 Moradias", imagemUrl: casa },
          { id: "servico", texto: "🏫 Serviços", imagemUrl: escola },
          { id: "publico", texto: "🌳 Espaços públicos", imagemUrl: praca },
          { id: "transporte", texto: "🚌 Transporte", imagemUrl: pontoOnibus },
          { id: "cuidado", texto: "♻️ Cuidado", imagemUrl: lixeiraRec },
        ],
