  ...
  momento10_minijogo: {
    ...
    jogo: {
      ...
      bloco: {
        ...
        alvos: [
          { id: "escola", texto: "Escola 🏫", imagemUrl: escola },
          { id: "saude", texto: "Posto de saúde 🏥", imagemUrl: postoSaude },
          { id: "padaria", texto: "Padaria 🍞", imagemUrl: padaria },
          { id: "biblio", texto: "Biblioteca 📚", imagemUrl: biblioteca },
        ],
