...
export const aula08_missaoFinal: AulaV4 = {
  ...
  iconeTrilha: "🎖️",
  bncc: ["EF05MA02", "EF05MA03", "EF05MA04", "EF05MA05", "EF05MA06", "EF05MA07", "EF05MA08"],
  duracaoMin: 22,
  metodologias: ["skemp"],
  ...
  momento08_aplicacao: {
    contexto: "Compra: R$ 84,25 + R$ 15,75, com desconto de 10% sobre o total.",
    problema: "Total a pagar?",
    interacao: {
      tipo: "escolhaVisual",
      pergunta: "Escolha:",
      opcoes: [{ nome: "R$ 90,00" }, { nome: "R$ 100,00" }, { nome: "R$ 10,00" }],
      respostaCerta: "R$ 90,00",
      feedbackAcerto: "🎯 O total é R$ 100,00; 10% são R$ 10,00; preço final R$ 90,00.",
      feedbackErro: "84,25 + 15,75 = 100,00. Desconto de 10% = 10,00. Restam R$ 90,00.",
    },
  },
