...
function SomaFracoes({ v }: { v: SomaFracoesV }) {
  ...
  }: { num: ReactNode; den: ReactNode; numColor?: string; denColor?: string }) => (
...
function TrinomioPassoAPasso({ v }: { v: TrinomioPassoAPassoV }) {
  ...
  return (
    <div className="my-4 w-full max-w-4xl mx-auto px-2 md:px-4">
      ...
      <div className="rounded-[40px] border-[6px] md:border-[12px] border-[#8b5e3c] bg-[#fff9f0] p-4 md:p-10 shadow-[inset_0_2px_15px_rgba(0,0,0,0.1),0_15px_40px_rgba(0,0,0,0.1)] relative overflow-hidden min-h-[300px]">
