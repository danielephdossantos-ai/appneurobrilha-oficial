...
import __asset_vocabTessela from "@/assets/arte-5ano/u5-vocab-tessela.jpg.asset.json";
const vocabTessela = __asset_vocabTessela.url;
...
import __asset_matRevista from "@/assets/arte-5ano/u5-mat-revista.jpg.asset.json";
const matRevista = __asset_matRevista.url;
import __asset_matVidro from "@/assets/arte-5ano/u5-mat-vidro.jpg.asset.json";
const matVidro = __asset_matVidro.url;
import __asset_matOuro from "@/assets/arte-5ano/u5-mat-ouro.jpg.asset.json";
const matOuro = __asset_matOuro.url;
import __asset_passo1 from "@/assets/arte-5ano/u5-passo1.jpg.asset.json";
const passo1 = __asset_passo1.url;
import __asset_passo2 from "@/assets/arte-5ano/u5-passo2.jpg.asset.json";
const passo2 = __asset_passo2.url;
import __asset_passo3 from "@/assets/arte-5ano/u5-passo3.jpg.asset.json";
