...
import __asset_motMonalisa from "@/assets/arte-5ano/u3-mot-monalisa.jpg.asset.json";
const motMonalisa = __asset_motMonalisa.url;
import __asset_motDavinci from "@/assets/arte-5ano/u3-mot-davinci.jpg.asset.json";
const motDavinci = __asset_motDavinci.url;
import __asset_motMontanhas from "@/assets/arte-5ano/u3-mot-montanhas.jpg.asset.json";
const motMontanhas = __asset_motMontanhas.url;
import __asset_motCeu from "@/assets/arte-5ano/u3-mot-ceu.jpg.asset.json";
const motCeu = __asset_motCeu.url;
import __asset_vocabSfumato from "@/assets/arte-5ano/u3-mot-monalisa.jpg.asset.json";
const vocabSfumato = __asset_vocabSfumato.url;
import __asset_vocabPerspectiva from "@/assets/arte-5ano/u3-vocab-perspectiva.jpg.asset.json";
const vocabPerspectiva = __asset_vocabPerspectiva.url;
import __asset_vocabContraste from "@/assets/arte-5ano/u3-vocab-contraste.jpg.asset.json";
const vocabContraste = __asset_vocabContraste.url;
import __asset_vocabEspalhamento from "@/assets/arte-5ano/u3-vocab-espalhamento.jpg.asset.json";
const vocabEspalhamento = __asset_vocabEspalhamento.url;
import __asset_matGuache from "@/assets/arte-5ano/u3-mat-guache-azul.jpg.asset.json";
const matGuache = __asset_matGuache.url;
import __asset_matPincel from "@/assets/arte-5ano/u3-mat-pincel-seco.jpg.asset.json";
const matPincel = __asset_matPincel.url;
import __asset_matReferencia from "@/assets/arte-5ano/u3-mat-referencia-fotos.jpg.asset.json";
const matReferencia = __asset_matReferencia.url;
import __asset_matPapel from "@/assets/arte-5ano/u3-mat-papel-canson.jpg.asset.json";
const matPapel = __asset_matPapel.url;
import __asset_qMonalisaDetalhe from "@/assets/arte-5ano/u3-q-monalisa-detalhe.jpg.asset.json";
const qMonalisaDetalhe = __asset_qMonalisaDetalhe.url;
import __asset_qMontanhas4 from "@/assets/arte-5ano/u3-q-montanhas4camadas.jpg.asset.json";
const qMontanhas4 = __asset_qMontanhas4.url;
import __asset_qCeu from "@/assets/arte-5ano/u3-mot-ceu.jpg.asset.json";
const qCeu = __asset_qCeu.url;
import __asset_passo1 from "@/assets/arte-5ano/u3-passo1.jpg.asset.json";
const passo1 = __asset_passo1.url;
import __asset_passo2 from "@/assets/arte-5ano/u3-passo2.jpg.asset.json";
const passo2 = __asset_passo2.url;
import __asset_passo3 from "@/assets/arte-5ano/u3-passo3.jpg.asset.json";
const passo3 = __asset_passo3.url;
import __asset_passo4 from "@/assets/arte-5ano/u3-passo4.jpg.asset.json";
