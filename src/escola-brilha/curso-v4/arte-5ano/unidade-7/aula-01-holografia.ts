...
import __asset_mapaGabor from "@/assets/arte-5ano/u7-mapa-gabor.jpg.asset.json";
const mapaGabor = __asset_mapaGabor.url;
import __asset_mapaMapping from "@/assets/arte-5ano/u7-mapa-mapping.jpg.asset.json";
const mapaMapping = __asset_mapaMapping.url;
import __asset_mapaInterativa from "@/assets/arte-5ano/u7-mapa-interativa.jpg.asset.json";
const mapaInterativa = __asset_mapaInterativa.url;
import __asset_mapaPiramide from "@/assets/arte-5ano/u7-mapa-piramide.jpg.asset.json";
const mapaPiramide = __asset_mapaPiramide.url;
import __asset_vocabHolografia from "@/assets/arte-5ano/u7-vocab-holografia.jpg.asset.json";
const vocabHolografia = __asset_vocabHolografia.url;
import __asset_vocabMapping from "@/assets/arte-5ano/u7-vocab-mapping.jpg.asset.json";
const vocabMapping = __asset_vocabMapping.url;
import __asset_vocabInterativa from "@/assets/arte-5ano/u7-vocab-interativa.jpg.asset.json";
const vocabInterativa = __asset_vocabInterativa.url;
import __asset_vocabFoton from "@/assets/arte-5ano/u7-vocab-foton.jpg.asset.json";
const vocabFoton = __asset_vocabFoton.url;
import __asset_matPlastico from "@/assets/arte-5ano/u7-mat-plastico.jpg.asset.json";
const matPlastico = __asset_matPlastico.url;
import __asset_matCelular from "@/assets/arte-5ano/u7-mat-celular.jpg.asset.json";
const matCelular = __asset_matCelular.url;
import __asset_matTesoura from "@/assets/arte-5ano/u7-mat-tesoura.jpg.asset.json";
const matTesoura = __asset_matTesoura.url;
import __asset_qPiramide from "@/assets/arte-5ano/u7-q-piramide.jpg.asset.json";
const qPiramide = __asset_qPiramide.url;
import __asset_passo1 from "@/assets/arte-5ano/u7-passo1.jpg.asset.json";
const passo1 = __asset_passo1.url;
import __asset_passo2 from "@/assets/arte-5ano/u7-passo2.jpg.asset.json";
const passo2 = __asset_passo2.url;
import __asset_passo3 from "@/assets/arte-5ano/u7-passo3.jpg.asset.json";
const passo3 = __asset_passo3.url;
import __asset_passo4 from "@/assets/arte-5ano/u7-passo4.jpg.asset.json";
const passo4 = __asset_passo4.url;
import __asset_passo5 from "@/assets/arte-5ano/u7-passo5.jpg.asset.json";
...
export const aula01: AulaArteV1 = {
  ...
  iconeTrilha: "🔮",
  bncc: ["EF15AR02", "EF15AR04", "EF15AR05", "EF15AR26"],
  duracaoMin: 30,
  ...
  cena01_motivacao: {
    ...
    itens: [
      {
        emoji: "🏆",
        rotulo: "Dennis Gabor (1947)",
        descricao:
          "Físico húngaro que inventou a holografia usando ondas de luz. Ganhou o Prêmio Nobel de Física em 1971 por essa descoberta.",
        cor: "#0f172a",
        fotoUrl: mapaGabor,
      },
      {
        ...
        descricao:
          "Projetores gigantes 'vestem' prédios e monumentos com vídeos que se encaixam perfeitamente nas formas 3D da superfície.",
        cor: "#a855f7",
        fotoUrl: mapaMapping,
      },
      {
        emoji: "🤖",
        rotulo: "Arte Interativa Digital",
        descricao:
          "Sensores detectam seu movimento e um código de computador transforma isso em cores, sons e formas na tela em tempo real.",
        cor: "#06b6d4",
        fotoUrl: mapaInterativa,
      },
      {
        emoji: "🔺",
        rotulo: "Pirâmide Holográfica",
        descricao:
          "Um pedaço de plástico transparente dobrado em pirâmide, sobre a tela do celular, faz imagens parecerem flutuar no ar.",
        cor: "#22d3ee",
        fotoUrl: mapaPiramide,
      },
    ],
    ...
    perguntas: [
      {
        ...
        feedbackErro:
          "Não é televisão! Gabor inventou a HOLOGRAFIA, usando o cruzamento de ondas de luz laser.",
      },
      {
        ...
        alternativas: [
          {
            texto: "Encaixam o vídeo exatamente nas formas 3D reais de um prédio ou objeto",
            correta: true,
          },
        ...
        feedbackAcerto:
          "Isso! O vídeo é programado pra 'vestir' cada janela, coluna e telhado do prédio.",
        feedbackErro:
          "Parede lisa é projeção comum. Video Mapping ENCAIXA o vídeo nas formas 3D reais da superfície.",
      },
      {
        ...
        alternativas: [
          {
            texto: "Um sensor que capta o movimento e um código que processa a informação",
            correta: true,
          },
        ...
        feedbackErro:
          "Não é mágica — é ENGENHARIA: sensor capta o movimento e o código transforma em imagem.",
      },
    ],
  },
    ...
    cards: [
      {
        termo: "Holografia",
        definicao:
          "Técnica que usa laser e interferência de ondas de luz pra registrar e reconstruir imagens em três dimensões.",
        emoji: "🔮",
        cor: "#0f172a",
      ...
      },
      {
        termo: "Video Mapping",
        definicao:
          "Projeção de vídeo calculada pra se encaixar perfeitamente nas formas 3D reais de uma superfície, como um prédio.",
        emoji: "🏙️",
        cor: "#a855f7",
        fotoUrl: vocabMapping,
      },
      {
        termo: "Arte Interativa Digital",
        definicao:
          "Instalação artística que usa sensores e código de computador pra reagir aos movimentos do público em tempo real.",
        emoji: "🤖",
        cor: "#06b6d4",
        fotoUrl: vocabInterativa,
      },
      {
        termo: "Fóton Coerente",
        definicao:
          "Partícula de luz laser que viaja em sincronia perfeita com as outras — essencial pra criar o padrão de interferência da holografia.",
        emoji: "✨",
        cor: "#22d3ee",
        fotoUrl: vocabFoton,
      },
  ...
  cena04_leituraGuiada: {
    ...
    pigmentos: [
      {
        nome: "Plástico transparente (trapézios)",
        hex: "#22d3ee",
        fonte: "Corpo da pirâmide holográfica",
        emoji: "🔺",
        fotoUrl: matPlastico,
      },
      {
        nome: "Celular com vídeo especial",
        hex: "#0f172a",
        fonte: "Fonte de luz da holografia caseira",
        emoji: "📱",
        fotoUrl: matCelular,
      },
      {
        nome: "Tesoura e régua",
        hex: "#a855f7",
        fonte: "Recortar os trapézios com precisão",
        emoji: "✂️",
        fotoUrl: matTesoura,
      },
    ],
    ...
    perguntas: [
      {
        ...
        alternativas: [
          {
            texto:
              "Porque guarda a luz vinda de vários ângulos, criando sensação de profundidade real",
            correta: true,
          },
        ...
        feedbackAcerto:
          "Isso! O padrão de interferência guarda informação de vários ângulos, não só um.",
      ...
      },
      {
        ...
        alternativas: [
          {
            texto: "O Video Mapping encaixa o vídeo nas formas 3D reais da superfície",
            correta: true,
          },
        ...
        feedbackAcerto:
          "Perfeito! O cálculo da forma real do objeto é o que faz a mágica funcionar.",
        feedbackErro:
          "Ao contrário! Video Mapping é feito pra superfícies COM RELEVO, não telas planas.",
      },
      {
        ...
        feedbackAcerto:
          "Isso! A tela reflete nos 4 lados de plástico e cria a ilusão de profundidade.",
        feedbackErro:
          "Lâmpada de teto não tem o vídeo certo. É a TELA DO CELULAR com o vídeo especial.",
      },
    ],
  },
  ...
  cena06_personagensLugar: {
    ...
    animais: [
      ...
      {
        nome: "Sensor + código reagindo a você",
        emoji: "🤖",
        fotoUrl: vocabInterativa,
  ...
  cena07_sequencia: {
    ...
    passos: [
      {
        id: "p1",
        texto: "DESENHO um trapézio: 6cm de base, 1cm no topo, 3,5cm de altura",
        emoji: "📐",
        ordem: 1,
        fotoUrl: passo1,
      },
      {
        id: "p2",
        texto: "RECORTO 4 trapézios iguais no plástico transparente",
        emoji: "✂️",
        ordem: 2,
        fotoUrl: passo2,
      },
      {
        id: "p3",
        texto: "COLO as bordas dos 4 trapézios formando uma pirâmide sem o topo",
        emoji: "🔺",
        ordem: 3,
        fotoUrl: passo3,
      },
      {
        id: "p4",
        texto: "COLOCO a pirâmide de cabeça pra baixo sobre a tela do celular",
        emoji: "📱",
        ordem: 4,
        fotoUrl: passo4,
      },
      {
        id: "p5",
        texto: "TOCO um vídeo especial de holograma e a imagem parece FLUTUAR no ar!",
        emoji: "✨",
        ordem: 5,
        fotoUrl: passo5,
      },
  ...
  cena08_voceLe: {
    ...
    trechos: [
      {
        texto: "Sou um arquiteto da luz. Uso a",
        palavraDestaque: "holografia",
        corDestaque: "#0f172a",
      },
      {
        texto: "pra fazer imagens flutuarem no ar, inventada por",
        palavraDestaque: "Dennis Gabor",
        corDestaque: "#a855f7",
      },
      {
        texto: "Quando projeto vídeo num prédio, chamo de",
        palavraDestaque: "video mapping",
        corDestaque: "#06b6d4",
      },
      {
        texto: "Se uso sensores e código, é",
        palavraDestaque: "arte interativa digital",
        corDestaque: "#22d3ee",
      },
    ...
    itens: [
      {
        emoji: "🏆",
        rotulo: "Dennis Gabor (1947)",
        descricao: "Inventou a holografia e ganhou o Nobel de Física em 1971.",
        cor: "#0f172a",
        fotoUrl: mapaGabor,
      },
      {
        emoji: "🔮",
        rotulo: "Holografia",
        descricao: "Laser + interferência de ondas de luz criam imagens em 3D reais.",
        cor: "#22d3ee",
        fotoUrl: vocabHolografia,
      },
      {
        emoji: "🏙️",
        rotulo: "Video Mapping",
        descricao: "Vídeo programado pra se encaixar nas formas 3D de um prédio.",
        cor: "#a855f7",
        fotoUrl: vocabMapping,
      },
      {
        emoji: "🤖",
        rotulo: "Arte Interativa Digital",
        descricao: "Sensores e código transformam movimento do público em arte.",
        cor: "#06b6d4",
        fotoUrl: vocabInterativa,
      },
      {
        emoji: "🔺",
        rotulo: "Pirâmide Holográfica Caseira",
        descricao: "4 trapézios de plástico sobre o celular fazem imagens flutuarem.",
        cor: "#22d3ee",
        fotoUrl: mapaPiramide,
      },
    ],
  ...
  cena11_avaliacao: {
    ...
    quiz: {
      pergunta:
        "Como se chama a técnica que projeta imagens tridimensionais no ar, usando luz laser e interferência de ondas?",
      alternativas: [
