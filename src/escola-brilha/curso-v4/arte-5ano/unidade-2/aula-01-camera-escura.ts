...
import __asset_mapaAlhazen from "@/assets/arte-5ano/u2-mapa-alhazen.jpg.asset.json";
const mapaAlhazen = __asset_mapaAlhazen.url;
import __asset_mapaVermeer from "@/assets/arte-5ano/u2-mapa-vermeer.jpg.asset.json";
const mapaVermeer = __asset_mapaVermeer.url;
import __asset_mapaPinhole from "@/assets/arte-5ano/u2-mapa-pinhole.jpg.asset.json";
const mapaPinhole = __asset_mapaPinhole.url;
import __asset_mapaEclipse from "@/assets/arte-5ano/u2-mapa-eclipse.jpg.asset.json";
const mapaEclipse = __asset_mapaEclipse.url;
import __asset_vocabRetilinea from "@/assets/arte-5ano/u2-vocab-retilinea.jpg.asset.json";
const vocabRetilinea = __asset_vocabRetilinea.url;
import __asset_vocabEstenopo from "@/assets/arte-5ano/u2-vocab-estenopo.jpg.asset.json";
const vocabEstenopo = __asset_vocabEstenopo.url;
import __asset_vocabInversao from "@/assets/arte-5ano/u2-vocab-inversao.jpg.asset.json";
const vocabInversao = __asset_vocabInversao.url;
import __asset_vocabFoco from "@/assets/arte-5ano/u2-vocab-foco.jpg.asset.json";
const vocabFoco = __asset_vocabFoco.url;
import __asset_matCaixa from "@/assets/arte-5ano/u2-mat-caixa.jpg.asset.json";
const matCaixa = __asset_matCaixa.url;
import __asset_matPapelVegetal from "@/assets/arte-5ano/u2-mat-papelvegetal.jpg.asset.json";
const matPapelVegetal = __asset_matPapelVegetal.url;
import __asset_matAgulha from "@/assets/arte-5ano/u2-mat-agulha.jpg.asset.json";
const matAgulha = __asset_matAgulha.url;
import __asset_matFita from "@/assets/arte-5ano/u2-mat-fita.jpg.asset.json";
const matFita = __asset_matFita.url;
import __asset_qInversao from "@/assets/arte-5ano/u2-q-inversao.jpg.asset.json";
const qInversao = __asset_qInversao.url;
import __asset_qVermeer from "@/assets/arte-5ano/u2-q-vermeer.jpg.asset.json";
const qVermeer = __asset_qVermeer.url;
import __asset_qFoco from "@/assets/arte-5ano/u2-q-foco.jpg.asset.json";
const qFoco = __asset_qFoco.url;
import __asset_passo1 from "@/assets/arte-5ano/u2-passo1.jpg.asset.json";
const passo1 = __asset_passo1.url;
import __asset_passo2 from "@/assets/arte-5ano/u2-passo2.jpg.asset.json";
const passo2 = __asset_passo2.url;
import __asset_passo3 from "@/assets/arte-5ano/u2-passo3.jpg.asset.json";
const passo3 = __asset_passo3.url;
import __asset_passo4 from "@/assets/arte-5ano/u2-passo4.jpg.asset.json";
const passo4 = __asset_passo4.url;
import __asset_passo5 from "@/assets/arte-5ano/u2-passo5.jpg.asset.json";
