...
import __asset_mapaEspiral from "@/assets/arte-5ano/u4-mapa-espiral.jpg.asset.json";
const mapaEspiral = __asset_mapaEspiral.url;
...
import __asset_vocabFadiga from "@/assets/arte-5ano/u4-vocab-fadiga.jpg.asset.json";
const vocabFadiga = __asset_vocabFadiga.url;
import __asset_vocabContraste from "@/assets/arte-5ano/u4-vocab-contraste.jpg.asset.json";
const vocabContraste = __asset_vocabContraste.url;
...
import __asset_matPapel from "@/assets/arte-5ano/u4-mat-papel.jpg.asset.json";
const matPapel = __asset_matPapel.url;
import __asset_matRegua from "@/assets/arte-5ano/u4-mat-regua.jpg.asset.json";
const matRegua = __asset_matRegua.url;
import __asset_matLapis from "@/assets/arte-5ano/u4-mat-lapis.jpg.asset.json";
...
import __asset_qEspiral from "@/assets/arte-5ano/u4-q-espiral.jpg.asset.json";
const qEspiral = __asset_qEspiral.url;
...
export const aula01: AulaArteV1 = {
  ...
  cena01_motivacao: {
    ...
    itens: [
      {
        emoji: "🌊",
        rotulo: "Bridget Riley e as ondas",
        descricao:
          "A artista britânica pintava linhas onduladas em preto e branco que fazem o olho enxergar movimento numa tela totalmente parada.",
        cor: "#000000",
        fotoUrl: mapaBridget,
      },
      {
        emoji: "🔲",
        rotulo: "Victor Vasarely e a grade",
        descricao:
          "O húngaro-francês distorcia grades quadriculadas até parecerem esferas 3D inchando pra fora do papel.",
        cor: "#dc2626",
        fotoUrl: mapaVasarely,
      },
      {
        emoji: "🌀",
        rotulo: "Espiral hipnótica",
        descricao:
          "Uma espiral em preto e vermelho parece girar sozinha — mas é só um desenho estático de linhas bem calculadas.",
        cor: "#f43f5e",
        fotoUrl: mapaEspiral,
      },
      {
        emoji: "🎯",
        rotulo: "Círculos concêntricos",
        descricao:
          "Anéis que se alternam em preto e branco fazem a retina vibrar e parecer que pulsam.",
        cor: "#000000",
    ...
    perguntas: [
      {
        ...
        alternativas: [
          {
            texto: "Porque o contraste preto/branco cansa a retina e cria fadiga visual",
            correta: true,
          },
        ...
        feedbackAcerto:
          "Isso! É a FADIGA RETINIANA — o olho cansa de tanto contraste e o cérebro interpreta como movimento.",
        feedbackErro:
          "O papel não se mexe 😄. É a sua RETINA que cansa com tanto contraste preto e branco.",
      },
      {
        ...
        feedbackAcerto:
          "Perfeito! A Op Art nasceu nos anos 1960, usando ciência da percepção pra criar ilusões.",
      ...
      },
      {
        ...
        alternativas: [
          {
            texto: "As linhas são curvadas e comprimidas em pontos calculados da grade",
            correta: true,
          },
        ...
        feedbackAcerto:
          "Correto! É COMPRESSÃO DE PADRÃO — linhas curvadas em pontos exatos enganam a percepção de profundidade.",
        feedbackErro:
          "A tinta é lisa, sem relevo. O truque é a curva calculada das linhas — compressão de padrão.",
      },
    ],
  },
  ...
  cena03_vocabulario: {
    ...
    cards: [
      {
        termo: "Fadiga Retiniana",
        definicao:
          "Cansaço temporário das células da retina depois de fixar cores ou contrastes fortes por muito tempo.",
        emoji: "👁️",
        cor: "#000000",
        fotoUrl: vocabFadiga,
      },
      {
        termo: "Contraste Simultâneo",
        definicao:
          "Quando duas cores ou tons colocados lado a lado mudam a forma como enxergamos cada um deles.",
        emoji: "⬛",
        cor: "#dc2626",
        fotoUrl: vocabContraste,
      },
      {
        termo: "Compressão de Padrão",
        definicao:
          "Técnica de aproximar ou curvar linhas repetidas pra criar sensação de profundidade ou inchaço.",
        emoji: "📏",
        cor: "#f43f5e",
        fotoUrl: vocabCompressao,
      },
      {
        termo: "Ilusão de Movimento",
        definicao:
          "Sensação de que uma imagem estática está se mexendo, causada por como o cérebro processa padrões repetidos.",
        emoji: "🎡",
        cor: "#000000",
        fotoUrl: vocabMovimento,
      },
    ],
  },
  ...
  cena04_leituraGuiada: {
    ...
    pigmentos: [
      {
        nome: "Papel branco + caneta preta",
        hex: "#000000",
        fonte: "Base de todo desenho de Op Art",
        emoji: "✏️",
        fotoUrl: matPapel,
      },
      {
        nome: "Régua e compasso",
        hex: "#facc15",
        fonte: "Traçam linhas e círculos precisos",
        emoji: "📐",
        fotoUrl: matRegua,
      },
      {
        nome: "Lápis preto e vermelho",
        hex: "#dc2626",
        fonte: "Cores de altíssimo contraste da Op Art",
        emoji: "🖍️",
        fotoUrl: matLapis,
      },
      {
        ...
        hex: "#64748b",
        fonte: "Ajuda a repetir o padrão certinho",
        emoji: "🧮",
    ...
    perguntas: [
      {
        ...
        alternativas: [
          {
            texto:
              "Criar ilusões ópticas de movimento e profundidade usando só padrões e contraste",
            correta: true,
          },
        ...
        feedbackAcerto:
          "Exato! A Op Art usa ciência da percepção pra mexer com o cérebro, sem representar nada 'real'.",
        feedbackErro:
          "Op Art não retrata paisagens — ela usa padrões matemáticos pra criar ILUSÕES no seu cérebro.",
      },
      {
        ...
        alternativas: [
          {
            texto: "A fadiga retiniana somada ao contraste simultâneo entre preto e branco",
            correta: true,
          },
        ...
        feedbackErro:
          "Não tem luz nenhuma escondida — é a fadiga retiniana e o contraste que enganam seus olhos.",
      },
      {
        pergunta:
          "A técnica de curvar e comprimir linhas repetidas para simular profundidade se chama…",
        fotoUrl: vocabCompressao,
        alternativas: [
        ...
        feedbackErro:
          "Perspectiva atmosférica é sobre névoa e distância. Aqui é COMPRESSÃO DE PADRÃO — linhas curvadas.",
      },
    ],
  },
  ...
  cena06_personagensLugar: {
    ...
    animais: [
      ...
      {
        nome: "Grade esférica de Vasarely",
        emoji: "🔲",
        fotoUrl: mapaVasarely,
  ...
  cena07_sequencia: {
    ...
    passos: [
      {
        id: "p1",
        texto: "CONTORNO minha mão aberta no meio de uma folha branca",
        emoji: "✋",
        ordem: 1,
        fotoUrl: passo1,
      },
      {
        id: "p2",
        texto: "DIVIDO todo o fundo da folha em faixas horizontais paralelas",
        emoji: "📏",
        ordem: 2,
        fotoUrl: passo2,
      },
      {
        id: "p3",
        texto: "DENTRO do contorno da mão, curvo essas mesmas linhas em arcos",
        emoji: "〰️",
        ordem: 3,
        fotoUrl: passo3,
      },
      {
        id: "p4",
        texto: "PINTO as faixas alternando preto e vermelho vibrante, sem pular nenhuma",
        emoji: "🖍️",
        ordem: 4,
        fotoUrl: passo4,
      },
      {
        id: "p5",
        texto: "OLHO de longe: a mão parece SALTAR da folha em 3D!",
        emoji: "🎯",
        ordem: 5,
        fotoUrl: passo5,
      },
  ...
  cena08_voceLe: {
    ...
    trechos: [
      {
        texto: "Sou um hacker da retina. Uso a",
        palavraDestaque: "fadiga retiniana",
        corDestaque: "#000000",
      },
      { texto: "e o", palavraDestaque: "contraste simultâneo", corDestaque: "#dc2626" },
      {
        texto: "pra criar ilusões que",
        palavraDestaque: "parecem se mexer",
        corDestaque: "#f43f5e",
      },
      {
        texto: "Aprendi com Bridget Riley e Victor Vasarely, mestres da",
        palavraDestaque: "Op Art",
        corDestaque: "#000000",
      },
  ...
  cena09_minijogo: {
    ...
    variante: "minijogo",
    aurora:
      "🎯 O Sincronizador Cinético! Toca em CADA componente do sistema óptico antes do tempo acabar.",
  ...
  cena10_revisao: {
    ...
    itens: [
      {
        emoji: "🌊",
        rotulo: "Bridget Riley",
        descricao: "Ondas pretas e brancas que criam movimento por fadiga retiniana.",
        cor: "#000000",
        fotoUrl: mapaBridget,
      },
      {
        emoji: "🔲",
        rotulo: "Victor Vasarely",
        descricao: "Grades comprimidas que parecem esferas 3D inchando do papel.",
        cor: "#dc2626",
        fotoUrl: mapaVasarely,
      },
      {
        emoji: "👁️",
        rotulo: "Fadiga Retiniana",
        descricao: "Cansaço da retina com contraste forte, interpretado como movimento.",
        cor: "#000000",
        fotoUrl: vocabFadiga,
      },
      {
        emoji: "⬛",
        rotulo: "Contraste Simultâneo",
        descricao: "Cores lado a lado mudam a percepção uma da outra.",
        cor: "#f43f5e",
        fotoUrl: vocabContraste,
      },
      {
        emoji: "📏",
        rotulo: "Compressão de Padrão",
        descricao: "Linhas curvadas e aproximadas simulam profundidade.",
        cor: "#64748b",
        fotoUrl: vocabCompressao,
      },
      {
        emoji: "🌀",
        rotulo: "Espirais e Círculos",
        descricao: "Padrões repetidos em preto e branco que parecem girar ou pulsar.",
        cor: "#000000",
        fotoUrl: mapaCirculos,
      },
    ],
  ...
  cena11_avaliacao: {
    ...
    quiz: {
      ...
      alternativas: [
        {
          texto:
            "Criar ilusões de movimento e profundidade em imagens estáticas usando contraste e padrões calculados",
          correta: true,
        },
      ...
      feedback:
        "Perfeito! A Op Art, criada por artistas como Bridget Riley e Victor Vasarely nos anos 1960, usa fadiga retiniana, contraste simultâneo e compressão de padrão pra fazer o cérebro enxergar movimento onde só existe tinta parada.",
    },
    missaoFamilia:
