...
const curso: CursoArteV1 = {
  ...
  descricao:
    "Um laboratório onde a arte encontra a física: lentes, prismas, chiaroscuro, perspectiva e cinema primitivo. Brilha e Aurora guiam a turma pelas descobertas ópticas dos grandes mestres.",
  corPrimaria: "#1e3a8a",
