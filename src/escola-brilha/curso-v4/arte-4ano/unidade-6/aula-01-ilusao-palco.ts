...
import __asset_mapaPalco from "@/assets/arte-4ano/u6-mapa-palco.jpg.asset.json";
const mapaPalco = __asset_mapaPalco.url;
import __asset_mapaOlimpico from "@/assets/arte-4ano/u6-mapa-olimpico.jpg.asset.json";
const mapaOlimpico = __asset_mapaOlimpico.url;
import __asset_mapaFundo from "@/assets/arte-4ano/u6-mapa-fundo.jpg.asset.json";
const mapaFundo = __asset_mapaFundo.url;
import __asset_mapaAdereco from "@/assets/arte-4ano/u6-mapa-adereco.jpg.asset.json";
const mapaAdereco = __asset_mapaAdereco.url;
import __asset_vocabPlanos from "@/assets/arte-4ano/u6-vocab-planos.jpg.asset.json";
const vocabPlanos = __asset_vocabPlanos.url;
import __asset_vocabCenografia from "@/assets/arte-4ano/u6-vocab-cenografia.jpg.asset.json";
const vocabCenografia = __asset_vocabCenografia.url;
import __asset_vocabAdereco from "@/assets/arte-4ano/u6-vocab-adereco.jpg.asset.json";
const vocabAdereco = __asset_vocabAdereco.url;
import __asset_matCaixa from "@/assets/arte-4ano/u6-mat-caixasapato.jpg.asset.json";
const matCaixa = __asset_matCaixa.url;
import __asset_matPapel from "@/assets/arte-4ano/u6-mat-papelcolorido.jpg.asset.json";
const matPapel = __asset_matPapel.url;
import __asset_matLanterna from "@/assets/arte-4ano/u6-mat-lanterna.jpg.asset.json";
const matLanterna = __asset_matLanterna.url;
import __asset_matPalito from "@/assets/arte-4ano/u6-mat-palito.jpg.asset.json";
const matPalito = __asset_matPalito.url;
import __asset_qMontanhas from "@/assets/arte-4ano/u6-q-montanhas.jpg.asset.json";
const qMontanhas = __asset_qMontanhas.url;
import __asset_qArvores from "@/assets/arte-4ano/u6-q-arvores.jpg.asset.json";
const qArvores = __asset_qArvores.url;
import __asset_passo1 from "@/assets/arte-4ano/u6-passo1.jpg.asset.json";
const passo1 = __asset_passo1.url;
import __asset_passo2 from "@/assets/arte-4ano/u6-passo2.jpg.asset.json";
const passo2 = __asset_passo2.url;
import __asset_passo3 from "@/assets/arte-4ano/u6-passo3.jpg.asset.json";
const passo3 = __asset_passo3.url;
import __asset_passo4 from "@/assets/arte-4ano/u6-passo4.jpg.asset.json";
const passo4 = __asset_passo4.url;
import __asset_passo5 from "@/assets/arte-4ano/u6-passo5.jpg.asset.json";
