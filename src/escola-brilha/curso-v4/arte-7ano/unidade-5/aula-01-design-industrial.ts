...
import __asset_bauhausDessau from "@/assets/arte-7ano/u5-bauhaus-dessau.jpg.asset.json";
const bauhausDessau = __asset_bauhausDessau.url;
import __asset_wassilyChair from "@/assets/arte-7ano/u5-wassily-chair.jpg.asset.json";
const wassilyChair = __asset_wassilyChair.url;
import __asset_bauhausWorkshop from "@/assets/arte-7ano/u5-bauhaus-workshop.jpg.asset.json";
const bauhausWorkshop = __asset_bauhausWorkshop.url;
import __asset_busStopMinimal from "@/assets/arte-7ano/u5-bus-stop-minimal.jpg.asset.json";
const busStopMinimal = __asset_busStopMinimal.url;
import __asset_parqueBanco from "@/assets/arte-7ano/u5-parque-banco.jpg.asset.json";
const parqueBanco = __asset_parqueBanco.url;
import __asset_abrigoSolar from "@/assets/arte-7ano/u5-abrigo-solar.jpg.asset.json";
const abrigoSolar = __asset_abrigoSolar.url;
import __asset_lixeirasColoridas from "@/assets/arte-7ano/u5-lixeiras-coloridas.jpg.asset.json";
const lixeirasColoridas = __asset_lixeirasColoridas.url;
import __asset_posteInteligente from "@/assets/arte-7ano/u5-poste-inteligente.jpg.asset.json";
const posteInteligente = __asset_posteInteligente.url;
import __asset_bicicletario from "@/assets/arte-7ano/u5-bicicletario.jpg.asset.json";
const bicicletario = __asset_bicicletario.url;
import __asset_cadeiraErgonomicaDiagrama from "@/assets/arte-7ano/u5-cadeira-ergonomica-diagrama.jpg.asset.json";
const cadeiraErgonomicaDiagrama = __asset_cadeiraErgonomicaDiagrama.url;
import __asset_designIndustrialVistas from "@/assets/arte-7ano/u5-design-industrial-vistas.jpg.asset.json";
const designIndustrialVistas = __asset_designIndustrialVistas.url;
import __asset_radioBraun from "@/assets/arte-7ano/u5-radio-braun.jpg.asset.json";
const radioBraun = __asset_radioBraun.url;
import __asset_cadeiraEames from "@/assets/arte-7ano/u5-cadeira-eames.jpg.asset.json";
const cadeiraEames = __asset_cadeiraEames.url;
import __asset_totemUrbano from "@/assets/arte-7ano/u5-totem-urbano.jpg.asset.json";
const totemUrbano = __asset_totemUrbano.url;
import __asset_formaFuncao from "@/assets/arte-7ano/u5-forma-funcao.jpg.asset.json";
const formaFuncao = __asset_formaFuncao.url;
import __asset_tubularSteel from "@/assets/arte-7ano/u5-tubular-steel.jpg.asset.json";
const tubularSteel = __asset_tubularSteel.url;
...
export const aula01: AulaArteV1 = {
  ...
  iconeTrilha: "🪑",
  bncc: ["EF69AR04", "EF69AR08", "EF69AR31"],
  duracaoMin: 34,
