...
import castelo from "@/assets/arte-7ano/u6-castelo-perspectiva.jpg";
import portal from "@/assets/arte-7ano/u6-portal-entrada.jpg";
import terraTematica from "@/assets/arte-7ano/u6-terra-tematica.jpg";
import playgroundModerno from "@/assets/arte-7ano/u6-playground-moderno.jpg";
import luzesNoturnas from "@/assets/arte-7ano/u6-luzes-noturnas.jpg";
import casteloForcado from "@/assets/arte-7ano/u6-castelo-forcado.jpg";
import caminhoCurvo from "@/assets/arte-7ano/u6-caminho-curvo.jpg";
import dragao from "@/assets/arte-7ano/u6-dragao-escultura.jpg";
import neonScifi from "@/assets/arte-7ano/u6-neon-scifi.jpg";
import ruaMedieval from "@/assets/arte-7ano/u6-rua-medieval.jpg";
import playgroundAventura from "@/assets/arte-7ano/u6-playground-aventura.jpg";
import palcoFestival from "@/assets/arte-7ano/u6-palco-festival.jpg";
import instalacaoArte from "@/assets/arte-7ano/u6-instalacao-arte.jpg";
import pavilhaoCogumelo from "@/assets/arte-7ano/u6-pavilhao-cogumelo.jpg";
import catedralLuz from "@/assets/arte-7ano/u6-catedral-luz.jpg";
