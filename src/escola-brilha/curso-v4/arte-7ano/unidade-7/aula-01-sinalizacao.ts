...
import londonTube from "@/assets/arte-7ano/u7-london-tube-map.jpg";
import munichPictograms from "@/assets/arte-7ano/u7-munich-pictograms.jpg";
import airportWayfinding from "@/assets/arte-7ano/u7-airport-wayfinding.jpg";
import cityTotem from "@/assets/arte-7ano/u7-city-totem.jpg";
import subwayPictograms from "@/assets/arte-7ano/u7-subway-pictograms.jpg";
import streetSigns from "@/assets/arte-7ano/u7-street-signs.jpg";
import bikeLane from "@/assets/arte-7ano/u7-bike-lane.jpg";
import restroomPictogram from "@/assets/arte-7ano/u7-restroom-pictogram.jpg";
import trafficGrid from "@/assets/arte-7ano/u7-traffic-pictogram-grid.jpg";
import smartCityHologram from "@/assets/arte-7ano/u7-smart-city-hologram.jpg";
import transitTypography from "@/assets/arte-7ano/u7-transit-typography.jpg";
import metroLinesDiagram from "@/assets/arte-7ano/u7-metro-lines-diagram.jpg";
import wayfindingKiosk from "@/assets/arte-7ano/u7-wayfinding-kiosk.jpg";
import departureBoard from "@/assets/arte-7ano/u7-departure-board.jpg";
import controlCenterHologram from "@/assets/arte-7ano/u7-control-center-hologram.jpg";
import cidadeSuspensaFinal from "@/assets/arte-7ano/u7-cidade-suspensa-final.jpg";
