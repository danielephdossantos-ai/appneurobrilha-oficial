...
export const aula01: AulaArteV1 = {
  ...
  cena01_motivacao: {
    ...
    itens: [
      {
        emoji: "🚇",
        rotulo: "Mapa do Metrô de Londres",
        descricao:
          "Harry Beck, em 1933, jogou fora a escala real da cidade e desenhou um DIAGRAMA — linhas retas, ângulos de 45°/90°, cores por linha. Virou o modelo de mapa de metrô do MUNDO INTEIRO.",
        cor: "#dc2626",
        fotoUrl: londonTube,
      },
      {
        emoji: "🏅",
        rotulo: "Pictogramas de Munique 1972",
        descricao:
          "Otl Aicher criou um sistema de ícones geométricos pros Jogos Olímpicos de Munique — pessoas de qualquer país entendiam o esporte SEM LER uma palavra. Nasceu o pictograma esportivo moderno.",
        cor: "#0891b2",
        fotoUrl: munichPictograms,
      },
      {
        emoji: "🛫",
        rotulo: "Sinalização de Aeroporto",
        descricao:
          "Preto no amarelo, setas gigantes, ícones universais: o aeroporto é o laboratório perfeito de wayfinding — bilhões de pessoas, zero tempo pra ficar perdido.",
        cor: "#f59e0b",
        fotoUrl: airportWayfinding,
      },
      {
        emoji: "🌆",
        rotulo: "Cidade Suspensa — Vista Final",
        descricao:
          "A SUA Cidade Suspensa, quase completa, agora precisa de um sistema de sinalização pra guiar seus milhões de habitantes. Esse é o último código a decifrar.",
        cor: "#7c2d12",
        fotoUrl: cidadeSuspensaFinal,
      },
    ],
    falaFinal:
      "Você vai aprender a projetar sistemas visuais que guiam MILHÕES de pessoas sem uma única palavra.",
  },
  ...
  cena02_previsao: {
    ...
    perguntas: [
      {
        pergunta:
          "Um pictograma de banheiro precisa ser entendido por uma pessoa que fala QUALQUER idioma do mundo, em menos de 1 segundo. Qual estratégia visual funciona melhor?",
        fotoUrl: restroomPictogram,
        alternativas: [
          {
            texto:
              "Silhuetas simples, alto contraste e formas UNIVERSAIS (sem texto, sem detalhe cultural específico)",
            correta: true,
          },
        ...
        feedbackAcerto:
          "Exato! Pictograma eficiente = silhueta simples + alto contraste + zero dependência de idioma.",
        feedbackErro:
          "Texto em um só idioma exclui quem não lê aquela língua — o pictograma precisa ser UNIVERSAL.",
      },
      {
        pergunta:
          "No mapa do metrô de Londres de Harry Beck, as distâncias reais entre estações foram DEFORMADAS. Por que isso é uma boa ideia?",
        fotoUrl: londonTube,
        alternativas: [
          {
            texto:
              "Porque o cérebro só precisa saber a ORDEM e as CONEXÕES das estações, não a distância exata — clareza vence precisão geográfica",
            correta: true,
          },
          {
            texto: "Porque mapas sempre devem ser 100% fiéis à escala real da cidade, sem exceções",
            correta: false,
          },
        ...
        feedbackAcerto:
          "Isso! Beck entendeu que um DIAGRAMA claro (não um mapa geográfico exato) é mais útil pra quem viaja.",
        feedbackErro:
          "Escala real geraria um mapa emaranhado e ilegível — a genialidade de Beck foi simplificar pra ganhar clareza.",
      },
      {
        pergunta:
          "Otl Aicher criou pictogramas geométricos pros Jogos de Munique 1972. Qual foi o maior ganho dessa escolha?",
        fotoUrl: munichPictograms,
        alternativas: [
          {
            texto:
              "Identidade visual COESA e COMPREENSÍVEL por qualquer visitante do mundo, sem depender de tradução",
            correta: true,
          },
          {
            texto: "Deixar os jogos mais bonitos, sem nenhuma função prática de comunicação",
            correta: false,
          },
        ...
        feedbackAcerto:
          "Perfeito! Os pictogramas de Aicher combinaram estética E função — comunicação universal instantânea.",
        feedbackErro:
          "O sistema de Aicher tinha função prática MUITO forte: guiar visitantes de qualquer país sem barreira de idioma.",
      },
    ],
  },
    ...
    cards: [
      {
        termo: "Wayfinding",
        definicao:
          "Sistema de sinalização e orientação espacial que ajuda pessoas a se localizarem e se deslocarem em ambientes complexos (aeroportos, hospitais, cidades).",
        emoji: "🧭",
        cor: "#0891b2",
        fotoUrl: cityTotem,
      },
      {
        termo: "Pictograma",
        definicao:
          "Ícone simplificado que representa uma ideia, ação ou lugar SEM usar palavras — precisa ser lido em segundos por qualquer pessoa.",
        emoji: "🚻",
        cor: "#dc2626",
        fotoUrl: subwayPictograms,
      },
      {
        termo: "Identidade Visual Urbana",
        definicao:
          "Conjunto coerente de cores, tipografia e ícones que dá uma 'personalidade visual' única a uma cidade ou sistema de transporte.",
        emoji: "🎨",
        cor: "#f59e0b",
        fotoUrl: metroLinesDiagram,
      },
      {
        termo: "Infográfico Espacial",
        definicao:
          "Representação visual (mapa, diagrama, painel) que organiza informação complexa de espaço de forma simples e rápida de entender.",
        emoji: "🗺️",
        cor: "#7c2d12",
        fotoUrl: smartCityHologram,
      },
    ],
  },
  ...
  cena04_leituraGuiada: {
    tipo: "leituraTintas",
    aurora:
      "Escuta como um bom sistema de sinalização pode salvar vidas e economizar tempo de milhões de pessoas.",
    paragrafos: [
    ...
    pigmentos: [
      {
        nome: "Diagrama de Beck (Londres)",
        hex: "#dc2626",
        fonte: "Clareza acima da escala real",
        emoji: "🚇",
        fotoUrl: londonTube,
      },
      {
        nome: "Pictogramas de Aicher (Munique)",
        hex: "#0891b2",
        fonte: "Comunicação universal sem palavras",
        emoji: "🏅",
        fotoUrl: munichPictograms,
      },
      {
        nome: "Wayfinding aeroportuário",
        hex: "#f59e0b",
        fonte: "Preto no amarelo, leitura instantânea",
        emoji: "🛫",
        fotoUrl: airportWayfinding,
      },
      {
        ...
        hex: "#7c2d12",
        fonte: "Infográficos espaciais em tempo real",
        emoji: "🌆",
        fotoUrl: smartCityHologram,
      },
    ],
    ...
    perguntas: [
      {
        ...
        alternativas: [
          {
            texto:
              "Sistema de sinalização e orientação que ajuda pessoas a se localizarem em espaços complexos",
            correta: true,
          },
        ...
        feedbackAcerto:
          "Correto! Wayfinding é orientação espacial funcional — guiar pessoas com clareza.",
        feedbackErro:
          "Wayfinding tem função PRÁTICA de orientação, não é decoração artística sem propósito.",
      },
      {
        pergunta:
          "Harry Beck ficou famoso por criar o mapa do metrô de Londres em 1933. Qual foi sua grande sacada?",
        fotoUrl: londonTube,
        alternativas: [
          {
            texto:
              "Transformar o mapa geográfico real em um DIAGRAMA simplificado, com linhas retas e cores por linha",
            correta: true,
          },
          {
            texto: "Desenhar o mapa em escala perfeitamente real, sem nenhuma simplificação",
            correta: false,
          },
        ...
        feedbackAcerto:
          "Isso! Ele sacrificou a fidelidade geográfica pra ganhar CLAREZA — virou padrão mundial.",
        feedbackErro:
          "Pelo contrário: Beck ABANDONOU a escala real pra criar um diagrama mais legível.",
      },
      {
        ...
        alternativas: [
          {
            texto: "Simples, de alto contraste e compreensível sem depender de idioma ou cultura",
            correta: true,
          },
        ...
        feedbackAcerto:
          "Perfeito! Simplicidade + universalidade = leitura instantânea por qualquer pessoa.",
        feedbackErro:
          "Texto e detalhe excessivo atrapalham a leitura rápida — pictograma é sobre SIMPLICIDADE universal.",
      },
    ],
  },
  ...
  cena06_personagensLugar: {
    ...
    animais: [
      {
        nome: "Mapa de metrô com linhas coloridas retas",
        emoji: "🚇",
        fotoUrl: metroLinesDiagram,
      ...
      {
        nome: "Ícone geométrico de atleta correndo",
        emoji: "🏃",
        fotoUrl: munichPictograms,
        ...
        falaAcerto:
          "Correto! Figura geométrica universal representando esporte = estilo Otl Aicher.",
      },
      {
        nome: "Painel holográfico com dados da cidade em tempo real",
        emoji: "🛰️",
        fotoUrl: controlCenterHologram,
    ...
    passos: [
      {
        id: "p1",
        texto:
          "Defino a PALETA de cores e a tipografia sans-serif do sistema (identidade visual única)",
        emoji: "🎨",
        ordem: 1,
        fotoUrl: transitTypography,
      },
      {
        id: "p2",
        texto:
          "Crio pictogramas simples e universais para os pontos principais (saída, transporte, emergência)",
        emoji: "🚻",
        ordem: 2,
        fotoUrl: trafficGrid,
      },
      {
        id: "p3",
        texto: "Desenho um diagrama tipo Harry Beck das rotas e conexões entre distritos da cidade",
        emoji: "🚇",
        ordem: 3,
        fotoUrl: metroLinesDiagram,
      },
      {
        id: "p4",
        texto:
          "Instalo totens e painéis de wayfinding nos pontos de decisão (cruzamentos, estações)",
        emoji: "🧭",
        ordem: 4,
        fotoUrl: wayfindingKiosk,
      },
      {
        id: "p5",
        texto:
          "Ligo os painéis holográficos inteligentes — a cidade agora se comunica em tempo real com todos!",
        emoji: "🛰️",
        ordem: 5,
        fotoUrl: controlCenterHologram,
      },
  ...
  cena08_voceLe: {
    ...
    trechos: [
      {
        texto: "Sou designer de sinalização. Minha missão é criar",
        palavraDestaque: "Wayfinding",
        corDestaque: "#0891b2",
      },
      {
        texto: "sistemas que guiam pessoas sem palavras. Uso",
        palavraDestaque: "Pictogramas",
        corDestaque: "#dc2626",
      },
      {
        texto: "universais, como fez Otl Aicher em Munique, e diagramas claros, como o de",
        palavraDestaque: "Harry Beck",
        corDestaque: "#7c2d12",
      },
      {
        texto: "no metrô de Londres. Cores e tipografia formam a",
        palavraDestaque: "Identidade Visual Urbana",
        corDestaque: "#f59e0b",
      },
      {
        texto: "da cidade, e painéis digitais viram",
        palavraDestaque: "Infográficos Espaciais",
        corDestaque: "#0f766e",
      },
  ...
  cena09_minijogo: {
    ...
    variante: "minijogo",
    aurora:
      "🚦 O Diretor de Tráfego Gráfico! Toca em TODOS os elementos de sinalização antes do tempo acabar.",
    titulo: "🚦 O Diretor de Tráfego Gráfico",
    instrucao:
      "Toca em todos os pictogramas e sinais antes do tempo acabar pra manter a cidade em movimento!",
    tempoSeg: 35,
    itens: [
    ...
    itens: [
      {
        ...
        rotulo: "Wayfinding",
        descricao:
          "Sistema de sinalização que orienta pessoas em espaços complexos com clareza e rapidez.",
        cor: "#0891b2",
        fotoUrl: cityTotem,
      },
      {
        emoji: "🚻",
        rotulo: "Pictograma",
        descricao: "Ícone simples e universal, lido em menos de 1 segundo, sem depender de idioma.",
        cor: "#dc2626",
        fotoUrl: subwayPictograms,
      },
      {
        emoji: "🚇",
        rotulo: "Diagrama de Harry Beck",
        descricao:
          "Mapa de metrô de Londres (1933) que trocou fidelidade geográfica por clareza visual.",
        cor: "#7c2d12",
        fotoUrl: londonTube,
      },
      {
        emoji: "🏅",
        rotulo: "Pictogramas de Otl Aicher",
        descricao:
          "Sistema de ícones geométricos criado pra Munique 1972, comunicando esportes sem palavras.",
        cor: "#0f766e",
        fotoUrl: munichPictograms,
      },
      {
        emoji: "🎨",
        rotulo: "Identidade Visual Urbana",
        descricao:
          "Cores, tipografia e ícones coerentes que dão personalidade e legibilidade a uma cidade.",
        cor: "#f59e0b",
        fotoUrl: metroLinesDiagram,
      },
      {
        emoji: "🛰️",
        rotulo: "Infográfico Espacial",
        descricao:
          "Painel visual (digital ou impresso) que organiza informação de espaço em tempo real.",
        cor: "#78716c",
        fotoUrl: smartCityHologram,
      },
    ],
  ...
  cena11_avaliacao: {
    ...
    quiz: {
      pergunta:
        "Uma pessoa chega em um aeroporto de um país onde não fala o idioma. Em 2 segundos, ela precisa achar o banheiro, a saída e a esteira de bagagem — sem ler nenhuma palavra. Que princípio de design torna isso possível?",
      alternativas: [
        {
          texto:
            "Sistemas de wayfinding com pictogramas universais, alto contraste e identidade visual coerente — comunicação instantânea sem depender de idioma",
          correta: true,
        },
        {
          texto:
            "Placas com textos longos e detalhados em um único idioma, exigindo leitura cuidadosa",
          correta: false,
        },
      ...
      feedback:
        "Exatamente! Wayfinding bem projetado combina PICTOGRAMAS universais (herança de Otl Aicher), DIAGRAMAS claros (herança de Harry Beck) e uma IDENTIDADE VISUAL coerente (cores + tipografia) pra guiar qualquer pessoa, de qualquer lugar do mundo, em segundos. É a última camada que transforma uma cidade bonita em uma cidade FUNCIONAL — e com isso, você conclui TODA a jornada das Crônicas das Cidades Suspensas!",
    },
    missaoFamilia:
    ...
    recompensaItem:
      "🚀 Emblema de Ouro de Urbanista Máster + Mapa Criptográfico da Cidade Suspensa",
  },
