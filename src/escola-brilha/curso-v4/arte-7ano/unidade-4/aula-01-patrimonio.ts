...
import antesDepois from "@/assets/arte-7ano/u4-antes-depois.jpg";
import azulejo from "@/assets/arte-7ano/u4-azulejo.jpg";
import casaIluminada from "@/assets/arte-7ano/u4-casa-iluminada.jpg";
import centroCultural from "@/assets/arte-7ano/u4-centro-cultural.jpg";
import louvre from "@/assets/arte-7ano/u4-louvre.jpg";
import museuOrsay from "@/assets/arte-7ano/u4-museu-orsay.jpg";
import ouroPretoIgreja from "@/assets/arte-7ano/u4-ouro-preto-igreja.jpg";
import pelourinho from "@/assets/arte-7ano/u4-pelourinho.jpg";
import placaTombamento from "@/assets/arte-7ano/u4-placa-tombamento.jpg";
import plantaRestauro from "@/assets/arte-7ano/u4-planta-restauro.jpg";
import rampaAcessibilidade from "@/assets/arte-7ano/u4-rampa-acessibilidade.jpg";
import restauroObra from "@/assets/arte-7ano/u4-restauro-obra.jpg";
import restauroQuadro from "@/assets/arte-7ano/u4-restauro-quadro.jpg";
import saoFranciscoOuro from "@/assets/arte-7ano/u4-sao-francisco-ouro.jpg";
import vidroPedra from "@/assets/arte-7ano/u4-vidro-pedra.jpg";
