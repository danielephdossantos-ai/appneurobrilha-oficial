...
import __asset_diegoRivera from "@/assets/arte-7ano/u2-diego-rivera.jpg.asset.json";
const diegoRivera = __asset_diegoRivera.url;
import __asset_siqueiros from "@/assets/arte-7ano/u2-siqueiros-mural.jpg.asset.json";
const siqueiros = __asset_siqueiros.url;
import __asset_becoBatman from "@/assets/arte-7ano/u2-beco-batman.jpg.asset.json";
const becoBatman = __asset_becoBatman.url;
import __asset_grafiteRua from "@/assets/arte-7ano/u2-grafite-rua-brasileira.jpg.asset.json";
