...
export const aula01: AulaArteV1 = {
  ...
  iconeTrilha: "🌐",
  bncc: ["EF69AR01", "EF69AR02", "EF69AR32", "EF69AR33"],
  duracaoMin: 38,
  ...
  cena01_motivacao: {
    ...
    itens: [
      {
        emoji: "🌐",
        rotulo: "Hibridismo na Arte",
        descricao:
          "Mistura intencional de linguagens (pintura + performance + som) ou fusão de elementos de culturas distintas numa mesma obra, gerando um significado novo.",
        cor: "#0891b2",
        fotoUrl: hibridismo,
      },
      {
        emoji: "🏛️",
        rotulo: "Descolonização Curatorial",
        descricao:
          "Movimento que RETIRA os padrões europeus e norte-americanos como únicos 'corretos' e integra produções indígenas, afro-diaspóricas e de povos historicamente marginalizados.",
        cor: "#dc2626",
        fotoUrl: bienal,
      },
      {
        emoji: "✨",
        rotulo: "Sincretismo Visual",
        descricao:
          "União de símbolos, rituais e iconografias de culturas diferentes fundidos numa nova expressão estética.",
        cor: "#7c3aed",
        fotoUrl: sincretismo,
      },
      {
        emoji: "🧱",
        rotulo: "Varal de Azulejos (Adriana Varejão)",
        descricao:
          "Painéis grossos que imitam azulejaria portuguesa tradicional, RACHADOS e cortados, revelando por baixo uma 'carne' orgânica fictícia: denúncia da mistura violenta de culturas no Brasil colonial.",
        cor: "#f97316",
        fotoUrl: varejao,
      },
    ],
    falaFinal:
      "Sua missão: virar Pensador Visual e Curador Crítico — cruzar heranças ancestrais e linguagens globais numa mesma obra.",
  },
  ...
  cena02_previsao: {
    ...
    perguntas: [
      {
        pergunta:
          "Uma artista brasileira pinta painéis que imitam AZULEJARIA portuguesa e depois faz cortes profundos, revelando uma 'carne' vermelha por baixo. Qual é a mensagem?",
        fotoUrl: varejao,
        alternativas: [
          {
            texto:
              "A azulejaria colonial esconde uma HISTÓRIA DE DOR e mistura violenta de culturas — o corte revela essa marca",
            correta: true,
          },
          {
            texto: "É apenas uma experimentação técnica com massa acrílica, sem crítica histórica",
            correta: false,
          },
        ...
        feedbackAcerto:
          "Perfeito! A obra denuncia o passado colonial e o hibridismo violento da formação do Brasil.",
        feedbackErro:
          "Cuidado: arte contemporânea NUNCA é só técnica. O corte fala da ferida colonial.",
      },
      {
        pergunta:
          "Uma bienal internacional expõe, LADO A LADO, obras europeias, indígenas amazônicas, africanas e asiáticas — com o MESMO peso curatorial. Que movimento isso representa?",
        fotoUrl: bienal,
        alternativas: [
          {
            texto: "Descolonização Curatorial — retira o padrão europeu como único 'correto'",
            correta: true,
          },
          {
            texto: "Universalismo Renascentista — só valem as regras clássicas europeias",
            correta: false,
          },
        ...
        feedbackAcerto:
          "Isso! A curadoria descolonial redistribui o poder de decidir o que é arte legítima.",
        feedbackErro:
          "O Renascimento centrava tudo na Europa. Aqui é o OPOSTO — vozes plurais no mesmo palco.",
      },
      {
        pergunta:
          "Um artista cruza um VIOLONCELO clássico com uma batida eletrônica de funk/trap. Que princípio ele aciona?",
        fotoUrl: celloEletronico,
        alternativas: [
          {
            texto:
              "Hibridismo — o contraste entre matrizes gera automaticamente uma nova mensagem estética",
            correta: true,
          },
          {
            texto: "Purismo musical — instrumentos de culturas diferentes NUNCA devem se misturar",
            correta: false,
          },
  ...
  cena03_vocabulario: {
    ...
    cards: [
      {
        termo: "Hibridismo na Arte",
        definicao:
          "Mistura intencional de linguagens artísticas (pintura + performance + som) ou fusão de elementos culturais distintos numa mesma obra, gerando novo significado.",
        emoji: "🌐",
        cor: "#0891b2",
        fotoUrl: hibridismo,
      },
      {
        termo: "Descolonização Curatorial",
        definicao:
          "Movimento que retira os padrões europeus/norte-americanos como únicos legítimos e integra produções indígenas, afro-diaspóricas e de povos marginalizados.",
        emoji: "🏛️",
        cor: "#dc2626",
        fotoUrl: bienal,
      },
      {
        termo: "Sincretismo Visual",
        definicao:
          "União de símbolos, rituais e iconografias religiosas/culturais diferentes fundidos numa nova expressão estética hibridizada.",
        emoji: "✨",
        cor: "#7c3aed",
        fotoUrl: sincretismo,
      },
      {
        termo: "Justaposição Crítica",
        definicao:
          "Colocar lado a lado matrizes opostas (mármore + palha, cello + trap) pra que o CONTRASTE em si gere a mensagem da obra.",
        emoji: "🧩",
        cor: "#f97316",
        fotoUrl: colagemGrega,
      },
    ],
  },
    ...
    pigmentos: [
      {
        nome: "Hibridismo",
        hex: "#0891b2",
        fonte: "Mistura de linguagens e culturas",
        emoji: "🌐",
        fotoUrl: hibridismo,
      },
      {
        nome: "Descolonização",
        hex: "#dc2626",
        fonte: "Fim do padrão único europeu",
        emoji: "🏛️",
        fotoUrl: bienal,
      },
      {
        nome: "Sincretismo",
        hex: "#7c3aed",
        fonte: "Fusão de símbolos culturais",
        emoji: "✨",
        fotoUrl: sincretismo,
      },
      {
        nome: "Varejão",
        hex: "#f97316",
        fonte: "Azulejo rachado revelando 'carne'",
        emoji: "🧱",
        fotoUrl: varejao,
      },
    ],
    ...
    perguntas: [
      {
        ...
        alternativas: [
          {
            texto:
              "Criar um SIGNIFICADO NOVO cruzando linguagens ou culturas que sozinhas não dariam conta",
            correta: true,
          },
        ...
        feedbackAcerto:
          "Correto! A mistura gera uma leitura de mundo que nenhuma matriz isolada oferece.",
      ...
      },
      {
        ...
        alternativas: [
          {
            texto:
              "Dar o mesmo espaço e peso a obras indígenas, africanas e asiáticas — retirando o padrão único europeu",
            correta: true,
          },
          {
            texto: "Expor SOMENTE obras europeias e americanas, consideradas as únicas 'de nível'",
            correta: false,
          },
        ...
        feedbackErro:
          "Esse era o modelo antigo. A descolonização quebra exatamente essa hierarquia.",
      },
      {
        pergunta:
          "O corte que revela 'carne' vermelha em 'Varal de Azulejos' de Adriana Varejão fala principalmente de quê?",
        fotoUrl: varejao,
        alternativas: [
          {
            texto: "Da FERIDA e da mistura violenta de culturas no passado colonial brasileiro",
            correta: true,
          },
          {
            texto: "Apenas de uma escolha decorativa aleatória, sem crítica histórica",
            correta: false,
          },
        ...
        feedbackAcerto:
          "Perfeito! A azulejaria é a pele europeia; a carne por baixo é a dor colonial.",
  ...
  cena06_personagensLugar: {
    ...
    animais: [
      {
        nome: "Azulejo rachado com 'carne' por baixo",
        emoji: "🧱",
        fotoUrl: varejao,
        ...
        falaAcerto:
          "Isso! Varejão denuncia o passado colonial cruzando azulejo europeu e 'carne' orgânica.",
      },
      {
        nome: "Mármore grego envolvido em palha indígena",
        emoji: "🌾",
        fotoUrl: colagemGrega,
        ...
        falaAcerto:
          "Correto! Matriz europeia + matriz nativa lado a lado = hibridismo por justaposição.",
      },
      {
        nome: "Altar com cruz, símbolos afro e plumas indígenas",
        emoji: "✨",
        fotoUrl: sincretismo,
  ...
  cena07_sequencia: {
    ...
    passos: [
      {
        id: "p1",
        texto:
          "Escolho um OBJETO cotidiano globalizado (tênis, celular, lata de refrigerante) e desenho o contorno no caderno",
        emoji: "👟",
        ordem: 1,
        fotoUrl: tenisHibrido,
      },
      {
        id: "p2",
        texto:
          "Seleciono UMA matriz ancestral: grafismo marajoara, estampa Kente africana ou grafismo oriental",
        emoji: "🌍",
        ordem: 2,
        fotoUrl: kente,
      },
      {
        id: "p3",
        texto: "PREENCHO o interior do objeto inteiro com o padrão geométrico ancestral escolhido",
        emoji: "🎨",
        ordem: 3,
        fotoUrl: marajoara,
      },
      {
        id: "p4",
        texto:
          "Escrevo 3 linhas explicando como o desenho CONECTA o passado ancestral ao mundo globalizado atual",
        emoji: "✍️",
        ordem: 4,
        fotoUrl: artistaJovem,
      },
      {
        id: "p5",
        texto:
          "Dou um TÍTULO à obra e assino como 'Artista Intercultural' — projeto híbrido pronto!",
        emoji: "🏷️",
        ordem: 5,
        fotoUrl: hibridismo,
      },
    ...
    falaAcerto:
      "Você acabou de criar seu primeiro projeto de Arte Intercultural — pensador visual online!",
  },
  ...
  cena08_voceLe: {
    ...
    trechos: [
      {
        texto: "Sou pensador visual. Minha ferramenta principal é o",
        palavraDestaque: "hibridismo cultural",
        corDestaque: "#0891b2",
      },
      {
        texto: "Quando cruzo matrizes de culturas diferentes numa obra, aciono a",
        palavraDestaque: "justaposição crítica",
        corDestaque: "#f97316",
      },
      {
        texto: "Se retiro o padrão europeu como único legítimo, pratico a",
        palavraDestaque: "descolonização curatorial",
        corDestaque: "#dc2626",
      },
      {
        texto: "Quando fundo símbolos religiosos ou rituais em uma nova estética, faço",
        palavraDestaque: "sincretismo visual",
        corDestaque: "#7c3aed",
      },
      {
        texto: "Assim, cada obra vira um mapa de identidades cruzadas — sou",
        palavraDestaque: "curador crítico",
        corDestaque: "#0f766e",
      },
  ...
  cena09_minijogo: {
    ...
    variante: "minijogo",
    aurora:
      "🧪 O Alquimista de Mídias! Arrasta os elementos culturais pro caldeirão e combina de forma equilibrada pra gerar uma obra híbrida ESTÁVEL.",
    titulo: "🧪 O Alquimista de Mídias",
    instrucao:
      "Combina máscaras tradicionais, texturas urbanas e pixels digitais dentro do caldeirão!",
    tempoSeg: 45,
    itens: [
      {
        emoji: "🎭",
        rotulo: "Máscara ancestral (matriz tradicional)",
        cor: "#78350f",
        fotoUrl: mascara,
      },
  ...
  cena10_revisao: {
    ...
    itens: [
      {
        emoji: "🌐",
        rotulo: "Hibridismo Cultural",
        descricao:
          "Mistura intencional de linguagens e culturas numa mesma obra pra gerar um significado novo.",
        cor: "#0891b2",
        fotoUrl: hibridismo,
      },
      {
        ...
        rotulo: "Descolonização Curatorial",
        descricao:
          "Fim do padrão único europeu — obras indígenas, africanas e asiáticas ocupam o mesmo peso curatorial.",
        cor: "#dc2626",
        fotoUrl: bienal,
      },
      {
        ...
        rotulo: "Sincretismo Visual",
        descricao:
          "Fusão de símbolos religiosos e culturais diferentes numa nova expressão estética.",
        cor: "#7c3aed",
        fotoUrl: sincretismo,
      },
      {
        emoji: "🧱",
        rotulo: "Adriana Varejão",
        descricao:
          "Painéis de azulejaria portuguesa rachados que revelam 'carne' orgânica — denúncia do passado colonial brasileiro.",
        cor: "#f97316",
        fotoUrl: varejao,
      },
      {
        emoji: "🧩",
        rotulo: "Justaposição Crítica",
        descricao:
          "Colocar matrizes opostas lado a lado (cello + trap, mármore + palha) pra que o contraste seja a mensagem.",
        cor: "#0f766e",
        fotoUrl: celloEletronico,
      },
      {
        emoji: "👟",
        rotulo: "Arte Intercultural",
        descricao:
          "Projeto híbrido que preenche um objeto globalizado com padrões ancestrais (marajoara, Kente, oriental).",
        cor: "#b45309",
        fotoUrl: tenisHibrido,
      },
    ],
    falaFinal:
      "Portal das Confluências ATIVADO — primeira página do Códice dos Cosmopolitismos aberta!",
  },
  ...
  cena11_avaliacao: {
    ...
    quiz: {
      pergunta:
        "O que MELHOR define o conceito de 'Hibridismo' na produção de arte do mundo contemporâneo?",
      alternativas: [
        {
          texto:
            "A mistura livre de diferentes mídias, técnicas, materiais e referências culturais que rompe com as barreiras tradicionais da arte",
          correta: true,
        },
        {
          texto:
            "A obrigação de pintar quadros utilizando apenas uma única cor de tinta do início ao fim",
          correta: false,
        },
