    ...
    perguntas: [
      {
        ...
        opcoes: ["A", "P", "U", "O"],
        correta: 1,
        feedbackAcerto: "🎉 Isso! P é consoante. A, U e O são vogais.",
        feedbackErro: "As vogais são A, E, I, O, U. Todas as outras letras são consoantes.",
      },
      {
      ...
      },
      {
        ...
        feedbackErro: "Bata palma: CA (1) — SA (2). São duas sílabas, não quatro letras.",
      },
      {
        pergunta: "4/5 — Quais sílabas formam a palavra PATO?",
        opcoes: ["PA + TO", "TO + PA", "PO + TA", "PAT + O"],
        correta: 0,
