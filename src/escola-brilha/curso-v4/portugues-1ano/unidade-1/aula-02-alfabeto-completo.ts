    ...
    perguntas: [
      {
        ...
        feedbackErro: "Conte na trilha do A até o Z: são 26 letras.",
      },
      {
        ...
        feedbackErro: "A trilha começa no A. O B é a segunda letra.",
      },
      {
        ...
        feedbackErro: "No fim da trilha vêm W, X, Y e, por último, o Z.",
      },
      {
        ...
        feedbackErro: "Ouça o começo: CA-SA. O som é de C, mesmo parecendo K.",
      },
      {
        pergunta: "5/5 — Para que serve saber a ordem do alfabeto?",
        opcoes: [
          "Para organizar listas e achar palavras",
          "Para deixar o caderno mais bonito",
          "Para contar de 1 até 26",
          "Para escrever só o próprio nome",
        ],
        correta: 0,
        feedbackAcerto: "🎉 Isso! Ajuda a organizar listas, como a lista de chamada. Trilha concluída! 🌟",
        feedbackErro: "Pense na lista de chamada da professora: ela usa a ordem do alfabeto para achar cada nome.",
      },
    ],
  },
