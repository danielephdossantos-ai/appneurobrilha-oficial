    ...
    perguntas: [
      {
        ...
        opcoes: ["Batemos palma", "Fechamos o olho", "Ficamos quietos"],
        correta: 0,
        feedbackAcerto: "🎉 Batemos PALMA!",
        feedbackErro: "Em cada sílaba, batemos uma PALMA.",
      },
      {
        ...
        feedbackErro: "SA-PO: bata palma duas vezes.",
      },
      {
        pergunta: "3/5 — Quantas sílabas tem GATO?",
        opcoes: ["Duas", "Três", "Uma"],
        correta: 0,
        feedbackAcerto: "🎉 DUAS: GA-TO.",
        feedbackErro: "GA-TO: são duas sílabas.",
      },
      {
        ...
        feedbackErro: "A-BE-LHA: são três sílabas.",
      },
      {
        ...
        feedbackErro: "BA-NA-NA: são três sílabas, três palmas.",
      },
    ],
  },
