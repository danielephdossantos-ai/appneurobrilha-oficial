    ...
    perguntas: [
      {
        ...
        opcoes: ["Cinco", "Quatro", "Três", "Seis"],
        correta: 0,
        feedbackAcerto: "🎉 CINCO: BA BE BI BO BU.",
        feedbackErro: "Uma para cada vogal (A, E, I, O, U): são CINCO sílabas.",
      },
      {
        ...
        correta: 1,
        feedbackAcerto: "🎉 BO!",
        feedbackErro: "Ouça a vogal do comecinho: B + O = BO-la.",
      },
      {
      ...
      },
      {
        ...
        correta: 2,
        feedbackAcerto: "🎉 BI!",
        feedbackErro: "A vogal do começo é o I: BI-ci-cle-ta.",
      },
      {
        pergunta: "5/5 — Qual é a ordem certa da família do B?",
        opcoes: ["BU BO BI BE BA", "BA BE BI BO BU", "BE BA BO BI BU", "BA BI BE BU BO"],
        correta: 1,
        feedbackAcerto: "🎉 Isso! BA BE BI BO BU, seguindo as vogais A E I O U. Família completa! 🌟",
        feedbackErro: "A ordem segue as vogais na ordem certa: A, E, I, O, U → BA BE BI BO BU.",
      },
    ],
  },
