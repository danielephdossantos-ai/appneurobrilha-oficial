    ...
    perguntas: [
      {
        ...
        opcoes: ["Começam com a mesma letra", "Terminam com o mesmo som", "Têm o mesmo tamanho"],
        correta: 1,
        feedbackAcerto: "🎉 Isso mesmo!",
        feedbackErro: "Rima é sobre o SOM FINAL das palavras.",
      },
      {
        pergunta: "2/5 — Qual palavra RIMA com GATO?",
        opcoes: ["SAPO", "PATO", "SOL"],
        correta: 1,
        feedbackAcerto: "🎉 PATO! Termina em ATO, igual GATO.",
        feedbackErro: "Pense no som final: GATO termina em ATO, assim como PATO.",
      },
      {
        pergunta: "3/5 — Qual palavra RIMA com MÃO?",
        opcoes: ["PÃO", "FLOR", "GATO"],
        correta: 0,
        feedbackAcerto: "🎉 PÃO! As duas terminam em ÃO.",
        feedbackErro: "MÃO termina em ÃO, igual PÃO.",
      },
      {
        pergunta: "4/5 — GATO, PATO e RATO rimam porque...",
        opcoes: ["Todos são animais", "Terminam com o som ATO", "Têm 4 letras"],
        correta: 1,
        feedbackAcerto: "🎉 Isso! O som final ATO se repete.",
        feedbackErro: "O que se repete no final é o som ATO.",
      },
      {
        pergunta: "5/5 — Qual palavra RIMA com FLOR?",
        opcoes: ["SOL", "GATO", "MÃO"],
        correta: 0,
        feedbackAcerto: "🎉 SOL! As duas terminam com o som OL/OR bem parecido.",
        feedbackErro: "FLOR e SOL têm o final bem parecido, tente ouvir de novo.",
      },
    ],
  },
