    ...
    perguntas: [
      {
        ...
        opcoes: ["Ciranda, Cirandinha", "A Canoa Virou", "Boi da Cara Preta", "Atirei o Pau no Gato"],
        correta: 0,
        feedbackAcerto: "🎉 Isso!",
        feedbackErro: "As outras também são cantigas conhecidas, mas o título do nosso texto era 'Ciranda, cirandinha'.",
      },
      {
        ...
        feedbackErro: "Ciranda precisa de um grupo cantando junto, de mãos dadas, em roda.",
      },
      {
      ...
      },
      {
        ...
        opcoes: ["Feijão no prato", "Feijão com arroz", "Arroz no prato", "Cinco, seis"],
        correta: 0,
        feedbackAcerto: "🎉 Isso! 'Três, quatro, feijão no prato.'",
        feedbackErro: "'Feijão com arroz' é a parte do 'um, dois'. Depois de 'três, quatro' vem 'feijão no PRATO'.",
      },
      {
        pergunta: "5/5 — Pra memorizar uma cantiga, o que ajuda?",
        opcoes: [
          "Repetir e acompanhar o texto escrito",
          "Ler só uma vez",
          "Ouvir bem rápido, uma vez só",
          "Escrever sem nunca cantar",
        ],
        correta: 0,
        feedbackAcerto: "🎉 Isso! Repetir e acompanhar o texto ajuda a memorizar.",
        feedbackErro: "A gente memoriza REPETINDO várias vezes e olhando pro texto enquanto canta.",
      },
    ],
  },
