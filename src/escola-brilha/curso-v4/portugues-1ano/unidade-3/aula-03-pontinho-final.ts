  ...
  momento10_avaliacao: {
    perguntas: [
      ...
      },
      {
        ...
        correta: 2,
        feedbackAcerto: "🎉 Isso!",
        feedbackErro: "É a exclamação ( ! ).",
      },
      {
        pergunta: "3/5 — O que Mia perguntou?",
        opcoes: ["Cadê meu lápis?", "Cadê meu carro?", "Cadê minha flor?"],
        correta: 0,
        feedbackAcerto: "🎉 Isso!",
      ...
      },
      {
        ...
        feedbackErro: "Frases de alegria ou susto usam exclamação ( ! ).",
      },
      {
        ...
        feedbackErro: "Quando é só contar algo com calma, usamos o ponto final ( . ).",
      },
    ],
  },
