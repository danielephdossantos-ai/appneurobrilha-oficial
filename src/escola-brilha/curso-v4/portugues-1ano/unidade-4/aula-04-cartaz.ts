    ...
    perguntas: [
      {
        ...
        opcoes: [
          "Um aviso com letras grandes, para muita gente ver",
          "Um bilhete para uma pessoa só",
          "Uma lista de compras",
          "Um convite de festa",
        ],
        correta: 0,
        feedbackAcerto: "🎉 Isso mesmo!",
        feedbackErro: "Bilhete é para UMA pessoa. O cartaz avisa MUITA gente, com letras grandes.",
      },
      {
        pergunta: "2/5 — Onde a escola colou o primeiro cartaz?",
        opcoes: ["No corredor", "No pátio", "Na sala", "Na porta da escola"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Silêncio", "Guardar os livros", "Correr devagar", "Falar mais alto"],
        correta: 0,
        feedbackAcerto: "🎉 Isso!",
        feedbackErro: "O cartaz dizia, em letras grandes, 'SILÊNCIO'.",
      },
      {
        pergunta: "4/5 — Qual desses é um texto do dia a dia que aprendemos nessa unidade?",
        opcoes: ["Lista de compras", "Poema com rimas", "História de fadas", "Música de roda"],
        correta: 0,
        feedbackAcerto: "🎉 Isso! Lista, bilhete, convite e cartaz.",
        feedbackErro: "Poema, história e música existem, mas nesta unidade vimos lista, bilhete, convite e cartaz.",
      },
      {
        pergunta: "5/5 — Por que as letras do cartaz são grandes?",
        opcoes: [
          "Pra dar pra ler de longe",
          "Pra caber mais palavras",
          "Pra deixar mais bonito",
          "Pra usar todas as cores",
        ],
        correta: 0,
        feedbackAcerto: "🎉 Isso! Letras grandes se leem de longe. Você é um Leitor do Mundo! 🌟",
        feedbackErro: "Letra grande até ocupa mais espaço, mas o motivo é permitir a leitura de LONGE.",
      },
    ],
  },
