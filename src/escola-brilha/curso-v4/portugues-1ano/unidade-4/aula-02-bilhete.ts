    ...
    perguntas: [
      {
        ...
        opcoes: [
          ...
          "Pra convidar para uma festa",
          "Pra listar as compras",
          "Pra contar uma história longa",
        ],
        correta: 0,
        feedbackAcerto: "🎉 Isso mesmo!",
        feedbackErro: "Convite chama para um evento e lista organiza itens. O bilhete AVISA algo rápido.",
      },
      {
        pergunta: "2/5 — Para onde a mamãe da Clara foi?",
        opcoes: ["Padaria", "Mercado", "Escola", "Praça"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: [
          ...
          "Pra quem o bilhete é escrito",
          "Quem entrega o bilhete",
          "O assunto do bilhete",
        ],
        correta: 1,
        feedbackAcerto: "🎉 Isso!",
        feedbackErro: "Quem escreve assina no fim. O DESTINATÁRIO é quem vai LER o bilhete.",
      },
      {
        pergunta: "4/5 — Onde o papai foi esperar a Ana?",
        opcoes: ["No parquinho", "Na escola", "No mercado", "Em casa"],
        correta: 0,
      ...
      },
      {
        ...
        feedbackErro: "O nome de quem lê vem no começo; no FIM fica a assinatura de quem escreveu.",
      },
    ],
  },
