    ...
    perguntas: [
      {
        ...
        opcoes: ["Começo, meio e fim", "Título, capa e página", "Personagem, cenário e cor"],
        correta: 0,
        feedbackAcerto: "🎉 Certo! COMEÇO, MEIO e FIM.",
        feedbackErro: "Toda história se divide em COMEÇO, MEIO e FIM.",
      },
      {
        pergunta: "2/5 — O que a coelhinha Fiona seguiu e se perdeu?",
        opcoes: ["Uma borboleta", "Um passarinho", "Um cachorro"],
        correta: 0,
      ...
      },
      {
        ...
        opcoes: ["Seguindo o cheiro de cenoura", "Perguntando pra árvore", "Voando"],
        correta: 0,
        feedbackAcerto: "🎉 Muito bem! O cheiro de cenoura a guiou.",
        feedbackErro: "No fim do texto: 'ela seguiu o cheiro' de quê?",
      },
      {
        pergunta: "4/5 — Na história da pipa, qual foi o problema do meio?",
        opcoes: ["A pipa rasgou", "O vento parou de soprar", "Ana ficou doente"],
        correta: 1,
        feedbackAcerto: "🎉 Isso! O vento parou e a pipa não subia.",
        feedbackErro: "Releia: 'No meio, o vento parou…'.",
      },
      {
        pergunta: "5/5 — Pra arrumar páginas embaralhadas, a gente pensa em…",
        opcoes: ["Qual página é mais bonita", "O que aconteceu primeiro, depois e por último", "Qual página tem mais cores"],
        correta: 1,
        feedbackAcerto: "🎉 Isso mesmo! Pensamos na ORDEM dos acontecimentos. 🌟",
        feedbackErro: "A ordem certa segue o que aconteceu PRIMEIRO, DEPOIS e no FIM.",
      },
    ],
  },
