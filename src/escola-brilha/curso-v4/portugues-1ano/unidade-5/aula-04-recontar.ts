    ...
    perguntas: [
      {
        ...
        opcoes: ["Ler o texto de novo em voz alta igualzinho", "Contar a história com as próprias palavras, na ordem", "Desenhar a capa do livro"],
        correta: 1,
        feedbackAcerto: "🎉 Certo!",
        feedbackErro: "Reconto é contar com SUAS palavras, mantendo a ordem certa.",
      },
      {
        pergunta: "2/5 — O que Bento plantou na história do girassol?",
        opcoes: ["Uma árvore grande", "Uma sementinha de girassol", "Um cacto"],
        correta: 1,
        feedbackAcerto: "🎉 Uma sementinha de girassol!",
        feedbackErro: "O texto diz: 'plantou uma sementinha de girassol'.",
      },
      {
        pergunta: "3/5 — O que Bento fazia todo dia enquanto esperava?",
        opcoes: ["Regava a terra", "Ia pra escola", "Dormia o dia todo"],
        correta: 0,
      ...
      },
      {
        ...
        feedbackErro: "Um bom reconto usa TUDO: personagem, cenário, tempo e a ordem começo-meio-fim.",
      },
    ],
  },
