...
export const aula01: AulaArteV1 = {
  ...
  cena01_motivacao: {
    ...
    itens: [
      {
        emoji: "🏙️",
        rotulo: "Mural gigante num prédio",
        descricao: "Uma pintura que ocupa a parede INTEIRA de um edifício — todo mundo pode ver.",
        cor: "#0284c7",
        fotoUrl: mapaMural,
      },
      {
        emoji: "🎨",
        rotulo: "Lata de spray",
        descricao: "Tinta líquida que sai como neblina — permite pintar áreas GRANDES bem rápido.",
        cor: "#dc2626",
        fotoUrl: mapaSpray,
      },
      {
        emoji: "🧑\u200d🎨",
        rotulo: "Grafiteiro trabalhando",
        descricao: "Artista de rua com máscara e capacete — a segurança vem primeiro.",
        cor: "#7c3aed",
        fotoUrl: mapaGrafiteiro,
      },
      {
        emoji: "🖐️",
        rotulo: "Pintura rupestre (caverna)",
        descricao: "Os PRIMEIROS grafites da história — há 30.000 anos, dentro das cavernas!",
        cor: "#b45309",
        fotoUrl: mapaCaverna,
      },
    ],
    falaFinal:
      "Grafitar já era feito na CAVERNA — o ser humano SEMPRE quis marcar as paredes com arte.",
  },
    ...
    cards: [
      {
        termo: "Grafite",
        definicao:
          "Arte feita com SPRAY em muros e paredes urbanas — com autorização vira arte oficial.",
        emoji: "🎨",
        cor: "#dc2626",
        fotoUrl: vocabGrafite,
      },
      {
        termo: "Muralismo",
        definicao: "Pintura GIGANTE em paredes públicas — conta histórias da comunidade.",
        emoji: "🏙️",
        cor: "#0284c7",
      ...
      {
        termo: "Estêncil",
        definicao: "Molde de papel VAZADO — passa spray por cima e a figura fica marcada.",
        emoji: "🦋",
        cor: "#7c3aed",
      ...
      {
        termo: "Arte Urbana",
        definicao: "TODA arte feita na rua: grafite, mural, adesivo, escultura pública.",
        emoji: "🏢",
        cor: "#4b5563",
        fotoUrl: vocabUrbano,
      },
  ...
  cena04_leituraGuiada: {
    tipo: "leituraTintas",
    aurora:
      "Vou te contar como a arte pulou da caverna pra parede da esquina. Presta atenção na história!",
    paragrafos: [
    ...
    pigmentos: [
      {
        nome: "Ocre-vermelho rupestre",
        hex: "#b45309",
        fonte: "Terra vermelha misturada com gordura",
        emoji: "🟠",
        fotoUrl: nosRupestre,
      },
      {
        nome: "Azul-elétrico do spray",
        hex: "#2563eb",
        fonte: "Tinta acrílica em aerossol",
        emoji: "🟦",
      ...
      },
      {
        nome: "Amarelo Kobra",
        hex: "#facc15",
        fonte: "Tinta acrílica de alta pigmentação",
        emoji: "🟡",
        fotoUrl: mapaMural,
      },
      {
        nome: "Preto do contorno",
        hex: "#1f2937",
        fonte: "Spray de contorno grosso",
        emoji: "⚫",
        fotoUrl: vocabGrafite,
      },
    ],
  ...
  cena06_personagensLugar: {
    ...
    animais: [
      {
        nome: "Pintura rupestre da Serra da Capivara",
        emoji: "🖐️",
        fotoUrl: nosRupestre,
  ...
  cena07_sequencia: {
    ...
    passos: [
      {
        id: "p1",
        texto: "PENSO na mensagem: o que quero contar pro mundo?",
        emoji: "💭",
        ordem: 1,
        fotoUrl: vocabMuralismo,
      },
      {
        id: "p2",
        texto: "ESBOÇO em folha pequena, planejando cores e formas",
        emoji: "✏️",
        ordem: 2,
        fotoUrl: passoEsboco,
      },
      {
        id: "p3",
        texto: "AMPLIO o desenho numa folha GIGANTE (papel-pardo)",
        emoji: "📄",
        ordem: 3,
        fotoUrl: mapaMural,
      },
      {
        id: "p4",
        texto: "PINTO com tintas coloridas — meu mural está no ar!",
        emoji: "🎨",
        ordem: 4,
        fotoUrl: nosGrafiteUrbano,
      },
  ...
  cena08_voceLe: {
    ...
    trechos: [
      {
        texto: "Andei pelas ruas e vi um enorme",
        palavraDestaque: "grafite",
        corDestaque: "#dc2626",
      },
      {
        texto: "Também vi uma parede inteira com um",
        palavraDestaque: "muralismo",
        corDestaque: "#0284c7",
      },
      {
        texto: "Uma figura repetida foi feita com um",
        palavraDestaque: "estêncil",
        corDestaque: "#7c3aed",
      },
      {
        texto: "Todas essas expressões formam a arte",
        palavraDestaque: "urbana",
        corDestaque: "#4b5563",
      },
  ...
  cena09_minijogo: {
    ...
    variante: "minijogo",
    aurora:
      "🎨 Muro do Beco! Toca em CADA elemento na ordem certa pra criar teu grafite completo antes do tempo acabar.",
    titulo: "🎨 Muro do Beco",
    ...
    itens: [
      {
        emoji: "🎨",
        rotulo: "Grafite",
        descricao: "Arte com spray em muros da cidade.",
        cor: "#dc2626",
        fotoUrl: vocabGrafite,
      },
      {
        emoji: "🏙️",
        rotulo: "Muralismo",
        descricao: "Pintura gigante em prédios públicos.",
        cor: "#0284c7",
        fotoUrl: vocabMuralismo,
      },
      {
        emoji: "🦋",
        rotulo: "Estêncil",
        descricao: "Molde vazado que imprime figuras.",
        cor: "#7c3aed",
        fotoUrl: vocabEstencil,
      },
      {
        emoji: "🏢",
        rotulo: "Arte Urbana",
        descricao: "Toda arte feita na rua.",
        cor: "#4b5563",
        fotoUrl: vocabUrbano,
      },
      {
        emoji: "🖐️",
        rotulo: "Pintura Rupestre",
        descricao: "Primeiro grafite: 30.000 anos atrás.",
        cor: "#b45309",
        fotoUrl: nosRupestre,
      },
      {
        emoji: "🇧🇷",
        rotulo: "Grafite Brasileiro",
        descricao: "Kobra e OSGEMEOS conquistando o mundo.",
        cor: "#facc15",
        fotoUrl: mapaMural,
      },
      {
        emoji: "📖",
        rotulo: "Atlas COMPLETO",
        descricao: "7 páginas restauradas — expedição encerrada!",
        cor: "#7c3aed",
        fotoUrl: mapaMural,
      },
    ],
    falaFinal:
      "PÁGINA 7 do Atlas dos Exploradores DESBLOQUEADA — A Cidade-Galeria! Terminou a expedição do 3º Ano!",
  },
  ...
  cena11_avaliacao: {
    ...
    quiz: {
      ...
      feedback:
        "PERFEITO, Explorador! Há 30.000 anos os humanos já pintavam paredes de cavernas com mãos e bichos. Hoje pintam paredes de prédios com spray. O DESEJO é o mesmo: contar quem somos, o que sentimos, marcar nosso lugar no mundo. A arte urbana é a filha mais nova das pinturas rupestres!",
    },
    missaoFamilia:
