...
export const aula01: AulaArteV1 = {
  ...
  cena01_motivacao: {
    ...
    itens: [
      {
        emoji: "📖",
        rotulo: "Livretos de Cordel (Nordeste)",
        descricao: "Pequenos livros de poesia pendurados num cordão — por isso o nome CORDEL.",
        cor: "#b45309",
        fotoUrl: mapaCordeis,
      },
      {
        emoji: "🪵",
        rotulo: "Matriz de madeira",
        descricao:
          "O artista talha o desenho num pedaço de madeira: o que fica ALTO recebe a tinta.",
        cor: "#78350f",
        fotoUrl: mapaMatriz,
      },
      {
        emoji: "⚫",
        rotulo: "Xilogravura estampada",
        descricao:
          "Aperta a madeira entintada no papel e nasce a GRAVURA — preta, cheia de linhas.",
        cor: "#1f2937",
        fotoUrl: mapaXilogravura,
      },
      {
        emoji: "🔪",
        rotulo: "Goiva: a ferramenta do gravador",
        descricao: "Uma faquinha com ponta em U que escava a madeira — só quem tem prática usa.",
        cor: "#0f766e",
        fotoUrl: mapaGoiva,
      },
    ],
  ...
  cena03_vocabulario: {
    ...
    cards: [
      {
        termo: "Cordel",
        definicao: "Livrinho de poesia popular do Nordeste, com capa em XILOGRAVURA.",
        emoji: "📖",
        cor: "#b45309",
        fotoUrl: vocabCordel,
      },
      {
        termo: "Gravura",
        definicao: "Imagem impressa a partir de uma MATRIZ (madeira, metal, pedra).",
        emoji: "⚫",
        cor: "#1f2937",
      ...
      {
        termo: "Matriz",
        definicao: "A superfície de onde a gravura é IMPRESSA — funciona como carimbo.",
        emoji: "🪵",
        cor: "#78350f",
        fotoUrl: vocabMatriz,
      },
      {
        termo: "Poesia popular",
        definicao: "Versos rimados que contam histórias do povo — heróis, cangaço, festas.",
        emoji: "🎤",
        cor: "#7c3aed",
        fotoUrl: vocabPoesia,
      },
  ...
  cena04_leituraGuiada: {
    tipo: "leituraTintas",
    aurora:
      "Vou te contar como o mestre xilogravador do Nordeste trabalha. Presta atenção na técnica!",
    paragrafos: [
    ...
    pigmentos: [
      {
        nome: "Tinta preta",
        hex: "#111827",
        fonte: "Tinta de impressão à base de óleo",
        emoji: "⚫",
        fotoUrl: mapaXilogravura,
      },
      {
        ...
        hex: "#78350f",
        fonte: "Cedro, cerejeira ou umburana",
        emoji: "🟤",
        fotoUrl: mapaMatriz,
      },
      {
        nome: "Papel jornal bege",
        hex: "#f5deb3",
        fonte: "Papel barato reciclado das gráficas",
        emoji: "📄",
        fotoUrl: vocabCordel,
      },
      {
        nome: "Cinza tipográfico",
        hex: "#4b5563",
        fonte: "Chumbo e antimônio das antigas letras",
        emoji: "🔡",
        fotoUrl: vocabGravura,
      },
    ],
  ...
  cena06_personagensLugar: {
    ...
    animais: [
      {
        nome: "Capa do Cangaceiro (Lampião)",
        emoji: "🤠",
        fotoUrl: mapaXilogravura,
      ...
      {
        nome: "Poeta cordelista com viola",
        emoji: "🎸",
        fotoUrl: vocabPoesia,
      ...
      {
        nome: "Carimbo escolar (gravura moderna)",
        emoji: "🔴",
        fotoUrl: cotidianoCarimbo,
  ...
  cena07_sequencia: {
    ...
    passos: [
      {
        id: "p1",
        texto: "CORTO uma batata ao meio e desenho uma estrela na parte lisa",
        emoji: "🥔",
        ordem: 1,
        fotoUrl: passo1,
      },
      {
        id: "p2",
        texto: "ESCAVO com um palito em volta da estrela, deixando ela em relevo",
        emoji: "✏️",
        ordem: 2,
        fotoUrl: passo2,
      },
      {
        id: "p3",
        texto: "PASSO tinta guache SÓ na estrela alta com um pincel",
        emoji: "🎨",
        ordem: 3,
        fotoUrl: passo3,
      },
      {
        id: "p4",
        texto: "CARIMBO no papel — a estrela aparece impressa!",
        emoji: "⭐",
        ordem: 4,
        fotoUrl: passo4,
      },
  ...
  cena08_voceLe: {
    ...
    trechos: [
      {
        texto: "Na feira do Nordeste vi um varal com livrinhos de",
      ...
      {
        texto: "Contava histórias em versos — pura",
        palavraDestaque: "poesia",
        corDestaque: "#7c3aed",
      },
  ...
  cena09_minijogo: {
    ...
    variante: "minijogo",
    aurora:
      "🪵 Oficina do Gravador! Toca em CADA ferramenta na ordem certa pra imprimir a xilogravura antes do tempo acabar.",
    ...
    falaFinal:
      "Gravura impressa! Agora dá pra fazer 50 iguaizinhas — o cordel está pronto pra viajar.",
  },
    ...
    itens: [
      {
        emoji: "📖",
        rotulo: "Cordel",
        descricao: "Livrinho de poesia pendurado num cordão.",
        cor: "#b45309",
        fotoUrl: vocabCordel,
      },
      {
        emoji: "⚫",
        rotulo: "Gravura",
        descricao: "Imagem impressa a partir de uma matriz.",
        cor: "#1f2937",
        fotoUrl: vocabGravura,
      },
      {
        emoji: "🪵",
        rotulo: "Matriz",
        descricao: "Superfície talhada que funciona como carimbo.",
        cor: "#78350f",
        fotoUrl: vocabMatriz,
      },
      {
        emoji: "🔪",
        rotulo: "Goiva",
        descricao: "Ferramenta em U pra escavar a madeira.",
        cor: "#0f766e",
        fotoUrl: mapaGoiva,
      },
      {
        emoji: "🎤",
        rotulo: "Poesia popular",
        descricao: "Versos rimados que contam histórias do povo.",
        cor: "#7c3aed",
        fotoUrl: vocabPoesia,
      },
      {
        emoji: "🔴",
        rotulo: "Carimbo",
        descricao: "Uma xilogravura em miniatura do dia a dia.",
        cor: "#dc2626",
        fotoUrl: cotidianoCarimbo,
      },
      {
        emoji: "🤠",
        rotulo: "Lampião no cordel",
        descricao: "Herói popular do Sertão gravado em madeira.",
        cor: "#1f2937",
        fotoUrl: mapaXilogravura,
      },
    ],
  ...
  cena11_avaliacao: {
    ...
    quiz: {
      ...
      feedback:
        "Excelente! Xilo = madeira. É a técnica de gravar uma matriz de madeira e imprimir várias cópias — usada no cordel nordestino há mais de 100 anos.",
    },
    missaoFamilia:
