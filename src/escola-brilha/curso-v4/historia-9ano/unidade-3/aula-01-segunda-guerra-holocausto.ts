...
export const aula01: AulaGeoV1 = {
  ...
  cena03_vocabulario: {
    ...
    instrucao: "",
    cadernos: [
      { id: "eix", capa: "Eixo × Aliados", emoji: "⚔️", cor: "from-slate-700 to-slate-900", fotoUrl: imgHiroshima, conteudo: "EIXO: Alemanha nazista + Itália fascista + Japão imperial. ALIADOS: Reino Unido, EUA, URSS, França Livre, Brasil, China e outros. Os Aliados venceram em 1945.", exemplo: "Exemplo: o Brasil enviou a FEB (Força Expedicionária Brasileira) para lutar na Itália contra os fascistas em 1944-45." },
      { id: "bli", capa: "Blitzkrieg", emoji: "⚡", cor: "from-amber-700 to-slate-900", fotoUrl: imgCampo, conteudo: "BLITZKRIEG ('guerra-relâmpago') foi a tática alemã: aviões + tanques + infantaria mecanizada atacando em velocidade máxima. Derrotou França em 6 semanas em 1940.", exemplo: "Exemplo: em 1940 Paris caiu em 40 dias — algo impensável na 1ª Guerra, quando avanços eram medidos em metros." },
      { id: "hol", capa: "Holocausto", emoji: "🕯️", cor: "from-slate-700 to-slate-900", fotoUrl: imgGuerra, conteudo: "HOLOCAUSTO (ou SHOAH) foi o extermínio sistemático de cerca de 6 milhões de judeus e mais 5 milhões de ciganos, homossexuais, deficientes, poloneses e opositores, em campos de concentração e extermínio nazistas.", exemplo: "Exemplo: Auschwitz-Birkenau, na Polônia, matou mais de 1 milhão de pessoas em câmaras de gás. Hoje é um memorial contra o esquecimento." },
      { id: "atom", capa: "Bomba Atômica", emoji: "☢️", cor: "from-cyan-700 to-slate-900", fotoUrl: imgHolo, conteudo: "BOMBA ATÔMICA foi a arma nuclear lançada pelos EUA em HIROSHIMA (6/agosto/1945) e NAGASAKI (9/agosto/1945). Cerca de 200 mil mortes imediatas, mais milhares por radiação. Japão se rendeu em setembro.", exemplo: "Exemplo: em Hiroshima, uma única bomba destruiu 90% da cidade. Foi o momento em que a humanidade percebeu que podia se autodestruir." },
    ],
  ...
  cena04_leituraGuiada: {
    ...
    mapaUrl: imgNormandia,
    pontos: [
      { id: "eur", x: 25, y: 30, emoji: "🇪🇺", cor: "from-teal-700 to-slate-900", fotoUrl: imgHiroshima, titulo: "FRENTE EUROPEIA", texto: "Alemanha invade Polônia (1939), França (1940), tenta invadir URSS (1941–44). Vira quando Stalingrado resiste (1943). Berlim cai em maio/1945." },
      { id: "pac", x: 55, y: 55, emoji: "🇯🇵", cor: "from-amber-700 to-slate-900", fotoUrl: imgCampo, titulo: "FRENTE DO PACÍFICO", texto: "Japão ataca Pearl Harbor (dez/1941) e arrasta EUA à guerra. Batalhas ilha por ilha até Hiroshima/Nagasaki em agosto/1945." },
  ...
  cena07_sequencia: {
    ...
    paradas: [
      ...
      { id: "pea", emoji: "🇯🇵", rotulo: "2. Pearl Harbor (1941)", fotoUrl: imgHolo, descricao: "Japão ataca; EUA entram na guerra." },
      { id: "dday", emoji: "🌊", rotulo: "3. Dia D — Normandia (1944)", fotoUrl: imgNormandia, descricao: "Aliados desembarcam na França." },
      { id: "hir", emoji: "☢️", rotulo: "4. Hiroshima (1945)", fotoUrl: imgHiroshima, descricao: "Bomba atômica; Japão se rende." },
    ],
  ...
  cena11_avaliacao: {
    ...
    selo: { nome: "Nó 3 da Teia", subtitulo: "2ª Guerra e Direitos Humanos", emoji: "🕯️", cor: "from-slate-500 to-slate-900", fotoUrl: imgGuerra },
