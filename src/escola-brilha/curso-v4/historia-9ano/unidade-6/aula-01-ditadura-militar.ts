...
export const aula01: AulaGeoV1 = {
  ...
  cena04_leituraGuiada: {
    ...
    mapaUrl: imgDir,
    pontos: [
      { id: "f1", x: 25, y: 30, emoji: "🎖️", cor: "from-teal-700 to-slate-900", fotoUrl: imgDir, titulo: "1964–68: INSTALAÇÃO", texto: "Golpe, cassações, atos institucionais. Milagre econômico começa. Ainda há alguma imprensa e oposição." },
      { id: "f2", x: 55, y: 55, emoji: "⛓️", cor: "from-slate-700 to-slate-900", fotoUrl: imgRes, titulo: "1968–74: ANOS DE CHUMBO", texto: "AI-5, censura total, tortura sistemática, guerrilha do Araguaia. Fase mais violenta." },
  ...
  cena07_sequencia: {
    ...
    paradas: [
      ...
      { id: "ai5", emoji: "📵", rotulo: "2. AI-5 (1968)", fotoUrl: imgDir, descricao: "Censura total e anos de chumbo." },
      { id: "dir", emoji: "✊", rotulo: "3. Diretas Já (1984)", fotoUrl: imgDir, descricao: "Milhões nas ruas por eleições diretas." },
      { id: "co", emoji: "📜", rotulo: "4. Constituição (1988)", fotoUrl: imgDir, descricao: "'Constituição Cidadã' sela a democracia." },
    ],
