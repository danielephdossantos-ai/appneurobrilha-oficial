...
export const aula01: AulaGeoV1 = {
  ...
  cena04_leituraGuiada: {
    ...
    mapaUrl: imgMuro,
    pontos: [
      { id: "arm", x: 25, y: 30, emoji: "☢️", cor: "from-slate-700 to-slate-900", fotoUrl: imgMuro, titulo: "CORRIDA NUCLEAR", texto: "EUA e URSS acumularam dezenas de milhares de ogivas nucleares. Doutrina MAD ('Destruição Mútua Assegurada') — se um atacar, ambos morrem." },
      { id: "esp", x: 55, y: 55, emoji: "🚀", cor: "from-amber-700 to-slate-900", fotoUrl: imgLua, titulo: "CORRIDA ESPACIAL", texto: "Sputnik (URSS, 1957) → Gagárin no espaço (URSS, 1961) → Armstrong na Lua (EUA, 1969). Ciência virou propaganda ideológica." },
  ...
  cena07_sequencia: {
    ...
    paradas: [
      ...
      { id: "muro", emoji: "🧱", rotulo: "2. Muro de Berlim construído (1961)", fotoUrl: imgMuro, descricao: "Divide Berlim em duas." },
      { id: "lua", emoji: "🌕", rotulo: "3. Homem na Lua (1969)", fotoUrl: imgLua, descricao: "EUA vencem a corrida espacial." },
      { id: "qm", emoji: "🕊️", rotulo: "4. Queda do Muro (1989)", fotoUrl: imgMuro, descricao: "Prenúncio do fim da URSS (1991)." },
    ],
