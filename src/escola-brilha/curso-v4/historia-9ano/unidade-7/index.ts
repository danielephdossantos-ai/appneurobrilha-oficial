...
import { aula08 } from "./aula-08-terrorismo-migracoes";
import { aula09 } from "./aula-09-diversidades";
...
export const unidade7: UnidadeGeoV1 = {
  ...
  corTema: "#0891b2",
  aulas: [aula01, aula02, aula03, aula04, aula05, aula06, aula07, aula08, aula09],
};
