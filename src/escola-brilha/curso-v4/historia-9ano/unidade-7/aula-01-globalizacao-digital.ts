...
export const aula01: AulaGeoV1 = {
  ...
  cena04_leituraGuiada: {
    ...
    mapaUrl: imgClima,
    pontos: [
      { id: "des", x: 25, y: 30, emoji: "🌡️", cor: "from-amber-700 to-slate-900", fotoUrl: imgClima, titulo: "MUDANÇAS CLIMÁTICAS", texto: "Aquecimento global, desmatamento, poluição. Ameaça direta às próximas gerações. Metas do Acordo de Paris (2015) e da COP30 (Belém, 2025)." },
      { id: "des2", x: 55, y: 55, emoji: "💰", cor: "from-cyan-700 to-slate-900", fotoUrl: imgDig, titulo: "DESIGUALDADE", texto: "Os 1% mais ricos concentram quase metade da riqueza do mundo. No Brasil, os 10% mais ricos ficam com mais da metade da renda. Debate central do século XXI." },
  ...
  cena07_sequencia: {
    ...
    paradas: [
      ...
      { id: "ip", emoji: "📱", rotulo: "2. iPhone (2007)", fotoUrl: imgDig, descricao: "Redes sociais viram cotidiano." },
      { id: "co", emoji: "😷", rotulo: "3. Pandemia COVID (2020)", fotoUrl: imgDig, descricao: "Mundo parado por semanas." },
      { id: "ia", emoji: "🤖", rotulo: "4. IA generativa (2022–25)", fotoUrl: imgDig, descricao: "ChatGPT e afins mudam trabalho e escola." },
    ],
