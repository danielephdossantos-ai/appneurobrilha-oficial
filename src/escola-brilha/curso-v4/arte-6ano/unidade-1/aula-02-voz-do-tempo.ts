...
export const aula02: AulaArteV1 = {
  ...
  cena01_motivacao: {
    ...
    itens: [
      {
        emoji: "🔥",
        rotulo: "Cantos rituais Krahô",
        descricao:
          "Etnia indígena do Tocantins. Os anciãos cantam narrativas ao redor da fogueira. Se param de cantar, aquela arte desaparece PRA SEMPRE — não existe partitura.",
        cor: "#dc2626",
        fotoUrl: cantoKraho,
      },
      {
        emoji: "👴",
        rotulo: "Anciãos = bibliotecas vivas",
        descricao:
          "Os mais velhos guardam regras, ciência, receitas e memória da comunidade INTEIRA na cabeça. Cada morte de um ancião é um arquivo que queima.",
        cor: "#7c2d12",
        fotoUrl: ancianoNarrando,
      },
      {
        emoji: "🎭",
        rotulo: "Patrimônio Imaterial",
        descricao:
          "Festas populares, danças, técnicas de fazer comida ou artesanato. A UNESCO protege esses saberes porque são a IDENTIDADE de um povo — mas não cabem em caixa.",
        cor: "#f59e0b",
        fotoUrl: patrimonio,
      },
      {
        emoji: "🌊",
        rotulo: "Lenda ribeirinha ameaçada",
        descricao:
          "Uma comunidade tem uma lenda sobre o surgimento do rio, contada só na voz. Mineradora chega, muda o curso do rio, jovens migram. A lenda pode ser PERDIDA.",
        cor: "#0ea5e9",
        fotoUrl: ribeirinha,
      },
    ],
    falaFinal:
      "Sua missão nesta página: aprender a CAPTURAR o som do tempo antes que ele silencie.",
  },
  ...
  cena02_previsao: {
    ...
    perguntas: [
      {
        pergunta:
          "Por que uma fonte ORAL é considerada mais frágil que uma fonte visual ou material?",
        fotoUrl: ancianoNarrando,
        alternativas: [
          {
            texto: "Ela só existe no momento em que é dita — se ninguém repete, desaparece",
            correta: true,
          },
        ...
        feedbackAcerto:
          "Perfeito! Fonte oral é IMATERIAL: sem transmissão contínua, some. Já uma pintura na rocha atravessa 30 mil anos parada.",
        feedbackErro:
          "Não é sobre esquecimento. É sobre DEPENDÊNCIA da transmissão viva — sem alguém contando, a fonte não existe mais.",
      },
      {
        pergunta:
          "Um canto ritual indígena, uma dança de festa popular e uma receita passada por gerações são exemplos de…",
        fotoUrl: patrimonio,
        alternativas: [
          {
            texto: "Patrimônio Imaterial — saberes que não cabem numa caixa de museu",
            correta: true,
          },
        ...
        feedbackAcerto:
          "Correto! A UNESCO criou essa categoria justamente pra proteger o que é VIVIDO, não guardado.",
        feedbackErro:
          "Cuidado: o critério não é ter corpo físico. É se o SABER está no objeto (material) ou na PRÁTICA viva (imaterial).",
      },
      {
        pergunta:
          "Uma comunidade ribeirinha tem uma lenda contada só oralmente. A mineradora muda o curso do rio e os jovens migram. Qual é o RISCO REAL?",
        fotoUrl: ribeirinha,
        alternativas: [
          {
            texto: "A lenda pode desaparecer, porque não há mais quem a conte às próximas gerações",
            correta: true,
          },
        ...
        feedbackAcerto:
          "Exato! Sem contexto e sem contadores, a fonte oral SILENCIA. Por isso etno-historiadores gravam e transcrevem antes que suma.",
        feedbackErro:
          "Lendas NÃO se mantêm sozinhas. Cultura oral precisa de VOZ humana viva — se corta o elo, corta a memória.",
      },
    ],
  },
    ...
    cards: [
      {
        termo: "Fonte Oral",
        definicao:
          "Relatos falados, entrevistas, lendas de geração em geração, cantos rituais. Registra a história do ponto de vista de quem VIVEU.",
        emoji: "🎙️",
        cor: "#dc2626",
        fotoUrl: ancianoNarrando,
      },
      {
        ...
        definicao:
          "Arte que não cabe em caixa: festas, danças, técnicas culinárias, artesanato. A UNESCO protege como identidade de um povo.",
        emoji: "🎭",
        cor: "#f59e0b",
        fotoUrl: patrimonio,
      },
      {
        termo: "Tradição Oral",
        definicao:
          "Sistema em que uma cultura passa conhecimento SEM escrita — pai pra filho, ancião pra jovem. Sustenta impérios inteiros por séculos.",
        emoji: "🔥",
        cor: "#7c2d12",
        fotoUrl: cantoKraho,
      },
      {
        termo: "Etno-historiador",
        definicao:
          "Cientista que estuda a cultura de um povo através dos RELATOS orais. Grava, transcreve e cruza com fontes materiais.",
        emoji: "🕵️",
        cor: "#0ea5e9",
  ...
  cena04_leituraGuiada: {
    ...
    pigmentos: [
      {
        nome: "Canto ritual Krahô",
        hex: "#dc2626",
        fonte: "Tradição oral indígena viva do Tocantins",
        emoji: "🔥",
        fotoUrl: cantoKraho,
      },
      {
        nome: "Receita da avó",
        hex: "#f59e0b",
        fonte: "Patrimônio imaterial da família",
        emoji: "🥣",
        fotoUrl: avoCozinha,
      },
      {
        nome: "Gravador digital",
        hex: "#7c3aed",
        fonte: "Ferramenta do etno-historiador moderno",
        emoji: "🎙️",
        fotoUrl: gravador,
      },
      {
        ...
        hex: "#0ea5e9",
        fonte: "Onde a fala vira transcrição analisável",
        emoji: "📓",
        fotoUrl: cadernoNotas,
      },
    ],
  },
  ...
  cena05_compreensao: {
    ...
    perguntas: [
      {
        pergunta:
          "Um historiador acha uma CARTA escrita por um soldado em 1910 e grava uma ENTREVISTA em áudio com a filha desse soldado em 2026. Qual é a diferença TÉCNICA entre as duas?",
        fotoUrl: carta1910,
        alternativas: [
          {
            texto:
              "A carta é fonte documental DIRETA do momento; a entrevista é fonte oral baseada na memória transmitida",
            correta: true,
          },
        ...
        feedbackAcerto:
          "Excelente! A carta capturou o momento EM 1910. A entrevista é MEMÓRIA de segunda mão — outra camada da verdade, igualmente valiosa mas diferente.",
        feedbackErro:
          "As duas NÃO dizem a mesma coisa. Uma é registro do fato; a outra é lembrança sobre o fato — cada uma revela uma camada.",
      },
      {
        pergunta:
          "Por que o etno-historiador NÃO deve confiar SÓ na fonte oral pra reconstruir uma cultura?",
        fotoUrl: etnoHistoriador,
        alternativas: [
          {
            texto:
              "Porque relatos orais podem mudar com o tempo — é preciso CRUZAR com fontes materiais e visuais",
            correta: true,
          },
        ...
        feedbackAcerto:
          "Perfeito! Cruzar fontes = método científico. Nunca confiar em UMA voz só, mesmo sendo verdadeira.",
        feedbackErro:
          "Zero desrespeito com os anciãos — eles são bibliotecas vivas. A questão é MÉTODO: toda fonte precisa ser CRUZADA com outras.",
      },
      {
        pergunta:
          "Uma comunidade perde seus anciãos sem que ninguém grave os cantos rituais. O que acontece com esse Patrimônio Imaterial?",
        fotoUrl: cantoKraho,
        alternativas: [
          {
            texto: "Ele desaparece pra sempre — não existe backup fora da voz humana viva",
            correta: true,
          },
        ...
        feedbackAcerto:
          "Trágico e verdadeiro. Por isso etno-historiadores correm contra o tempo pra gravar e transcrever.",
        feedbackErro:
          "Nada de DNA cultural automático 😅. Sem transmissão viva (ou registro), o saber some COMPLETAMENTE.",
      },
    ],
  },
  ...
  cena06_personagensLugar: {
    ...
    animais: [
      {
        nome: "Canto ritual indígena Krahô",
        emoji: "🔥",
        fotoUrl: cantoKraho,
      ...
      {
        nome: "Leitura de um decreto real do rei",
        emoji: "📜",
        fotoUrl: decreto,
        ...
        falaAcerto:
          "Correto! Decreto vem de documento escrito pelo poder oficial — Fonte Documental.",
      },
    ],
  },
  ...
  cena07_sequencia: {
    ...
    passos: [
      {
        id: "p1",
        texto: "ESCOLHO uma pessoa mais velha da família (pais, avós, tios, vizinho)",
        emoji: "👴",
        ordem: 1,
        fotoUrl: ancianoNarrando,
      },
      {
        id: "p2",
        texto: "PREPARO duas perguntas-chave sobre a infância ou uma tradição da pessoa",
        emoji: "❓",
        ordem: 2,
        fotoUrl: cadernoNotas,
      },
      {
        id: "p3",
        texto: "PEÇO AUTORIZAÇÃO pra gravar o áudio (respeito é regra nº 1)",
        emoji: "🙏",
        ordem: 3,
        fotoUrl: avoCozinha,
      },
      {
        id: "p4",
        texto: "GRAVO o relato ou anoto as palavras EXATAS que a pessoa usar",
        emoji: "🎙️",
        ordem: 4,
        fotoUrl: passoGravar,
      },
      {
        id: "p5",
        texto: "ANALISO em 5 linhas o que o relato revela que NENHUM objeto ou foto mostraria",
        emoji: "📝",
        ordem: 5,
        fotoUrl: ondaSonora,
      },
    ...
    falaAcerto:
      "Você acabou de virar um ETNO-HISTORIADOR — capturou memória viva antes que virasse silêncio!",
  },
  ...
  cena08_voceLe: {
    ...
    trechos: [
      {
        texto: "Sou etno-historiador. Estudo o passado através das",
        palavraDestaque: "fontes orais",
        corDestaque: "#dc2626",
      },
      ...
      {
        texto:
          "Por isso GRAVO, TRANSCREVO e sempre CRUZO com fontes materiais. A memória viva é a arte mais frágil do mundo.",
      },
    ],
  },
  ...
  cena09_minijogo: {
    ...
    variante: "minijogo",
    aurora:
      "🎯 Gravador de Frequências! Escave TODAS as fontes orais e imateriais antes que o silêncio chegue.",
    ...
    itens: [
      {
        ...
        rotulo: "Fonte Oral",
        descricao:
          "Relatos falados, entrevistas, lendas, cantos rituais. História do ponto de vista de quem VIVEU.",
        cor: "#dc2626",
        fotoUrl: ancianoNarrando,
      },
      {
        ...
        rotulo: "Patrimônio Imaterial",
        descricao:
          "Festas, danças, técnicas de comida e artesanato. Protegido pela UNESCO como identidade viva.",
        cor: "#f59e0b",
        fotoUrl: patrimonio,
      },
      {
        emoji: "🔥",
        rotulo: "Tradição Oral",
        descricao:
          "Cultura sem escrita, transmitida de geração em geração pela VOZ. Frágil mas poderosa.",
        cor: "#7c2d12",
        fotoUrl: cantoKraho,
      },
      {
        emoji: "🕵️",
        rotulo: "Etno-historiador",
        descricao: "Cientista que grava, transcreve e cruza fontes orais com materiais e visuais.",
        cor: "#0ea5e9",
        fotoUrl: etnoHistoriador,
      },
      {
        emoji: "📜",
        rotulo: "Cruzar as fontes",
        descricao:
          "Nunca confiar em UMA voz só. Oral + material + visual + documental = várias camadas da verdade.",
        cor: "#1e3a8a",
        fotoUrl: decreto,
      },
      {
        emoji: "🌊",
        rotulo: "Risco do silêncio",
        descricao:
          "Sem transmissão viva ou registro, o Patrimônio Imaterial desaparece PRA SEMPRE.",
        cor: "#0ea5e9",
        fotoUrl: ribeirinha,
      },
      {
        emoji: "🔮",
        rotulo: "Amuleto do Eco",
        descricao:
          "Sua recompensa: desbloqueia os arquivos de áudio ocultos do Códice e a Linha do Tempo Sonora.",
        cor: "#f59e0b",
        fotoUrl: amuletoEco,
      },
      {
        emoji: "🌐",
        rotulo: "Linha do Tempo Sonora",
        descricao: "Mapa global das vozes humanas atravessando as eras — sua página restaurada.",
        cor: "#a16207",
        fotoUrl: linhaSonora,
      },
    ],
    falaFinal:
      "Segunda página do Códice dos Impérios Perdidos RESTAURADA — Linha do Tempo Sonora desbloqueada!",
  },
  ...
  cena11_avaliacao: {
    ...
    quiz: {
      pergunta:
        "Um historiador encontra uma CARTA escrita por um soldado em 1910 e grava uma ENTREVISTA em áudio com a filha desse soldado em 2026. Qual é a diferença TÉCNICA entre as duas fontes na análise da história?",
      alternativas: [
        {
          texto:
            "O diário/carta é fonte documental DIRETA do momento do fato; a entrevista é fonte oral baseada na MEMÓRIA e na transmissão familiar",
          correta: true,
        },
      ...
      feedback:
        "Perfeito! A carta capturou o momento EM 1910 — testemunho direto. A entrevista de 2026 é memória de SEGUNDA mão, filtrada pela família. As duas revelam camadas DIFERENTES da mesma história — o etno-historiador CRUZA as duas pra descobrir a verdade completa.",
    },
    missaoFamilia:
