...
export const aula01: AulaGeoV1 = {
  ...
  cena02_previsao: {
    ...
    opcoes: [
      ...
      { id: "continua", titulo: "CONTINUA IGUAL", subtitulo: "sem vibração", emoji: "▶️", cor: "from-blue-500 to-indigo-700" },
    ],
    respostaCerta: "para",
  ...
  cena08_voceLe: {
    ...
    paragrafos: [
      ...
      { id: "p3", texto: "Dentro do ouvido, uma membrana chamada TÍMPANO vibra. Outras estruturas transformam essa vibração em sinais que o cérebro interpreta como som. Alterações auditivas têm causas e intensidades diferentes.",
