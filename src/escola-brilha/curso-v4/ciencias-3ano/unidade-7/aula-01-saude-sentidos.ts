...
export const aula01: AulaGeoV1 = {
  ...
  cena02_previsao: {
    ...
    opcoes: [
      ...
      { id: "dano", titulo: "DANOS À AUDIÇÃO", subtitulo: "pode prejudicar a capacidade de ouvir", emoji: "🚨", cor: "from-red-500 to-rose-700" },
      { id: "melhora", titulo: "MELHORA O OUVIDO", subtitulo: "vira super-audição", emoji: "🦸", cor: "from-yellow-500 to-amber-700" },
      { id: "sem-efeito", titulo: "NÃO TEM EFEITO", subtitulo: "o ouvido não muda", emoji: "➖", cor: "from-blue-500 to-indigo-700" },
    ],
    respostaCerta: "dano",
  ...
  cena04_leituraGuiada: {
    ...
    pontos: [
      ...
      { id: "luz", x: 80, y: 30, emoji: "💡", cor: "from-yellow-500 to-amber-700", titulo: "Iluminação confortável", texto: "Use iluminação suficiente e ajuste o brilho da tela para evitar desconforto visual.", fotoUrl: oculosImg },
    ...
    perguntas: [
      ...
      { id: "q2", pergunta: "Qual atitude PROTEGE a audição?", fotoUrl: foneImg,
        cards: [
          ...
          { id: "b", emoji: "🔉", titulo: "Usar volume confortável e fazer pausas", cor: "from-emerald-500 to-green-700" },
  ...
  cena09_minijogo: {
    ...
    rodadas: [
      { id: "r1", municipioA: { nome: "Volume muito alto", emoji: "🔊", cor: "from-red-500 to-rose-700" }, municipioB: { nome: "Sem pausas", emoji: "🎧", cor: "from-red-500 to-rose-700" }, contexto: "Uso prolongado de fones em volume muito alto.", pecaCertaId: "prej", fotoUrl: foneImg, feedbackAcerto: "PREJUDICIAL. Pode danificar a audição.", feedbackErro: "Som intenso por muito tempo pode prejudicar a audição." },
