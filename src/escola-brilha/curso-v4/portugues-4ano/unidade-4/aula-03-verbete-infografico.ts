...
export const aula03: AulaPortuguesV4 = {
  ...
  momento02_previsao: {
    ...
    bloco: {
      ...
      pergunta:
        "Qual gênero organiza a informação em ETAPAS, usando imagem e texto curto lado a lado?",
      hipoteses: [
  ...
  momento03_vocabulario: {
    ...
    cards: [
      ...
      },
      {
        ...
        exemplo:
          "O infográfico mostrou, em 4 etapas com desenhos, como a abelha poliniza uma flor.",
        imagemUrl: mapa,
      },
      {
        palavra: "polinização",
    ...
    blocos: [
      {
        ...
        exemplos: [
          {
            palavra: "'Abelha: inseto que vive em colmeias, produz mel e poliniza flores.'",
            destaque: "definição objetiva",
            motivo: "Diz o que a abelha é, sem opinar se é boa ou ruim.",
          },
          {
            palavra: "'Rio: curso de água natural que corre até o mar, lago ou outro rio.'",
            destaque: "curso de água",
            motivo: "Define o termo com características claras.",
          },
          {
            palavra: "'Vulcão: montanha com abertura por onde sai magma do interior da Terra.'",
            destaque: "montanha... magma",
            motivo: "Explica o que é, sem contar uma história.",
          },
        ],
        desafios: [
          {
            ...
            opcoes: [
              "'Borboleta: inseto com asas coloridas, que passa por metamorfose.'",
              "'Nossa, que borboleta linda voou aqui!'",
              "'Era uma vez uma borboleta muito curiosa...'",
            ],
            correta: 0,
          ...
          },
          {
            ...
            opcoes: [
              "De forma objetiva, sem opinião pessoal",
              "Com muita opinião do autor",
              "Como uma história de aventura",
            ],
            correta: 0,
          ...
          {
            molde:
              "'A abelha é um inseto maravilhoso que eu adoro.' Essa frase NÃO é um bom verbete porque: _",
            opcoes: [
              "Traz opinião pessoal ('eu adoro')",
              "É curta demais",
              "Usa a palavra 'inseto'",
            ],
            correta: 0,
      ...
      },
      {
        ...
        exemplos: [
          {
            palavra:
              "1) Abelha pousa na flor. 2) Pólen gruda nas patas. 3) Abelha voa para outra flor.",
            destaque: "etapas numeradas",
            motivo: "Mostra o processo de polinização passo a passo.",
          },
          {
            palavra: "Setas ligando desenho do sol → nuvem → chuva.",
            destaque: "setas",
            motivo: "Indica a ordem das etapas do ciclo da água.",
          },
          {
            palavra: "Ícones pequenos ao lado de cada frase curta.",
            destaque: "ícones + texto curto",
            motivo: "Combina imagem e texto para facilitar o entendimento.",
          },
        ],
        desafios: [
          {
            ...
            opcoes: [
              "Um processo em etapas, com imagens e texto curto",
              "Uma definição objetiva de uma palavra",
              "Uma carta de opinião",
            ],
            correta: 0,
            feedbackErro:
              "Infográfico organiza etapas com apoio visual — diferente do verbete, que define uma palavra.",
          },
          {
          ...
          {
            molde:
              "Qual gênero usa MAIS imagem combinada a texto curto para mostrar um processo? _",
            opcoes: ["Infográfico", "Verbete", "Carta de leitor"],
            correta: 0,
            feedbackErro:
              "O infográfico é o gênero que mais combina imagem e texto curto em etapas.",
          },
        ],
      },
    ],
    ...
    perguntas: [
      {
        ...
        correta: 1,
        feedbackAcerto:
          "📋 Isso! O verbete diz que elas vivem em grupos organizados chamados COLMEIAS.",
        feedbackErro:
      ...
      },
      {
        ...
        correta: 1,
        feedbackAcerto:
          "📋 Correto! A primeira etapa é a abelha pousar na flor para coletar néctar.",
  ...
  momento06_personagensCenario: {
    instrucao:
      "Verbete e infográfico não têm 'personagens' como uma história — eles organizam SERES e PROCESSOS. Vamos identificar.",
    perguntas: [
      {
        ...
        correta: 0,
        feedbackAcerto:
          "📋 Isso! O verbete define o assunto A ABELHA, com suas características reais.",
        feedbackErro:
      ...
      },
      {
        ...
        opcoes: [
          ...
          "A polinização das flores pelas abelhas",
  ...
  momento07_sequencia: {
    ...
    bloco: {
      ...
      itens: [
        ...
        {
          id: "s3",
          texto: "A abelha voa até outra flor e o pólen se solta, gerando sementes.",
          imagemUrl: girassol,
        },
      ],
      ordemCerta: ["s1", "s2", "s3"],
    ...
    perguntas: [
      {
        ...
        feedbackOpcoes: [
          null,
          "❌ “Uma carta pessoal” não é a resposta. Verbete não é carta nem anúncio — ele DEFINE algo, como num dicionário.",
          "❌ “Um anúncio publicitário” não é a resposta. Verbete não é carta nem anúncio — ele DEFINE algo, como num dicionário.",
      ...
      },
      {
        ...
        feedbackOpcoes: [
          null,
          "❌ “Apenas números, sem nenhuma imagem” não é a resposta. Pense no que aparece junto no infográfico: imagens E frases curtas.",
          "❌ “Apenas desenhos, sem nenhum texto” não é a resposta. Pense no que aparece junto no infográfico: imagens E frases curtas.",
      ...
      },
      {
        ...
        correta: 0,
        feedbackAcerto:
          "📋 Isso! Polinização é o transporte do pólen entre flores, gerando sementes e frutos.",
        feedbackErro:
          "Releia o verbete de 'polinização' no momento 3 — o que acontece com o pólen?",
        feedbackOpcoes: [
          null,
          "❌ “Quando a abelha dorme dentro da colmeia” não é a resposta. Releia o verbete de 'polinização' no momento 3 — o que acontece com o pólen?",
          "❌ “Quando uma flor muda de cor” não é a resposta. Releia o verbete de 'polinização' no momento 3 — o que acontece com o pólen?",
      ...
      },
      {
        ...
        opcoes: [
          "A lagarta nasce",
          "A borboleta já nasce adulta",
          "O casulo se forma primeiro",
          "A flor produz frutos",
        ],
        correta: 0,
        ...
        feedbackOpcoes: [
          null,
          "❌ “A borboleta já nasce adulta” não é a resposta. Releia a ordem das etapas: o que vem na etapa 2, logo depois do ovo?",
          "❌ “O casulo se forma primeiro” não é a resposta. Releia a ordem das etapas: o que vem na etapa 2, logo depois do ovo?",
      ...
      },
      {
        ...
        feedbackErro:
          "Nenhum dos dois inventa história nem rima — os dois ORGANIZAM informação real.",
        feedbackOpcoes: [
          null,
          "❌ “Sempre têm rima” não é a resposta. Nenhum dos dois inventa história nem rima — os dois ORGANIZAM informação real.",
          "❌ “Sempre contam uma opinião pessoal” não é a resposta. Nenhum dos dois inventa história nem rima — os dois ORGANIZAM informação real.",
  ...
  momento11_missaoFamilia: {
    ...
    registro:
      "📝 O verbete e o infográfico feitos à mão (ou digitados), para trazer na próxima aula.",
  },
