...
export const aula01: AulaPortuguesV4 = {
  ...
  momento_ensinoVisual: {
    ...
    instrucao: "Veja como a reportagem usa fontes e dados para investigar mais fundo que uma notícia.",
    blocos: [
      {
        ...
        exemplos: [
          { palavra: "Notícia: 'Ponte é reconstruída no bairro.'", destaque: "curta", motivo: "Informa o fato rapidamente, sem investigar." },
          { palavra: "Reportagem com entrevista da engenheira e do morador.", destaque: "fontes", motivo: "Ouve vozes diferentes para aprofundar o assunto." },
          { palavra: "'Passam 500 carros por dia pela ponte.'", destaque: "dado", motivo: "Número que dá credibilidade à reportagem." },
        ],
        desafios: [
          {
            molde: "Qual texto é uma REPORTAGEM? _",
            opcoes: ["O que traz entrevistas e dados sobre o fato", "O que só informa o fato em uma frase", "O que é sempre inventado"],
            correta: 0,
            feedbackErro: "Reportagem investiga com fontes e dados; notícia só informa rapidamente.",
          },
          {
            molde: "'A engenheira Ana Paula afirmou que a obra termina em 60 dias.' Isso é um exemplo de: _",
          ...
          },
          {
            ...
            opcoes: ["Para mostrar pontos de vista diferentes e ser mais confiável", "Porque é obrigatório ter três pessoas", "Porque uma só fonte sempre mente"],
            correta: 0,
            feedbackErro: "Ouvir várias fontes garante uma visão mais completa e confiável do fato.",
          },
        ],
      },
      {
        ...
        exemplos: [
          { palavra: "'A obra começou em março de 2023.'", destaque: "março de 2023", motivo: "Data precisa que comprova o início da obra." },
          { palavra: "'Passam 500 carros por dia pela ponte.'", destaque: "500 carros", motivo: "Número que mostra a importância da ponte." },
          { palavra: "'A reforma custou 2 milhões de reais.'", destaque: "2 milhões", motivo: "Dado financeiro que dá dimensão ao fato." },
        ],
        desafios: [
          {
            molde: "Qual frase traz um DADO? _",
            opcoes: ["A ponte tem 40 metros de comprimento", "A ponte é muito bonita", "Todos gostam da nova ponte"],
            correta: 0,
          ...
          },
          {
            ...
            opcoes: ["Porque mostram que a informação foi apurada com precisão", "Porque deixam o texto mais bonito", "Porque substituem as fontes"],
            correta: 0,
          ...
          },
          {
            ...
            opcoes: ["Um dado com fonte identificada", "Uma opinião pessoal", "Um exagero sem prova"],
            correta: 0,
            frase: "Segundo dados da prefeitura, 500 carros passam pela ponte por dia.",
            feedbackErro: "O número vem de uma fonte (a prefeitura), o que reforça a credibilidade.",
          },
        ],
      },
    ],
