...
export const aula1: AulaPortuguesV4 = {
  ...
  momento02_previsao: {
    ...
    bloco: {
      ...
      hipoteses: [
        {
          texto: "Qual sílaba de cada palavra soa mais forte, e quando isso pede acento.",
          imagemUrl: estrela,
        },
  ...
  momento03_vocabulario: {
    ...
    cards: [
      ...
      {
        palavra: "oxítona",
        explicacao: "Palavra cuja sílaba tônica é a ÚLTIMA. Ex.: café, jacaré, paletó.",
    ...
    perguntas: [
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Oxítona”. Oxítona = força na última sílaba, como em CAFÉ. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Sempre leva acento”. Toda proparoxítona é acentuada, sem exceção. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Paroxítona”. O texto diz que a paroxítona é o tipo mais comum. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
    ...
    perguntas: [
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “sílaba tônica” — é a sílaba pronunciada com MAIS FORÇA dentro da palavra. Em 'CA-FÉ', o pedaço 'FÉ' é mais forte. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “No diário de bordo da expedição”. A descoberta foi registrada no diário de bordo. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “sílaba tônica” — é a sílaba pronunciada com MAIS FORÇA dentro da palavra. Em 'CA-FÉ', o pedaço 'FÉ' é mais forte. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “A bússola”. A bússola aponta a sílaba mais forte da palavra. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
  ...
  momento07_sequencia: {
    ...
    bloco: {
      ...
      itens: [
        ...
        {
          id: "p2",
          texto: "Fale a palavra em voz alta e sinta qual sílaba soa mais forte.",
          imagemUrl: bussola,
        },
        {
          id: "p3",
          texto: "Descubra se essa sílaba é a última, penúltima ou antepenúltima.",
          imagemUrl: mapa,
        },
        {
          id: "p4",
          texto: "Verifique se, pela terminação, a palavra precisa de acento.",
          imagemUrl: estrela,
        },
      ],
    ...
    perguntas: [
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Porque é proparoxítona, e toda proparoxítona é acentuada”. Proparoxítona sempre leva acento. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “São paroxítonas terminadas em L e R, o que pede acento”. Paroxítonas terminadas em L, R (entre outras) recebem acento. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
        ...
        alvos: [
          {
            ...
            nome: "Oxítona",
            imagemUrl: estrela,
            descricao: "Força na última sílaba",
          },
          {
            id: "paroxitona",
            nome: "Paroxítona",
            imagemUrl: arvore,
            descricao: "Força na penúltima sílaba",
          },
          {
            id: "proparoxitona",
            nome: "Proparoxítona",
            imagemUrl: livro,
            descricao: "Força na antepenúltima sílaba",
          },
        ],
  ...
  momento09_revisao: {
    ...
    miniDesafio: {
      ...
      reensino: "📚 Vamos rever juntos: a resposta certa é “Sempre tem acento, porque toda proparoxítona é acentuada”. Essa é a regra de ouro da aula de hoje. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
    },
  },
    ...
    perguntas: [
      {
        ...
        feedbackOpcoes: [
          "❌ “A primeira sílaba da palavra” não é a resposta. Lembre: tônica é a sílaba que soa com mais força.",
          null,
          "❌ “A última letra da palavra” não é a resposta. Lembre: tônica é a sílaba que soa com mais força.",
          "❌ “Proparoxítona” não é a resposta. Lembre: tônica é a sílaba que soa com mais força.",
        ],
        dica: "🧭 Pista de explorador: lembre o que significa “sílaba tônica” — é a sílaba pronunciada com MAIS FORÇA dentro da palavra. Em 'CA-FÉ', o pedaço 'FÉ' é mais forte. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “A sílaba pronunciada com mais força”. Tônica é a sílaba mais forte. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        feedbackOpcoes: [
          null,
          "❌ “Paroxítona” não é a resposta. Em CAFÉ, a força cai na última sílaba: é oxítona.",
          "❌ “Proparoxítona” não é a resposta. Em CAFÉ, a força cai na última sílaba: é oxítona.",
          "❌ “Nunca leva acento” não é a resposta. Em CAFÉ, a força cai na última sílaba: é oxítona.",
        ],
        dica: "🧭 Pista de explorador: lembre o que significa “sílaba tônica” — é a sílaba pronunciada com MAIS FORÇA dentro da palavra. Em 'CA-FÉ', o pedaço 'FÉ' é mais forte. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Oxítona”. A força cai na última sílaba: ca-FÉ. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        feedbackOpcoes: [
          "❌ “Oxítona” não é a resposta. Em ÁRVORE, a força está na penúltima sílaba: é paroxítona.",
          null,
          "❌ “Proparoxítona” não é a resposta. Em ÁRVORE, a força está na penúltima sílaba: é paroxítona.",
          "❌ “Só leva acento às vezes” não é a resposta. Em ÁRVORE, a força está na penúltima sílaba: é paroxítona.",
        ],
        dica: "🧭 Pista de explorador: lembre o que significa “sílaba tônica” — é a sílaba pronunciada com MAIS FORÇA dentro da palavra. Em 'CA-FÉ', o pedaço 'FÉ' é mais forte. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Paroxítona”. A força cai na penúltima sílaba: ÁR-vo-re. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        opcoes: [
          "Nunca leva acento",
          "Leva acento sempre",
          "Leva acento só às vezes",
          "Numa placa da estrada",
        ],
        correta: 1,
        ...
        feedbackOpcoes: [
          "❌ “Nunca leva acento” não é a resposta. Lembre da regra de ouro: toda proparoxítona é acentuada, sempre.",
          null,
          "❌ “Leva acento só às vezes” não é a resposta. Lembre da regra de ouro: toda proparoxítona é acentuada, sempre.",
          "❌ “Numa placa da estrada” não é a resposta. Lembre da regra de ouro: toda proparoxítona é acentuada, sempre.",
        ],
        dica: "🧭 Pista de explorador: lembre o que significa “oxítona” — palavra cuja sílaba tônica é a ÚLTIMA. Ex.: café, jacaré, paletó. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Leva acento sempre”. Regra sem exceção: toda proparoxítona é acentuada. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        feedbackOpcoes: [
          "❌ “Última” não é a resposta. Separe: LÂM-pa-da. A força está na primeira sílaba, que é a antepenúltima.",
          "❌ “Penúltima” não é a resposta. Separe: LÂM-pa-da. A força está na primeira sílaba, que é a antepenúltima.",
          null,
          "❌ “Num bilhete perdido” não é a resposta. Separe: LÂM-pa-da. A força está na primeira sílaba, que é a antepenúltima.",
        ],
        dica: "🧭 Pista de explorador: lembre o que significa “sílaba tônica” — é a sílaba pronunciada com MAIS FORÇA dentro da palavra. Em 'CA-FÉ', o pedaço 'FÉ' é mais forte. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Antepenúltima”. Expedição concluída! LÂM-pa-da: a força está na antepenúltima sílaba. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
  ...
  momento11_missaoFamilia: {
    ...
    registro:
      "📝 Uma foto da lista com as classificações, ou um áudio batendo palmas nas sílabas tônicas.",
  },
