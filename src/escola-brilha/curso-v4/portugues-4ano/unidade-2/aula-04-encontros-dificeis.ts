...
export const aula04: AulaPortuguesV4 = {
  ...
  momento02_previsao: {
    ...
    bloco: {
      ...
      hipoteses: [
        {
          texto: "Quais letras fazem sons parecidos e como não trocar uma pela outra na escrita.",
          imagemUrl: estrela,
        },
    ...
    blocos: [
      {
        ...
        frases: [
          {
            texto: "CHUVA e XÍCARA",
            explicacao: "CH e X podem fazer o MESMO som — não dá pra confiar só no ouvido.",
          },
  ...
  momento05_compreensao: {
    ...
    perguntas: [
      {
        pergunta:
          "Segundo o texto, depois de um ditongo (como AI, EI, OU), qual letra costuma aparecer?",
        opcoes: ["X", "CH", "J"],
        correta: 0,
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “X”. Depois de ditongo, quase sempre é X, como em CAIXA e FEIXE. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “G”. -AGEM, -IGEM e -UGEM usam G, como em VIAGEM e FERRUGEM. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Porque está entre duas vogais”. Entre vogais, o S sozinho soa Z. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
    ...
    perguntas: [
      {
        ...
        opcoes: [
          "No pântano das letras traiçoeiras",
          "Numa praia deserta",
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “dígrafo” — duas letras juntas que representam UM SÓ SOM. CH é um dígrafo: junto, faz o som de 'X' de CHUVA. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “No pântano das letras traiçoeiras”. A expedição entrou no pântano das letras traiçoeiras. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “dígrafo” — duas letras juntas que representam UM SÓ SOM. CH é um dígrafo: junto, faz o som de 'X' de CHUVA. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “No diário de bordo”. Tudo foi registrado no diário de bordo. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
  ...
  momento07_sequencia: {
    ...
    bloco: {
      ...
      itens: [
        {
          id: "p1",
          texto: "Fale a palavra em voz alta e ouça o som da letra duvidosa.",
          imagemUrl: bussola,
        },
        {
          id: "p2",
          texto:
            "Veja em que posição da palavra o som aparece (entre vogais, antes de A/O/U etc.).",
          imagemUrl: mapa,
        },
        {
          id: "p3",
          texto: "Lembre da regra ou da família de palavras parecidas.",
          imagemUrl: arvore,
        },
        {
          id: "p4",
          texto: "Escreva a palavra e confira se ela combina com outras da mesma família.",
          imagemUrl: lapis,
        },
      ],
      ordemCerta: ["p1", "p2", "p3", "p4"],
      feedbackAcerto:
        "🎉 Perfeito! Essa é a rota certa para atravessar o pântano das letras traiçoeiras.",
      feedbackErro:
    ...
    perguntas: [
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Porque o som de SS aparece antes de A, e Ç é a letra certa nessa posição”. Ç aparece antes de A, O, U para manter o som de SS. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        correta: 0,
        feedbackAcerto:
          "🎉 Exato! Entre vogais, SS mantém o som de S puro; um S sozinho ali soaria Z.",
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Porque o som de S puro está entre vogais”. Entre vogais, SS mantém o som de S puro; um S sozinho ali soaria Z. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
  ...
  momento09_revisao: {
    ...
    miniDesafio: {
      ...
      dica: "🧭 Pista de explorador: lembre o que significa “dígrafo” — duas letras juntas que representam UM SÓ SOM. CH é um dígrafo: junto, faz o som de 'X' de CHUVA. Use essa ideia para eliminar as alternativas que não combinam.",
      reensino: "📚 Vamos rever juntos: a resposta certa é “Porque está entre duas vogais”. Essa é a regra de ouro do S entre vogais. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
    },
  },
    ...
    perguntas: [
      {
        ...
        opcoes: [
          "Duas letras juntas que fazem um só som",
        ...
        feedbackOpcoes: [
          null,
          "❌ “Uma palavra com acento” não é a resposta. Lembre: dígrafo é quando duas letras juntas formam um único som, como CH.",
          "❌ “Uma sílaba tônica” não é a resposta. Lembre: dígrafo é quando duas letras juntas formam um único som, como CH.",
          "❌ “Porque a palavra é pequena” não é a resposta. Lembre: dígrafo é quando duas letras juntas formam um único som, como CH.",
        ],
        dica: "🧭 Pista de explorador: lembre o que significa “dígrafo” — duas letras juntas que representam UM SÓ SOM. CH é um dígrafo: junto, faz o som de 'X' de CHUVA. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Duas letras juntas que fazem um só som”. CH, por exemplo, é um dígrafo. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        feedbackOpcoes: [
          null,
          "❌ “CH” não é a resposta. Depois de ditongo (AI, EI, OU), quase sempre usamos X.",
          "❌ “As duas nunca aparecem” não é a resposta. Depois de ditongo (AI, EI, OU), quase sempre usamos X.",
          "❌ “Porque vem antes de A” não é a resposta. Depois de ditongo (AI, EI, OU), quase sempre usamos X.",
        ],
        dica: "🧭 Pista de explorador: lembre o que significa “dígrafo” — duas letras juntas que representam UM SÓ SOM. CH é um dígrafo: junto, faz o som de 'X' de CHUVA. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “X”. Depois de ditongo, como em CAIXA, quase sempre é X. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        feedbackOpcoes: [
          "❌ “J” não é a resposta. Lembre da família -AGEM/-IGEM/-UGEM: todas usam G.",
          null,
          "❌ “X” não é a resposta. Lembre da família -AGEM/-IGEM/-UGEM: todas usam G.",
          "❌ “Numa praia deserta” não é a resposta. Lembre da família -AGEM/-IGEM/-UGEM: todas usam G.",
        ],
        dica: "🧭 Pista de explorador: lembre o que significa “dígrafo” — duas letras juntas que representam UM SÓ SOM. CH é um dígrafo: junto, faz o som de 'X' de CHUVA. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “G”. -AGEM usa G. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        feedbackOpcoes: [
          "❌ “S” não é a resposta. Lembre: S entre vogais soa como Z.",
          null,
          "❌ “CH” não é a resposta. Lembre: S entre vogais soa como Z.",
          "❌ “No topo de uma montanha” não é a resposta. Lembre: S entre vogais soa como Z.",
        ],
        dica: "🧭 Pista de explorador: lembre o que significa “dígrafo” — duas letras juntas que representam UM SÓ SOM. CH é um dígrafo: junto, faz o som de 'X' de CHUVA. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Z”. Entre vogais, o S soa Z. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        feedbackOpcoes: [
          "❌ “S” não é a resposta. Lembre: Ç aparece antes de A, O, U, como em AÇÚCAR e CABEÇA.",
          "❌ “SS” não é a resposta. Lembre: Ç aparece antes de A, O, U, como em AÇÚCAR e CABEÇA.",
          null,
          "❌ “Numa placa de madeira” não é a resposta. Lembre: Ç aparece antes de A, O, U, como em AÇÚCAR e CABEÇA.",
        ],
        dica: "🧭 Pista de explorador: lembre o que significa “dígrafo” — duas letras juntas que representam UM SÓ SOM. CH é um dígrafo: junto, faz o som de 'X' de CHUVA. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Ç”. Expedição concluída! Ç é usado antes de A, O, U para o som de SS. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
  ...
  momento11_missaoFamilia: {
    ...
    registro:
      "📝 Uma foto da lista com os grupos de palavras, ou um áudio lendo cada palavra encontrada.",
  },
