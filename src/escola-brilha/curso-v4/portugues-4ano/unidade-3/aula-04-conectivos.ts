...
export const aula04: AulaPortuguesV4 = {
    ...
    perguntas: [
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Um contraste: apesar da chuva, continuaram”. 'Mas' liga duas ideias opostas: chovia forte, e mesmo assim eles continuaram. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Porque a trilha principal estava alagada”. 'Porque' introduz a causa: a trilha principal alagada. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Armaram o acampamento ali mesmo”. 'Então' liga o sol aparecer à consequência: armar o acampamento. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
    ...
    perguntas: [
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “e” — liga duas ideias que acontecem juntas, somando informações. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Mudaria completamente: deixaria de ser oposição e passaria a soar como explicação de causa”. Trocar o conectivo muda a relação entre as ideias — de oposição para (estranha) explicação de causa. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “e” — liga duas ideias que acontecem juntas, somando informações. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Porque o conectivo errado pode confundir o leitor sobre a relação entre as ideias”. O conectivo é a 'engrenagem' que mostra COMO as ideias se relacionam — errar ele pode mudar todo o sentido do texto. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
    ...
    perguntas: [
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “A água muito alta”. 'Quando' marca o momento: ao chegar, encontraram a água alta. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Porque a ponte estava quebrada”. 'Por isso' liga a consequência (procurar outro caminho) à causa (ponte quebrada). Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
  ...
  momento09_revisao: {
    ...
    miniDesafio: {
      ...
      dica: "🧭 Pista de explorador: lembre o que significa “e” — liga duas ideias que acontecem juntas, somando informações. Use essa ideia para eliminar as alternativas que não combinam.",
      reensino: "📚 Vamos rever juntos: a resposta certa é “mas”. 'Mas' cria a relação de oposição: apesar de chover, continuaram. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
    },
  },
    ...
    perguntas: [
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “e” — liga duas ideias que acontecem juntas, somando informações. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Liga duas ideias e mostra a relação entre elas”. O conectivo mostra COMO duas ideias se relacionam (soma, causa, oposição, tempo...). Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “e” — liga duas ideias que acontecem juntas, somando informações. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “porque”. 'Porque' explica o motivo, a causa de um fato. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        pergunta:
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “e” — liga duas ideias que acontecem juntas, somando informações. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “A consequência de ter estudado”. 'Por isso' mostra a consequência: a nota boa resultou de ter estudado. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “e” — liga duas ideias que acontecem juntas, somando informações. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “QUANDO a chuva parou, saímos para brincar.”. 'Quando' marca o momento em que a segunda ação acontece. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        pergunta:
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “e” — liga duas ideias que acontecem juntas, somando informações. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Com sentido diferente e confuso, pois 'porque' pede uma explicação, não uma oposição”. Cada conectivo cria uma relação própria — trocar um pelo outro muda (e pode confundir) o sentido da frase. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
