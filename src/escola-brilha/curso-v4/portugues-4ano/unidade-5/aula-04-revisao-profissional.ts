...
export const aula04: AulaPortuguesV4 = {
    ...
    perguntas: [
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “'nois' (o certo é 'nós')”. 'Nois' é um erro de ortografia — a forma certa é 'nós'. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “'meus amigo' (faltava o 's')”. O certo é 'meus amigos', no plural, combinando com 'meus'. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Uma das partes virou 'jogamos futebol', variando a ideia”. Pedro trocou a repetição por uma ideia nova (futebol), deixando o texto mais interessante. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
    ...
    perguntas: [
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “concordância” — é quando as palavras da frase 'combinam' em número (singular/plural) e gênero (masculino/feminino). Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Porque o checklist ajuda a não esquecer nenhum tipo de erro”. O checklist garante que você confira ortografia, concordância, pontuação, repetição E clareza — um de cada vez. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “concordância” — é quando as palavras da frase 'combinam' em número (singular/plural) e gênero (masculino/feminino). Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Está correto, sem repetições e mais fácil de entender”. Certo! Um bom texto não precisa ser longo — precisa estar correto e claro. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
    ...
    perguntas: [
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Faltavam pontos para separar as ideias”. O texto original era uma única frase corrida, sem pontos para separar as ideias. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Usando o pronome 'nele' e cortando repetições desnecessárias”. Ela usou 'nele' no lugar de repetir 'bolo', deixando o texto mais fluido. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
  ...
  momento09_revisao: {
    ...
    miniDesafio: {
      ...
      dica: "🧭 Pista de explorador: lembre o que significa “concordância” — é quando as palavras da frase 'combinam' em número (singular/plural) e gênero (masculino/feminino). Use essa ideia para eliminar as alternativas que não combinam.",
      reensino: "📚 Vamos rever juntos: a resposta certa é “Falta concordância: o certo é 'as meninas brincaram'”. 'As meninas brincaram' concorda corretamente no plural. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
    },
  },
    ...
    perguntas: [
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “concordância” — é quando as palavras da frase 'combinam' em número (singular/plural) e gênero (masculino/feminino). Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Ortografia, concordância, pontuação, repetição e clareza”. Esses são os cinco pontos essenciais da revisão profissional. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “concordância” — é quando as palavras da frase 'combinam' em número (singular/plural) e gênero (masculino/feminino). Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Combinar singular/plural e masculino/feminino nas palavras da frase”. Concordância é combinar as palavras corretamente. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “concordância” — é quando as palavras da frase 'combinam' em número (singular/plural) e gênero (masculino/feminino). Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Porque organiza onde uma ideia termina e a próxima começa”. Sem pontuação, o texto vira uma frase só, confusa. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “concordância” — é quando as palavras da frase 'combinam' em número (singular/plural) e gênero (masculino/feminino). Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “'Nois foi ao parque.'”. 'Nois' está escrito errado — o certo é 'nós'. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “concordância” — é quando as palavras da frase 'combinam' em número (singular/plural) e gênero (masculino/feminino). Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Reescrever o parágrafo, corrigindo o que foi encontrado”. Reescrever é o passo final — é aí que o texto vira uma versão de verdade, revisada e pronta. Missão cumprida, explorador! 🌟. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
