...
export const aula04: AulaPortuguesV4 = {
    ...
    perguntas: [
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Cerca de três horas”. O texto diz: 'Depois de caminhar por quase três horas em corredores apertados'. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Um pequeno rio subterrâneo”. 'Na saída, encontraram um pequeno rio subterrâneo que precisaram atravessar.'. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
    ...
    perguntas: [
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “resumo” — é um texto curto que conta só as ideias mais importantes de um texto maior. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Uma equipe explorou uma caverna cheia de cristais por três horas e voltou atravessando um rio subterrâneo”. Essa frase junta a ideia principal de cada parte da história: a exploração, os cristais e a volta pelo rio — sem copiar detalhes soltos. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “resumo” — é um texto curto que conta só as ideias mais importantes de um texto maior. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Porque resumir exige escolher as ideias principais e recontar com palavras próprias, não só copiar um trecho”. Muito bem! Resumir é um trabalho de seleção e reformulação — não basta pegar um pedaço pronto do texto, é preciso pensar e recontar com suas próprias palavras. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
  ...
  momento09_revisao: {
    ...
    miniDesafio: {
      ...
      dica: "🧭 Pista de explorador: lembre o que significa “resumo” — é um texto curto que conta só as ideias mais importantes de um texto maior. Use essa ideia para eliminar as alternativas que não combinam.",
      reensino: "📚 Vamos rever juntos: a resposta certa é “Uma frase reformulada com as próprias palavras, juntando as ideias principais”. Resumir é reformular com suas próprias palavras, juntando o essencial — nunca copiar um trecho pronto. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
    },
  },
    ...
    perguntas: [
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “resumo” — é um texto curto que conta só as ideias mais importantes de um texto maior. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Um texto curto com as ideias mais importantes, escrito com palavras próprias”. Resumo é síntese com palavras próprias, não cópia nem ampliação do texto. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “resumo” — é um texto curto que conta só as ideias mais importantes de um texto maior. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Porque resumir exige entender o texto e recontar com as próprias palavras”. Resumir mostra que você entendeu o texto — copiar não prova isso. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “resumo” — é um texto curto que conta só as ideias mais importantes de um texto maior. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Ler o texto todo com atenção”. Antes de selecionar ou reformular, é preciso ler o texto todo com atenção. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “resumo” — é um texto curto que conta só as ideias mais importantes de um texto maior. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Proporcional ao texto original: bem menor, mas mantendo o essencial”. Muito bem! O resumo precisa ser proporcional: menor que o original, mas sem perder as ideias principais. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        pergunta:
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “resumo” — é um texto curto que conta só as ideias mais importantes de um texto maior. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “A descoberta de duas novas espécies de pássaros durante a pesquisa”. Você já sabe separar a ideia principal dos detalhes — parabéns, explorador da leitura! 🌟. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
