...
export const aula02: AulaPortuguesV4 = {
    ...
    perguntas: [
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Uma metáfora para o brilho e a cor do sol”. É uma metáfora: o sol NÃO é moeda, mas a imagem mostra seu brilho dourado. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Eles se despedem do sol virando o rosto”. 'como se quisessem se despedir' — isso é personificação: dar sentimento de gente a uma planta. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “'sentíamos que tínhamos andado um século'”. Ninguém anda um século de verdade — é um exagero para mostrar o quanto a trilha pareceu longa. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
    ...
    perguntas: [
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “metáfora” — é dizer que uma coisa É outra, sem usar 'como', para criar uma imagem forte. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “A comparação usa 'como'; a metáfora diz que uma coisa É a outra, sem 'como'”. 'As folhas dançavam COMO bailarinas' é comparação; 'o sol É uma moeda' é metáfora — sem o 'como'. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        pergunta:
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Para reforçar, com exagero, o quanto aquilo pareceu cansativo”. O exagero da hipérbole reforça a EMOÇÃO — o cansaço parecia eterno, mesmo sem ser literalmente verdade. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
    ...
    perguntas: [
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Metáfora”. O rio É chamado de serpente, sem 'como' — é uma metáfora. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “Ele sussurra segredos”. 'sussurrava segredos' é ação de gente dada ao vento — personificação. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “'parecia que tinha caído o mar inteiro sobre o acampamento'”. Um mar inteiro nunca caberia numa chuva — é um exagero para mostrar que choveu muito forte. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
  ...
  momento09_revisao: {
    ...
    miniDesafio: {
      ...
      dica: "🧭 Pista de explorador: lembre o que significa “metáfora” — é dizer que uma coisa É outra, sem usar 'como', para criar uma imagem forte. Use essa ideia para eliminar as alternativas que não combinam.",
      reensino: "📚 Vamos rever juntos: a resposta certa é “Hipérbole”. Ninguém chora um rio de verdade — é exagero para mostrar o tamanho da tristeza. Hipérbole! Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
    },
  },
    ...
    perguntas: [
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “metáfora” — é dizer que uma coisa É outra, sem usar 'como', para criar uma imagem forte. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Um jeito de usar as palavras que não deve ser lido ao pé da letra”. Linguagem figurada cria sentidos além do literal. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “metáfora” — é dizer que uma coisa É outra, sem usar 'como', para criar uma imagem forte. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Metáfora”. Tempo não voa de verdade — é metáfora para dizer que passou rápido. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        reensino: "📚 Vamos rever juntos: a resposta certa é “'Seus olhos brilhavam como estrelas.'”. A palavra 'como' marca a comparação. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        pergunta:
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “metáfora” — é dizer que uma coisa É outra, sem usar 'como', para criar uma imagem forte. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Personificação”. Acenar é gesto de gente — dar isso a uma árvore é personificação. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
      {
        ...
        dica: "🧭 Pista de explorador: lembre o que significa “metáfora” — é dizer que uma coisa É outra, sem usar 'como', para criar uma imagem forte. Use essa ideia para eliminar as alternativas que não combinam.",
        reensino: "📚 Vamos rever juntos: a resposta certa é “Para criar imagens fortes e emocionar o leitor”. As figuras de linguagem tornam o texto mais vivo, visual e emocionante. Cristal decifrado! 🌟. Agora releia a pergunta com essa ideia na cabeça — pense antes de responder.",
      },
    ],
  },
