...
import { aulaFatoracaoEquacoes } from "../aulas-bncc-complementares";
...
export const unidade2: Unidade = {
  ...
  corTema: "#0ea5e9",
  aulas: [aula01_formaGeral, aula02_incompletas, aulaFatoracaoEquacoes, aula03_bhaskara, aula04_discriminante, aula05_problemasMissao],
};
