    ...
    etapas: [
      {
        ...
        exemploReal: {
          ...
          visualMat: {
            ...
            linhas: [
              { rotulo: "1", valores: ["chame de x", "x = 0,777…"] },
              { rotulo: "2", valores: ["multiplique por 10", "10x = 7,777…"] },
              { rotulo: "3", valores: ["subtraia", "10x − x = 7"] },
              { rotulo: "4", valores: ["resolva", "9x = 7 → x = 7/9"] },
            ],
          },
          destaque: "0,777… = 7/9.",
        },
      },
      {
        ...
        exemploReal: {
          ...
          visualMat: {
            tipo: "tabela",
            cabecalhos: ["Período", "Regra", "Fração"],
            linhas: [
              { rotulo: "3", valores: ["3", "3/9", "1/3"] },
              { rotulo: "27", valores: ["27", "27/99", "3/11"] },
              { rotulo: "18", valores: ["18", "18/99", "2/11"] },
            ],
          },
          destaque: "0,18181… = 18/99 = 2/11.",
        },
      },
      {
        texto: "Dízima composta: separe a parte não periódica.",
        exemploReal: {
          contexto: "0,1666… = 0,1 + 0,0666…",
          visualMat: {
            tipo: "tabela",
            cabecalhos: ["Parte", "Fração"],
            linhas: [
              { rotulo: "não períod.", valores: ["0,1", "1/10"] },
              { rotulo: "periódica", valores: ["0,0666…", "6/90"] },
              { rotulo: "soma", valores: ["1/10 + 6/90", "15/90 = 1/6"] },
            ],
          },
          destaque: "0,1666… = 1/6.",
        },
