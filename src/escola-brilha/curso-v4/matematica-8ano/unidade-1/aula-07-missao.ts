  ...
  momento03_descoberta: {
    ...
    visualMat: {
      ...
      passos: [
        ...
        { expr: "= 25 · 10⁻²", explica: "Mesma quantidade, escrita não canônica.", status: "x", professor: "Cuidado: 25 · 10⁻² tem o mesmo VALOR (0,25), mas NÃO é notação científica válida — mantissa precisa estar em [1, 10)." },
  ...
  momento08_aplicacao: {
    ...
    visualMat: {
      ...
      passos: [
        ...
        { expr: "= 0,4 · 10⁷", explica: "Mantissa 0,4 fora de [1,10) — ajusto.", status: "x", professor: "0,4 é menor que 1. Ajuste: 0,4 = 4·10⁻¹." },
