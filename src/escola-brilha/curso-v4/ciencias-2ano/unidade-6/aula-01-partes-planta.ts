...
export const aula01: AulaGeoV1 = {
  ...
  cena04_leituraGuiada: {
    ...
    pontos: [
      ...
      { id: "flor", x: 65, y: 25, emoji: "🌸", cor: "from-pink-400 to-rose-600", titulo: "Flor", texto: "Atrai borboletas e abelhas. Depois vira FRUTO.", fotoUrl: florImg },
  ...
  cena11_avaliacao: {
    ...
    fotoUrl: brilhaImg,
    perguntas: [
      { id: "q1", pergunta: "Puxa água da terra:", fotoUrl: raizImg, opcoes: [{ id: "a", texto: "Raiz", correta: true }, { id: "b", texto: "Flor" }], feedbackAcerto: "Isso!", feedbackErro: "É a RAIZ." },
      { id: "q2", pergunta: "Fabrica alimento com o sol:", fotoUrl: folhasImg, opcoes: [{ id: "a", texto: "Folha", correta: true }, { id: "b", texto: "Fruto" }], feedbackAcerto: "Certo!", feedbackErro: "É a FOLHA." },
      { id: "q3", pergunta: "Guarda as sementes:", fotoUrl: frutoImg, opcoes: [{ id: "a", texto: "Fruto", correta: true }, { id: "b", texto: "Raiz" }], feedbackAcerto: "PERFEITO!", feedbackErro: "Semente fica dentro do FRUTO." },
    ],
