...
export const aula01: AulaGeoV1 = {
    ...
    perguntas: [
      {
        ...
        cards: [
          ...
          { id: "d", emoji: "🤫", titulo: "Escondo o remédio", cor: "from-blue-400 to-indigo-700" },
        ],
        correta: "b",
      ...
      },
      {
        ...
        cards: [
          ...
          { id: "d", emoji: "🖐️", titulo: "Encosto para testar", cor: "from-blue-400 to-indigo-700" },
        ],
        correta: "a",
      ...
      },
      {
        ...
        cards: [
          ...
          { id: "d", emoji: "🙈", titulo: "Faço escondido", cor: "from-blue-400 to-indigo-700" },
        ],
        correta: "a",
  ...
  cena11_avaliacao: {
    ...
    fotoUrl: brilhaImg,
    perguntas: [
      { id: "q1", pergunta: "Achei remédio no chão. O que faço?", fotoUrl: kitImg, opcoes: [{ id: "a", texto: "Aviso um adulto", correta: true }, { id: "b", texto: "Como como bala" }, { id: "c", texto: "Outra resposta" }, { id: "d", texto: "Nenhuma das anteriores" }], feedbackAcerto: "Perfeito! Adulto.", feedbackErro: "Remédio NÃO é bala. AVISE o adulto." },
      { id: "q2", pergunta: "Posso encostar na panela quente?", fotoUrl: cozinhaImg, opcoes: [{ id: "a", texto: "Não, queima", correta: true }, { id: "b", texto: "Sim, rapidinho" }, { id: "c", texto: "Outra resposta" }, { id: "d", texto: "Nenhuma das anteriores" }], feedbackAcerto: "Isso! Queima.", feedbackErro: "Sempre queima. NUNCA encostar!" },
      { id: "q3", pergunta: "Onde ficam os produtos de limpeza?", fotoUrl: cozinhaImg, opcoes: [{ id: "a", texto: "Armário alto e fechado", correta: true }, { id: "b", texto: "No chão" }, { id: "c", texto: "Outra resposta" }, { id: "d", texto: "Nenhuma das anteriores" }], feedbackAcerto: "PERFEITO!", feedbackErro: "No chão é PERIGO. Sempre ALTO e fechado." },
    ],
