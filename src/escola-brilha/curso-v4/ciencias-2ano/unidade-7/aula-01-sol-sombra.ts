...
export const aula01: AulaGeoV1 = {
  ...
  cena04_leituraGuiada: {
    ...
    mapaUrl: panoramaImg,
    pontos: [
      { id: "manha", x: 15, y: 30, emoji: "🌅", cor: "from-orange-400 to-red-600", titulo: "Manhã", texto: "Pela manhã, o Sol aparece baixo perto do horizonte; a sombra costuma ficar comprida no lado oposto.", fotoUrl: panoramaImg },
      { id: "meio", x: 50, y: 15, emoji: "☀️", cor: "from-yellow-400 to-orange-600", titulo: "Perto do meio-dia", texto: "Quando o Sol aparece mais alto no céu, a sombra costuma ficar menor.", fotoUrl: panoramaImg },
      { id: "tarde", x: 85, y: 30, emoji: "🌇", cor: "from-pink-400 to-purple-600", titulo: "Fim da tarde", texto: "No fim da tarde, o Sol aparece baixo novamente e a sombra fica comprida no lado oposto.", fotoUrl: panoramaImg },
      { id: "asfalto", x: 30, y: 75, emoji: "🖤", cor: "from-slate-700 to-slate-900", titulo: "Asfalto escuro", texto: "Sob a mesma iluminação e durante o mesmo tempo, superfícies escuras costumam absorver mais energia luminosa.", fotoUrl: superficiesImg },
      { id: "areia", x: 70, y: 75, emoji: "🏖️", cor: "from-amber-300 to-yellow-500", titulo: "Superfície clara", texto: "Sob condições iguais, superfícies claras costumam refletir mais luz; o material também influencia o aquecimento.", fotoUrl: superficiesImg },
    ],
  ...
  cena05_compreensao: {
    ...
    perguntas: [
      { id: "q1", pergunta: "A sombra fica MAIS COMPRIDA quando o sol está:", fotoUrl: panoramaImg, cards: [{ id: "a", emoji: "☀️", titulo: "Bem alto", cor: "from-yellow-400 to-orange-600" }, { id: "b", emoji: "🌅", titulo: "Bem baixo", cor: "from-orange-400 to-red-600" }, { id: "c", emoji: "🌑", titulo: "Escondido pela nuvem", cor: "from-slate-400 to-slate-700" }, { id: "d", emoji: "❓", titulo: "Outra resposta", cor: "from-blue-400 to-indigo-700" }], correta: "b", feedbackAcerto: "Isso! Sol BAIXO = sombra COMPRIDA.", feedbackErro: "Quanto mais BAIXO o sol, mais COMPRIDA a sombra." },
      { id: "q2", pergunta: "Qual superfície esquenta MAIS no sol?", fotoUrl: superficiesImg, cards: [{ id: "a", emoji: "🖤", titulo: "Asfalto escuro", cor: "from-slate-700 to-slate-900" }, { id: "b", emoji: "🏖️", titulo: "Areia clara", cor: "from-amber-300 to-yellow-500" }, { id: "c", emoji: "❄️", titulo: "Gelo", cor: "from-cyan-300 to-sky-500" }, { id: "d", emoji: "❓", titulo: "Outra resposta", cor: "from-blue-400 to-indigo-700" }], correta: "a", feedbackAcerto: "Certo! Cor ESCURA absorve mais calor.", feedbackErro: "Escuro absorve MAIS calor que claro. É o asfalto!" },
      { id: "q3", pergunta: "O que o sol dá pra Terra?", fotoUrl: panoramaImg, cards: [{ id: "a", emoji: "☀️", titulo: "Luz e calor", cor: "from-yellow-400 to-orange-600" }, { id: "b", emoji: "🍕", titulo: "Pizza", cor: "from-red-400 to-orange-600" }, { id: "c", emoji: "🎮", titulo: "Videogame", cor: "from-purple-400 to-fuchsia-600" }, { id: "d", emoji: "❓", titulo: "Outra resposta", cor: "from-blue-400 to-indigo-700" }], correta: "a", feedbackAcerto: "PERFEITO! LUZ + CALOR.", feedbackErro: "Sol não dá pizza nem game. Dá LUZ e CALOR!" },
    ],
  ...
  cena07_sequencia: {
    ...
    pergunta: "Como a posição aparente do Sol muda no céu?",
    paradas: [
  ...
  cena11_avaliacao: {
    ...
    fotoUrl: brilhaImg,
    perguntas: [
      { id: "q1", pergunta: "Ao meio-dia, a sombra é:", fotoUrl: panoramaImg, opcoes: [{ id: "a", texto: "Curtinha", correta: true }, { id: "b", texto: "Comprida" }, { id: "c", texto: "Outra resposta" }, { id: "d", texto: "Nenhuma das anteriores" }], feedbackAcerto: "Isso!", feedbackErro: "Sol ALTO = sombra CURTA." },
      { id: "q2", pergunta: "O sol dá:", fotoUrl: panoramaImg, opcoes: [{ id: "a", texto: "Luz e calor", correta: true }, { id: "b", texto: "Chuva" }, { id: "c", texto: "Outra resposta" }, { id: "d", texto: "Nenhuma das anteriores" }], feedbackAcerto: "Certo!", feedbackErro: "Sol dá LUZ e CALOR (chuva vem da nuvem)." },
      { id: "q3", pergunta: "Qual esquenta MAIS no sol?", fotoUrl: superficiesImg, opcoes: [{ id: "a", texto: "Asfalto escuro", correta: true }, { id: "b", texto: "Areia clara" }, { id: "c", texto: "Outra resposta" }, { id: "d", texto: "Nenhuma das anteriores" }], feedbackAcerto: "PERFEITO!", feedbackErro: "Escuro ABSORVE mais calor. É o asfalto!" },
    ],
