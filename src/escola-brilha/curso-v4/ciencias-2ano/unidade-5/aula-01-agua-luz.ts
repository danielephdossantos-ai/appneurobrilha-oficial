...
export const aula01: AulaGeoV1 = {
  ...
  cena05_compreensao: {
    ...
    perguntas: [
      { id: "q1", pergunta: "Uma planta no escuro:", fotoUrl: estufaImg, cards: [{ id: "a", emoji: "🌱", titulo: "Cresce forte", cor: "from-emerald-400 to-green-700" }, { id: "b", emoji: "🥀", titulo: "Fica amarela e murcha", cor: "from-yellow-500 to-orange-700" }, { id: "c", emoji: "🌈", titulo: "Fica arco-íris", cor: "from-pink-400 to-purple-600" }, { id: "d", emoji: "❓", titulo: "Outra resposta", cor: "from-blue-400 to-indigo-700" }], correta: "b", feedbackAcerto: "Isso! Sem luz, a planta AMARELECE e murcha.", feedbackErro: "Sem sol, a planta murcha e fica amarela." },
      { id: "q2", pergunta: "Regar TODO DIA um monte de água é:", fotoUrl: brotoImg, cards: [{ id: "a", emoji: "❤️", titulo: "Amor pela planta", cor: "from-pink-400 to-rose-600" }, { id: "b", emoji: "😵", titulo: "Ruim — afoga a raiz", cor: "from-cyan-400 to-sky-700" }, { id: "c", emoji: "🎯", titulo: "Sempre ideal", cor: "from-emerald-400 to-green-600" }, { id: "d", emoji: "❓", titulo: "Outra resposta", cor: "from-blue-400 to-indigo-700" }], correta: "b", feedbackAcerto: "Certo! Água DEMAIS AFOGA a raiz. Regar com medida.", feedbackErro: "Água em excesso apodrece a raiz. Regar na medida!" },
      { id: "q3", pergunta: "Como a planta produz açúcares para crescer?", fotoUrl: estufaImg, cards: [{ id: "a", emoji: "☀️💧", titulo: "Com luz, água e gás carbônico", cor: "from-emerald-400 to-green-700" }, { id: "b", emoji: "🍔", titulo: "Comprando comida", cor: "from-orange-400 to-red-600" }, { id: "c", emoji: "🐜", titulo: "Comendo insetos", cor: "from-red-400 to-rose-700" }, { id: "d", emoji: "🪨", titulo: "Comendo pedras", cor: "from-blue-400 to-indigo-700" }], correta: "a", feedbackAcerto: "PERFEITO! Na fotossíntese, a planta usa luz, água e gás carbônico.", feedbackErro: "A fotossíntese usa luz, água e gás carbônico do ar." },
    ],
  ...
  cena11_avaliacao: {
    ...
    fotoUrl: brilhaImg,
    perguntas: [
      { id: "q1", pergunta: "Uma planta no escuro fica:", fotoUrl: estufaImg, opcoes: [{ id: "a", texto: "Amarela e murcha", correta: true }, { id: "b", texto: "Cresce super rápido" }, { id: "c", texto: "Outra resposta" }, { id: "d", texto: "Nenhuma das anteriores" }], feedbackAcerto: "Isso!", feedbackErro: "Sem sol ela amarela." },
      { id: "q2", pergunta: "A água entra pela:", fotoUrl: brotoImg, opcoes: [{ id: "a", texto: "Raiz", correta: true }, { id: "b", texto: "Flor" }, { id: "c", texto: "Outra resposta" }, { id: "d", texto: "Nenhuma das anteriores" }], feedbackAcerto: "Certo!", feedbackErro: "Água entra pela RAIZ." },
      { id: "q3", pergunta: "Na fotossíntese, a planta usa:", fotoUrl: estufaImg, opcoes: [{ id: "a", texto: "Luz, água e gás carbônico", correta: true }, { id: "b", texto: "Ração de cachorro" }, { id: "c", texto: "Pedras e plástico" }, { id: "d", texto: "Somente terra" }], feedbackAcerto: "PERFEITO!", feedbackErro: "A planta usa luz, água e gás carbônico do ar." },
    ],
