...
export const aula01: AulaGeoV1 = {
  ...
  cena05_compreensao: {
    ...
    perguntas: [
      { id: "q1", pergunta: "Qual destes é um SER VIVO?", fotoUrl: jardimImg, cards: [{ id: "a", emoji: "🌳", titulo: "Árvore", cor: "from-emerald-400 to-green-700" }, { id: "b", emoji: "🪨", titulo: "Pedra", cor: "from-slate-400 to-slate-700" }, { id: "c", emoji: "🥤", titulo: "Copo", cor: "from-cyan-300 to-sky-600" }, { id: "d", emoji: "❓", titulo: "Outra resposta", cor: "from-blue-400 to-indigo-700" }], correta: "a", feedbackAcerto: "Isso! Árvore NASCE, CRESCE e se REPRODUZ. Pedra e copo não!", feedbackErro: "Pedra e copo não nascem nem crescem. Ser vivo é a ÁRVORE." },
      { id: "q2", pergunta: "Onde a borboleta procura comida?", fotoUrl: borboletaImg, cards: [{ id: "a", emoji: "🌸", titulo: "Nas flores", cor: "from-pink-400 to-rose-600" }, { id: "b", emoji: "🪨", titulo: "Nas pedras", cor: "from-slate-400 to-slate-700" }, { id: "c", emoji: "💧", titulo: "Na água salgada", cor: "from-cyan-400 to-sky-700" }, { id: "d", emoji: "❓", titulo: "Outra resposta", cor: "from-blue-400 to-indigo-700" }], correta: "a", feedbackAcerto: "Combo! Borboleta chupa o NÉCTAR das flores.", feedbackErro: "Borboleta não come pedra nem sal. É o NÉCTAR das flores!" },
      { id: "q3", pergunta: "Na cena do jardim, onde o passarinho construiu o ninho?", fotoUrl: jardimImg, cards: [{ id: "a", emoji: "🌳", titulo: "Na árvore", cor: "from-emerald-400 to-green-700" }, { id: "b", emoji: "🌊", titulo: "No fundo do rio", cor: "from-cyan-400 to-sky-700" }, { id: "c", emoji: "🕳️", titulo: "Num buraco de minhoca", cor: "from-amber-700 to-yellow-900" }, { id: "d", emoji: "🏠", titulo: "Dentro da casa", cor: "from-blue-400 to-indigo-700" }], correta: "a", feedbackAcerto: "Na cena, o ninho está na ÁRVORE! Diferentes aves constroem ninhos em locais variados.", feedbackErro: "Observe a cena: o ninho mostrado está na árvore." },
    ],
  ...
  cena11_avaliacao: {
    ...
    fotoUrl: brilhaImg,
    perguntas: [
      { id: "q1", pergunta: "Qual destes é ser vivo?", fotoUrl: jardimImg, opcoes: [{ id: "a", texto: "Árvore", correta: true }, { id: "b", texto: "Pedra" }, { id: "c", texto: "Outra resposta" }, { id: "d", texto: "Nenhuma das anteriores" }], feedbackAcerto: "Isso!", feedbackErro: "Pedra não nasce nem cresce. Árvore SIM." },
      { id: "q2", pergunta: "Onde a minhoca vive?", fotoUrl: jardimImg, opcoes: [{ id: "a", texto: "Na terra", correta: true }, { id: "b", texto: "No topo da árvore" }, { id: "c", texto: "Outra resposta" }, { id: "d", texto: "Nenhuma das anteriores" }], feedbackAcerto: "Certo!", feedbackErro: "Minhoca vive na TERRA úmida." },
      { id: "q3", pergunta: "Borboleta nasce de:", fotoUrl: borboletaImg, opcoes: [{ id: "a", texto: "Um ovo", correta: true }, { id: "b", texto: "Uma pedra" }, { id: "c", texto: "Outra resposta" }, { id: "d", texto: "Nenhuma das anteriores" }], feedbackAcerto: "PERFEITO!", feedbackErro: "Pedra não gera vida. Borboleta vem do OVO." },
    ],
