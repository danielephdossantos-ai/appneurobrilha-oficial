...
const aula01: AulaEI = {
  ...
  momentos: [
    ...
    // 8 — Compreensão: quantas no final?
    {
      ...
      perguntaAudio: "Qual bichinho chegou de um em um até formar o grupo de três?",
      opcoes: [
        ...
        { nome: "um coelho", imagemUrl: coelho, correta: false },
      ],
      feedbackAcerto: "Isso! As joaninhas chegaram uma de cada vez: uma, duas e três!",
      feedbackErro: "Na história, chegou uma joaninha, depois outra e mais outra. Procure a joaninha.",
    },
...
const aula02: AulaEI = {
  ...
  momentos: [
    ...
    },
    {
      ...
      imagemUrl: elefante,
      versos: [
        "Comparar é olhar duas coisas e perceber o tamanho de cada uma.",
        "O leão ocupa mais espaço: ele é grande.",
        "A joaninha ocupa menos espaço: ela é pequena.",
      ],
    },
    {
      tipo: "vocabularioVisual",
      instrucaoAudio: "Vamos aprender antes de responder. Toca em cada imagem: o leão e a árvore são grandes; a joaninha é pequena.",
      itens: [
    ...
    {
      tipo: "compreensaoImagem",
      perguntaAudio: "Entre estes bichinhos, qual aprendemos que ocupa mais espaço e é o MAIOR?",
      opcoes: [
    ...
    },
    {
      ...
      cenas: [
        ...
        },
        {
          imagemUrl: coracao,
          narracao:
            "Os dois ficaram lado a lado para comparar: o leão continuava GRANDE e a joaninha continuava PEQUENA.",
        },
      ],
    },
    {
...
const aula03: AulaEI = {
  ...
  momentos: [
    ...
    },
    {
      ...
      grupoA: { qtd: 3, imagemUrl: estrela, rotulo: "três estrelas" },
      grupoB: { qtd: 1, imagemUrl: estrela, rotulo: "uma estrela" },
      itemPlural: "estrelas",
      alvo: "mais",
      falaModelagem: "Eu conto o primeiro grupo: uma, duas, três estrelas. No outro grupo há uma estrela. Três é mais do que uma, então o primeiro grupo tem MAIS.",
      mascoteUrl: brilha,
      elogio: "Agora você sabe: para descobrir onde há mais, conte os dois grupos e compare.",
    },
    {
      tipo: "pareamento1a1",
      grupoA: { qtd: 3, imagemUrl: estrela },
      grupoB: { qtd: 1, imagemUrl: flor },
      itemPlural: "figuras",
      instrucaoAudio: "Vamos ligar uma figura de cada grupo. Depois de formar um par, observe o que sobra.",
      conclusao: "Sobram duas estrelas. O grupo que tem figuras sobrando tem MAIS; o outro tem POUCO.",
      elogio: "Muito bem! Você comparou formando pares.",
    },
    {
      tipo: "compreensaoImagem",
      ...
      opcoes: [
        ...
        { nome: "uma bola", imagemUrl: bola, correta: false },
        { nome: "uma estrela", imagemUrl: estrela, correta: false },
      ],
    ...
    },
    {
      ...
      opcoes: [
        ...
        { nome: "muitas flores", imagemUrl: flor, correta: false },
      ],
...
const aula04: AulaEI = {
  ...
  momentos: [
    ...
    },
    {
      ...
      imagemUrl: circulo,
      versos: [
        "O círculo é redondo e não tem pontas.",
        "O quadrado tem quatro lados e quatro cantos.",
        "O triângulo tem três lados e três cantos.",
      ],
    },
    {
      tipo: "vocabularioVisual",
      instrucaoAudio: "Aprenda as pistas antes de responder. Toca em cada forma: círculo sem pontas, quadrado com quatro lados e triângulo com três lados.",
      itens: [
    ...
    {
      tipo: "compreensaoImagem",
      perguntaAudio: "Qual imagem mostra o CÍRCULO, a forma redondinha e sem pontas?",
      opcoes: [
...
const aula05: AulaEI = {
  ...
  momentos: [
    ...
    },
    {
      ...
      imagemUrl: arcoIris,
      versos: [
        "Classificar é juntar as coisas que têm a mesma cor.",
        "A maçã é vermelha, a banana é amarela e a folha é verde.",
        "Observe a cor primeiro; depois escolha o grupo correto.",
      ],
    },
    {
      tipo: "vocabularioVisual",
      instrucaoAudio: "Vamos aprender a classificar por cor. Toca em cada figura e observe: maçã vermelha, banana amarela e folha verde.",
      itens: [
    ...
    },
    {
      ...
      opcoes: [
        ...
        { nome: "lua azul", imagemUrl: lua, correta: false },
      ],
    ...
    },
    {
      ...
      opcoes: [
        ...
        { nome: "azul como lua", imagemUrl: lua, correta: false },
      ],
