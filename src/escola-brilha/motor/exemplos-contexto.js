 ...
 */
function gerarProcedural(codigoBncc, contexto, objetivo, idx) {
    ...
    return {
        ...
        facilita: `Traz a habilidade para uma cena que a criança já vive, ` +
 ...
 */
export function exemplosParaHabilidade(codigoBncc, opts = {}) {
