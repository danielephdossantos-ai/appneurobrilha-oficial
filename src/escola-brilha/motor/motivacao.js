...
function chave(childId) {
    return `${STORAGE_KEY}::${childId || "anon"}`;
}
function carregarHist(childId) {
    try {
...
export function proximaMensagem(gatilho, childId = "anon") {
