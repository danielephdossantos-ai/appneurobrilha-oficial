...
import { CATALOGO_ATIVIDADES, TODOS_TIPOS } from "./tipos";
...
export function parseBncc(codigo) {
    ...
    const etapa = codigo.slice(0, 2) || "EF";
...
export function selecionarAtividades(codigo, quantidade = 4) {
    ...
    const genericos = TODOS_TIPOS.filter((t) => {
        const meta = CATALOGO_ATIVIDADES[t];
...
export function selecionarAtividadesDetalhado(codigo, quantidade) {
