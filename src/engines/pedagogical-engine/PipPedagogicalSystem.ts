...
export class PipPedagogicalSystem {
  private static MENSAGENS_EXPLICACAO: Record<number, string[]> = {
    4: [
      ...
      "Vou te mostrar um segredo novo!",
      "Vamos brincar de aprender?",
    ],
    6: [
      "Hoje o desafio é muito especial!",
      "Vou te explicar como ser um mestre aqui!",
      "Preparado para essa missão?",
    ],
    8: [
      "Vamos explorar um novo conhecimento juntos!",
      "Este desafio vai exercitar seu super cérebro!",
      "Pronto para subir de nível hoje?",
    ],
    10: [
      "O objetivo de hoje é dominar esta habilidade!",
      "Vamos analisar este desafio passo a passo.",
      "Pronto para o próximo degrau do conhecimento?",
    ],
  };
  ...
  private static MENSAGENS_INCENTIVO: Record<number, string[]> = {
    4: [
      ...
      "Que lindo o que você está fazendo!",
      "Continue assim, pequeno brilhante!",
    ],
    6: [
      "Estou adorando seu esforço!",
      "Você é muito inteligente!",
      "Olha só como você está conseguindo!",
    ],
    8: [
      "Excelente concentração!",
      "Cada passo te deixa mais forte!",
      "Seu cérebro está brilhando agora!",
    ],
    10: [
      "Sua linha de raciocínio está ótima!",
      "Persistência é o segredo dos mestres!",
      "Continue focado, você está quase lá!",
    ],
  };
  ...
  private static MENSAGENS_COMEMORACAO: Record<number, string[]> = {
    ...
    8: [
      "Excepcional! Objetivo alcançado!",
      "Você dominou esse desafio!",
      "Estou muito orgulhoso da sua evolução!",
    ],
    10: [
      "Desempenho de mestre! Parabéns!",
      "Sua evolução é constante e brilhante!",
      "Conhecimento desbloqueado com sucesso!",
    ],
  };
