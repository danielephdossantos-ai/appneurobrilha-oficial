...
const ACTIVITY_C = [
  // 6º Ano
  {
    ...
    subtitle: "Regulação climática e biodiversidade",
    icon: Globe,
  ...
  },
  {
    ...
    subtitle: "Os 6 grandes biomas do Brasil",
    icon: Globe,
  ...
  // 7º Ano
  {
    ...
    subtitle: "A unidade básica da vida",
    icon: FlaskConical,
  ...
  },
  {
    ...
    subtitle: "Álgebra e pensamento matemático",
    icon: Calculator,
  ...
  // 8º Ano
  {
    ...
    subtitle: "Trabalho, sociedade e tecnologia",
    icon: Landmark,
  ...
  },
  {
    ...
    subtitle: "Controle e coordenação do corpo",
    icon: FlaskConical,
  ...
  // 9º Ano
  {
    ...
    subtitle: "DNA, genes e Leis de Mendel",
    icon: FlaskConical,
  ...
  },
  {
    ...
    subtitle: "Razão, liberdade e democracia",
    icon: Landmark,
...
const LEGACY_CATEGORIES = [
  {
    id: "portugues_1ano",
    title: "1º Ano — Sílabas",
    badge: "Alfabetização",
    Icon: BookOpen,
    gradient: "from-emerald-400 to-green-500",
    xp: 100,
    type: "legacy",
    desc: "Primeiras sílabas",
  },
  {
    id: "matematica",
    title: "1º Ano — Contas",
              ...
              {(["6º Ano", "7º Ano", "8º Ano", "9º Ano"] as const).map((year) => {
                ...
                return (
                  <div key={year} className="mb-5">
                    <p className="text-white/40 text-xs font-black uppercase tracking-widest mb-2 px-1">
                      {year}
                    </p>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {EARLY_CATEGORIES.map((cat, i) => (
                    ...
                    >
                      <div
                        className={`bg-gradient-to-b ${cat.gradient} w-16 flex items-center justify-center shrink-0`}
                      >
                      ...
                      <div className="flex-1 p-4 flex flex-col justify-center">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          <span className="text-xs font-black text-rose-500 bg-rose-50 px-2 py-0.5 rounded-full">
                            {cat.badge}
                          </span>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {LEGACY_CATEGORIES.map((cat, i) => (
                    ...
                    >
                      <div
                        className={`bg-gradient-to-br ${cat.gradient} w-10 h-10 rounded-xl flex items-center justify-center mb-3 shadow-sm`}
                      >
...
const CardC: React.FC<{ cat: (typeof ACTIVITY_C)[0]; index: number; onClick: () => void }> = ({
  cat,
  index,
  onClick,
}) => (
  <motion.button
    ...
    animate={{ opacity: 1, y: 0 }}
    transition={{ delay: index * 0.06, type: "spring", stiffness: 140 }}
    whileHover={{ y: -2 }}
    whileTap={{ scale: 0.98 }}
    onClick={onClick}
        ...
        <div className="flex items-start justify-between gap-2">
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-0.5">
              <div
                className={`w-7 h-7 rounded-lg bg-gradient-to-br ${cat.gradient} flex items-center justify-center shadow-sm`}
              >
            ...
            <div className="flex items-center gap-1.5 flex-wrap pl-9">
              <span className={`text-xs font-black px-2 py-0.5 rounded-full ${cat.badgeColor}`}>
                {cat.badge}
              </span>
          ...
          <div className="flex flex-col items-end gap-1.5 shrink-0">
            ...
            <div
              className={`w-7 h-7 rounded-full bg-gradient-to-br ${cat.gradient} flex items-center justify-center shadow-sm`}
            >
...
const CardB: React.FC<{ cat: (typeof ACTIVITY_B)[0]; index: number; onClick: () => void }> = ({
  cat,
  index,
  onClick,
}) => (
