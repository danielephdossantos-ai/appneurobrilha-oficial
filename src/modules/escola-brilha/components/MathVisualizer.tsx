...
const ACCENT_STYLES: Record<string, { bg: string; text: string; border: string; light: string; badge: string }> = {
  orange: { bg: 'bg-orange-500', text: 'text-orange-600', border: 'border-orange-300', light: 'bg-orange-50', badge: 'bg-orange-100 text-orange-700' },
  violet: { bg: 'bg-violet-500', text: 'text-violet-600', border: 'border-violet-300', light: 'bg-violet-50', badge: 'bg-violet-100 text-violet-700' },
  emerald:{ bg: 'bg-emerald-500',text: 'text-emerald-600',border: 'border-emerald-300',light: 'bg-emerald-50',badge: 'bg-emerald-100 text-emerald-700' },
  blue:   { bg: 'bg-blue-500',   text: 'text-blue-600',   border: 'border-blue-300',   light: 'bg-blue-50',   badge: 'bg-blue-100 text-blue-700' },
};
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white border-2 border-slate-100 rounded-2xl p-5 shadow-sm">
        <p className="text-xs font-black text-slate-400 uppercase tracking-widest mb-3 text-center">Equação</p>
                  ...
                  {stepPhase === 'result' && (
                    ...
                    >
                      ...
                      <div className={`bg-white rounded-xl p-3 border-2 ${ac.border} shadow`}>
                        <p className="text-xs font-black text-slate-400 text-center mb-2">RESULTADO</p>
