...
export const PORTUGUES_2ANO_LESSON: Lesson = {
  ...
  steps: [
    ...
    { id: 'p3', phase: 'practice', type: 'interaction', mascot: 'pip',
      ...
      elements: [
        { id: 'bo', type: 'text', content: 'BO', position: { x: -30, y: 0 }, animation: 'pop', delay: 0.2 },
        { id: 'la-gap', type: 'text', content: '__', position: { x: 30, y: 0 }, animation: 'pop', delay: 0.4 }
      ],
      interaction: { type: 'click', correctAnswer: 'LA', options: ['LA', 'MA', 'PA'] } },
    { id: 'p4', phase: 'practice', type: 'interaction', mascot: 'pipa',
      speech: 'Qual destas palavras está escrita corretamente?',
      interaction: { type: 'click', correctAnswer: 'CASA', options: ['CASA', 'KAZA', 'CAZA'] } },
    { id: 'p5', phase: 'practice', type: 'interaction', mascot: 'pip',
      speech: 'Separe as sílabas da palavra JANELA.',
      interaction: { type: 'click', correctAnswer: 'JA-NE-LA', options: ['JA-NE-LA', 'JAN-EL-A', 'JANE-LA'] } }
  ]
};
...
export const MATH_2ANO_LESSON: Lesson = {
  ...
  steps: [
    { id: 'mt1', phase: 'practice', type: 'interaction', mascot: 'pip',
      ...
      elements: [{ id: 'eq1', type: 'text', content: '10 + 5 = ?', position: { x: 0, y: 0 }, animation: 'pop', delay: 0.2 }],
      interaction: { type: 'click', correctAnswer: '15', options: ['12', '15', '20'] } },
    { id: 'mt2', phase: 'practice', type: 'interaction', mascot: 'pipa',
      speech: 'Temos 8 lápis e perdemos 3. Quantos restam?',
      elements: [{ id: 'eq2', type: 'text', content: '8 - 3 = ?', position: { x: 0, y: 0 }, animation: 'pop', delay: 0.2 }],
      interaction: { type: 'click', correctAnswer: '5', options: ['4', '5', '6'] } },
    { id: 'mt3', phase: 'practice', type: 'interaction', mascot: 'pip',
      speech: 'Qual número completa a sequência: 10, 20, 30...',
      interaction: { type: 'click', correctAnswer: '40', options: ['35', '40', '50'] } },
    { id: 'mt4', phase: 'practice', type: 'interaction', mascot: 'pipa',
