...
export const OCEANOS_LESSON: ActivityLessonC = {
  ...
  screens: {
    ...
    pontos_chave: {
      ...
      points: [
        { icon: '', title: 'Regulação Climática', text: 'Absorvem calor e distribuem temperatura pelo planeta.' },
  ...
  screens: {
    ...
    pontos_chave: {
      ...
      points: [
        ...
        { icon: '', title: 'Ameaças', text: 'Desmatamento e queimadas destroem habitats inteiros.' },
  ...
  screens: {
    ...
    pontos_chave: {
      ...
      points: [
        ...
        { icon: '', title: 'Membrana Plasmática', text: 'Controla a entrada e saída de substâncias na célula.' },
      ],
    },
    exemplo_aplicado: {
      title: 'Exemplo prático:',
...
export const EQUACOES_LESSON: ActivityLessonC = {
  ...
  screens: {
    ...
    pontos_chave: {
      ...
      points: [
        { icon: '', title: 'Isolar a incógnita', text: 'Mova todos os termos com x para um lado da equação.' },
        { icon: '', title: 'Operações inversas', text: 'Use + para cancelar −, e × para cancelar ÷.' },
        { icon: '', title: 'Verificar', text: 'Substitua o valor de x na equação original para conferir.' },
      ],
    },
    exemplo_aplicado: {
      title: 'Exemplo prático:',
...
export const ILUMINISMO_LESSON: ActivityLessonC = {
  ...
  screens: {
    ...
    pontos_chave: {
      ...
      points: [
        { icon: '', title: 'Montesquieu', text: 'Criou a teoria da separação dos poderes: Executivo, Legislativo e Judiciário.' },
        { icon: '', title: 'Rousseau', text: 'Defendeu a soberania popular — o poder pertence ao povo.' },
