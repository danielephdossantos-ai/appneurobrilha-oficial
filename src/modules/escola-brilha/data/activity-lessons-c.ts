...
export const OCEANOS_LESSON: ActivityLessonC = {
  ...
  bncc_code: "EF06CI04",
  bncc_description:
    "Compreender a importância dos oceanos na regulação climática e na biodiversidade.",
  xp: 230,
  ...
  screens: {
    ...
    exploracao: {
      ...
      texto:
        "Os oceanos são importantes porque regulam a temperatura do planeta, absorvem grande parte do CO₂ atmosférico e abrigam mais de 80% de todos os seres vivos da Terra.",
      pontos_destaque: [
        { emoji: "", text: "Produzem grande parte do oxigênio que respiramos." },
        { emoji: "", text: "Regulam o clima do planeta." },
    ...
    pontos_chave: {
      ...
      points: [
        {
          icon: "",
          title: "Regulação Climática",
          text: "Absorvem calor e distribuem temperatura pelo planeta.",
        },
        {
          icon: "",
          title: "Ciclo da Água",
          text: "Evaporação dos oceanos forma as nuvens e as chuvas.",
        },
        {
          icon: "",
          title: "Produção de Oxigênio",
          text: "Algas e fitoplâncton produzem +50% do oxigênio terrestre.",
        },
      ],
    },
    exemplo_aplicado: {
    ...
    desafio: {
      ...
      options: [
        {
          letter: "A",
          text: "Porque absorvem e liberam calor de forma equilibrada.",
          isCorrect: true,
        },
      ...
      explanation:
        "Os oceanos absorvem calor durante o dia e o liberam à noite, equilibrando as temperaturas globais.",
    },
  },
};
...
export const BIOMAS_LESSON: ActivityLessonC = {
  ...
  bncc_code: "EF06GE08",
  bncc_description:
    "Identificar os principais biomas brasileiros e suas características geográficas.",
  xp: 220,
  ...
  screens: {
    missao: {
      ...
      context_emoji: "",
      context_text:
        "O Brasil abriga 6 biomas terrestres e é o país com maior biodiversidade do mundo.",
    },
    exploracao: {
      instruction: "Explore os biomas abaixo.",
      texto:
        "Os biomas são grandes regiões geográficas com clima, flora e fauna específicos. O Brasil possui a Amazônia, Cerrado, Mata Atlântica, Caatinga, Pampa e Pantanal.",
      pontos_destaque: [
        { emoji: "", text: "Amazônia: maior floresta tropical do mundo." },
        { emoji: "", text: "Cerrado: savana mais biodiversa do planeta." },
        { emoji: "", text: "Caatinga: único bioma exclusivamente brasileiro." },
      ...
      points: [
        {
          icon: "",
          title: "Diversidade",
          text: "Cada bioma tem espécies de animais e plantas exclusivas.",
        },
        {
          icon: "",
          title: "Ameaças",
          text: "Desmatamento e queimadas destroem habitats inteiros.",
        },
        {
          icon: "",
          title: "Importância",
          text: "Os biomas regulam o clima, a água e o ar que respiramos.",
        },
      ],
    },
    exemplo_aplicado: {
    ...
    desafio: {
      ...
      explanation:
        "A Caatinga é o único bioma exclusivamente brasileiro, com vegetação adaptada ao clima semiárido.",
    },
  },
};
...
export const CELULAS_LESSON: ActivityLessonC = {
  ...
  bncc_code: "EF07CI10",
  bncc_description:
    "Conceituar célula como unidade básica dos seres vivos e identificar suas estruturas.",
  xp: 240,
  ...
  screens: {
    missao: {
      ...
      context_emoji: "",
      context_text:
        "Todas as formas de vida são compostas por células — as unidades básicas da vida.",
    },
    exploracao: {
      instruction: "Explore as informações sobre células.",
      texto:
        "A célula é a menor unidade estrutural e funcional dos seres vivos. Ela realiza todas as funções vitais: nutrição, respiração, reprodução e excreção.",
      pontos_destaque: [
        ...
        { emoji: "", text: "A membrana controla o que entra e sai da célula." },
      ],
      ...
      points: [
        {
          icon: "",
          title: "Núcleo",
          text: "Centro de controle — contém o DNA e dirige as atividades celulares.",
        },
        {
          icon: "",
          title: "Mitocôndria",
          text: 'A "usina de energia" — transforma nutrientes em ATP.',
        },
        {
          icon: "",
          title: "Membrana Plasmática",
          text: "Controla a entrada e saída de substâncias na célula.",
        },
      ],
    },
    exemplo_aplicado: {
      ...
      conclusion:
        "Essa diferença é usada por antibióticos para combater bactérias sem afetar nossas células!",
    },
    desafio: {
      ...
      explanation:
        "A mitocôndria realiza a respiração celular, transformando glicose em energia (ATP) para a célula.",
    },
  },
};
...
export const EQUACOES_LESSON: ActivityLessonC = {
  ...
  screens: {
    ...
    exploracao: {
      ...
      texto:
        "Uma equação do 1º grau tem a forma ax + b = c, onde x é a incógnita (o valor que queremos descobrir). Para resolver, isolamos o x usando operações inversas.",
      pontos_destaque: [
        { emoji: "", text: "A incógnita (x) é o valor desconhecido." },
        { emoji: "", text: 'O sinal "=" indica equilíbrio entre os dois lados.' },
        { emoji: "", text: "Operações inversas: soma/subtração, multiplicação/divisão." },
      ...
      points: [
        {
          ...
          text: "Mova todos os termos com x para um lado da equação.",
        },
        {
          icon: "",
          title: "Operações inversas",
          text: "Use + para cancelar −, e × para cancelar ÷.",
        },
        {
          icon: "",
          title: "Verificar",
          text: "Substitua o valor de x na equação original para conferir.",
        },
      ],
    },
    exemplo_aplicado: {
      ...
      conclusion: "Verificando: 2(4) + 4 = 8 + 4 = 12 (correto)",
      visual_steps: {
        build: [
          { text: "2", role: "coef" },
          { text: "x", role: "unknown" },
        ...
        steps: [
          {
            id: 1,
            action: "Subtrair 4 dos dois lados",
            action_symbol: "− 4",
            accent: "orange",
            explanation: "Subtraímos 4 de ambos os lados para isolar o 2x.",
            before: [
              { text: "2", role: "coef" },
              { text: "x", role: "unknown" },
              { text: " + ", role: "op", dim: true },
              { text: "4", role: "number", strike: true },
              { text: " = ", role: "eq" },
              { text: "12", role: "number" },
              { text: " − 4", role: "op" },
            ],
          ...
          {
            id: 2,
            action: "Dividir os dois lados por 2",
            action_symbol: "÷ 2",
            accent: "violet",
            explanation: "Dividimos os dois lados por 2 para encontrar o valor de x.",
            before: [
              { text: "2", role: "coef", strike: true },
              { text: "x", role: "unknown" },
              { text: " = ", role: "eq" },
              { text: "8", role: "number" },
              { text: " ÷ 2", role: "op" },
        ...
        verification: "2(4) + 4 = 8 + 4 = 12 (correto)",
      },
    },
    desafio: {
      ...
      explanation: "3x − 6 = 9 → 3x = 15 → x = 5. Verificando: 3(5) − 6 = 15 − 6 = 9 (correto)",
    },
  },
};
...
export const REVOLUCAO_LESSON: ActivityLessonC = {
  ...
  bncc_code: "EF08HI13",
  bncc_description:
    "Analisar as transformações sociais, econômicas e culturais decorrentes da Revolução Industrial.",
  xp: 260,
  ...
  screens: {
    missao: {
      ...
      context_emoji: "",
      context_text:
        "Séculos XVIII e XIX — a Inglaterra criou a maior transformação econômica da história moderna.",
    },
    exploracao: {
      instruction: "Explore o contexto histórico.",
      texto:
        "A Revolução Industrial começou na Inglaterra no século XVIII, com a invenção da máquina a vapor. Ela substituiu o trabalho artesanal pelas fábricas, criou o proletariado urbano e transformou a economia global.",
      pontos_destaque: [
        { emoji: "", text: "Máquina a vapor: motor da industrialização." },
        { emoji: "", text: "Urbanização acelerada e crescimento das cidades." },
        { emoji: "", text: "Surgimento do trabalho assalariado e das fábricas." },
        { emoji: "", text: "Condições de trabalho precárias — exploração e trabalho infantil." },
      ],
      mascot_tip:
        "Muitos direitos trabalhistas de hoje surgiram como resposta às condições desta época!",
    },
    pontos_chave: {
      ...
      points: [
        {
          icon: "",
          title: "Nova Classe Social",
          text: "Surgimento do proletariado — trabalhadores assalariados das fábricas.",
        },
        {
          icon: "",
          title: "Imperialismo",
          text: "Europa buscou matéria-prima e mercados consumidores na Ásia e na África.",
        },
        {
          icon: "",
          title: "Avanço Tecnológico",
          text: "Inovações como trem, telégrafo e eletricidade transformaram o cotidiano.",
        },
      ],
    },
    exemplo_aplicado: {
      title: "Exemplo prático:",
      scenario:
        "Uma criança de 8 anos trabalhava 14h por dia em minas de carvão na Inglaterra do século XIX.",
      scenario_emoji: "",
      analysis: [
    ...
    desafio: {
      ...
      explanation:
        "A máquina a vapor, inventada por James Watt em 1769, foi a grande força motriz da industrialização, movendo fábricas, trens e navios.",
    },
  },
};
...
export const SISTEMA_NERVOSO_LESSON: ActivityLessonC = {
  ...
  bncc_code: "EF08CI08",
  bncc_description:
    "Comparar o modo de ação e a eficiência dos sistemas nervoso e endócrino na coordenação do organismo.",
  xp: 250,
  ...
  screens: {
    missao: {
      ...
      context_emoji: "",
      context_text:
        "Seu cérebro processa 70.000 pensamentos por dia e transmite sinais a 400 km/h!",
    },
    exploracao: {
      instruction: "Explore o sistema nervoso.",
      texto:
        "O sistema nervoso é formado pelo encéfalo (cérebro, cerebelo e bulbo), pela medula espinhal e pelos nervos periféricos. Ele coordena todas as funções do organismo, recebendo e enviando sinais através dos neurônios.",
      pontos_destaque: [
        { emoji: "", text: "Cérebro: controla pensamento, memória e emoções." },
        { emoji: "", text: "Cerebelo: coordena movimentos e equilíbrio." },
      ...
      mascot_tip:
        "O reflexo de tirar a mão do fogo acontece antes do cérebro pensar — é a medula espinhal agindo!",
    },
    pontos_chave: {
      ...
      points: [
        {
          ...
          text: "Composto por encéfalo e medula espinhal — processa informações.",
        },
        {
          icon: "",
          title: "Sistema Nervoso Periférico (SNP)",
          text: "Nervos que ligam o SNC ao restante do corpo.",
        },
        {
          icon: "",
          title: "Sistema Nervoso Autônomo",
          text: "Controla funções involuntárias: batimentos, respiração, digestão.",
        },
      ],
    },
    exemplo_aplicado: {
    ...
    desafio: {
      question:
        "Qual parte do sistema nervoso é responsável por coordenar o equilíbrio e os movimentos precisos?",
      options: [
      ...
      explanation:
        "O cerebelo coordena os movimentos voluntários, o equilíbrio e a postura corporal.",
    },
  },
};
...
export const GENETICA_LESSON: ActivityLessonC = {
  ...
  bncc_code: "EF09CI08",
  bncc_description:
    "Analisar o papel do DNA na transmissão das características hereditárias, identificando as leis de Mendel.",
  xp: 280,
  ...
  screens: {
    missao: {
      ...
      context_emoji: "",
      context_text:
        "Gregor Mendel descobriu as leis da hereditariedade estudando ervilhas no século XIX.",
    },
    exploracao: {
      instruction: "Explore os conceitos de genética.",
      texto:
        "A genética estuda como as características são transmitidas de pais para filhos. Os genes, localizados no DNA, carregam essas informações. Mendel descobriu que os genes se apresentam em pares — um dominante e um recessivo.",
      pontos_destaque: [
    ...
    pontos_chave: {
      ...
      points: [
        {
          icon: "",
          title: "Genótipo x Fenótipo",
          text: "Genótipo = genes que você possui. Fenótipo = característica visível.",
        },
        {
          icon: "",
          title: "1ª Lei de Mendel",
          text: "Cada característica é determinada por um par de fatores que se separam na formação dos gametas.",
        },
        {
          icon: "",
          title: "2ª Lei de Mendel",
          text: "Diferentes características são herdadas de forma independente entre si.",
        },
      ],
    },
    exemplo_aplicado: {
    ...
    desafio: {
      ...
      explanation:
        "Heterozigoto (Aa) possui dois alelos diferentes — um dominante (A) e um recessivo (a). Homozigoto seria AA ou aa.",
    },
  },
};
...
export const ILUMINISMO_LESSON: ActivityLessonC = {
  ...
  bncc_code: "EF09HI01",
  bncc_description:
    "Analisar as ideias iluministas e sua influência nas revoluções burguesas e nas independências.",
  xp: 270,
  ...
  screens: {
    missao: {
      ...
      context_emoji: "",
      context_text:
        "Liberdade, Igualdade e Fraternidade — três palavras que mudaram a história da humanidade.",
    },
    exploracao: {
      instruction: "Explore o Iluminismo.",
      texto:
        "O Iluminismo foi um movimento intelectual do século XVIII que defendia a razão como guia supremo da humanidade. Seus pensadores (Locke, Voltaire, Rousseau, Montesquieu) criticaram o absolutismo e a Igreja e influenciaram revoluções.",
      pontos_destaque: [
        { emoji: "", text: "Razão acima da fé e da tradição." },
        { emoji: "", text: "Separação dos poderes (Montesquieu)." },
        { emoji: "", text: "Contrato Social: o governo deriva do povo (Rousseau)." },
        { emoji: "", text: "Influência direta na Revolução Americana e Francesa." },
      ],
      mascot_tip:
        "Muitos direitos que você tem hoje — como liberdade de expressão — vêm dessas ideias!",
    },
    pontos_chave: {
      ...
      points: [
        {
          icon: "",
          title: "Montesquieu",
          text: "Criou a teoria da separação dos poderes: Executivo, Legislativo e Judiciário.",
        },
        {
          icon: "",
          title: "Rousseau",
          text: "Defendeu a soberania popular — o poder pertence ao povo.",
        },
        {
          icon: "",
          title: "Voltaire",
          text: "Criticou a intolerância religiosa e defendeu a liberdade de expressão.",
        },
      ],
    },
    exemplo_aplicado: {
    ...
    desafio: {
      ...
      explanation:
        'Montesquieu, em "O Espírito das Leis" (1748), propôs a divisão do governo em Executivo, Legislativo e Judiciário para evitar a tirania.',
    },
  },
};
