...
export const HISTORIAS_GRADUADAS: HistoriaGraduada[] = [
  ...
  // ====================================================================
  {
    ...
    paginas: [
      { texto: "Era uma vez uma princesa.", imagem: "PRINCESA" },
      { texto: "Ela morava num castelo.", imagem: "CASTELO" },
      { texto: "Um dia, ela foi ao lago.", imagem: "PRINCESA" },
      { texto: "Lá ela viu um sapo verde.", imagem: "SAPO" },
      { texto: "O sapo estava sozinho.", imagem: "TRISTE" },
      { texto: "A princesa pegou o sapo.", imagem: "SAPO" },
      { texto: "Ela deu um beijinho nele.", imagem: "CORACAO" },
      { texto: "O sapo virou um amigo.", imagem: "SAPO" },
      { texto: "Os dois voltaram ao castelo.", imagem: "CASTELO" },
      { texto: "E viveram felizes pra sempre.", imagem: "FELIZ" },
    ],
    perguntas: [
      { pergunta: "Onde morava a princesa?", correta: "CASTELO", distratores: ["CASA", "ARVORE"] },
      { pergunta: "Quem ela achou no lago?", correta: "SAPO", distratores: ["PEIXE", "PATO"] },
      { pergunta: "Como ficaram no final?", correta: "FELIZ", distratores: ["TRISTE", "BRAVO"] },
    ],
  },
  {
    id: "h1-heroi-castelo",
