...
export const seedCognitiveData = async (childId: string) => {
  ...
  const history: CognitiveMetrics[] = [
    { attention: 40, selfRegulation: 30, autonomy: 20, language: 45, memory: 50, coordination: 55, reading: 30, math: 25 },
    { attention: 45, selfRegulation: 35, autonomy: 25, language: 48, memory: 52, coordination: 58, reading: 35, math: 30 },
    { attention: 55, selfRegulation: 40, autonomy: 35, language: 55, memory: 60, coordination: 65, reading: 45, math: 40 },
    { attention: 65, selfRegulation: 50, autonomy: 45, language: 65, memory: 70, coordination: 75, reading: 60, math: 55 },
  ];
