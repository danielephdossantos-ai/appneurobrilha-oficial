  ...
  return (
    <div className="fixed inset-0 z-0 overflow-hidden bg-slate-900">
      <img
        ...
        decoding="async"
        onError={(e) => {
          console.warn("[Jornada365] falha ao carregar mundo:", theme.image);
          (e.currentTarget as HTMLImageElement).style.display = "none";
        }}
      />
      <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-black/30 to-black/60 pointer-events-none" />
      <div className="absolute inset-0 pointer-events-none mix-blend-screen opacity-30 bg-[linear-gradient(115deg,transparent_30%,rgba(255,255,255,0.25)_50%,transparent_70%)] bg-[length:250%_250%] animate-[shimmerWorld_14s_ease-in-out_infinite]" />
    </div>
  );
}
