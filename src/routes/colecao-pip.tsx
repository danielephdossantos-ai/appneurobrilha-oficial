...
const SKINS = [
  ...
  { key: 'dinossauros', name: 'Lumi Explorador', title: 'Dinossauros', image: PIP_SKINS.dinossauros, description: 'Vamos rugir e descobrir o mundo jurássico!' },
  { key: 'espaco', name: 'Lumi Astronauta', title: 'Espaço', image: PIP_SKINS.espaco, description: 'Pronto para decolar até as estrelas!' },
  { key: 'arte', name: 'Lumi Artista', title: 'Arte', image: PIP_SKINS.arte, description: 'Pincel na mão e muita cor pra criar.' },
  { key: 'animais', name: 'Lumi Veterinário', title: 'Animais', image: PIP_SKINS.animais, description: 'Cuidando dos amiguinhos com muito carinho.' },
  { key: 'musica', name: 'Lumi Maestro', title: 'Música', image: PIP_SKINS.musica, description: 'Vamos reger uma sinfonia de aprendizado!' },
  { key: 'fazendinha', name: 'Lumi Fazendeiro', title: 'Fazendinha', image: PIP_SKINS.fazendinha, description: 'Plantando aprendizado e colhendo conquistas.' },
  { key: 'super-herois', name: 'Lumi Super', title: 'Super-Heróis', image: PIP_SKINS['super-herois'], description: 'Salvando o dia com o poder do estudo!' },
  { key: 'princesas', name: 'Lumi Realeza', title: 'Princesas', image: PIP_SKINS.princesas, description: 'Coroado de gentileza e sabedoria.' },
  { key: 'minecraft', name: 'Lumi Builder', title: 'Minecraft', image: PIP_SKINS.minecraft, description: 'Construindo aventuras bloco a bloco.' },
  { key: 'carros', name: 'Lumi Piloto', title: 'Carros', image: PIP_SKINS.carros, description: 'Acelerando rumo a novas conquistas.' },
  { key: 'trens', name: 'Lumi Maquinista', title: 'Trens', image: PIP_SKINS.trens, description: 'Tchu-tchuuu! Bora pra próxima estação.' },
  { key: 'robos', name: 'Lumi Robô', title: 'Robôs', image: PIP_SKINS.robos, description: 'Tecnologia e curiosidade juntos.' },
  { key: 'veiculos', name: 'Lumi Aventureiro', title: 'Veículos', image: PIP_SKINS.veiculos, description: 'Mapa, binóculos e muita exploração.' },
  // Coleção Luma (menina)
