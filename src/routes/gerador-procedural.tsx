        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 border-t pt-12">
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Define a estrutura lógica (seleção, sequência, pareamento) e vincula às habilidades da
              BNCC por faixa etária.
            </p>
          </div>
          <div className="space-y-3">
            <h3 className="font-bold text-lg flex items-center gap-2">
            ...
            <p className="text-sm text-muted-foreground">
              Combina cenários, personagens e objetos de forma estocástica para criar atividades
              únicas a cada execução.
            </p>
          </div>
          <div className="space-y-3">
            <h3 className="font-bold text-lg flex items-center gap-2">
            ...
            <p className="text-sm text-muted-foreground">
              Ajusta dinamicamente a complexidade baseando-se no histórico de performance e perfil
              neuroadaptativo.
            </p>
          </div>
        </div>
