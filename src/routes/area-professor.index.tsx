...
function TeacherArea() {
  ...
  return <Shell><div className="max-w-5xl mx-auto space-y-6"><header className="rounded-3xl bg-gradient-to-r from-indigo-700 to-violet-600 text-white p-6"><p className="text-sm font-bold opacity-80">ÁREA DO PROFESSOR</p><h1 className="text-3xl font-black">{profile.display_name||"Professor(a)"}</h1><p className="mt-2">Acesso válido até {new Date(profile.access_expires_at).toLocaleDateString("pt-BR")}</p></header>
    ...
    <Link to="/area-professor/apostilas" className="block rounded-2xl border-2 border-amber-200 bg-amber-50 p-5"><Printer className="text-amber-700"/><h2 className="font-black mt-2">Apostilas para imprimir</h2><p className="mt-1 text-sm text-muted-foreground">As aulas do app em folha A4: guia do professor, folhas da criança, gabarito e carta para a família.</p></Link>
    <Link to="/area-professor/atividades-imprimir" className="block rounded-2xl border-2 border-rose-200 bg-rose-50 p-5"><Printer className="text-rose-700"/><h2 className="font-black mt-2">Atividades para Imprimir</h2><p className="mt-1 text-sm text-muted-foreground">Atividades adaptadas prontas em A4 colorido para baixar ou imprimir.</p></Link>
    ...
    <section className="grid sm:grid-cols-2 gap-4"><div className="rounded-2xl border-2 border-indigo-200 bg-indigo-50 p-5"><Users className="text-indigo-700"/><h2 className="font-black text-lg mt-2">Conectar aluno assinante</h2><p className="text-sm text-muted-foreground mt-2">Com autorização da família, acompanhe progresso e trabalhe em conjunto.</p></div><Link to="/area-professor/tarefas" className="rounded-2xl border-2 border-sky-200 bg-sky-50 p-5"><ClipboardList className="text-sky-700"/><h2 className="font-black text-lg mt-2">Tarefa de Casa Inteligente</h2><p className="text-sm text-muted-foreground mt-2">Envie e acompanhe atividades dos alunos autorizados.</p></Link></section>
    <section className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3"><Link to="/area-professor/assistente-pedagogico" className="rounded-2xl border-2 border-violet-200 bg-violet-50 p-5"><Sparkles className="text-violet-700"/><h2 className="font-black mt-2">Assistente Pedagógico Brilha</h2><p className="mt-1 text-sm text-muted-foreground">Sugestões inclusivas com revisão do professor.</p></Link><Link to="/area-professor/biblioteca-inclusiva" className="rounded-2xl border-2 border-indigo-200 bg-indigo-50 p-5"><BookOpenCheck className="text-indigo-700"/><h2 className="font-black mt-2">Biblioteca Inclusiva</h2><p className="mt-1 text-sm text-muted-foreground">Aulas adaptadas para necessidades específicas.</p></Link><Link to="/biblioteca-pedagogica" className="rounded-2xl border bg-white p-5"><BookOpen className="text-indigo-600"/><h2 className="font-black mt-2">Consultar BNCC</h2></Link><div className="rounded-2xl border bg-white p-5"><Users className="text-indigo-600"/><h2 className="font-black mt-2">{students.length} aluno(s) conectado(s)</h2></div></section>
