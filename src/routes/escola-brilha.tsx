...
import imgLumia from "@/assets/pip-girl-professora.png";
...
const materias = [
  { id: "portugues", nome: "Português", img: imgPortugues, cor: "from-coral/30 to-coral/5", mascote: imgLumia, mascoteNome: "Professora Lumia" },
  { id: "matematica", nome: "Matemática", img: imgMatematica, cor: "from-sky/30 to-sky/5", mascote: imgLumi, mascoteNome: "Professor Lumi" },
  { id: "ciencias", nome: "Ciências", img: imgCiencias, cor: "from-success/20 to-success/5", mascote: imgLumia, mascoteNome: "Professora Lumia" },
  { id: "historia", nome: "História", img: imgHistoria, cor: "from-sun/30 to-sun/5", mascote: imgLumi, mascoteNome: "Professor Lumi" },
  { id: "geografia", nome: "Geografia", img: imgGeografia, cor: "from-lilac/30 to-lilac/5", mascote: imgLumia, mascoteNome: "Professora Lumia" },
...
const materiasInfantil = [
  { id: "trilha-palavras", nome: "ESCUTA, FALA, PENSAMENTO E IMAGINAÇÃO", img: imgLinguagemEI, cor: "from-coral/30 to-coral/5", descricao: "Trilha das Palavras", mascote: imgLumia, mascoteNome: "Professora Lumia", code_pref: "EI03EF" },
  ...
  { id: "trilha-movimentos", nome: "CORPO, GESTOS E MOVIMENTOS", img: imgNaturezaEI, cor: "from-success/20 to-success/5", descricao: "Trilha dos Movimentos", mascote: imgLumia, mascoteNome: "Professora Lumia", code_pref: "EI03CG" },
  { id: "trilha-emocoes", nome: "O EU, O OUTRO E O NÓS", img: imgArtesEI, cor: "from-indigo/30 to-indigo/5", descricao: "Trilha das Emoções", mascote: imgLumia, mascoteNome: "Professora Lumia", code_pref: "EI03EO" },
] as const;
        ...
        <div className="mb-4 flex items-end gap-3 md:gap-4">
          ...
          <div className="relative shrink-0">
            ...
            <div className="absolute -bottom-1 -right-1 bg-white rounded-full px-2 py-0.5 text-[10px] font-black text-primary border-2 border-coral shadow uppercase">
              {activeMascot?.mascot?.name || "Profª Lumia"}
            </div>
          </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
        ...
        {isTeen && (
          <div className="flex items-center gap-3 bg-card border border-border rounded-2xl px-4 py-2 shadow-sm">
            ...
            <div className="flex-1">
              <div className="text-sm font-bold leading-tight">Atividade guiada por {activeMascot?.mascot?.name || "Lumi/Lumia"}</div>
...
function AulaView({ aula, setAula, childId, childNome, activeMascot, tier, onCompleted }: { aula: any; setAula: (a: any) => void; childId: string; childNome: string; hiperfoco: string; activeMascot: any; tier: GradeTier; onCompleted?: (activityId: string) => void }) {
  ...
  const isLumiaMateria = aula.isEI || aula.materia === 'portugues';
  const mascotImg = isLumiaMateria ? imgLumia : imgLumi;
  const mascotNome = isLumiaMateria ? "Professora Lumia" : "Professor Lumi";
