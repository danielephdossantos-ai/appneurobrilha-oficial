...
const DESTINOS_KIDS: Destino[] = [
  {
    to: "/brilha-kids",
    title: "BRILHA KIDS",
    subtitle: "Mundo da Alfabetização",
  ...
  {
    to: "/historias-brilha",
    title: "Histórias Brilha",
    subtitle: "98 leituras guiadas",
  ...
  {
    to: "/tabuada-brilha",
    title: "Tabuada Brilha",
    subtitle: "Multiplicação em 3 níveis",
  ...
  {
    to: "/soletracao-brilha",
    title: "Soletração Brilha",
    subtitle: "500+ palavras com áudio",
            ...
            <div className="mt-2.5 inline-flex bg-white/90 backdrop-blur-sm px-3 py-1.5 rounded-xl border border-[#FFC93C]/70 shadow-sm max-w-[90%]">
              <p className="text-[#0d1f55] font-black text-[11px] leading-tight">
                {activeChild
                  ...
                  : "Oi! Escolha um Companheiro de Jornada para começar! 🚀"}
              </p>
            </div>
          </div>
        </div>
