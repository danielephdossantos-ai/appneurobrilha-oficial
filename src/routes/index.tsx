...
const DESTINOS_KIDS: Destino[] = [
  {
    ...
    subtitle: "Trilha do dia · com lembrete",
    gradient: "from-[#FFC93C] via-[#F59E0B] to-[#B45309]",
    glow: "rgba(255,201,60,0.75)",
    emoji: "🌟",
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <div className="mt-2">
              <div className="text-white/55 text-[9px] font-black uppercase tracking-[0.3em]">
                AJA COMO UM PROFESSOR COM OS MELHORES DIPLOMAS PEDAGÓGICOS FAZ UMA AUDIÊNCIA NO GEOGRAFIA, HISTORIA, CIÊNCIAS, INGLES, ARTES, FILOSOFIA E ENSINO RELIGIOSO SEGUEM CURRICULUM DO ALUNO. TEM METODOLOGIA , PEDAGOGIA ENTRE OUTRAS SÃO AUALS REALMENTE ADAPTADAS PRA CRIANÇAS COM DEFHTES.PRA VER SE ELE REALMENTE ESTÁ PRONTO PRA AJUDAR NO ENSINO , SE SEGUE O CURRÍCULO ESTUDANTIL, SE ES'TA COMPLETO O BNCC. SE TEM METODOLOGIA E PEDAGOGIA .
              </div>
