...
const DEMO_PROFILES: DemoProfile[] = [
  {
    diagnostico: "nenhum",
    emoji: "🌟",
    nome: "Criança Neurotípica",
    resumo: "Versão padrão da aula, sem adaptações específicas.",
  ...
  },
  {
    ...
    emoji: "⚡",
    nome: "Perfil TDAH",
    resumo: "Aulas curtas, comandos diretos, estímulos motores e reforços frequentes.",
  ...
  },
  {
    ...
    emoji: "🧩",
    nome: "Perfil TEA",
    resumo: "Linguagem literal, rotina previsível, apoio visual e baixa estimulação sensorial.",
    cor: "from-emerald-400 to-teal-500",
  },
  {
    diagnostico: "dislexia",
    emoji: "📖",
    nome: "Perfil Dislexia",
    resumo: "Foco em consciência fonológica, sílabas separadas, leitura assistida e tempo extra.",
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <header className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Demonstração ao vivo do sistema adaptativo para escolas e pais.
            </p>
          </div>
        </header>
        ...
        {!activeChild && (
          <Card className="border-amber-300 bg-amber-50 dark:bg-amber-950/30">
            <CardContent className="flex items-start gap-3 p-4 text-sm">
              ...
              <div>
                Selecione uma criança ativa no Painel dos Pais antes de aplicar um perfil demo. O
                sistema atualiza o diagnóstico dela em tempo real para mostrar as aulas adaptadas.
              </div>
            </CardContent>
          </Card>
        )}
          ...
          <Card>
            <CardContent className="p-4 flex flex-wrap items-center gap-3">
              ...
              <span className="text-xs text-muted-foreground">
                (diagnostico = <code>{activeChild.diagnostico || "—"}</code>)
              </span>
            </CardContent>
          </Card>
        )}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {DEMO_PROFILES.map((p) => {
              ...
              return (
                <Card
                  key={p.diagnostico}
                  className={`overflow-hidden transition ${isAtivo ? "ring-2 ring-primary" : ""}`}
                >
                  ...
                  <CardContent className="p-4 space-y-3">
                    ...
                    <Button
                      ...
                      onClick={() => aplicarPerfil(p.diagnostico)}
        ...
        <section>
          ...
          <p className="text-sm text-muted-foreground mb-3">
            Aplique um perfil acima, depois abra qualquer aula. A versão exibida muda automaticamente
            conforme o diagnóstico da criança ativa.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {LESSONS.map((l) => (
              <Link
                ...
                search={{ category: l.id, type: "activity" }}
                className="block"
              >
        ...
        <Card className="bg-primary/5 border-primary/20">
          <CardContent className="p-4 text-sm space-y-2">
            <div className="font-semibold">Como apresentar:</div>
            <ol className="list-decimal pl-5 space-y-1 text-muted-foreground">
              <li>Clique em <b>Aplicar este perfil</b> em "Perfil TDAH".</li>
              <li>Abra a aula <b>Vogais</b> — note a linguagem direta e o estímulo motor.</li>
              <li>Volte aqui, troque para <b>Perfil TEA</b> e reabra <b>Vogais</b>.</li>
              <li>Mostre que a mesma aula apareceu com linguagem literal e rotina previsível.</li>
              <li>Repita com <b>Dislexia</b> usando a aula <b>Sílabas</b>.</li>
            </ol>
          </CardContent>
        </Card>
      </div>
