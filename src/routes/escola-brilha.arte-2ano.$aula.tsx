    ...
    return (
      <div className="min-h-screen grid place-items-center bg-background text-foreground p-6 text-center">
        <div>
          ...
          <div className="font-black font-display">Aula de Arte não encontrada.</div>
          <button
            onClick={() => navigate({ to: "/" })}
            className="mt-4 px-4 py-2 rounded-xl bg-primary text-primary-foreground text-sm font-bold shadow-kid hover:opacity-90"
          >
            ← Voltar
          </button>
        </div>
