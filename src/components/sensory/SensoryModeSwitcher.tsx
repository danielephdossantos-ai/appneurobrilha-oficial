...
import { SensoryMode, SensoryEngine } from "@/core/sensory/engine";
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="text-[10px] bg-primary/10 text-primary px-2 py-0.5 rounded-full font-black uppercase tracking-widest">Ativo</span>
      </div>
      ...
      <div className="grid grid-cols-1 gap-3">
        {MODES.map((mode) => (
          ...
          >
            <div className={`h-12 w-12 rounded-xl shrink-0 grid place-items-center ${mode.color} transition-transform group-hover:scale-110`}>
      ...
      <p className="text-[10px] text-muted-foreground italic px-2">
        * O sistema ajusta automaticamente velocidade, estímulos, cores e reforços com base no modo selecionado.
      </p>
    </div>
  );
}
