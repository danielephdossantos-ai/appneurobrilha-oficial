        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex gap-4">
            <motion.div
              ...
              className="flex items-center gap-2 bg-yellow-50 px-4 py-1 rounded-full border border-yellow-200"
            >
            ...
            <motion.div
              whileHover={{ scale: 1.1 }}
              className="flex items-center gap-2 bg-blue-50 px-4 py-1 rounded-full border border-blue-200"
            >
              <span className="text-xl">💎</span>
        ...
        {showReward && (
          ...
          >
            <motion.div
              ...
              className="relative"
            >
              <RewardBadge stars={activity.reward.stars} coins={activity.reward.coins} />
              {[...Array(20)].map((_, i) => (
                <motion.div
                  key={i}
