...
export const LearningMap: React.FC<LearningMapProps> = ({ skills, mastery, onSkillClick }) => {
      ...
      {grades.map((grade, gIndex) => (
        <div key={grade} className="relative">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-2xl font-black uppercase tracking-tight italic">{grade}</h2>
