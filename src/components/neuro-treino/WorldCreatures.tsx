...
export type WorldKey =
  ...
  | "animais" | "herois" | "arte" | "musica" | "princesas"
  | "trens" | "robos" | "veiculos" | "oceano" | "floresta" | "castelo" | "default";

type Motion = "walk" | "fly" | "swim" | "drift" | "drive" | "bounce";
type SoundKind = "roar" | "moo" | "meow" | "tweet" | "honk" | "boop" | "chime" | "splash" | "whoosh" | "neigh" | "bark" | "robot" | "magic" | "pop";
...
const CREATURES: Record<WorldKey, Creature[]> = {
  dinossauros: [
    ...
    { id: "d2", emoji: "🦕", motion: "walk", top: "70%", duration: 30, delay: 4, sound: "roar", size: 3 },
    { id: "d3", emoji: "🦋", motion: "fly", top: "20%", duration: 18, sound: "tweet", size: 1.8 },
    { id: "d4", emoji: "🌿", motion: "bounce", top: "78%", duration: 5, delay: 1, sound: "pop", size: 1.6 },
  ],
  minecraft: [
    { id: "m1", emoji: "🐷", motion: "walk", top: "70%", duration: 24, sound: "boop", size: 2.4 },
    { id: "m2", emoji: "🐮", motion: "walk", top: "76%", duration: 28, delay: 5, sound: "moo", size: 2.4 },
  ...
  carros: [
    ...
    { id: "c2", emoji: "🚗", motion: "drive", top: "80%", duration: 11, delay: 2, sound: "honk", size: 2.6, reverse: true },
  ...
  fazendinha: [
    ...
    { id: "f2", emoji: "🐔", motion: "walk", top: "78%", duration: 18, delay: 3, sound: "tweet", size: 2 },
    { id: "f3", emoji: "🐑", motion: "walk", top: "74%", duration: 30, delay: 6, sound: "moo", size: 2.4 },
  ...
  espaco: [
    ...
    { id: "e3", emoji: "🛸", motion: "fly", top: "20%", duration: 22, delay: 4, sound: "robot", size: 2.6, reverse: true },
    { id: "e4", emoji: "⭐", motion: "bounce", top: "12%", duration: 4, sound: "chime", size: 1.6 },
    { id: "e5", emoji: "🪐", motion: "drift", top: "40%", duration: 30, delay: 6, sound: "chime", size: 2.6 },
  ],
  animais: [
    { id: "a1", emoji: "🦁", motion: "walk", top: "70%", duration: 26, sound: "roar", size: 3 },
    { id: "a2", emoji: "🐘", motion: "walk", top: "76%", duration: 34, delay: 4, sound: "roar", size: 3.4 },
    { id: "a3", emoji: "🦒", motion: "walk", top: "60%", duration: 32, delay: 8, sound: "moo", size: 3.2 },
  ...
  herois: [
    ...
    { id: "h2", emoji: "🦸‍♀️", motion: "fly", top: "22%", duration: 18, delay: 3, sound: "whoosh", size: 2.8, reverse: true },
  ...
  arte: [
    { id: "ar1", emoji: "🎨", motion: "bounce", top: "60%", duration: 5, sound: "chime", size: 2.6 },
    { id: "ar2", emoji: "🖌️", motion: "drift", top: "40%", duration: 18, sound: "magic", size: 2.4 },
    { id: "ar3", emoji: "🌈", motion: "drift", top: "20%", duration: 30, sound: "magic", size: 3 },
    { id: "ar4", emoji: "🦄", motion: "walk", top: "72%", duration: 22, delay: 2, sound: "neigh", size: 2.6 },
  ],
  musica: [
    { id: "mu1", emoji: "🎵", motion: "drift", top: "30%", duration: 12, sound: "chime", size: 2.4 },
    { id: "mu2", emoji: "🎶", motion: "drift", top: "20%", duration: 16, delay: 3, sound: "chime", size: 2.6, reverse: true },
    { id: "mu3", emoji: "🎺", motion: "bounce", top: "65%", duration: 4, sound: "honk", size: 2.6 },
    { id: "mu4", emoji: "🥁", motion: "bounce", top: "72%", duration: 3, delay: 1, sound: "pop", size: 2.4 },
  ],
  princesas: [
    { id: "p1", emoji: "👸", motion: "walk", top: "72%", duration: 26, sound: "magic", size: 2.8 },
    { id: "p2", emoji: "🦢", motion: "swim", top: "82%", duration: 22, delay: 3, sound: "splash", size: 2.4 },
  ...
  robos: [
    ...
    { id: "r2", emoji: "🤖", motion: "walk", top: "78%", duration: 26, delay: 4, sound: "robot", size: 2.4, reverse: true },
  ...
  veiculos: [
    ...
    { id: "v2", emoji: "🚚", motion: "drive", top: "80%", duration: 14, delay: 3, sound: "honk", size: 3, reverse: true },
    { id: "v3", emoji: "🏍️", motion: "drive", top: "76%", duration: 7, delay: 1, sound: "honk", size: 2.4 },
  ...
  oceano: [
    ...
    { id: "o2", emoji: "🐬", motion: "swim", top: "40%", duration: 22, delay: 3, sound: "splash", size: 2.8, reverse: true },
    { id: "o3", emoji: "🐢", motion: "swim", top: "75%", duration: 30, sound: "boop", size: 2.6 },
    { id: "o4", emoji: "🐙", motion: "drift", top: "65%", duration: 26, delay: 5, sound: "boop", size: 2.6 },
  ...
  floresta: [
    ...
    { id: "fl2", emoji: "🦋", motion: "fly", top: "30%", duration: 14, delay: 2, sound: "tweet", size: 1.8 },
    ...
    { id: "fl5", emoji: "✨", motion: "bounce", top: "50%", duration: 3, sound: "chime", size: 1.4 },
  ],
  castelo: [
    { id: "ca1", emoji: "🐉", motion: "fly", top: "28%", duration: 18, sound: "roar", size: 3.2 },
    { id: "ca2", emoji: "🦅", motion: "fly", top: "20%", duration: 20, delay: 3, sound: "tweet", size: 2.4, reverse: true },
...
function playSound(kind: SoundKind, ctxRef: { current: AudioContext | null }) {
  try {
    ...
    switch (kind) {
      case "roar":   make("sawtooth", 180, 0.55, 0.22, 70); break;
      case "moo":    make("sine", 220, 0.55, 0.2, 140); break;
      case "meow":   make("triangle", 700, 0.35, 0.18, 500); break;
      case "tweet":  make("sine", 1800, 0.12, 0.15, 2400); setTimeout(() => make("sine", 2200, 0.1, 0.12, 1800), 110); break;
      case "honk":   make("square", 280, 0.18, 0.18); setTimeout(() => make("square", 220, 0.18, 0.18), 180); break;
      case "boop":   make("triangle", 520, 0.12, 0.18); break;
      case "chime":  make("sine", 880, 0.25, 0.18, 1320); break;
      case "splash": make("sine", 600, 0.3, 0.15, 200); break;
      case "whoosh": make("sawtooth", 400, 0.4, 0.1, 80); break;
      case "neigh":  make("triangle", 380, 0.4, 0.2, 240); break;
      case "bark":   make("square", 320, 0.12, 0.2); setTimeout(() => make("square", 280, 0.12, 0.18), 130); break;
      case "robot":  make("square", 240, 0.1, 0.16); setTimeout(() => make("square", 360, 0.1, 0.16), 110); setTimeout(() => make("square", 200, 0.12, 0.16), 230); break;
      case "magic":  make("sine", 660, 0.18, 0.16, 1320); setTimeout(() => make("sine", 990, 0.18, 0.14, 1760), 140); break;
      case "pop":    make("triangle", 440, 0.08, 0.2, 220); break;
    }
  } catch {
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden z-0">
      {list.map((c) => {
        ...
        const anim =
          c.motion === "walk"   ? "creature-walk" :
          c.motion === "drive"  ? "creature-drive" :
          c.motion === "swim"   ? "creature-swim" :
          c.motion === "fly"    ? "creature-fly" :
