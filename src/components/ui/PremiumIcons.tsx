import { 
  Bird, Apple, Car, Dog, Cat, Star, Heart, Sun, Moon, Trees, Flower, Circle, Plane, Ship, Fish, 
  BookOpen, Pencil, Ruler, School, Home, Rainbow, Bug, Telescope, TestTube, Map, Satellite, 
  Brain, Target, Sparkles, Beef, Egg, Banana, Grape, Bone, Waves, Sprout, Tractor, Pizza, 
  Crown, IceCream, Music, Gift, Rocket, Bike, GlassWater, Ghost, Zap, Cloud, Triangle, Square
} from "lucide-react";
...
export const PremiumIcon = ({ name, className = "" }: { name: string; className?: string }) => {
  const map: Record<string, any> = {
    ...
    "beef": Beef, "egg": Egg, "banana": Banana, "grape": Grape, "bone": Bone,
    "waves": Waves, "sprout": Sprout, "tractor": Tractor, "pizza": Pizza,
    "crown": Crown, "icecream": IceCream, "music": Music, "gift": Gift,
    "rocket": Rocket, "bike": Bike, "glasswater": GlassWater, "ghost": Ghost,
    "zap": Zap, "cloud": Cloud, "triangle": Triangle, "square": Square
  };
...
export const RenderVisual = ({ value, className }: { value: string; className?: string }) => {
  ...
  const emojiMap: Record<string, string> = {
    "🍎": "apple", "🍏": "apple", "🚗": "car", "🐶": "dog", "🐱": "cat", "⭐": "star",
    "❤️": "heart", "☀️": "sun", "🌙": "moon", "🐦": "bird", "🌳": "tree",
    "🌸": "flower", "🌈": "rainbow", "🎓": "school", "📚": "book", "✨": "sparkles",
    "🐝": "bug", "🐘": "beef", "⛪": "home", "🥚": "egg", "🍇": "grape", "🍌": "banana",
    "🦴": "bone", "🏠": "home", "🥣": "music", "🚜": "tractor", "🌿": "tree",
    "💻": "brain", "⚽": "target", "🌊": "waves", "🌽": "sprout", "🏚️": "home", "🍕": "pizza",
    "🥩": "beef", "👑": "crown", "🍦": "icecream", "🧶": "music", "🧺": "gift",
    "🚀": "rocket", "👜": "gift", "🥛": "glasswater", "🚲": "bike", "✈️": "plane", "🚢": "ship",
    "🐮": "beef", "🐄": "beef", "🐔": "bird", "⭕": "circle", "🟦": "square", "🔺": "triangle",
    "☁️": "cloud", "🌵": "sprout", "🌻": "flower", "🎈": "gift"
  };
