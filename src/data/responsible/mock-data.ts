...
export const mockResponsibleData: MockResponsibleData = {
  ...
  focusSessions: [
    ...
    { timestamp: "2024-05-19", durationMinutes: 40, focusLevel: 0.7, sensoryMode: "foco" },
    {
      ...
      durationMinutes: 50,
      focusLevel: 0.85,
      sensoryMode: "recompensa-intensa",
    },
  ],
  alerts: [
    {
      ...
      message:
        "Lucas apresentou sinais de fadiga após 40 minutos de Matemática. Sugerimos pausas mais frequentes.",
    ...
    },
    {
      id: "2",
      type: "success",
      title: "Domínio de Habilidade",
      message: "Parabéns! Lucas atingiu domínio pleno em 'Números e Operações' (EF02MA01).",
    ...
    },
    {
      ...
      title: "Nova Sugestão",
      message:
        "Com base no desempenho em Português, recomendamos o jogo 'Aventura das Letras' para reforço.",
