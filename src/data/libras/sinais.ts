...
import letraK from "@/assets/libras/letras/k.png";
import letraL from "@/assets/libras/letras/l.png";
import letraM from "@/assets/libras/letras/m.png";
import letraN from "@/assets/libras/letras/n.png";
import letraO from "@/assets/libras/letras/o.png";
import letraP from "@/assets/libras/letras/p.png";
import letraQ from "@/assets/libras/letras/q.png";
import letraR from "@/assets/libras/letras/r.png";
import letraS from "@/assets/libras/letras/s.png";
import letraT from "@/assets/libras/letras/t.png";
import letraU from "@/assets/libras/letras/u.png";
import letraV from "@/assets/libras/letras/v.png";
import letraW from "@/assets/libras/letras/w.png";
import letraX from "@/assets/libras/letras/x.png";
import letraY from "@/assets/libras/letras/y.png";
import letraZ from "@/assets/libras/letras/z.png";
...
import numSeis from "@/assets/libras/numeros/seis.png";
import numSete from "@/assets/libras/numeros/sete.png";
import numOito from "@/assets/libras/numeros/oito.png";
import numNove from "@/assets/libras/numeros/nove.png";
import numDez from "@/assets/libras/numeros/dez.png";
...
export const TRILHAS: Trilha[] = [
  ...
  },
  {
    ...
    sinais: [
      ...
      { id: "d", nome: "D", imagem: letraD, nivel: 1,
      ...
      { id: "e", nome: "E", imagem: letraE, nivel: 1,
      ...
      { id: "f", nome: "F", imagem: letraF, nivel: 1,
      ...
      { id: "g", nome: "G", imagem: letraG, nivel: 1,
      ...
      { id: "h", nome: "H", imagem: letraH, nivel: 1,
      ...
      { id: "k", nome: "K", imagem: letraK, nivel: 2,
        instrucao: "Letra K: indicador e médio em V, com o polegar no meio dos dois.",
        passos: ["Indicador e médio em V", "Polegar entre eles", "Palma para frente"] },
      { id: "l", nome: "L", imagem: letraL, nivel: 2,
        instrucao: "Letra L: polegar e indicador esticados formando um L.",
        passos: ["Indicador para cima", "Polegar para o lado", "Forma um L"] },
      { id: "m", nome: "M", imagem: letraM, nivel: 2,
        instrucao: "Letra M: mão fechada com o polegar passando por baixo de três dedos.",
        passos: ["Mão fechada", "Polegar por baixo", "De três dedinhos"] },
      { id: "n", nome: "N", imagem: letraN, nivel: 2,
        instrucao: "Letra N: mão fechada com o polegar passando por baixo de dois dedos.",
        passos: ["Mão fechada", "Polegar por baixo", "De dois dedinhos"] },
      { id: "o", nome: "O", imagem: letraO, nivel: 2,
        instrucao: "Letra O: curve todos os dedinhos tocando o polegar formando uma bolinha.",
        passos: ["Dedos curvados", "Tocam o polegar", "Forma um O"] },
      { id: "p", nome: "P", imagem: letraP, nivel: 2,
        instrucao: "Letra P: como a letra K, mas com a mão apontada para baixo.",
        passos: ["Indicador e médio em V", "Polegar no meio", "Mão apontada para baixo"] },
      { id: "q", nome: "Q", imagem: letraQ, nivel: 2,
        instrucao: "Letra Q: polegar e indicador apontados para baixo, outros dedos fechados.",
        passos: ["Polegar e indicador esticados", "Apontados para baixo", "Outros fechados"] },
      { id: "r", nome: "R", imagem: letraR, nivel: 3,
        instrucao: "Letra R: indicador e médio cruzados, palma para frente.",
        passos: ["Dois dedos para cima", "Indicador e médio cruzados", "Palma para frente"] },
      { id: "s", nome: "S", imagem: letraS, nivel: 3,
        instrucao: "Letra S: mão bem fechada como um soquinho, polegar por cima dos dedos.",
        passos: ["Mão fechada", "Polegar por cima", "Palma para frente"] },
      { id: "t", nome: "T", imagem: letraT, nivel: 3,
        instrucao: "Letra T: mão fechada com o polegar aparecendo entre o indicador e o médio.",
        passos: ["Mão fechada", "Polegar entre dois dedos", "Aparece de fora"] },
      { id: "u", nome: "U", imagem: letraU, nivel: 3,
        instrucao: "Letra U: indicador e médio esticados juntinhos para cima.",
        passos: ["Dois dedos para cima", "Bem juntinhos", "Palma para frente"] },
      { id: "v", nome: "V", imagem: letraV, nivel: 3,
        instrucao: "Letra V: indicador e médio em V, separados.",
        passos: ["Dois dedos para cima", "Em forma de V", "Palma para frente"] },
      { id: "w", nome: "W", imagem: letraW, nivel: 3,
        instrucao: "Letra W: indicador, médio e anelar esticados para cima.",
        passos: ["Três dedos para cima", "Indicador, médio e anelar", "Palma para frente"] },
      { id: "x", nome: "X", imagem: letraX, nivel: 3,
        instrucao: "Letra X: indicador dobrado como um ganchinho, outros dedos fechados.",
        passos: ["Indicador em ganchinho", "Outros fechados", "Palma para frente"] },
      { id: "y", nome: "Y", imagem: letraY, nivel: 3,
        instrucao: "Letra Y: polegar e mindinho esticados, outros dedos fechados.",
        passos: ["Polegar para o lado", "Mindinho para cima", "Outros fechados"] },
      { id: "z", nome: "Z", imagem: letraZ, nivel: 3,
        instrucao: "Letra Z: indicador para cima e desenhe um Z no ar.",
        passos: ["Indicador para cima", "Desenhe um Z no ar", "Três risquinhos"] },
    ],
  },
  {
    slug: "numeros",
    ...
    sinais: [
      ...
      { id: "3", nome: "Três", imagem: numTres, nivel: 1,
      ...
      { id: "5", nome: "Cinco", imagem: numCinco, nivel: 2,
      ...
      { id: "6", nome: "Seis", imagem: numSeis, nivel: 2,
        instrucao: "Número 6: polegar encosta no mindinho, três dedos para cima.",
        passos: ["Polegar no mindinho", "Três dedos para cima", "Palma para frente"] },
      { id: "7", nome: "Sete", imagem: numSete, nivel: 2,
        instrucao: "Número 7: polegar encosta no anelar, três dedos para cima.",
        passos: ["Polegar no anelar", "Três dedos para cima", "Palma para frente"] },
      { id: "8", nome: "Oito", imagem: numOito, nivel: 3,
        instrucao: "Número 8: polegar encosta no dedo do meio, três dedos para cima.",
        passos: ["Polegar no médio", "Três dedos para cima", "Palma para frente"] },
      { id: "9", nome: "Nove", imagem: numNove, nivel: 3,
        instrucao: "Número 9: polegar encosta no indicador formando uma rodinha, três dedos para cima.",
        passos: ["Polegar no indicador", "Forma uma rodinha", "Três dedos para cima"] },
      { id: "10", nome: "Dez", imagem: numDez, nivel: 3,
        instrucao: "Número 10: mão fechada com o polegar para cima, balançando.",
        passos: ["Mão fechada", "Polegar para cima", "Balance de leve"] },
    ],
  },
  {
    slug: "familia",
