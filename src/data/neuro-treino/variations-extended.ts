...
export const DISCRIMINACAO_AUDITIVA_VARS: Variation[] = range(30).map((i) => {
  ...
  return { id:`da-${i+1}`, payload:{ ...b, ordem: i % 2 === 0 ? [b.par1, b.par2] : [b.par2, b.par1] } };
});
...
const ARTIC_BANK = [
  ...
  { palavra:"RODA", silabas:["RO","DA"], emoji:"⚙️", fonema:"R" },
  { palavra:"TERRA", silabas:["TER","RA"], emoji:"🌎", fonema:"R" },
  { palavra:"CARRO", silabas:["CAR","RO"], emoji:"🚗", fonema:"R" },
  { palavra:"BURRO", silabas:["BUR","RO"], emoji:"🫏", fonema:"R" },
  { palavra:"FLOR", silabas:["FLOR"], emoji:"🌸", fonema:"R" },
  { palavra:"SAPO", silabas:["SA","PO"], emoji:"🐸", fonema:"S" },
  { palavra:"SOPA", silabas:["SO","PA"], emoji:"🍲", fonema:"S" },
  { palavra:"SOL", silabas:["SOL"], emoji:"☀️", fonema:"S" },
  { palavra:"ZEBRA", silabas:["ZE","BRA"], emoji:"🦓", fonema:"Z" },
  { palavra:"LEÃO", silabas:["LE","ÃO"], emoji:"🦁", fonema:"L" },
  { palavra:"BOLA", silabas:["BO","LA"], emoji:"⚽", fonema:"L" },
  { palavra:"LULA", silabas:["LU","LA"], emoji:"🦑", fonema:"L" },
  { palavra:"PIPA", silabas:["PI","PA"], emoji:"🪁", fonema:"P" },
  { palavra:"FADA", silabas:["FA","DA"], emoji:"🧚", fonema:"F" },
  { palavra:"FOCA", silabas:["FO","CA"], emoji:"🦭", fonema:"F" },
  { palavra:"MOLA", silabas:["MO","LA"], emoji:"🌀", fonema:"M" },
  { palavra:"NUVEM", silabas:["NU","VEM"], emoji:"☁️", fonema:"N" },
  { palavra:"VACA", silabas:["VA","CA"], emoji:"🐮", fonema:"V" },
  { palavra:"TATU", silabas:["TA","TU"], emoji:"🦔", fonema:"T" },
];
export const ARTICULACAO_SONS_VARS: Variation[] = range(30).map((i) => {
  ...
  return { id:`as-${i+1}`, payload:{ ...b, silaba_foco: b.silabas[nivelSilaba], nivel: 1 + (i % 3) } };
});

// F3. VOCABULÁRIO SEMÂNTICO — qual item NÃO pertence ao grupo?
const VOCAB_BANK = [
  { grupo:"Animais 🐾", itens:["🐱 Gato","🐶 Cachorro","🐭 Rato","🍎 Maçã"], intruso:"🍎 Maçã" },
  { grupo:"Frutas 🍎", itens:["🍌 Banana","🍓 Morango","🚗 Carro","🍇 Uva"], intruso:"🚗 Carro" },
  { grupo:"Brinquedos 🧸", itens:["⚽ Bola","🧸 Ursinho","🎮 Videogame","🥕 Cenoura"], intruso:"🥕 Cenoura" },
  { grupo:"Transportes 🚗", itens:["🚂 Trem","✈️ Avião","🚲 Bike","🐮 Vaca"], intruso:"🐮 Vaca" },
  { grupo:"Roupas 👕", itens:["👕 Camiseta","👖 Calça","🧦 Meia","🍕 Pizza"], intruso:"🍕 Pizza" },
  { grupo:"Comidas 🍽️", itens:["🍎 Maçã","🥕 Cenoura","🍞 Pão","🚀 Foguete"], intruso:"🚀 Foguete" },
  { grupo:"Móveis 🛋️", itens:["🛋️ Sofá","🛏️ Cama","🪑 Cadeira","🐠 Peixe"], intruso:"🐠 Peixe" },
  { grupo:"Instrumentos 🎵", itens:["🎸 Guitarra","🥁 Bateria","🎹 Piano","🔨 Martelo"], intruso:"🔨 Martelo" },
  { grupo:"Cores ❤️", itens:["🔴 Vermelho","🔵 Azul","🟢 Verde","🥛 Leite"], intruso:"🥛 Leite" },
  { grupo:"Escola 📚", itens:["📚 Livro","✏️ Lápis","📏 Régua","🦁 Leão"], intruso:"🦁 Leão" },
  { grupo:"Esportes ⚽", itens:["⚽ Futebol","🏀 Basquete","🎾 Tênis","🎂 Bolo"], intruso:"🎂 Bolo" },
  { grupo:"Flores 🌸", itens:["🌸 Sakura","🌻 Girassol","🌹 Rosa","🚁 Helicóptero"], intruso:"🚁 Helicóptero" },
  { grupo:"Oceano 🌊", itens:["🐬 Golfinho","🦈 Tubarão","🐙 Polvo","🦅 Águia"], intruso:"🦅 Águia" },
  { grupo:"Profissões 👨‍⚕️", itens:["👨‍⚕️ Médico","👩‍🏫 Professora","👮 Policial","🌵 Cacto"], intruso:"🌵 Cacto" },
  { grupo:"Planetas 🪐", itens:["🌍 Terra","🌕 Lua","🪐 Saturno","🐧 Pinguim"], intruso:"🐧 Pinguim" },
];
...
export const TOQUE_SEQUENCIA_VARS: Variation[] = range(30).map((i) => {
  ...
  return { id:`ts-${i+1}`, payload:{ pontos, ordem: pontos.map(p => p.id), tempoLimite: 20 + qtd * 3 } };
});
...
const RITMO_BANK = [
  ...
  { padrao:["●","●","●","─"], simbolos:["curto","curto","curto","longo"], durMs:[200,200,200,600] },
...
export const COPIAR_FIGURA_VARS: Variation[] = range(30).map((i) => {
  const rows = 4, cols = 4;
  const cells: number[][] = range(rows).map(r => range(cols).map(c => ((i + r * 3 + c * 7) % 3 === 0 ? 1 : 0)));
...
export const MEMORIA_VISUAL_VARS: Variation[] = range(30).map((i) => {
  ...
  const cols = tam, rows = Math.ceil(tam * 0.8);
...
export const REACAO_RAPIDA_VARS: Variation[] = range(30).map((i) => {
  ...
  const rounds = 5 + (i % 5);
  const seq = range(rounds).map(k => ({ tipo: (k + i) % 3 === 0 ? "erro" : "alvo", emoji: (k + i) % 3 === 0 ? t.erro : t.alvo }));
...
export const SEGUIR_INSTRUCAO_VARS: Variation[] = range(30).map((i) => {
  ...
  const shuffled = [...b.itens].sort(() => (i % 2 ? -1 : 1));
  return { id:`si2-${i+1}`, payload:{ instrucao: b.instrucao, itens: shuffled, correta: b.correta } };
});
...
const LETRASSOM_BANK = [
  { fonema:"B", imagens:[{e:"⚽",n:"BOLA"},{e:"🐱",n:"GATO"},{e:"☀️",n:"SOL"},{e:"🌙",n:"LUA"}], correta:"BOLA" },
  { fonema:"C", imagens:[{e:"🏠",n:"CASA"},{e:"🐸",n:"SAPO"},{e:"🦆",n:"PATO"},{e:"🌸",n:"FLOR"}], correta:"CASA" },
  { fonema:"G", imagens:[{e:"🐱",n:"GATO"},{e:"⚽",n:"BOLA"},{e:"🚂",n:"TREM"},{e:"🍎",n:"MAÇÃ"}], correta:"GATO" },
  { fonema:"P", imagens:[{e:"🦆",n:"PATO"},{e:"🌙",n:"LUA"},{e:"🐱",n:"GATO"},{e:"⭐",n:"ESTRELA"}], correta:"PATO" },
  { fonema:"S", imagens:[{e:"☀️",n:"SOL"},{e:"🐶",n:"CACHORRO"},{e:"🏠",n:"CASA"},{e:"⚽",n:"BOLA"}], correta:"SOL" },
  { fonema:"L", imagens:[{e:"🌙",n:"LUA"},{e:"🚗",n:"CARRO"},{e:"🍎",n:"MAÇÃ"},{e:"🐸",n:"SAPO"}], correta:"LUA" },
  { fonema:"F", imagens:[{e:"🌸",n:"FLOR"},{e:"⚽",n:"BOLA"},{e:"🌙",n:"LUA"},{e:"🏠",n:"CASA"}], correta:"FLOR" },
  { fonema:"M", imagens:[{e:"🍎",n:"MAÇÃ"},{e:"🌸",n:"FLOR"},{e:"⚽",n:"BOLA"},{e:"🚗",n:"CARRO"}], correta:"MAÇÃ" },
  { fonema:"T", imagens:[{e:"🚂",n:"TREM"},{e:"🐶",n:"CACHORRO"},{e:"☀️",n:"SOL"},{e:"🌸",n:"FLOR"}], correta:"TREM" },
  { fonema:"V", imagens:[{e:"🐮",n:"VACA"},{e:"⭐",n:"ESTRELA"},{e:"🍌",n:"BANANA"},{e:"🏠",n:"CASA"}], correta:"VACA" },
  { fonema:"D", imagens:[{e:"👆",n:"DEDO"},{e:"🌙",n:"LUA"},{e:"⚽",n:"BOLA"},{e:"🐱",n:"GATO"}], correta:"DEDO" },
  { fonema:"N", imagens:[{e:"☁️",n:"NUVEM"},{e:"🍎",n:"MAÇÃ"},{e:"🚗",n:"CARRO"},{e:"🌸",n:"FLOR"}], correta:"NUVEM" },
  { fonema:"R", imagens:[{e:"🐭",n:"RATO"},{e:"🐱",n:"GATO"},{e:"🏠",n:"CASA"},{e:"☀️",n:"SOL"}], correta:"RATO" },
  { fonema:"J", imagens:[{e:"🪟",n:"JANELA"},{e:"⚽",n:"BOLA"},{e:"🐸",n:"SAPO"},{e:"🌙",n:"LUA"}], correta:"JANELA" },
  { fonema:"Z", imagens:[{e:"🦓",n:"ZEBRA"},{e:"🍎",n:"MAÇÃ"},{e:"🐱",n:"GATO"},{e:"🏠",n:"CASA"}], correta:"ZEBRA" },
];
export const LETRA_SOM_VARS: Variation[] = range(30).map((i) => {
  ...
  return { id:`ls2-${i+1}`, payload:{ fonema: b.fonema, imagens: shuffled, correta: b.correta } };
});
