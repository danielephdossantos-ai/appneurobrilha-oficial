...
export const OBJETO_IMG: Record<string, string> = {
  ...
  "LEÃO": leao, LEAO: leao, TIGRE: tigre, MACACO: "https://cdn-icons-png.flaticon.com/512/3069/3069172.png",
...
export const EMOJI_IMG: Record<string, string> = {
  ...
  "🦊": raposa,
  "🐰": coelho,
  "🐼": panda, "🐨": "https://cdn-icons-png.flaticon.com/512/3069/3069165.png", "🐵": "https://cdn-icons-png.flaticon.com/512/3069/3069172.png",
  "🦁": leao,
  "🐯": tigre,
  "🧸": ursinho,
  "🎁": presente, "🎀": presente,
