...
export const PORTUGUESE_SKILLS: Skill[] = [
  {
    ...
    description: "Expressar ideias, desejos e sentimentos sobre suas vivências, por meio da linguagem oral e escrita (escrita não convencional).",
...
export const MATH_SKILLS: Skill[] = [
  {
    ...
    neuroStrategies: ["Material concreto", "Reforço visual intenso", "Quantidade reduzida de itens"],
...
export const SCIENCE_SKILLS: Skill[] = [
  {
    ...
    bnccCode: "EF01CI01",
    title: "Corpo Humano",
    description: "Comparar características físicas entre os colegas, reconhecendo a diversidade e a importância da valorização de cada um.",
