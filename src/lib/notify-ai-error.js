 ...
 */
export function notificarErroIA(motivo, contexto) {
    const prefixo = contexto ? `${contexto}: ` : "";
    if (motivo === "creditos") {
        toast.warning(`${prefixo}A ajuda da IA acabou por hoje 💤`, {
            id: "ia-limite-diario",
            description: "A criança já usou toda a cota de IA do dia. Volte amanhã que o Professor Brilha estará descansado e pronto pra ajudar de novo!",
            duration: 8000,
        });
        return;
    }
