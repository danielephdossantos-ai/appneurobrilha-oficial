-- Recria o validador do contrato obrigatório da aula e conecta o trigger na tabela lessons.
...
-- Conecta o trigger na tabela lessons (bloqueia INSERT/UPDATE incompletos).
